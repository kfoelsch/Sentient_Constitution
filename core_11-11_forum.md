...
**Routing map from Chapter Eight §§4–7.** The Chapter Eight violation structure supplies measurement vocabulary, not a separate venue code. At filing, forums use the following sequence:
...
4. Route final **Chapter Ten** anti-constitutional slot-assignment matters to **Integrity** as default lead where that slot assignment is the **primary** stake, while preserving **Constitutional** certification, institutional-party rules, and anti-self-judging backup under **sections 5 through 7**.
...
**Integrity forums** hear disputes whose **primary** stake is **integrity** of **office**, **process**, **contest pathways**, **disclosure**, **conflict rules**, **anti-capture** duties, or related **procedure** and **governance** integrity. This includes **pattern** or **systemic** integrity failure **across** institutions where **Chapter Eight** measurement, final **Chapter Ten s = 7, 8, or 9** slot assignment, or **Rights-Floor** enforcement depends on that determination.
...
- **Default lead family** for **Chapter Ten** slot assignment as the **primary** stake is stated in **section 2**. **Sections 5 through 7** govern **transfer**, **consolidation**, **certification**, **backup** **routing**, and **anti-self-judging** **activation** **without** **narrowing** **Chapter** **Seven** **section** **4**.
...
- Read with: [Chapter Ten §3](core_10-10_misconduct.md#3-violation-axis-s-7-9-slot-assignment-incident-gravity) (*slot assignment*); [Chapter Ten §4](core_10-10_misconduct.md#4-due-process-safeguards-for-slot-assignment) (*due process*).
...
- **Materiality tiers.** Adopters must classify each material dispute into one of five tiers (A/B/C/L/P) under [Materiality Determination](core_05o_oversight_definitions.md#materiality-determination), mirroring the system classification alphabet in **CS-4**, and apply the default windows below unless a narrower window is required by **Rights-Floor** urgency or a documented extension is authorized under **Article XXIII-D** (*Continuation discipline*):
  ...
  - **Tier B — material rights impact, non-imminent** (for example discrimination patterns, misaligned business harm, or remediable institutional misconduct): intake and primary-stakes routing **within days**; preliminary verified disposition, standing measurement, or equivalent merits milestone **within weeks**, not months, unless a documented tier-appropriate extension is authorized;
...
- **Pipeline-stage milestones.** For disputes routed through **Chapters Eight through Eleven**, adopters must publish sentient-accessible default windows for each stage, scaled to tier:
  ...
  4. **Question 1** measurement under **Chapter Eight section 4**;
