...
>
> This file is **part of the Sentient Constitution** and is **binding only together** with the other numbered `core_*` files read as one instrument. It contains **Chapter Eleven**: forum families, default venue and primary-stakes routing, forensic support, intake triage, and jurisdiction for disputes under the standing pipeline and Rights Floor. Forums **supervise** dispute handling under the [Constitutional Tetrad](core_00_preamble.md#constitutional-tetrad) **participation**, **oversight**, and **timeliness** legs, scaled to [material stake](core_00_preamble.md#material-stake). When the facts are verified, they may **open, update, or correct** standing records — or **set a bad record aside on challenge** — under [Chapter Eight §2.4](core_08-08_standing_assessment.md#3-standing-record-operational-requirements); a filed case is not standing by itself, and forum narrative must not substitute for Chapter Eight standing measurement ([Chapter Eight §2.4.6](core_08-08_standing_assessment.md#36-forum-boundary)). Read [Chapters Eight–Eleven constitutional compass](core_08-08_standing_assessment.md#chapters-eight-eleven-constitutional-compass) first. Operational forum mechanics remain in designated implementation files. Chapter numbering and cross-references match the integrated instrument. Reading order, the binding/support split, and corpus edition metadata are maintained in [README.md](README.md).
...
> - **Chapters Eight–Nine three-question pipeline:** Chapter Eight **sections 2–3** answer Question 1 (*what happened?*) through verified, axis-pure records. [Chapter Eight sections 4–7](core_08-08_standing_assessment.md#4-standing-measurement-evaluation-dimensions) answer Question 2 (*how good or bad was it?*) through evaluation dimensions and the shared **s** = 1...9 grammar. [Chapter Nine](core_09-09_standing_integration.md#chapter-nine-standing-effects-and-integration) answers Question 3 (*what happens because of it?*) through remedies, safeguards, competency gates, and standing locks. Supplemental descriptors may inform routing and assessment, but none of those layers is restated here or relocates final **Chapter Ten s = 7, 8, or 9** slot assignment.
...
- Upstream: [Chapter Eight](core_08-08_standing_assessment.md#chapter-eight-compliance-violation-and-standing-model) (*Question 1 records and Question 2 measurement that supply disputes this chapter routes*); [Chapter Eight §3.5](core_08-08_standing_assessment.md#5-slot-grammar-and-display-labels) (*standing-slot grammar*); [Chapter Nine §2.1](core_09-09_standing_integration.md#71-shared-domain-lenses-cross-axis-vocabulary) (*cross-axis domain lenses*); [Chapter Nine §2.2](core_09-09_standing_integration.md#72-stackable-benefit-and-stewardship-descriptors-contribution-state-supplement) (*Contribution Axis supplemental descriptors*); [Chapter Nine §3.9](core_09-09_standing_integration.md#73-stackable-harm-and-conduct-descriptors-violation-nature-supplement) (*Violation Axis supplemental descriptors*); [Chapter Ten](core_10-10_misconduct.md#chapter-ten-anti-constitutional-misconduct) (*final top-slot classification*); [Chapters Two through Four](core_02-03_definition_mechanics.md) (*record, verification, and tracing expectations*); [Chapter Five](core_05-05_definitions_a_independent.md#chapter-five-foundational-definitions) (*foundational definitions*); [Chapter One](core_01_c_stewardship_capacity_principles.md#chapter-01-principles-and-constraints) (*interpretive constraints*); [Chapter Six — Foundational Rights](core_06-06_rights_part_a.md#chapter-six-foundational-rights) through [Part D](core_06-06_rights_part_d.md) (*challenge, audit, and justice-article hooks*).
...
- Read with: [Chapter Eight §3.5](core_08-08_standing_assessment.md#5-slot-grammar-and-display-labels) (*standing-slot grammar*); [Chapter Nine §2.1](core_09-09_standing_integration.md#71-shared-domain-lenses-cross-axis-vocabulary) (*cross-axis domain lens table*); [Chapter Nine §2.2](core_09-09_standing_integration.md#72-stackable-benefit-and-stewardship-descriptors-contribution-state-supplement) (*Contribution Axis supplemental descriptors*).
...
**Routing map from Chapter Eight §3.** The Chapter Eight violation structure supplies measurement vocabulary, not a separate venue code. At filing, forums use the following sequence:
...
- Read with: [Chapter Eight §3.5](core_08-08_standing_assessment.md#5-slot-grammar-and-display-labels) (*standing-slot grammar*); [Chapter Eight §3.7.1](core_08-08_standing_assessment.md#71-contribution-axis-bands-and-table-2) (*Contribution Axis primary category defaults*); [Chapter Nine §2.1](core_09-09_standing_integration.md#71-shared-domain-lenses-cross-axis-vocabulary) (*cross-axis domain lens table*); [Chapter Nine §2.2](core_09-09_standing_integration.md#72-stackable-benefit-and-stewardship-descriptors-contribution-state-supplement) (*Contribution Axis supplemental descriptors*); [Chapter Nine §3.9](core_09-09_standing_integration.md#73-stackable-harm-and-conduct-descriptors-violation-nature-supplement) (*Violation Axis supplemental descriptors informing primary stake*); [Chapter Eight §3.7.2](core_08-08_standing_assessment.md#72-violation-axis-severity-ladder) (*severity ladder*); [Chapter Nine §3](core_09-09_standing_integration.md#6-extended-axis-ii-legal-hybrid-duty-and-harm-descriptors) (*process / response character*); [Evidence Preservation](core_05o_oversight_definitions.md#evidence-preservation); [corpus_forum.md](corpus_forum.md) (**CF-5**); [Chapter Ten §3](core_10-10_misconduct.md#3-violation-axis-s-7-9-slot-assignment-incident-gravity) (*final Violation Axis s = 7, 8, or 9 assignment*); [Chapter Ten §4](core_10-10_misconduct.md#4-due-process-safeguards-for-slot-assignment) (*due process for final Chapter Ten slot assignment read with this chapter and **Article XXIII** (*Conflict Resolution, Escalation, and Emergency Proportionality*)*); [Article XXIII-A](core_06-06_rights_part_d.md#article-xxiii-a-justice-objective-and-scope) (*justice objective and scope*).
...
- **Pipeline-stage milestones.** For disputes routed through **Chapters Eight through Eleven**, adopters must publish sentient-accessible default windows for each stage, scaled to tier:
  ...
  3. **Question 1** verified finding and **standing record** opening under **Chapter Eight sections 2–3**;
  4. **Question 2** measurement under **Chapter Eight sections 4–7**;
  5. **Question 3** integration under **Chapter Nine**;
...
- **Anti-delay floor:** The following are non-compliant where they foreseeably nullify rights, remedies, or timely protection:
  ...
  - treating allegations as verified standing inputs to buy time ([Chapter Eight §2.4.1](core_08-08_standing_assessment.md#verified-inputs-for-standing));
