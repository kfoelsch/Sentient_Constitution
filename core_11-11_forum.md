...
>
> This file is **part of the Sentient Constitution** and is **binding only together** with the other numbered `core_*` files read as one instrument. It contains **Chapter Eleven**: forum families, default venue and primary-stakes routing, forensic support, intake triage, and jurisdiction for disputes under the standing pipeline and Rights Floor. Forums **supervise** dispute handling under the [Constitutional Tetrad](core_00_preamble.md#constitutional-tetrad) **participation**, **oversight**, and **timeliness** legs, scaled to [material stake](core_00_preamble.md#material-stake). When the facts are verified, they may **open, update, or correct** standing records — or **set a bad record aside on challenge** — under [Chapter Eight §3](core_08-08_standing_assessment.md#3-standing-record-operational-requirements); a filed case is not standing by itself, and forum narrative must not substitute for Chapter Eight standing-record classification ([Chapter Eight §3.6](core_08-08_standing_assessment.md#36-forum-boundary)). Read [Chapters Eight–Eleven constitutional compass](core_08-08_standing_assessment.md#chapters-eight-eleven-constitutional-compass) first. Operational forum mechanics remain in designated implementation files. Chapter numbering and cross-references match the integrated instrument. Reading order, the binding/support split, and corpus edition metadata are maintained in [README.md](README.md).
...
- Read with: [Constitutional Tetrad](core_00_preamble.md#constitutional-tetrad) — **participation**, **oversight**, and **timeliness** legs; [material stake](core_00_preamble.md#material-stake) scaling for primary-stakes routing; [Chapter Eight §5](core_08-08_standing_assessment.md#5-slot-grammar-and-display-labels) (*standing-slot grammar*); [Chapter Nine Chapter One §8.1](core_09-09_standing_integration.md#71-shared-domain-lenses-cross-axis-vocabulary) (*cross-axis domain lens table*); [Chapter Eight §7](core_09-09_standing_integration.md#72-stackable-benefit-and-stewardship-descriptors-contribution-state-supplement) (*Contribution Axis supplemental descriptors*); [Chapter Nine §3.9](core_09-09_standing_integration.md#73-stackable-harm-and-conduct-descriptors-violation-nature-supplement) (*Violation Axis supplemental descriptors informing primary stake*); [corpus_forum.md](corpus_forum.md) (**CF-5** and **CF-7.2**); [corpus_systems.md](corpus_systems.md) (*system classification, deployment, and revalidation duties*); [Chapter Ten §3](core_10-10_misconduct.md#3-violation-axis-s-7-9-slot-assignment-incident-gravity) (*final Violation Axis s = 7, 8, or 9 assignment*); [Chapter Ten §4](core_10-10_misconduct.md#4-due-process-safeguards-for-slot-classification) (*due process for final Chapter Ten slot assignment read with this chapter and **Article XXIII** (*Conflict Resolution, Escalation, and Emergency Proportionality*)*); [Article XXIII-A](core_06-06_rights_part_d.md#article-xxiii-a-justice-objective-and-scope) (*justice objective and scope*).
...
**Routing map from Chapter Eight §§4–7.** The Chapter Eight violation structure supplies classification vocabulary, not a separate venue code. At filing, forums use the following sequence:
...
- **Anti-self-judging backup.** Where material allegations warrant independent merits review of **Integrity** forum integrity in a Chapter Ten slot-classification proceeding, backup routing under **sections 6 and 7** applies without narrowing **Chapter Ten section 4** or **Article XXIII** (*Conflict Resolution, Escalation, and Emergency Proportionality*).
...
- Read with: [Chapter Eight §5](core_08-08_standing_assessment.md#5-slot-grammar-and-display-labels) (*standing-slot grammar*); [Chapter Eight §7.1](core_08-08_standing_assessment.md#71-contribution-axis-bands-and-table-2) (*Contribution Axis primary category defaults*); [Chapter Nine Chapter One §8.1](core_09-09_standing_integration.md#71-shared-domain-lenses-cross-axis-vocabulary) (*cross-axis domain lens table*); [Chapter Nine Chapter One §8.2](core_09-09_standing_integration.md#72-stackable-benefit-and-stewardship-descriptors-contribution-state-supplement) (*Contribution Axis supplemental descriptors*); [Chapter Nine §3.9](core_09-09_standing_integration.md#73-stackable-harm-and-conduct-descriptors-violation-nature-supplement) (*Violation Axis supplemental descriptors informing primary stake*); [Chapter Eight §7.2](core_08-08_standing_assessment.md#72-violation-axis-severity-ladder) (*severity ladder*); [Chapter Nine §3](core_09-09_standing_integration.md#6-extended-axis-ii-legal-hybrid-duty-and-harm-descriptors) (*process / response character*); [Evidence Preservation](core_05o_oversight_definitions.md#evidence-preservation); [corpus_forum.md](corpus_forum.md) (**CF-5**); [Chapter Ten §3](core_10-10_misconduct.md#3-violation-axis-s-7-9-slot-assignment-incident-gravity) (*final Violation Axis s = 7, 8, or 9 assignment*); [Chapter Ten §4](core_10-10_misconduct.md#4-due-process-safeguards-for-slot-classification) (*due process for final Chapter Ten slot assignment read with this chapter and **Article XXIII** (*Conflict Resolution, Escalation, and Emergency Proportionality*)*); [Article XXIII-A](core_06-06_rights_part_d.md#article-xxiii-a-justice-objective-and-scope) (*justice objective and scope*).
...
- Downstream: [§13](#8-anti-gaming-and-interim-relief) (*interim relief while certification completes*); [Chapter Sixteen](core_16-16_incorporation.md) (*implementation routing for **Article V-E** (*Sentience-Status Adjudication Floor*) implementation design*).
...
- Detailed institutional design, appointment mechanics, filing conditions, and sequencing route to adopted implementation text under **Chapter Sixteen** incorporation discipline and **must not** narrow the **Article V-E** (*Sentience-Status Adjudication Floor*) floor.
...
- Final anti-constitutional misconduct assignments remain **anchored** in **Chapter Ten**. **Forum** **families** **apply** **independent** **review** and **due-process** **requirements** stated there (especially **Chapter Ten**, **section 4**) and in **Article XXIII** (*Conflict Resolution, Escalation, and Emergency Proportionality*).
...
- **Pipeline-stage milestones.** For disputes routed through **Chapters Eight through Eleven**, adopters must publish sentient-accessible default windows for each stage, scaled to tier:
  ...
  4. **Question 1** classification under **Chapter Eight section 4**;
...
- **Anti-delay floor:** The following are non-compliant where they foreseeably nullify rights, remedies, or timely protection:
  ...
  - treating allegations as verified standing inputs to buy time ([Chapter Eight §3.1](core_08-08_standing_assessment.md#verified-inputs-for-standing));
