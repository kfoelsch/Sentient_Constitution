...
*In plain terms: this section assigns constitutional **participation** and **oversight** through forum families that **supervise** dispute handling on the standing pipeline — default starting points, routing, remediation sequencing, and coordination for disputes tied to Chapter Eight measurement, Chapter Ten designation, earlier definitional chapters, and the Rights Floor — then states accountability requirements for published threshold placement. Detailed hearing rules live elsewhere and may not quietly shrink what this chapter guarantees.*

This chapter states which **forum families** **supervise** which primary questions through **participation** (sentient-accessible challenge, representative treatment, and proportionate access) and **oversight** (independence, forensic support, and traceable merits review). It does **not** specify docket rules, staffing, budgets, granular procedure, or operational escalation mechanics. Those details belong in corpus implementation layers which must **implement, not narrow**, this chapter. This chapter defines **constitutional forum families** and **default jurisdiction** for **supervising** application of **Chapter Eight** (separate Contribution and Violation records measured on the §7 unified proportional LEQU scale, character descriptors, and standing effect), **Chapter Ten** where an anti-constitutional-misconduct designation is at issue for a Chapter Eight slot 7–9 record, **Chapters Two through Five**, and **Chapter Six** (*Foundational Rights*). Verified findings may **open, update, or correct** standing records — or **set a bad record aside on challenge** — under [Chapter Eight §3](core_08-08_standing_assessment.md#3-standing-record-operational-requirements) when they satisfy the verified-input gate; a filed case is not standing by itself, and forum narrative must not substitute for Chapter Eight standing measurement ([Chapter Eight §3.6](core_08-08_standing_assessment.md#36-forum-boundary)).
...
- Read with: [Constitutional Tetrad](core_00_preamble.md#constitutional-tetrad) — **participation**, **oversight**, and **timeliness** legs; [material stake](core_00_preamble.md#material-stake) scaling for primary-stakes routing; [Chapter Eight §5.1](core_08-08_standing_assessment.md#6-slot-grammar-and-display-labels) (*standing-slot grammar*); [Chapter Eight §7 unified scale](core_08-08_standing_assessment.md#7-unified-proportional-lequ-scale) (*shared five-times LEQU bands and separate axis records*); [Chapter Nine §2.1](core_09-09_standing_integration.md#71-shared-domain-lenses-cross-axis-vocabulary) (*cross-axis domain lens table*); [Chapter Nine §2.2](core_09-09_standing_integration.md#72-stackable-benefit-and-stewardship-descriptors-contribution-state-supplement) (*Contribution Axis supplemental descriptors*); [Chapter Nine §3.9](core_09-09_standing_integration.md#73-stackable-harm-and-conduct-descriptors-violation-nature-supplement) (*Violation Axis character descriptors informing primary stake without moving the impact slot*); [corpus_forum.md](corpus_forum.md) (**CF-5** and **CF-7.2**); [corpus_systems.md](corpus_systems.md) (*system classification, deployment, and revalidation duties*); [Chapter Ten §3](core_10-10_misconduct.md#3-violation-axis-s-7-9-slot-assignment-incident-gravity) (*anti-constitutional-misconduct designation for qualifying Chapter Eight slots 7–9; legacy anchor preserved*); [Chapter Ten §4](core_10-10_misconduct.md#4-due-process-safeguards-for-slot-assignment) (*due process for that designation read with this chapter and **Article XXIII** (*Conflict Resolution, Escalation, and Emergency Proportionality*)*); [Article XXIII-A](core_06-06_rights_part_d.md#article-xxiii-a-justice-objective-and-scope) (*justice objective and scope*).
...
| **Integrity** | **Integrity** as **the** main issue (including **grave** breach of conflict, procedure, or capture controls), official **constitutional alignment recognition** or **ongoing alignment validation** for systems, **or** a **Chapter Ten** anti-constitutional-misconduct designation for a Chapter Eight **s = 7, 8, or 9** impact slot as **the** **primary** stake | **Integrity** of office, process, contest pathways, disclosure, conflict rules, anti-capture duties, official system-alignment recognition, validation, and revalidation using technical-forum inputs and Environment forum environmental-alignment component determinations where material (**including** **pattern** or **systemic** failure **across** institutions or systems where **Chapter Eight** measurement, a corresponding **Chapter Ten** designation, or **Rights-Floor** enforcement depends on that determination) |
...
- **Anti-self-judging backup.** Where material allegations warrant independent merits review of **Integrity** forum integrity in a Chapter Ten designation proceeding concerning a Chapter Eight slot 7–9 record, backup routing under **sections 6 and 7** applies without narrowing **Chapter Ten section 4** or **Article XXIII** (*Conflict Resolution, Escalation, and Emergency Proportionality*).
...
- Read with: [Chapter Eight §5.1](core_08-08_standing_assessment.md#6-slot-grammar-and-display-labels) (*standing-slot grammar*); the [Chapter Eight §7 unified scale](core_08-08_standing_assessment.md#7-unified-proportional-lequ-scale) (*shared five-times LEQU bands for separately recorded axes*); [Chapter Nine §2.1](core_09-09_standing_integration.md#71-shared-domain-lenses-cross-axis-vocabulary) (*cross-axis domain lens table*); [Chapter Nine §2.2](core_09-09_standing_integration.md#72-stackable-benefit-and-stewardship-descriptors-contribution-state-supplement) (*Contribution Axis supplemental descriptors*); [Chapter Nine §3.9](core_09-09_standing_integration.md#73-stackable-harm-and-conduct-descriptors-violation-nature-supplement) and [Chapter Nine §3](core_09-09_standing_integration.md#6-extended-axis-ii-legal-hybrid-duty-and-harm-descriptors) (*Violation Axis character descriptors informing primary stake without moving the verified-impact slot*); [Evidence Preservation](core_05o_oversight_definitions.md#evidence-preservation); [corpus_forum.md](corpus_forum.md) (**CF-5**); [Chapter Ten §3](core_10-10_misconduct.md#3-violation-axis-s-7-9-slot-assignment-incident-gravity) (*designation for qualifying Chapter Eight slots 7–9*); [Chapter Ten §4](core_10-10_misconduct.md#4-due-process-safeguards-for-slot-assignment) (*due process for that designation read with this chapter and **Article XXIII** (*Conflict Resolution, Escalation, and Emergency Proportionality*)*); [Article XXIII-A](core_06-06_rights_part_d.md#article-xxiii-a-justice-objective-and-scope) (*justice objective and scope*).
...
- **Default lead family** for a **Chapter Ten** designation as the **primary** stake is stated in **section 2**. **Sections 5 through 7** govern **transfer**, **consolidation**, **certification**, **backup** **routing**, and **anti-self-judging** **activation** without authorizing Chapter Ten or a forum to assign or move the numeric slot.
...
- Read with: [Chapter Eight §7 unified scale](core_08-08_standing_assessment.md#7-unified-proportional-lequ-scale) (*verified-impact slot assignment*); [Chapter Ten §3](core_10-10_misconduct.md#3-violation-axis-s-7-9-slot-assignment-incident-gravity) (*corresponding designation; legacy anchor preserved*); [Chapter Ten §4](core_10-10_misconduct.md#4-due-process-safeguards-for-slot-assignment) (*due process*).
...
- Upstream: [Article XXIV-C](core_06-06_rights_part_d.md#article-xxiv-c-timely-resolution-and-anti-delay-floor) (*timely, efficient, and just floor*); [README — Standing pipeline and forums](README.md#standing-pipeline-and-forums); [Article XII-B](core_06-06_rights_part_c.md#article-xii-b-right-to-challenge-review-and-redress) (*challenge and redress access*); [Article XXIII-D](core_06-06_rights_part_d.md#article-xxiii-d-emergency-measures-and-continuation-burden) (*continuation discipline*).
...
- **Materiality tiers.** Adopters must classify each material dispute into one of five tiers (A/B/C/L/P) under [Materiality Determination](core_05o_oversight_definitions.md#materiality-determination), mirroring the system classification alphabet in **CS-4**, and apply the default windows below unless a narrower window is required by **Rights-Floor** urgency or a documented extension is authorized under **Article XXIII-D** (*Continuation discipline*):
  - **Tier A — imminent or dependency-vulnerable ongoing harm, or final high-impact review** (for example acute care-duty failure, ongoing violence, participation-barrier injury in dependency-asymmetric settings, a final Chapter Eight **Violation Axis s = 7, 8, or 9** impact-slot review, or the corresponding **Chapter Ten** designation where applicable): lawful **interim protection** must be available without waiting for full merits; intake, acknowledgment, and evidence preservation must begin **within days**, not weeks, unless [Force Majeure](core_05a_accountability_definitions.md#force-majeure-constitutional) or a documented safety constraint prevents it;
