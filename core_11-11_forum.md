...
- Read with: [Chapter Eight §5.1](core_08-08_standing_assessment.md#6-slot-grammar-and-display-labels) (*standing-slot grammar*); [Chapter Nine §3](core_09-09_standing_integration.md#3-shared-descriptor-and-attachment-normalization) (*cross-axis domain lens table*); [Chapter Nine §3](core_09-09_standing_integration.md#3-shared-descriptor-and-attachment-normalization) (*Contribution Axis supplemental descriptors*).
- Read also with: [Chapter Nine §3](core_09-09_standing_integration.md#3-shared-descriptor-and-attachment-normalization) (*Violation Axis supplemental descriptors read with section 2 primary-stakes routing*); [README.md](README.md) (*reading order and corpus organization*); [doc_architecture.md](doc_architecture.md) (*non-binding editorial maps unless adopted*).
