...
- **What it is**
  - **In scope:** Governance decisions whose subject is authorization of governing authority itself:
    ...
    - Owner: [Chapter Twelve Chapter One §4.1](core_12_governance.md#41-entitlement-and-eligibility).
