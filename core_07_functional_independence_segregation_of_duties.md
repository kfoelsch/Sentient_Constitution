...
>
> - **Constitutional owner:** the distinct-seat floor for materially binding acts; independence from the actor and the actor's [Material Control Line](core_05_band_accountability.md#material-control-line); published lane and role placement; conflict, vacancy, substitution, and wrong-seat routing; proportionate merged hosting; attributable handoffs; and the minimum independence conditions that every later constitutional process must apply.
...
>
> Reading order: §1 purpose and scope → §2 four-seat floor → §3 independence and conflicts → §4 published placement and substitutes → §5 proportional scaling → §6 emergencies → §7 handoffs and wrong-seat routing → §8 downstream application.
...
3. **[Record Seat](core_05_band_accountability.md#record-seat)** — enters, versions, holds, preserves, and publishes the official record of what the Verify-or-Authorize Seat determined.
...
- Downstream: [§4](#4-published-placement-vacancy-and-substitution); [§7](#7-attributable-handoffs-and-wrong-seat-routing); Chapter Eight certification component roles; Chapter Nine record custody; Chapter Twelve forum anti-self-judging.
...
<a id="4-published-placement-vacancy-and-substitution"></a>
...
- Downstream: [§7](#7-attributable-handoffs-and-wrong-seat-routing); [CI-3.2](corpus_institutions/ci_03_institutional_design_separation_of_powers.md#ci-32-functional-separation-lanes); [CI-4.5](corpus_institutions/ci_04_appointment_competency_rotation_removal.md#ci-45-authorized-roles-and-accountability-chains); Chapter Eight and Chapter Nine records.
...
<a id="5-proportional-scaling-and-merged-hosting"></a>
...
Scarce staffing, speed, convenience, or concentration of expertise does not by itself justify a merger. The higher the material stake, the stronger the presumption of separate offices, competency redundancy, and independent substitutes.

<a id="6-emergency-and-urgent-action"></a>
...
*In plain terms: a real emergency may justify acting before the ordinary check finishes. It does not let the actor certify its own continuation, erase the trail, or become the final reviewer afterward.*
...
Emergency action does not permit the actor to verify its own continuation, become record custodian for a conflicted record, hear the challenge to its act, or convert temporary necessity into permanent authority. A deadline, release target, staffing shortage, or reputational concern is not by itself an emergency.

<a id="7-attributable-handoffs-and-wrong-seat-routing"></a>
### 7. Attributable Handoffs and Wrong-Seat Routing

<details>
<summary><strong><span style="color: #2563eb;">Trace</span></strong></summary>

- Upstream: [§2](#2-four-seat-constitutional-floor) through [§6](#6-emergency-and-urgent-action); [Attributable Action](core_05_band_accountability.md#attributable-action-constitutional); [Attribution Integrity](core_05_band_accountability.md#attribution-integrity-constitutional).
- Downstream: [CS-4 §10](corpus_systems/cs_04_critical_system_stewardship.md#10-inspectable-attributable-action); [CI-4.6 shared seat rules](corpus_institutions/ci_04_appointment_competency_rotation_removal.md#ci-46-shared-seat-rules); every process record governed by §8.
...
*In plain terms: when a step is not yours, do not silently take it and do not simply walk away. Say which seat must act, preserve what arrived, log the gap, and pass the matter to the right place.*

Every materially binding act's record must identify, at a minimum:

- the act and governing authority;
- the initiating seat;
- the verify-or-authorize seat and standard applied;
- the record seat and version entered;
- the contest seat or published challenge route;
- every delegation, recusal, substitution, permitted merger, or emergency departure; and
- the material handoffs, refusals, conditions, unresolved objections, and clocks.
...
Logs prove who did what; they do not by themselves verify the underlying act. A self-generated log, signature, model trace, checklist, or attestation is an input to independent verification, not a substitute for it.

<a id="8-relationship-to-later-processes"></a>
### 8. Relationship to Later Processes

<details>
<summary><strong><span style="color: #2563eb;">Trace</span></strong></summary>

- Upstream: [§1](#1-purpose-scope-and-owner-boundary) through [§7](#7-attributable-handoffs-and-wrong-seat-routing).
...
Every later constitutional process must identify how it instantiates the four seats and satisfies this chapter. In particular:
