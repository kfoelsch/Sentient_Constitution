...
Limitations on constitutional **values** — including **Chapter Six** Rights-Floor protections and other principles and protections subject to tradeoff under [§5](#6-process-conflict-resolution) — must be proportionate to the magnitude and likelihood of the **harm** or **systemic impact** legitimately addressed, consistent with [Proportionality](core_05_band_accountability.md#proportionality) in **Chapter Five**.
...
- **Delayed disclosure** and **limited disclosure** — permitted only where [§7.3](#621-preservation-of-epistemic-integrity) conditions are met, under [Necessity](core_05_band_accountability.md#necessity) and [Proportionality](core_05_band_accountability.md#proportionality), and with maximum feasible [Epistemic Integrity](core_05_band_oversight.md#epistemic-integrity).
