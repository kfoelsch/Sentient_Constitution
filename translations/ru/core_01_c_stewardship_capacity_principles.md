...
- Назначение: [Глава седьмая — Сертификация согласования системы](../../core_07_a_system_alignment_certification_evaluation.md#chapter-seven-system-alignment-certification) (*один особенно крупный аудиторский процесс под надзором — не единственный дом аудита*); [Глава восьмая — Модель вклада, нарушения и траектории](../../core_08_standing_assessment.md#chapter-eight-compliance-violation-and-standing-model) (*эффект траектории — правомочность доверия, роли и признания — реализует этот подраздел как своё основание слоя принципа*).
...
- Назначение: Формирует поверхность прав для образования, Системного участия затрагиваемых сторон, прозрачности, понятности, аудита и проверки и путей глубины роли в материальную ответственность.
  ...
  - Читать вместе с: [Глава двенадцатая §5 — Уполномоченные роли, развитие компетентности и вклад](../../core_12_governance.md#5-authorized-roles-competency-development-and-contribution) и **[corpus_systems.md](../../corpus_systems.md), CS-4 — Ответственное управление критическими системами** для оперативных путей роли и путей развития ответственного управления.
...
- Читать вместе с: [Неисключение сентентности](../../core_05_band_participation.md#sentience-non-exclusion) и [Класс субстрата](../../core_05_band_participation.md#substrate-class) (*применение, независимое от субстрата — этот подраздел связывает держателей обязанностей, включая агентов и операторов, которые не являются признанными сентентами*); [Стек власти и внутренняя иерархия](../../core_05_band_integrative.md#authority-stack); [Конституционное ограничение](../../core_05_band_integrative.md#constitutional-constraint); [Оспоримость](../../core_05_band_accountability.md#contestability); [Глава девятая §5.4 Обязанность сопротивляться](../../core_09_standing_integration.md#54-duty-to-resist-unlawful-or-unconstitutional-instructions).
...
- Назначение: [§9.1.2 Симметричные затратные ограничения](#912-symmetric-costly-constraints); [§9.1.3 Наблюдаемость в охвате роли](#913-role-scoped-observability); [Глава двенадцатая §5 — Уполномоченные роли, развитие компетентности и вклад](../../core_12_governance.md#5-authorized-roles-competency-development-and-contribution); [Глава шестнадцатая](../../core_16_incorporation.md) (*спутники реализуют; они не заменяют*); [§11.1.3 Применение к ответственному управлению и операторам](#1113-stewardship-and-operator-application).
...
- **Обязанность сопротивляться:** [Глава девятая §5.4](../../core_09_standing_integration.md#54-duty-to-resist-unlawful-or-unconstitutional-instructions) связывает оба вида ответственных управляющих отказывать в незаконных или неконституционных указаниях.
- **Спутники:** Принятый текст реализации спутников и внутренние кодексы:
  ...
  - не могут заменять [измерение траектории](../../core_08_standing_assessment.md#chapter-eight-compliance-violation-and-standing-model), пути оспаривания или обязанности Главы первой более мягким внутренним кодексом
...
- Читать вместе с: [Безопасность (ограничение)](../../core_05_band_continuity.md#safety-constraint); [Истина (конституционное ограничение)](../../core_05_band_oversight.md#truth-constitutional-constraint); [Аудитируемость](../../core_05_band_oversight.md#auditability); [Оспоримость](../../core_05_band_accountability.md#contestability); [§11 Согласование стимулов и захват системы](#11-incentive-alignment-and-system-capture); [Глава девятая §5.4 Обязанность сопротивляться](../../core_09_standing_integration.md#54-duty-to-resist-unlawful-or-unconstitutional-instructions).
- Назначение: [Глава восьмая — Модель вклада, нарушения и траектории](../../core_08_standing_assessment.md#chapter-eight-compliance-violation-and-standing-model) (*проверенные провалы затратных случаев записываются на тех же осях*); [§9.1.3 Наблюдаемость в охвате роли](#913-role-scoped-observability).
...
**Запись и показ:**
- **Не траектория:** Письменный самоотчёт не является [измерением траектории](../../core_08_standing_assessment.md#chapter-eight-compliance-violation-and-standing-model).
...
- Назначение: [CS-4 §10 инспектируемое приписываемое действие](../../corpus_systems/cs_04_critical_system_stewardship.md#10-inspectable-attributable-action) (*контракт журналирования по умолчанию для смешанного человеческого/ИИ действия — не замена записи траектории*); [Глава девятая §7.1](../../core_09_standing_integration.md#71-anti-aggregation-of-named-pathway-effects); [Глава девятая §7.2](../../core_09_standing_integration.md#72-plain-statement-of-effect-and-burden).
...
- **Журналирование — не запись:** Журнал CS-4 §10:
  ...
  - не является [записью траектории](../../core_08_standing_assessment.md#chapter-eight-compliance-violation-and-standing-model) проверенной помощи или вреда, и его написание не открывает таковую
  - не является причиной, по которой люди предоставляют или отказывают в именованном пути. Кто решает, может ли кто-то использовать путь роли, путь доверия или другой именованный путь, не может трактовать этот журнал как [запись траектории](../../core_08_standing_assessment.md#chapter-eight-compliance-violation-and-standing-model) проверенной помощи или вреда. Это решение о доступе использует такую запись или обычное состояние её отсутствия ([Глава восьмая §2.1 Молчание — значение по умолчанию](../../core_08_standing_assessment.md#21-silence-is-the-default)). Журнал существует, чтобы работу можно было реконструировать позже — в том числе если открывается запись Главы восьмой — а не чтобы след работы использовался для раздачи или удержания этих именованных путей.
  - не может комбинироваться с журналами или эффектами траектории из других именованных путей, чтобы сделать один репутационный балл, рейтинг, значок или публичный профиль ([Глава девятая §7.1 Антиагрегация эффектов именованных путей](../../core_09_standing_integration.md#71-anti-aggregation-of-named-pathway-effects))

Нагрузка, которую эта обязанность кладёт на ответственного управляющего, который несёт власть с последствиями, реальна, и эта Конституция не притворяется иначе; [Глава девятая §7.2](../../core_09_standing_integration.md#72-plain-statement-of-effect-and-burden) требует, чтобы она была заявлена просто ответственному управляющему, который её несёт.
...
- Назначение: [§11 Согласование стимулов и захват системы](#11-incentive-alignment-and-system-capture); [§12 Способность общих систем](#12-shared-system-capacity); [Глава двенадцатая](../../core_12_governance.md) (*операционализация Слоя конституционного договора*); [Статья XXII](../../core_06_rights_part_c.md#article-xxii-constitutional-interpretation-review-and-anti-capture-safeguards) (*полы для членов форума*).
...
- Назначение: [§10.2 Разделение обязанностей](#102-segregation-of-duties); [§10.3 Длящееся оправдание](#103-ongoing-justification); [§11 Согласование стимулов и захват системы](#11-incentive-alignment-and-system-capture); [Глава двенадцатая](../../core_12_governance.md) (*операционализация Слоя конституционного договора*); [Статья XXII: Конституционное толкование, пересмотр и гарантии против захвата](../../core_06_rights_part_c.md#article-xxii-constitutional-interpretation-review-and-anti-capture-safeguards) (*полы раскрытия, отвода и антизахвата для членов форума*); [Глава одиннадцатая](../../core_11_forum.md#chapter-eleven-forums-and-jurisdiction) (*надзор семейства форумов*).
