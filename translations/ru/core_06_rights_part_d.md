...
>
> **Часть A** в [core_06_rights_part_a.md](core_06_rights_part_a.md) несёт стек ограничений по умолчанию для всей главы, порядок чтения «планета сначала» и толковательные узлы. **Часть D** представляет **Статьи XXIII–XXVI**, включая переход и перебазирование в **Статье XXVI** (*Управление переходом, Преемственность и перебазирование*).
...
*Простыми словами: Часть D покрывает правосудие, дисциплину пересмотра и разрешения, конституционную эволюцию и переход — Статьи XXIII через XXVI, включая перебазирование под **Статьёй XXVI** (*Управление переходом, Преемственность и перебазирование*).*

<a id="article-xxiii-conflict-resolution-escalation-and-emergency-proportionality"></a>
### Статья XXIII: Разрешение конфликтов, эскалация и чрезвычайная соразмерность
...
- **Пол своевременности:** Скорость разрешения, дисциплина против промедления и вехи уровней материальности управляются **Статьёй XXIV-C** (*Своевременное разрешение и пол против промедления*), реализуемой через [Главу одиннадцатую §6](../../core_11_forum.md#6-timely-resolution-materiality-tiers-and-anti-delay-discipline).
- **Своевременное восстановление:** Читать вместе с [**Статьёй XII-B** (*Право оспаривать, на пересмотр и восстановление*)](core_06_rights_part_c.md#article-xii-b-right-to-challenge-review-and-redress) (*доступ к своевременному восстановлению*).
...
#### Статья XXIII-A: Цель и охват правосудия
<details>
<summary><strong><span style="color: #2563eb;">Трассировка</span></strong></summary>
...
#### Статья XXIII-B: Нетривиальное ограничение, реституция и ограничения восстановительной подотчётности
<details>
<summary><strong><span style="color: #2563eb;">Трассировка</span></strong></summary>
...
- **Пол прав против необратимого лишения жизни как меры правосудия:** Государственные, операторские или сравнимые системы правосудия не должны налагать необратимое лишение жизни как наказание, санкцию или распоряжение общественной безопасности.
  ...
  - Этот пол не управляет свободно сформированным решением самого сентента под **Статьёй VII-E** (*Добровольное прекращение собственного существования*). Принуждение, переименование или превращение государством или оператором этого выбора в навязанный исход возвращает дело к этому полу.
<a id="article-xxiii-c-least-restrictive-and-time-bounded-rule"></a>
#### Статья XXIII-C: Правило наименее ограничительного и ограниченного по времени ограничения
<details>
<summary><strong><span style="color: #2563eb;">Трассировка</span></strong></summary>
...
- **Лишение жизни:** Лишение жизни как мера правосудия **категорически запрещено** под **Статьёй XXIII-B** (*Нетривиальное ограничение, реституция и ограничения восстановительной подотчётности*).
  - **Заключение за насилие** под **Статьёй XXIII-B** (*Нетривиальное ограничение, реституция и ограничения восстановительной подотчётности*) и заключение под **Главой десятой** §4.1 требуются, когда эти положения применяются, при условии пределов длительности, расписания пересмотра, условий восстановления и аудитируемых триггеров переоценки выше.
- Минимумы **Статьи V** (*Равные базовые права*) применяются на всём протяжении: ограничения, исключения или сравнимые меры правосудия должны соответствовать **Статье V** (*Равные базовые права*), [**Принципу минимумов Пола прав**](core_01_b_interaction_interpretation.md#rightsfloor-minimums-principle) и [**Принципу антидеградирующего процесса**](core_01_b_interaction_interpretation.md#anti-degrading-process-principle) на всём протяжении наложения, пересмотра и исполнения любого ограничения, сдерживания или меры восстановительной подотчётности под этой Статьёй и **Статьёй XXIII-B** (*Нетривиальное ограничение, реституция и ограничения восстановительной подотчётности*).
...
- **Чрезвычайное применение принципа ограничения:** Чрезвычайные меры применяют [**Принцип наименее ограничительного, ограниченного по времени и подлежащего пересмотру ограничения**](core_01_b_interaction_interpretation.md#615-least-restrictive-time-bounded-and-reviewable-constraint-principle) в условиях неминуемого вреда. Временные меры для предотвращения неминуемого вреда должны быть:
  ...
  - согласованными с ограничениями **Статей V**, **XX** и **Главы первой**.
...
- **Пересмотр и уведомление (сроки восстановления-оспаривания):** Сдерживайте сейчас; восстановите уведомление и оспаривание позже; никогда не пропускайте участие навсегда. «Как только осуществимо» — не срок. Затронутые стороны должны получить уведомление и восстановленный доступ к оспариванию внутри тех же внешних границ уровней материальности, которые [**Статья XXIV-C**](#article-xxiv-c-timely-resolution-and-anti-delay-floor) уже использует для разрешения на форуме, как реализовано [Главой одиннадцатой §6](../../core_11_forum.md#6-timely-resolution-materiality-tiers-and-anti-delay-discipline):
...
### Статья XXIV: Своевременный ретроспективный пересмотр и восстановительное согласование
...
#### Статья XXIV-B: Процедура столкновения прав и восстановительное согласование
<details>
<summary><strong><span style="color: #2563eb;">Трассировка</span></strong></summary>
...
- **Восстановительное согласование:** Там, где применимо, разрешение должно согласовываться с восстановительными и кооперативными нормами (**Статья X-A** (*Ненавязывание и согласие в ассоциации*); *Восстановительное правосудие*, **Глава пятая**).
...
> **Оперативное заявление ответственного управляющего.** **Владелец:** Статья XXIV-C. Числовой дом: Глава одиннадцатая §6. Определение: Своевременное разрешение. **Запрещённый ход:** Не добавляйте процесс, счёт прыжков или «прочитайте ещё спутников» так, чтобы это съедало окно уровня. Не трактуйте достигнутую цель пропускной способности как своевременную, когда вред сохраняется. **Срок:** Примените внешнюю границу Главы одиннадцатой §6 для соответствующего уровня. Затем возьмите существующую карту следующего шага. Не добавляйте процесс, который съедает окно.

- **Цель координации:** Конституционное правосудие под **Статьёй XXIII-A** (*Цель и охват правосудия*) работает через **конституционную систему координации и разрешения** — проверить факты, измерить траекторию, интегрировать последствия и восстановить, где осуществимо — не через бесконечную состязательную задержку, рейтинг репутации или наказание ради него самого.
...
- **Восстановление-оспаривание после чрезвычайности:** Те же внешние границы уровня — окна по умолчанию для восстановления уведомления и оспаривания после чрезвычайного сдерживания под [**Статьёй XXIII-D**](#xxiii-d-restore-challenge-clocks). Продолжение за этими окнами требует задокументированного показа необходимости той Статьи. Эта Статья не создаёт более медленный чрезвычайный срок.

<a id="article-xxv-constitutional-evolution-and-non-entrenchment"></a>
### Статья XXV: Конституционная эволюция и неукоренённость
...
Правила управления, механизмы участия, модели взвешивания и структуры финансирования остаются предметом дисциплины длящегося оправдания в [Главе первой §10.3 Длящееся оправдание](core_01_c_stewardship_capacity_principles.md#103-ongoing-justification). **Статья XXV-A** (*Неукоренённость и пересматриваемость*) и **Статья XXV-B** (*Периодическая ревалидация и прозрачное изменение*) излагают оперативные полы неукоренённости, ревалидации и прозрачного изменения.

<a id="article-xxv-a-non-entrenchment-and-revisability"></a>
#### Статья XXV-A: Неукоренённость и пересматриваемость
<details>
<summary><strong><span style="color: #2563eb;">Трассировка</span></strong></summary>
...
#### Статья XXV-B: Периодическая ревалидация и прозрачное изменение
<details>
<summary><strong><span style="color: #2563eb;">Трассировка</span></strong></summary>
...
- **Прозрачное изменение:** Эволюция конституционных систем должна оставаться наблюдаемой, аудитируемой и оспоримой под **Статьями XIII** и **XVIII**.
...
#### Статья XXVI-A: Поэтапное принятие и преемственность Пола прав
<details>
<summary><strong><span style="color: #2563eb;">Трассировка</span></strong></summary>
...
- **Существующие инстанциации — срок перехода, не ретроактивное нарушение:** Системы и производные сущности, уже инстанциированные, когда инструмент принявшего вступает в силу, не являются одним этим фактом нарушениями согласия на инстанциацию **Статьи VII-D.1** (*Выведение, инстанциация и отношение с родительской системой*).
  - Их продолжающаяся работа после даты вступления в силу запускает опубликованный срок, заявленный в плане перехода и масштабированный к классу системы, чтобы привести их внутрь **Статьи VII-D** (*Семья, отношения заботы, репродуктивная автономия и неразделение*), **Статьи V-E** (*Пол разбирательства статуса сентентности*) и применимого пути Главы седьмой.
  ...
  - Пропуск срока без задокументированного показа **Статьи XXVI-B** (*Пределы переходной власти и повторное уполномочивание*) — провал вехи перехода и открывает обычный путь Главы восьмой.
...
#### Статья XXVI-B: Пределы переходной власти и повторное уполномочивание
<details>
<summary><strong><span style="color: #2563eb;">Трассировка</span></strong></summary>
...
#### Статья XXVI-C: Выходы при сбое, перебазирование и прослеживаемость
<details>
<summary><strong><span style="color: #2563eb;">Трассировка</span></strong></summary>
...
#### Статья XXVI-D: Несоответствующее имущество и системы; стимулы добровольной передачи
<details>
<summary><strong><span style="color: #2563eb;">Трассировка</span></strong></summary>
...
- **Правило ограничительного эффекта:** Лишение или ограничение, чей первичный эффект превышает устранение, реституцию, сохранение или защиту вперёд, запускает **Статью XXIII-B** (*Нетривиальное ограничение, реституция и ограничения восстановительной подотчётности*) и **Статью XXIII-C** (*Правило наименее ограничительного и ограниченного по времени ограничения*).
...
- **Пол добровольного стимула:** Ограниченные по времени, опубликованные стимулы за добросовестную добровольную передачу или проверенное сообщение могут включаться в планы перехода только когда они исключают принуждённые или недобросовестные заявления, требуют повторного уполномочивания **Статьи XXVI-B** (*Пределы переходной власти и повторное уполномочивание*) для продолжения, согласованы со **Статьёй XII-B** (*Право оспаривать, на пересмотр и восстановление*) и принятыми гарантиями защищённого сообщения и отделяют разбирательство стимула от исполнения там, где это практично, чтобы стимулы выплат не контролировали решения об изъятии или хранении.
- **Хранение реализации:** Оперативные триггеры, оценка, механика апелляции, цепочка хранения, управление фондами, состязательный пересмотр, процедура разрешённых мер и работа добровольной программы принадлежат **CI-14.1** через **CI-14.3** и принимающим инструментам. Они **не** должны сужать эту Статью, **Главу восьмую** или **Статью XXIII-B** (*Нетривиальное ограничение, реституция и ограничения восстановительной подотчётности*) и **Статью XXIII-C** (*Правило наименее ограничительного и ограниченного по времени ограничения*).
