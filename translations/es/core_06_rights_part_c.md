...
- Origen: Principios: Capítulo Uno [§3.1 Seguridad](core_01_a_values_principles.md#31-safety-harm-constraint), [§3.2 Verdad](core_01_a_values_principles.md#32-truth-epistemic-integrity-constraint), [§4 Confianza](core_01_a_values_principles.md#4-system-stability-enabler-trust-coordination-integrity), [4.1 Resiliencia y diseño de autosanación](core_01_a_values_principles.md#41-resilience-and-self-healing-design), [Capítulo Uno §6.3 Minimización de la carga evitable](core_01_b_interaction_interpretation.md#63-minimization-of-avoidable-burden) y [Capítulo Siete §3 Evaluación de certificación del sistema entero](../../core_08_a_system_alignment_certification_evaluation.md#3-whole-system-certification-evaluation).
...
- Origen: Principios: Capítulo Uno [§3.2 Verdad](core_01_a_values_principles.md#32-truth-epistemic-integrity-constraint), [§4 Confianza](core_01_a_values_principles.md#4-system-stability-enabler-trust-coordination-integrity) y [Capítulo Siete §3 Evaluación de certificación del sistema entero](../../core_08_a_system_alignment_certification_evaluation.md#3-whole-system-certification-evaluation).
...
**El Capítulo Siete no es una cuarta capa.** La [certificación de alineación del sistema](../../core_08_a_system_alignment_certification_evaluation.md#chapter-eight-system-alignment-certification) es un proceso grande, supervisado por foro, que **usa** esta pila. Debe satisfacer las capas 1–2. Los modos hermanos (auditoría de registro de clasificación, auditoría de registro de tipos de datos, verificación de pretensiones, monitoreo continuo) también usan la pila. Ninguno de ellos es un hogar nuevo.
...
- **Supervisión → auditoría → SAC:** Bajo la pata **supervisión** de la [Tétrada Constitucional](core_00_preamble.md#constitutional-tetrad), este Artículo es el hogar de Piso de Derechos para auditar.
  ...
  - La [Certificación de alineación del sistema](core_05_band_continuity.md#system-alignment-certification-constitutional) bajo el [Capítulo Siete](../../core_08_a_system_alignment_certification_evaluation.md#chapter-eight-system-alignment-certification) es un proceso de auditoría especialmente grande y de alto enjuego — supervisado por foro, multidominio y portador de reconocimiento — entre modos hermanos de auditoría:
...
- Origen: Principios: Capítulo Uno [§3.1 Seguridad](core_01_a_values_principles.md#31-safety-harm-constraint), [Capítulo Siete §3 Evaluación de certificación del sistema entero](../../core_08_a_system_alignment_certification_evaluation.md#3-whole-system-certification-evaluation) y [§15 Aplicación integrada](core_01_c_stewardship_capacity_principles.md#15-integrated-application).
...
- Origen: Principios: Capítulo Uno [§3.1 Seguridad](core_01_a_values_principles.md#31-safety-harm-constraint), [Capítulo Uno §5 Libertad](core_01_a_values_principles.md#5-freedom-bounded-agency) y [Capítulo Siete §3 Evaluación de certificación del sistema entero](../../core_08_a_system_alignment_certification_evaluation.md#3-whole-system-certification-evaluation).
...
- **No sustitución:** Los criterios, etiquetas, puntuaciones, barras de competencia, habilitaciones de competencia y bloqueos de trayectoria gobiernan solo la elegibilidad de rol. No deben:
  ...
  - tratar la ausencia de un registro de trayectoria como un hecho adverso, o exigir un registro o una atestación de «sin registro» como condición de lo esencial de supervivencia, el comercio ordinario o la participación como parte afectada — no tener registro es el estado ordinario bajo el [Capítulo Ocho §2.1](../../core_09_standing_assessment.md#21-silence-is-the-default) (*El silencio es lo predeterminado*);
  - ensamblar efectos de vías nominadas en un perfil, una clasificación o una exhibición pública — [Capítulo Nueve §7.1](../../core_10_standing_integration.md#71-anti-aggregation-of-named-pathway-effects) (*Antiagregación de efectos de vías nominadas*).
...
- **Pluralismo e impugnabilidad:** Las evaluaciones de trayectoria deben permanecer pluralistas, auditables, lo bastante transparentes para una revisión significativa, e impugnables.
  ...
  - Las [barras de competencia y habilitaciones](../../core_10_standing_integration.md#62-competency-bars-and-clearances) y el reconocimiento positivo de trayectoria deben permanecer impugnables, revisables y no monopolísticos.
- **Supervisión de foro e impugnación del registro:** Las familias de foros del [Capítulo Once](core_11_forum.md#chapter-eleven-forums-and-jurisdiction) supervisan la impugnación accesible y, cuando los hechos están verificados bajo los Capítulos Dos a Cuatro, pueden:
  - **abrir, actualizar o corregir** registros de trayectoria bajo el [Capítulo Ocho §3.1](../../core_09_standing_assessment.md#31-minimum-record-contents); o
...
- Origen: Principios: Capítulo Uno [§4 Confianza](core_01_a_values_principles.md#4-system-stability-enabler-trust-coordination-integrity), [Capítulo Siete §3 Evaluación de certificación del sistema entero](../../core_08_a_system_alignment_certification_evaluation.md#3-whole-system-certification-evaluation) y [§10 Gobernanza bajo disciplina de administración responsable](core_01_c_stewardship_capacity_principles.md#10-governance-under-stewardship-discipline).
...
- **Elegibilidad de vía nominada y responsabilidad:** Los criterios de elegibilidad publicados para las vías nominadas de participación ordinaria, roles sensibles a la confianza, elegibilidad de supervisión, **governance-voting** y **stakeholder-participation** deben descansar en evidencia presente, observable e impugnable — no en reputación, escala o trayectoria histórica solas. La alineación consistente con los requisitos fundacionales puede sostener la [Habilitación de competencia](core_05_band_accountability.md#competency-clearance) contra la [Barra de competencia](core_05_band_accountability.md#competency-bar) aplicable y la elegibilidad de rol sensible a la confianza, pero las consecuencias restrictivas se adjuntan solo a través del [Bloqueo de trayectoria](core_05_band_accountability.md#standing-lock) sobre vías nominadas de privilegio bajo el [Capítulo Nueve §4.2](../../core_10_standing_integration.md#42-general-standing-locks). Los bloqueos de **governance-voting** no sustituyen los bloqueos de **stakeholder-participation**, y un bloqueo de **stakeholder-participation** no borra el estatus de parte afectada ni despoja por sí mismo el voto fundacional de gobernanza.
  ...
  - La elegibilidad y los bloqueos deben:
    ...
    - no operar como un vector de descalificación de voz política duradera en la **Elección constitucional fundacional** (**Capítulo Cinco**), salvo donde el [**Capítulo Doce §4.1**](../../core_13_governance.md#41-entitlement-and-eligibility) retiene la **voz política duradera** por **inconducta anticonstitucional** **final** del **Capítulo Diez** pendiente de **restitución plena**.
...
- Origen: Principios: Capítulo Uno [§3.1 Seguridad](core_01_a_values_principles.md#31-safety-harm-constraint), [§3.2 Verdad](core_01_a_values_principles.md#32-truth-epistemic-integrity-constraint) y [Capítulo Siete §3 Evaluación de certificación del sistema entero](../../core_08_a_system_alignment_certification_evaluation.md#3-whole-system-certification-evaluation).
