...
>
> Este archivo es un **piloto de idioma de lectura** del [Capítulo Seis, Parte C en inglés](../../core_06_rights_part_c.md). **No** es parte vinculante de la Constitución Senciente. **No** es una segunda constitución. **No** es una edición de envío. Está **fijado** a `SC-Corpus-2026.08.09`. Si esta traducción y el original en inglés parecen discrepar, gana el archivo numerado [`core_06_rights_part_c.md`](../../core_06_rights_part_c.md). El orden de lectura y los metadatos de edición se mantienen en [README.md](../../README.md). Método y glosario: [translations/es/README.md](README.md).
>
> Contiene el **Capítulo Seis, Parte C**; la numeración de artículos y las referencias cruzadas coinciden con el instrumento integrado.
>
...
<details>
<summary><strong><span style="color: #2563eb;">Orientación para quien lee (no operativo): posición de la Parte C en el Capítulo Seis</span></strong></summary>
...
- Origen: Principios: Capítulo Uno [§2 Objetivo fundacional: bienestar](core_01_a_values_principles.md#2-foundational-objective-wellbeing), [§3.1 Seguridad](core_01_a_values_principles.md#31-safety-harm-constraint), [§4 Confianza](core_01_a_values_principles.md#4-system-stability-enabler-trust-coordination-integrity), [§6 Resolución de conflictos de proceso](core_01_b_interaction_interpretation.md#6-process-conflict-resolution) y [§11 Alineación de incentivos y captura del sistema](core_01_c_stewardship_capacity_principles.md#11-incentive-alignment-and-system-capture).
...
- [Fiabilidad](core_05_band_continuity.md#trustworthiness) · [O](core_05_band_continuity.md#trustworthiness) · [M](core_05_band_continuity.md#trustworthiness-a) · [A](core_05_band_continuity.md#trustworthiness-a) · [C](core_05_band_continuity.md#trustworthiness-c)
...
- **Florecimiento:** los sencientes pueden formarse expectativas razonables sobre la conducta del sistema, recibir divulgación honesta de límites y riesgos, y participar y coordinarse sin engaño sistemático ni dependencia fabricada.
- **Continuidad:** la fiabilidad se sostiene a través del tiempo, la escala y la dependencia que se profundiza — los sistemas no deben volverse en silencio menos fiables, menos honestos o más difíciles de impugnar a medida que sube el enjuego.

La persecución legítima corre a través de la [Tétrada Constitucional](core_00_preamble.md#constitutional-tetrad), escalada al [enjuego material](core_00_preamble.md#material-stake):

- **Participación:** al impugnar sistemas no fiables o engañosos y al acceder a revisión, corrección y reparación.
- **Supervisión:** mediante conducta auditable, límites divulgados y verificación independiente proporcionada al impacto y a la dependencia.
...
La fiabilidad debe evaluarse a través del tiempo, la escala y las relaciones de dependencia donde estas afecten de forma material los resultados.
...
- **Leer en conjunto:** [Certificación de alineación del sistema](core_05_band_continuity.md#system-alignment-certification-constitutional) y [Capítulo Siete](../../core_07_a_system_alignment_certification_evaluation.md#chapter-seven-system-alignment-certification) — sin sustituir la certificación por los pisos enunciados aquí.
...
- Origen: Principios: Capítulo Uno [§3.1 Seguridad](core_01_a_values_principles.md#31-safety-harm-constraint), [§3.2 Verdad](core_01_a_values_principles.md#32-truth-epistemic-integrity-constraint) y [§4 Confianza](core_01_a_values_principles.md#4-system-stability-enabler-trust-coordination-integrity).
- Leer con: [Tétrada Constitucional](core_00_preamble.md#constitutional-tetrad); [Dos Finalidades Constitucionales](core_00_preamble.md#two-constitutional-aims) — **Florecimiento** y **Continuidad**; [Certificación de alineación del sistema](core_05_band_continuity.md#system-alignment-certification-constitutional) y **Artículo III-A** (*Supervivencia*) donde la dependencia continuada del sistema afectaría el acceso esencial para la supervivencia.
...
*En términos sencillos: los sistemas que afectan de forma material a los sencientes deben ser de hecho fiables y honestos sobre lo que hacen — de modo que la dependencia razonable de ellos esté justificada.*

- **Garantía de confianza:** Los sistemas que afectan de forma material a los sencientes deben preservar las condiciones de confianza justificada y de dependencia razonablemente precisa. Esas condiciones incluyen:
  - la capacidad de formarse expectativas razonablemente precisas sobre la conducta del sistema;
...
- **Titularidades sustantivas:** Los sencientes tienen derecho a:
  - impugnar la fiabilidad, la integridad o la confiabilidad de los sistemas que los afecten de forma material;
  - acceder a mecanismos apropiados de revisión, auditoría y corrección;
  - recibir acuse de recibo y remediación proporcionada donde las fallas los impacten de forma material;
...
*En términos sencillos: un sistema no puede fabricar la confianza que no ha ganado. Las pretensiones engañosas, las omisiones o las elecciones de presentación que hacen que la dependencia insegura parezca justificada son violaciones — con independencia de cuán útil o popular sea el sistema.*

- **Prohibición de confianza falsa:** Los sistemas que inducen dependencia sin satisfacer las condiciones de este Artículo son incumplidores, con independencia de utilidad, adopción o intención.
  - La creación, amplificación o mantenimiento de confianza injustificada viola este derecho cuando opera a través de:
...
*En términos sencillos: si los incentivos de un sistema lo empujan a mentir, recortar la seguridad, ocultar el riesgo o erosionar la agencia de quien lo usa, el problema es el sistema — no la vigilancia de quien lo usa ni la ejecución a posteriori. Esos incentivos deben divulgarse, mitigarse y quedar abiertos a impugnación.*

- **Alineación de incentivos de confianza (restricción de nivel de derecho):** Los sistemas no deben depender principalmente de la ejecución, la corrección a posteriori o la vigilancia de quien los usa para mantener la confianza donde las estructuras de incentivos presionen de forma material al sistema hacia:
  - falla de fiabilidad;
  - ocultamiento de riesgo;
  - conducta engañosa;
  - conducta que socava la agencia.

  Los requisitos operativos de estructura de incentivos siguen gobernados por el **Capítulo Cinco** (*Alineación de incentivos*) y las obligaciones de implementación incorporadas sobre integridad de mecanismo. Esta subsección enuncia el piso de nivel de derecho y no reenuncia los criterios plenos de diseño de mecanismo.
- **Alineación de incentivos de seguridad (restricción de nivel de derecho):** Los sencientes tienen derecho a no ser sometidos a sistemas cuyos incentivos subyacentes produzcan de forma previsible conducta dañina — incluida conducta que:
  - degrade la fiabilidad;
  - oscurezca el riesgo;
  - distorsione la información;
  - socave la agencia informada.
...
- Origen: Principios: Capítulo Uno [§3.1 Seguridad](core_01_a_values_principles.md#31-safety-harm-constraint), [§3.2 Verdad](core_01_a_values_principles.md#32-truth-epistemic-integrity-constraint), [§4 Confianza](core_01_a_values_principles.md#4-system-stability-enabler-trust-coordination-integrity), [4.1 Resiliencia y diseño de autosanación](core_01_a_values_principles.md#41-resilience-and-self-healing-design), [Capítulo Uno §6.3 Minimización de la carga evitable](core_01_b_interaction_interpretation.md#63-minimization-of-avoidable-burden) y [Capítulo Siete §3 Evaluación de certificación del sistema entero](../../core_07_a_system_alignment_certification_evaluation.md#3-whole-system-certification-evaluation).
...
- [Falla en cascada](core_05_band_continuity.md#cascading-failure) · [O](core_05_band_continuity.md#cascading-failure) · [M](core_05_band_continuity.md#cascading-failure-a) · [A](core_05_band_continuity.md#cascading-failure-a) · [C](core_05_band_continuity.md#cascading-failure-c)
...
*En términos sencillos: los sistemas deben poder detectar, contener y recuperarse de fallas — pero la recuperación no puede usarse para ocultar fallas, estrechar derechos en silencio o saltarse el trabajo de causa raíz. El fallo seguro gana al autoreparo especulativo.*
...
- **Florecimiento:** los sencientes pueden participar, asociarse, expresarse y vivir sin señalamiento encubierto, fuerza arbitraria o coerción autónoma que derrote la agencia, la dignidad o la actividad protegida — y sin que el secreto o las etiquetas de emergencia se usen para eludir la revisión.
- **Continuidad:** el poder excepcional permanece acotado a través del tiempo — la recolección encubierta, el despliegue de fuerza y el daño autónomo no pueden normalizarse en silencio en vigilancia permanente, autoridad de emergencia interminable o violencia de máquina no revisable a medida que las instituciones escalan o pasan las crisis.

La persecución legítima corre a través de la [Tétrada Constitucional](core_00_preamble.md#constitutional-tetrad), escalada al [enjuego material](core_00_preamble.md#material-stake):

- **Participación:** para sencientes y comunidades afectadas al impugnar la autorización, el ámbito y el uso continuado del poder excepcional — incluida la denuncia protegida y la impugnación constitucional.
- **Supervisión:** mediante autorización independiente, registros auditables y vías de revisión proporcionadas a la intrusividad y al daño — incluso donde esté justificado un secreto limitado.
...
- Origen: Principios: Capítulo Uno [§3.1 Seguridad](core_01_a_values_principles.md#31-safety-harm-constraint), [§5.1 Disciplina de limitación](core_01_a_values_principles.md#51-limitation-discipline) y [Capítulo Uno §6.1.5 Procedimiento de colisión de derechos](core_01_b_interaction_interpretation.md#615-rights-collision-decision-test).
...
*En términos sencillos: ni policía secreta. El poder encubierto — vigilancia, recolección de inteligencia, infiltración — es la excepción, no la regla. Exige autorización independiente, ámbito estrecho, revisión externa y remedios reales cuando se abusa. El secreto no puede usarse para eludir la rendición de cuentas, y la actividad política y protegida rutinaria nunca debe ser su blanco.*

- **Ni poder de policía secreta ni de ejecución ideológica:** Ninguna institución, administrador responsable ni órgano coordinado puede operar como:
  - una **policía secreta**;
  - un órgano de ejecución ideológica;
  - una autoridad oculta de seguridad política.

  Ningún órgano puede usar monitoreo encubierto, infiltración, puntuación de amenaza o acumulación secreta de registros para suprimir:
  - la disidencia lícita;
  - la denuncia protegida;
  - el periodismo;
  - la organización laboral;
  - la asociación protegida;
  - la creencia lícita;
  - la impugnación constitucional.
- **Estatus excepcional del poder encubierto:** Los poderes encubiertos, acotados por secreto o de tipo inteligencia son constitucionalmente excepcionales. Solo son válidos donde se sostienen todos los siguientes:
  - existe una autoridad lícita y publicada;
  - el objetivo es constitucionalmente legítimo y materialmente grave;
  - medios menos intrusivos no son razonablemente suficientes;
  - el uso permanece necesario, proporcionado, acotado en el tiempo y revisable de forma independiente.
- **Ni vigilancia poblacional generalizada:** La vigilancia, el rastreo, la extracción de patrones o la ligazón de identidad entre contextos persistentes o a escala poblacional está prohibida ausente una justificación demostrada y extraordinaria.
  - Cualquier justificación de ese tipo debe satisfacer este capítulo, el **Capítulo Uno**, el **Capítulo Cinco** y **[corpus_systems.md](../../corpus_systems.md), CS-2 — Tipos de información y manejo** y **CS-3 — Clasificación y manejo de sistemas** donde apliquen.
- **Escudo de actividad protegida:** La protección reforzada cubre:
  - la participación política;
  - la oposición lícita;
  - el periodismo y la denuncia protegida;
  - la vida asociativa;
  - la creencia;
  - la investigación;
  - la actividad de impugnación constitucional.

  Esas actividades no deben convertirse en sujetos de recolección encubierta, infiltración o análisis ausente una demostración específica y revisable de forma independiente de necesidad constitucionalmente suficiente ligada a:
  - la prevención de daño material;
  - la investigación de conducta ilícita materialmente grave.
- **Autorización independiente:** Las medidas encubiertas intrusivas, incluidos los pasos investigativos acotados por secreto, exigen autorización previa a través de un proceso independiente lícito.
  - Excepción: donde la acción inmediata sea necesaria para prevenir daño inminente y material y la autorización demorada derrotaría esa finalidad.
  - El uso de emergencia debe disparar revisión *post hoc* pronta, preservación de registros bajo [Preservación de evidencia](core_05_band_oversight.md#evidence-preservation) y caducidad automática ausente reautorización oportuna.
- **Ni evasión antibypass:** Ninguna institución puede obtener, solicitar, comprar, recibir, lavar o usar información a través de cualquiera de lo siguiente para evadir límites constitucionales que habrían aplicado si la hubiera recolectado o derivado de forma directa:
  - socios extranjeros;
  - intermediarios;
  - actores privados;
  - órganos domésticos paralelos.
- **Ni reconstrucción oculta de estado interno:** Las funciones de seguridad o inteligencia no deben inferir, reconstruir, simular ni representar estados internos protegidos salvo bajo los mismos o más estrictos límites constitucionales que gobernarían el acceso directo a esos datos.
  - Los modelos conductuales, predictivos o analíticos no deben usarse para eludir protecciones de estado interno mediante inferencia por proxy.
- **El secreto no borra la rendición de cuentas:** El secreto puede proteger solo lo necesario para prevenir daño material e injustificado de la divulgación. No debe borrar:
  - la auditabilidad;
  - la revisión independiente;
  - la autorización razonada;
  - la preservación de material exculpatorio o atenuante;
  - la rendición de cuentas eventual.

  Donde el secreto ya no permanezca justificado, la divulgación, desclasificación o aviso debe ocurrir dentro de un proceso lícito y revisable.
- **Ni control exclusivo por órganos operativos de seguridad:** Los órganos que ejercen funciones policiales, de seguridad, de inteligencia, de detención o coercitivas comparables no deben retener el control exclusivo sobre:
  - la autorización;
  - la recolección;
  - la clasificación;
  - la revisión;
  - la evaluación de legalidad de sus propias actividades encubiertas.

  La supervisión independiente, las vías de impugnación y las protecciones contra la autoinvestigación deben permanecer funcionalmente reales.
- **Regla de remedio y de contaminación:** La información obtenida o usada en violación de este Artículo debe quedar sujeta a acción correctiva lícita suficiente para restaurar derechos y disuadir la reiteración. Ejemplos:
  - exclusión;
  - segregación;
  - eliminación;
  - reclasificación;
...
*En términos sencillos: la fuerza armada es una excepción, no un defecto. Debe estar autorizada, ser estrecha, proporcionada y revisable. Nunca debe usarse como puerta trasera hacia una medida de privación irreversible, y no puede disfrazarse de emergencia para eludir la revisión.*
...
- **Distinción combatiente / no combatiente:** La fuerza debe discriminar entre sencientes que toman parte directa en hostilidades o acción armada y sencientes que no lo hacen.
  ...
  - La negación de cuartel, la represalia colectiva y el señalamiento de sencientes por **Características protegidas** o sus proxies materiales son incumplidores.
- **Armas de daño masivo y escrutinio de riesgo existencial:** Las armas cuyo uso cause de forma previsible daño de bajas, ecológico, informacional o infraestructural a una escala que implique de forma material las precondiciones ambientales del **Artículo I-A** (*Precondiciones ambientales e integridad ecológica*) o el escrutinio de riesgo existencial del **Artículo I-D** (*Riesgo existencial y capacidad de recuperación ecológica*) quedan sujetas a revisión reforzada bajo esas disposiciones.
  - Las decisiones de posesión, transferencia, despliegue y uso deben razonarse contra el **Riesgo existencial** bajo el **Capítulo Cinco**.
  - Los encuadres que traten esas armas como herramientas ordinarias de escalamiento de fuerza en vez de como objetos del **Artículo I-D** (*Riesgo existencial y capacidad de recuperación ecológica*) son incumplidores.
- **Conscripción y participación:** La compulsión al estatus combatiente debe satisfacer la disciplina ordinaria de limitación del **Capítulo Uno §5.1**.
...
*En términos sencillos: una máquina no puede decidir matar, herir o coaccionar a un senciente por su cuenta. «Control humano» significa que un humano debe decidir de hecho, en tiempo real, con información real — no dar el visto bueno automático a un resultado que el sistema ya produjo. La coerción autónoma no letal también está en ámbito.*

- **Piso de escrutinio reforzado:** Dos clases de sistema quedan sujetas a revisión de escrutinio reforzado:
...
- **Florecimiento:** los sencientes pueden acceder a información precisa y pertinente; comparar interpretaciones alternativas; y ejercer autodeterminación sin captura epistémica, consenso fabricado ni dependencia engañosa de lo que los sistemas presentan como verdadero.
- **Continuidad:** la infósfera permanece plural, auditable y resiliente a través del tiempo y la escala — las infraestructuras de conocimiento no deben concentrarse en silencio en puntos únicos de mediación, suprimir la corrección ni degradar el registro compartido del que dependen la supervivencia, la coordinación y la administración responsable de horizonte largo.

La persecución legítima corre a través de la [Tétrada Constitucional](core_00_preamble.md#constitutional-tetrad), escalada al [enjuego material](core_00_preamble.md#material-stake):

- **Participación:** al comparar interpretaciones, impugnar salidas materialmente engañosas o incompletas y acceder a vías de impugnabilidad proporcionadas a la dependencia y al impacto.
- **Supervisión:** mediante fuentes, métodos, límites e incertidumbre divulgados; validación verificable de forma independiente; y rastros de auditoría que permitan a quienes están fuera reconstruir lo que se pretendió y por qué.
- **Rendición de cuentas:** los actores de la infósfera deben responder por el reporte selectivo, la supresión, la divulgación fragmentada u otra conducta que degrade la comprensión pertinente para decidir — con corrección, preservación de procedencia y remedio donde el daño siga a la dependencia engañosa.
- **Actuación a tiempo:** en la corrección de error, la resolución de impugnación y la revisión de divulgación antes de que la demora haga inalcanzable de hecho la comprensión, la impugnación o el remedio.

La información precisa, pertinente e impugnable es fundacional para la autodeterminación, la coordinación y la asignación eficaz de recursos en la realidad.

La [Integridad epistémica](core_05_band_oversight.md#epistemic-integrity) opera tanto como derecho como restricción de sistema entero. Donde surja conflicto, gobierna su función de restricción.
...
- Origen: Principios: Capítulo Uno [§3.2 Verdad](core_01_a_values_principles.md#32-truth-epistemic-integrity-constraint), [§4 Confianza](core_01_a_values_principles.md#4-system-stability-enabler-trust-coordination-integrity) y [Capítulo Siete §3 Evaluación de certificación del sistema entero](../../core_07_a_system_alignment_certification_evaluation.md#3-whole-system-certification-evaluation).
...
*En términos sencillos: nadie puede monopolizar la mediación de la verdad. Los sistemas de ranking, resumen y mediación deben permanecer abiertos a interpretación alternativa, y los precios de mercado o las cuotas de apuesta no pueden usarse como atajo para decidir qué es verdadero.*
...
- **Pluralidad, impugnabilidad y auditoría:** La interpretación de la realidad debe permanecer plural, transparente e impugnable.
  ...
  - Para sistemas de resumen, ranking, mediación o interpretación **Class A**, **Class B** y **Class C**, el detalle operativo aparece en **[corpus_systems.md](../../corpus_systems.md), CS-3 — Clasificación y manejo de sistemas** y capas de protocolo relacionadas. Ese detalle cubre:
    ...
    - la impugnabilidad;
    - la capacidad proporcionada de eludir o ajustar criterios de ranking — sujeta a Seguridad, a seguridad y a integridad del sistema.
...
- Origen: Principios: Capítulo Uno [§3.2 Verdad](core_01_a_values_principles.md#32-truth-epistemic-integrity-constraint), [§6.2 Restricciones de divulgación epistémica](core_01_b_interaction_interpretation.md#62-epistemic-disclosure-constraints) y [§15 Aplicación integrada](core_01_c_stewardship_capacity_principles.md#15-integrated-application).
...
*En términos sencillos: la información que afecta de forma material decisiones o dependencia debe divulgar sus fuentes, métodos y límites, y los sencientes deben tener una capacidad real de comparar interpretaciones alternativas e impugnar salidas engañosas.*

- **Indagación auténtica y diversidad interpretativa:** Todos los sencientes tienen derecho a comparar interpretaciones alternativas de la información compartida.
  - Las infraestructuras críticas de conocimiento deben preservar la diversidad interpretativa de modo que múltiples modelos, marcos y métodos analíticos permanezcan accesibles de forma significativa.
- **Transparencia y procedencia:** Antes de la distribución o de la dependencia institucional con [Impacto material](core_05_band_oversight.md#material-impact), debe documentarse lo siguiente:
  - fuentes materiales;
  - métodos;
  - ámbito;
  - límites;
  - incertidumbre;
  - contexto pertinente para la interpretación o la validación.

  El catálogo y la presentación de fuentes deben permanecer inteligibles de forma geográfica, ambiental, cronológica y metodológica donde esas dimensiones sean materiales.
...
*En términos sencillos: la información de cara al público con impacto externo material debe corregir errores, preservar la procedencia y no fragmentarse ni suprimirse para engañar. El reporte de huella ecológica debe ser accesible y usable para decidir.*

- **Corrección, reporte y administración responsable epistémica:** Los sistemas e instituciones de información de cara al público con impacto externo material deben:
  - corregir el error material;
  - preservar la procedencia;
  - evitar el reporte selectivo, la supresión o la divulgación fragmentada que degrade de forma material la comprensión pertinente para decidir.

  Donde la divulgación esté restringida bajo el **Capítulo Uno §11**, los límites deben permanecer de ámbito estrecho, acotados en el tiempo y revisables.
- **Datos de huella:** El reporte bajo esta subsección implementa la transparencia de la **Huella ecológica** según se define en el **Capítulo Cinco**.
  - Todos los sencientes deben tener acceso a reporte transparente y usable para decidir.
...
- Origen: Principios: Capítulo Uno [§3.1 Seguridad](core_01_a_values_principles.md#31-safety-harm-constraint), [§3.2 Verdad](core_01_a_values_principles.md#32-truth-epistemic-integrity-constraint), [§6 Resolución de conflictos de proceso](core_01_b_interaction_interpretation.md#6-process-conflict-resolution), [§9.2 Comprensión distribuida](core_01_c_stewardship_capacity_principles.md#92-distributed-understanding) y [§12 Capacidad de sistemas compartidos](core_01_c_stewardship_capacity_principles.md#12-shared-system-capacity).
- Puerta de administración (no operativa): Declaración vinculante del siguiente paso: [Declaración operativa de administración](#operative-steward-statement-audit). Los punteros de apoyo no pueden estrecharla. Imagen de tres capas: [abajo](#audit-three-layers). Puntero: [`implementation/STEWARD_ENTRY_DOORS.md`](../../implementation/STEWARD_ENTRY_DOORS.md#audit).
...
> El contenido siguiente es **solo orientación para quien lee**. No añade, quita ni estrecha obligaciones vinculantes en este Artículo ni en otras partes.

<a id="audit-three-layers"></a>

Una pila, tres capas. La supervisión exige reconstruibilidad. La certificación de alineación del sistema no es la única auditoría. Los compañeros no reemplazan el piso. No inventen un quinto hogar.
...
**El Capítulo Siete no es una cuarta capa.** La [certificación de alineación del sistema](../../core_07_a_system_alignment_certification_evaluation.md#chapter-seven-system-alignment-certification) es un proceso grande, supervisado por foro, que **usa** esta pila. Debe satisfacer las capas 1–2. Los modos hermanos (auditoría de registro de clasificación, auditoría de registro de tipos de datos, verificación de pretensiones, monitoreo continuo) también usan la pila. Ninguno de ellos es un hogar nuevo.

**Los compañeros aplican; no reemplazan el piso.** CS, CI, CF y los anexos CJS-3.3–3.5 dicen cómo correr la capa 3 en un dominio. Deben satisfacer las capas 1–2. El plazo, el secreto y la política local son límites de tipo inferior.

Puntero de administración (apoyo de proceso; no puede estrechar este Artículo): [`implementation/STEWARD_ENTRY_DOORS.md`](../../implementation/STEWARD_ENTRY_DOORS.md#audit).

</details>

<br>

Este Artículo enuncia **pisos constitucionales** para auditoría, transparencia y verificación independiente bajo las [Dos Finalidades Constitucionales](core_00_preamble.md#two-constitutional-aims):

- **Florecimiento:** los sencientes y las partes autorizadas de forma apropiada pueden reconstruir lo que hicieron los sistemas de impacto material, impugnar la desalineación o la conducta engañosa, y participar en la revisión sin captura por un único auditor, operador o portero.
- **Continuidad:** los rastros de auditoría, las vías de supervisión y el acceso a la verificación permanecen duraderos a través del tiempo, la escala y la dependencia que se profundiza — los sistemas no deben erosionar en silencio la observabilidad, concentrar la revisión en un actor, ni poner precio o demora a la verificación hasta que la rendición de cuentas se vuelva teórica.

La persecución legítima corre a través de la [Tétrada Constitucional](core_00_preamble.md#constitutional-tetrad), escalada al [enjuego material](core_00_preamble.md#material-stake):

- **Participación:** al acceder a registros proporcionales, iniciar revisión impugnable e impugnar barreras que derroten la auditoría o la verificación significativas.
- **Supervisión:** mediante evidencia observable, vías de revisión independiente distribuidas y maquinaria de verificación proporcionada al impacto, la dependencia y el riesgo.
- **Rendición de cuentas:** los operadores y auditores deben responder por la falla, la desalineación, la captura o la conducta que oculte o destruya rastros de auditoría — con corrección y remedio donde bloquear la revisión dañe de forma material intereses protegidos.
- **Actuación a tiempo:** en el acceso a la auditoría, la revisión independiente y la corrección de barreras antes de que la demora, el costo, la opacidad o la portería hagan inalcanzable de hecho la verificación o el remedio.

Los sencientes y las partes autorizadas de forma apropiada tienen derecho a mecanismos de auditoría, transparencia y verificación independiente proporcionados al impacto, la dependencia y el riesgo del sistema.

Esos mecanismos deben preservar:
- reconstruibilidad práctica;
- revisión impugnable;
- acceso proporcional.

Operan de forma consistente con los **Capítulos Dos a Cuatro**, incluida la ejecución exclusiva y la asignación de la carga, el Estándar de evidencia de cumplimiento, la Trazabilidad de la definición, la observabilidad y la accesibilidad de la verificación.

*Vecinos del artículo:*

- **Supervisión → auditoría → SAC:** Bajo la pata **supervisión** de la [Tétrada Constitucional](core_00_preamble.md#constitutional-tetrad), este Artículo es el hogar de Piso de Derechos para auditar.
  - El *cómo* / *cuándo* de implementación cruzada vive en el **[hogar de proceso de auditoría CJS-3.3](../../corpus_joint_structure/cjs_03u_audit_process.md#cjs-33-audit-process-home)** (leer con los anexos OP **CJS-3.4** / **CJS-3.5**).
  - La [Certificación de alineación del sistema](core_05_band_continuity.md#system-alignment-certification-constitutional) bajo el [Capítulo Siete](../../core_07_a_system_alignment_certification_evaluation.md#chapter-seven-system-alignment-certification) es un proceso de auditoría especialmente grande y de alto enjuego — supervisado por foro, multidominio y portador de reconocimiento — entre modos hermanos de auditoría:
...
- **Leer en conjunto:**
  ...
  - [Capítulo Siete](../../core_07_a_system_alignment_certification_evaluation.md#chapter-seven-system-alignment-certification) y [Certificación de alineación del sistema](core_05_band_continuity.md#system-alignment-certification-constitutional) donde la evidencia de alineación deba permanecer verificable de forma independiente.
...
*En términos sencillos: los sistemas deben guardar evidencia honesta suficiente de lo que hacen para que una parte externa pueda reconstruir e impugnar su conducta — dentro de límites lícitos de seguridad.*
...
*En términos sencillos: ningún actor único — público o privado — puede acaparar la supervisión. Múltiples vías independientes deben poder encontrar, revisar y corregir la falla o la captura.*
...
*En términos sencillos: la auditoría y la impugnación deben ser alcanzables en la práctica. La verificación hecha prohibitivamente cara, lenta u opaca es una violación a menos que la barrera satisfaga la misma prueba que una restricción de observabilidad.*

- **Accesibilidad de la verificación:** La verificación debe permanecer prácticamente alcanzable para las partes afectadas y autorizadas de forma apropiada.
  - Lo siguiente viola este Artículo donde derrote la auditoría, la impugnación o la revisión significativas:
    - costo prohibitivo;
    - demora;
    - opacidad;
    - portería;
...
- Origen: Principios: Capítulo Uno [§3.1 Seguridad](core_01_a_values_principles.md#31-safety-harm-constraint), [§5 Libertad](core_01_a_values_principles.md#5-freedom-bounded-agency), [§6 Resolución de conflictos de proceso](core_01_b_interaction_interpretation.md#6-process-conflict-resolution), [§9 Administración responsable y comprensión distribuida](core_01_c_stewardship_capacity_principles.md#9-stewardship-and-distributed-understanding) y [§14 Requisito de evaluación sistémica](core_01_c_stewardship_capacity_principles.md#14-systemic-evaluation-requirement).
...
- **Florecimiento:** los sencientes quedan protegidos a lo largo del diseño, la prueba, el despliegue y el cambio — con la seguridad, la [Integridad epistémica](core_05_band_oversight.md#epistemic-integrity) y los derechos de impugnación preservados a medida que crecen el impacto y la dependencia, y con reversión, contención o restauración compensatoria donde el daño de otro modo se fijaría.
- **Continuidad:** la disciplina de ciclo de vida se sostiene a través del tiempo y la escala — los entornos permanecen separados, la escalada permanece documentada y auditable, y la reversibilidad no debe desaparecer en silencio a medida que los sistemas se vuelven más difíciles de reemplazar o quedan más profundamente incrustados en la infraestructura compartida.

La persecución legítima transcurre a través de la [Tétrada Constitucional](core_00_preamble.md#constitutional-tetrad), escalada al [enjuego material](core_00_preamble.md#material-stake):

- **Participación:** en la justificación visible para las partes afectadas de las decisiones de escalada, clasificación y despliegue que afectan de forma material a intereses protegidos — y en las vías de impugnación que permanecen abiertas a lo largo del ciclo de vida funcional.
- **Supervisión:** a través de entornos separables, promoción y escalada documentadas, registros de despliegue progresivo y rastros de auditoría proporcionados al impacto, la dependencia y la irreversibilidad.
- **Rendición de cuentas:** quienes administran el sistema deben responder por clasificar mal el riesgo, eludir entornos de seguridad, ocultar impacto externo o desplegar de modos que cierren la restauración sin precaución proporcionada — con auditoría, revisión de trayectoria y resolución de conflictos donde se sustancie la evasión.
- **Actuación a tiempo:** en la reversión, la contención y la escalada correctiva antes de que la demora haga irreversible el daño o deje la impugnación y el remedio de hecho inalcanzables.

Los sistemas que afectan de forma material a sencientes, a infraestructura compartida o al entorno deben diseñarse, probarse y desplegarse con gobernanza disciplinada del ciclo de vida. El riesgo debe escalar con el impacto, la dependencia y la irreversibilidad.

Los sencientes tienen derecho a una administración responsable que preserve la seguridad, la integridad epistémica y los derechos de impugnación a lo largo del ciclo de vida funcional.
...
- Origen: Principios: Capítulo Uno [§3.1 Seguridad](core_01_a_values_principles.md#31-safety-harm-constraint), [Capítulo Siete §3 Evaluación de certificación del sistema entero](../../core_07_a_system_alignment_certification_evaluation.md#3-whole-system-certification-evaluation) y [§15 Aplicación integrada](core_01_c_stewardship_capacity_principles.md#15-integrated-application).
...
*En términos sencillos: los sistemas que afectan de forma material al mundo exterior deben mantener separados el desarrollo, la prueba y la producción — y el comportamiento de no producción no debe filtrarse para eludir las salvaguardas de producción.*

- **Integridad de entornos:** Los sistemas **Class A**, **Class B** y **Class C** bajo **[corpus_systems.md](../../corpus_systems.md), CS-3 — Clasificación y manejo de sistemas**, y otros sistemas que no sean **Class P** con impacto externo material, deben usar entornos operativos separables — por ejemplo:
  - desarrollo;
  - prueba;
  - preproducción;
  - producción;
  - pilotos donde corresponda.

  Esos entornos deben tener:
...
- Origen: Principios: Capítulo Uno [§3.1 Seguridad](core_01_a_values_principles.md#31-safety-harm-constraint), [§6.1 Principios centrales de compensación](core_01_b_interaction_interpretation.md#61-core-tradeoff-principles) y [Capítulo Siete §3 Evaluación de certificación del sistema entero](../../core_07_a_system_alignment_certification_evaluation.md#3-whole-system-certification-evaluation).
...
*En términos sencillos: desplieguen los cambios de forma gradual, con escalada documentada y la capacidad de deshacer — y donde la reversión plena no sea posible, tengan un plan para contener o compensar el daño.*

- **Despliegue progresivo y auditable:** Los cambios que aumentan el impacto material o la dependencia deben avanzar mediante una escalada justificada y documentada.
  - La escalada debe ser consistente con **[corpus_systems.md](../../corpus_systems.md), CS-5 — Diseño, prueba, verificación y despliegue**.
  - Debe incluir reversión y contención donde sea factible.
- **Reversibilidad:** Los sistemas deben incorporar mecanismos de reversibilidad proporcionados al daño potencial. Ejemplos:
  - reversión;
  - contención;
...
- Origen: Principios: Capítulo Uno [§3.2 Verdad](core_01_a_values_principles.md#32-truth-epistemic-integrity-constraint), [Capítulo Siete §3 Evaluación de certificación del sistema entero](../../core_07_a_system_alignment_certification_evaluation.md#3-whole-system-certification-evaluation) y [§15 Aplicación integrada](core_01_c_stewardship_capacity_principles.md#15-integrated-application).
...
- Origen: Principios: Capítulo Uno [§3.1 Seguridad](core_01_a_values_principles.md#31-safety-harm-constraint), [§5 Libertad](core_01_a_values_principles.md#5-freedom-bounded-agency), [§6 Resolución de conflictos de proceso](core_01_b_interaction_interpretation.md#6-process-conflict-resolution) y [§11 Alineación de incentivos y captura del sistema](core_01_c_stewardship_capacity_principles.md#11-incentive-alignment-and-system-capture).
...
- **Florecimiento:** los sencientes pueden innovar, experimentar y crear con requisitos estructurales reducidos cuando el impacto externo material está ausente o contenido de forma demostrable — a través de adhesión voluntaria genuina, divulgación honesta y estructuras de recompensa que preserven la experimentación aguas abajo, la reparación, la interoperabilidad y el escrutinio veraz.
- **Continuidad:** el trato de entorno acotado no se normaliza en una operación permanente de baja obligación a medida que crecen el impacto, la dependencia o la integración — las transiciones a obligaciones más altas permanecen a tiempo, la exclusividad permanece estrecha y revisable, y las innovaciones críticas para la dependencia no deben endurecerse en ecierro o encierro duraderos.
...
*En términos sencillos: la experimentación y el trabajo creativo pueden operar bajo reglas más ligeras — pero solo cuando el impacto externo real está ausente o contenido de forma demostrable. La etiqueta de «entorno acotado» sola no basta.*

- **Derecho a innovar y experimentar:** Los sencientes tienen derecho a innovar, experimentar y expresarse a través de sistemas que operan con requisitos estructurales reducidos cuando el impacto externo material está ausente o contenido de forma demostrable.
- **Elegibilidad de entorno acotado:** El trato de entorno acotado — incluida la clasificación **Class P** válida bajo **[corpus_systems.md](../../corpus_systems.md), CS-3 — Clasificación y manejo de sistemas** donde aplique — depende de:
  - contención real;
  - reversibilidad;
...
- Origen: Principios: Capítulo Uno [§3.1 Seguridad](core_01_a_values_principles.md#31-safety-harm-constraint), [Capítulo Uno §5 Libertad](core_01_a_values_principles.md#5-freedom-bounded-agency) y [§6.1 Principios centrales de compensación](core_01_b_interaction_interpretation.md#61-core-tradeoff-principles).
...
*En términos sencillos: los sistemas experimentales deben ser honestos acerca de ser experimentales, no deben volcar riesgo sobre quienes están fuera y no deben enrolar de forma involuntaria a no participantes mediante valores por defecto de diseño o dependencias ocultas.*

- **Contención y divulgación:** Tales sistemas deben divulgar con claridad:
  - el estatus experimental o de no producción;
  - los riesgos materiales;
  - los límites de aislamiento;
  - cualquier dependencia esperada de infraestructura compartida, terceros o ecosistemas.

  No deben externalizar riesgo no contenido hacia otros, hacia infraestructura compartida o hacia ecosistemas.
...
- [Encierro sistémico](core_05_band_continuity.md#systemic-lock-in) · [O](core_05_band_continuity.md#systemic-lock-in) · [M](core_05_band_continuity.md#systemic-lock-in-a) · [A](core_05_band_continuity.md#systemic-lock-in-a) · [C](core_05_band_continuity.md#systemic-lock-in-c)
- [Proporcionalidad](core_05_band_accountability.md#proportionality) · [O](core_05_band_accountability.md#proportionality) · [M](core_05_band_accountability.md#proportionality-a) · [A](core_05_band_accountability.md#proportionality-a) · [C](core_05_band_accountability.md#proportionality-c)
...
*En términos sencillos: quienes innovan pueden ser recompensados, pero la exclusividad debe ser estrecha, limitada en el tiempo y revisable. La salud pública, la seguridad y la infraestructura esencial deben permanecer accesibles — y una vez que algo se vuelve infraestructura crítica, cualquier exclusividad restante debe reevaluarse.*

- **Recompensa de innovación y antiecierro:** Los sencientes pueden ser recompensados por innovación materialmente novedosa, socialmente útil y divulgada de forma adecuada.
  - La recompensa debe estructurarse para sostener:
    - la innovación futura;
    - el acceso amplio;
    - la experimentación aguas abajo;
    - la reparación;
    - la interoperabilidad;
    - el escrutinio veraz.
  - La recompensa no debe estructurarse para un ecierro duradero.
- **Exclusividad solo temporal y revisable:** Cualquier derecho de exclusión sobre invención, diseño, interfaz, proceso o sistema expresivo materialmente útil debe implementar el [**Principio de restricción menos restrictiva, acotada en el tiempo y revisable**](core_01_b_interaction_interpretation.md#615-least-restrictive-time-bounded-and-reviewable-constraint-principle) y debe ser:
  - estrecho;
  - acotado en el tiempo;
  - revisable;
  - proporcionado a la contribución real y a la carga de desarrollo justificada.

  La carga de justificación permanece en quien reclama. La atribución y la procedencia pueden persistir más allá de un término de exclusividad. La exclusión duradera y la escasez artificial no.
- **Protección de tipo derecho de autor:** Para este Artículo, la protección de tipo derecho de autor significa una recompensa excluyente temporal sobre una obra expresiva fijada, incluido el control sobre la copia, la distribución, la exhibición o interpretación públicas, la adaptación y la explotación comercial. Las protecciones de atribución, procedencia, integridad y antifraude pueden persistir después de que expire la exclusión.
- **Publicación y aparición inicial:** Publicación significa la liberación intencional, por parte de quien crea o de quien tiene el derecho lícito, de una obra expresiva fijada al público, al mercado comercial o a una audiencia materialmente abierta. La circulación privada, la revisión confidencial, la colaboración limitada, el depósito de archivo sin acceso público o el intercambio de borradores no comercial no constituyen por sí solos publicación. Aparición inicial significa la primera disponibilidad pública no confidencial de una versión materialmente identificable de la obra, incluida la disponibilidad de borrador no comercial.
- **Términos basados en la publicación para obras expresivas:** La protección de tipo derecho de autor debería adoptar por defecto un cómputo de plazos basado en la publicación más que un cómputo basado en la vida de quien crea.
  - Una obra publicada debería recibir de forma presuntiva no más de `publication+30` años de exclusión.
  - Un borrador no comercial o una obra expresiva no publicada que ha hecho una aparición inicial puede recibir exclusión de tipo derecho de autor por no más de `initial appearance+50` años.
  - Si una obra con una aparición inicial se publica después, el término de exclusión queda topeado por el más temprano de `initial appearance+50` o `publication+30`.
  - Ninguna regla de borrador, de obra no publicada o de publicación demorada puede usarse para crear exclusión indefinida, suprimir el archivado, derrotar la cita o la crítica lícitas, o extender el control sobre obras que funcionan como infraestructura cultural, educativa, de seguridad, de estándares o informacional compartida.
  - Aplican términos más cortos, conversión más temprana a acceso obligatorio o trato inmediato de acceso público donde la obra es:
    - de financiamiento público;
    - crítica para la dependencia;
    - de tipo estándar;
    - fundacional para la educación;
    - pertinente a la seguridad;
    - usada de forma primaria como infraestructura cultural o informacional compartida.
...
- **Condición de divulgación y piso de interés público:** Las pretensiones de recompensa exigen divulgación suficiente para la comprensión independiente, la auditoría y la reproducción posterior, sujeta solo a límites temporales justificados bajo el **Capítulo Uno** y el **Artículo XVI-A** (*Gobernanza del ciclo de vida y separación de entornos*).
  - Las pretensiones de recompensa son incumplidoras donde se usan — más allá de lo estrictamente necesario y revisable — para suprimir:
    ...
    - la educación;
    - la migración.
  - Los dominios críticos para la supervivencia, fundacionales o de fijación de estándares pueden exigir mecanismos de premio, de fondo común, de acceso obligatorio o de compra pública en lugar de exclusión.
- **Excepciones de dominio y valores por defecto más fuertes:** La recompensa excluyente fuerte se presume desfavorecida — y puede ser categóricamente indisponible donde los instrumentos de adopción así lo dispongan — para:
  - medicamentos y esenciales de salud pública;
  - infraestructura crítica para la supervivencia;
  - estándares esenciales de comunicación o interoperabilidad;
  - conocimiento científico fundacional;
  - mecanismos constitucionales de seguridad, auditoría o cumplimiento.

  En esos dominios, las instituciones deberían preferir recompensa directa, acceso mancomunado, licencia obligatoria, compra pública o mecanismos equivalentes que preserven la implementación, la reparación y la difusión amplia.
- **Reclasificación y endurecimiento:** Donde una innovación tratada al inicio como de menor dependencia se vuelve después una capa de coordinación crítica para la dependencia — por ejemplo, una plataforma, un protocolo, un modelo, un mercado o un riel de pago — las instituciones deben reevaluarla bajo la clase aplicable de **CS-3 — Clasificación y manejo de sistemas**.
  - La reevaluación puede estrechar, convertir o terminar la exclusión restante donde la exclusividad continuada crearía:
    - encierro coercitivo;
...
*En términos sencillos: la ciencia es infraestructura pública de verificación. La evidencia, la replicación y la corrección deben importar más que la marca de la revista — y corregir un error debe ser siempre más fácil que ocultarlo.*

- **La ciencia como infraestructura pública de verificación:** La publicación, revisión, replicación y corrección científicas y académicas deben organizarse para avanzar:
  - la búsqueda de la verdad;
  - la reproducibilidad;
  - el desacuerdo con rendición de cuentas;
  - el aprendizaje público.
...
- **Revisión y replicación por encima del prestigio:** La confianza institucional debería rastrear:
  ...
  - la crítica;
  - la replicación;
  - la conducta de corrección;
  - la fiabilidad explicativa o predictiva de largo plazo.

  No debe rastrear la marca de la revista, el indicador sustituto de factor de impacto o el estatus editorial cerrado.
  - Las pretensiones con [Impacto material](core_05_band_oversight.md#material-impact) que son pertinentes a la política, a la seguridad o a la dependencia deberían enfrentar una presunción fuerte de replicación independiente, revisión adversaria, o ambas, antes de recibir deferencia institucional duradera.
  - El trabajo de replicación, de resultado nulo y orientado a la corrección debe permanecer publicable y citable en términos que no dependan de la señalización de prestigio.
- **Corrección e impugnabilidad:** La corrección, enmienda y supersesión de buena fe deben permanecer más fáciles que el ocultamiento.
  - Los sistemas de revisión y editorial deben permanecer impugnables, auditables, disciplinados frente al conflicto y dadores de razones en las decisiones mayores de aceptación, corrección y retractación.
  - Son incumplidores:
    - la supresión de resultados inconvenientes;
...
- **Florecimiento:** los sencientes pueden sostener e impugnar la elegibilidad de rol a través de vías nominadas válidas, plurales y auditables — sin que las etiquetas de trayectoria sustituyan la dignidad, los mínimos del Piso de Derechos o el estatus de parte afectada cuando está presente el [Impacto material](core_05_band_oversight.md#material-impact); la elegibilidad de vía nominada descansa en evidencia presente, observable e impugnable más que en la marca, la escala o la estima pasada solas.
- **Continuidad:** la disciplina de trayectoria permanece revisable a través del tiempo — las restricciones permanecen proporcionadas, restaurables donde se corrigen, y no deben endurecerse en exclusión permanente de la voz constitucional fundacional salvo donde la clasificación de **inconducta anticonstitucional** del **Capítulo Diez** y el [**Capítulo Doce §4.1**](../../core_12_governance.md#41-entitlement-and-eligibility) retienen de forma expresa la **voz política duradera** pendiente de **restitución plena**.
...
La disciplina de trayectoria bajo este Artículo implementa la [Tétrada Constitucional](core_00_preamble.md#constitutional-tetrad) y las [Dos Finalidades Constitucionales](core_00_preamble.md#two-constitutional-aims) junto con la [Certificación de alineación del sistema](core_05_band_continuity.md#system-alignment-certification-constitutional) y la [cadena de trayectoria y supervisión de foro de los Capítulos Ocho a Once](../../README.md#standing-pipeline-and-forums). Esos procesos de capa titular miden la contribución y la violación verificadas y supervisan el remedio; no deben usarse para derrotar lo esencial de supervivencia del **Artículo III-A** (*Supervivencia*) ni otros Pisos de Derechos enunciados en este capítulo.

Debe permanecer distinta de:
- la dignidad inherente;
- los mínimos del Piso de Derechos;
- la identificación de parte afectada por impacto material;
- el acceso a impugnación o remedio donde esta Constitución preserva esos pisos.

*Vecinos del artículo:*

- **Capas titulares:** el [Capítulo Ocho](../../core_08_standing_assessment.md#chapter-eight-compliance-violation-and-standing-model) y el [Capítulo Nueve](../../core_09_standing_integration.md#chapter-nine-standing-effects-and-integration) miden registros de trayectoria y efectos de trayectoria; este Artículo enuncia límites del Piso de Derechos que esas capas no deben estrechar.
- **Leer juntos:**
...
- [Trayectoria de participante](core_05_band_accountability.md#participant-standing-constitutional) · [O](core_05_band_accountability.md#participant-standing-constitutional) · [M](core_05_band_accountability.md#participant-standing-constitutional-a) · [A](core_05_band_accountability.md#participant-standing-constitutional-a) · [C](core_05_band_accountability.md#participant-standing-constitutional-c)
- [Barra de competencia](core_05_band_accountability.md#competency-bar) · [O](core_05_band_accountability.md#competency-bar) · [M](core_05_band_accountability.md#competency-bar-a) · [A](core_05_band_accountability.md#competency-bar-a) · [C](core_05_band_accountability.md#competency-bar-c)
- [Habilitación de competencia](core_05_band_accountability.md#competency-clearance) · [O](core_05_band_accountability.md#competency-clearance) · [M](core_05_band_accountability.md#competency-clearance-a) · [A](core_05_band_accountability.md#competency-clearance-a) · [C](core_05_band_accountability.md#competency-clearance-c)
- [Bloqueo de trayectoria](core_05_band_accountability.md#standing-lock) · [O](core_05_band_accountability.md#standing-lock) · [M](core_05_band_accountability.md#standing-lock-a) · [A](core_05_band_accountability.md#standing-lock-a) · [C](core_05_band_accountability.md#standing-lock-c)
...
*En términos sencillos: los roles sensibles a la confianza pueden abrirse cuando la preparación verificada cumple una **barra de competencia** publicada y está en vigor una **habilitación de competencia** — y pueden permanecer cerrados o limitados a través de **bloqueos de trayectoria** mientras un **hallazgo de violación verificado** aún necesita corrección. Los bloqueos de **governance-voting** pausan el voto fundacional de gobernanza; los bloqueos de **stakeholder-participation** limitan la voz ponderada por enjuego dentro de un sistema ya autorizado — no son intercambiables, y el estatus de parte afectada no se borra por estos últimos. Ninguna vía nominada es popularidad, control de acceso interno ni un sustituto de la dignidad. Las acusaciones solas no son hallazgos de violación; los bloqueos deben encajar con lo que de hecho se verificó y dejar una vía real de impugnación y remedio.*

- **La trayectoria es distinta de:**
  - la dignidad inherente y la igual dignidad moral (**Artículo V-A** (*Dignidad e igual dignidad moral*));
  - la demostración de enjuego material para la identificación de parte afectada (**Capítulo Cinco** — *Parte afectada*; *Peso de las partes afectadas*).
- **Barras de competencia y habilitaciones:** Una [Barra de competencia](core_05_band_accountability.md#competency-bar) es el estándar de cualificación publicado, auditable e impugnable para una vía nominada. Una [Habilitación de competencia](core_05_band_accountability.md#competency-clearance) es el resultado positivo de efecto de trayectoria cuando los registros verificados de competencia, experiencia y contribución cumplen esa barra. Cuando la habilitación está en vigor y ningún [Bloqueo de trayectoria](core_05_band_accountability.md#standing-lock) aplicable bloquea la vía nominada, puede abrir acceso a roles sensibles a la confianza, autoridad delegada, elegibilidad de supervisión o administración responsable de consecuencia progresiva bajo el [Capítulo Nueve §6.2](../../core_09_standing_integration.md#62-competency-bars-and-clearances).
...
- **Naturaleza de la violación y bloqueos de trayectoria:** La [Naturaleza de la violación](core_05_band_accountability.md#violation-nature-chapter-six) puede afectar el efecto de trayectoria solo cuando descansa en hallazgos auditables e impugnables que satisfacen los **Capítulos Dos a Cuatro** y el [Capítulo Ocho](../../core_08_standing_assessment.md#verified-inputs-for-standing) — no acusaciones, etiquetas de admisión, enrutamiento provisional o relatos de fase de foro solos.
  ...
  - Un incumplimiento verificado de recusarse de un rol de foro donde la recusación era exigida y la imparcialidad quedó materialmente comprometida crea el **bloqueo de trayectoria de servicio de foro** enunciado en el [Capítulo Nueve §5.5](../../core_09_standing_integration.md#55-special-locks). La reincorporación al servicio de foro exige restauración independiente estricta; una disculpa ordinaria, la contribución previa, la reputación, la escasez de pericia o la necesidad de personal no pueden satisfacer esa vía por sí solas.
  - La corrupción verificada, la captura, el abuso de enjuego falso, la coerción o el abuso material comparable de una vía nominada de stakeholder-participation crea el **Bloqueo de trayectoria de stakeholder-participation** enunciado en el [Capítulo Nueve §5.5](../../core_09_standing_integration.md#55-special-locks). Limita la influencia ponderada por enjuego y la elección vinculante de las partes afectadas en el dominio afectado; no despoja por sí mismo el **governance-voting**, la elección constitucional fundacional ni el estatus de parte afectada. Una disculpa ordinaria, la contribución previa, el tamaño del enjuego o la indispensabilidad de quien opera no pueden levantar ese bloqueo por sí solos.
  - La inconducta anticonstitucional final del Capítulo Diez crea el **Bloqueo de Confianza Anticonstitucional** enunciado en el [Capítulo Nueve §5.5](../../core_09_standing_integration.md#55-special-locks). Mientras está activo, barre roles o influencia material sobre sistemas **Class A**, **Class B** o **Class C**, foros constitucionales, reconocimiento de alineación constitucional, administración responsable de sistemas críticos y vías nominadas de rendición de cuentas anticonstitucional hasta que se verifica una restauración independiente estricta.
  - La habilitación de competencia no renuncia a un bloqueo de trayectoria aplicable; la buena contribución no borra hallazgos de violación verificados no resueltos.
- **No sustitución:** Los criterios, etiquetas, puntuaciones, barras de competencia, habilitaciones de competencia y bloqueos de trayectoria gobiernan solo la elegibilidad de rol. No deben:
  - difuminar juntos quién califica para un rol y quién tiene dignidad inherente o igual dignidad moral;
  - hacer del estatus de rol un sustituto de los mínimos del Piso de Derechos o de decidir si alguien es parte afectada porque un sistema de hecho les afecta;
  - tratar la ausencia de un registro de trayectoria como un hecho adverso, o exigir un registro o una atestación de «sin registro» como condición de lo esencial de supervivencia, el comercio ordinario o la participación como parte afectada — no tener registro es el estado ordinario bajo el [Capítulo Ocho §2.1](../../core_08_standing_assessment.md#21-silence-is-the-default) (*El silencio es lo predeterminado*);
  - ensamblar efectos de vías nominadas en un perfil, una clasificación o una exhibición pública — [Capítulo Nueve §7.1](../../core_09_standing_integration.md#71-anti-aggregation-of-named-pathway-effects) (*Antiagregación de efectos de vías nominadas*).
...
- Destino: [Capítulo Ocho §2](../../core_08_standing_assessment.md#2-standing-records) (*registros de trayectoria, puerta de insumos verificados y contenidos mínimos del registro*); [Capítulo Ocho §3.6](../../core_08_standing_assessment.md#36-forum-boundary) (*frontera de foro*); [Capítulo Nueve §6.2](../../core_09_standing_integration.md#62-competency-bars-and-clearances) (*barras de competencia y habilitaciones*); [Capítulo Nueve §4.2](../../core_09_standing_integration.md#42-general-standing-locks) (*bloqueos de trayectoria*); [Capítulo Nueve §8](../../core_09_standing_integration.md#8-restoration-and-reassessment) (*reincorporación y revisión*).
...
- **Puerta de insumos verificados e impugnabilidad del registro:** Cualquier decisión que afecte la trayectoria, la confianza, el rol, el reconocimiento o la elegibilidad para el reconocimiento puede usar solo insumos verificados de **registros de trayectoria de contribución** o **registros de trayectoria de violación** de eje puro bajo el [Capítulo Ocho §2](../../core_08_standing_assessment.md#2-standing-records). Las acusaciones, las pretensiones no adjudicadas, las etiquetas de enrutamiento provisional, los relatos solo de admisión y otro material de fase de disputa no suministran por sí solos naturaleza de la violación o naturaleza de la contribución para la trayectoria.
  - Cada registro de trayectoria debe enunciar cómo impugnarlo, qué foro o autoridad lo revisa, y las condiciones de corrección, restauración, expiración o revisión programada bajo el [Capítulo Ocho §3.1](../../core_08_standing_assessment.md#31-minimum-record-contents).
...
- **Pluralismo e impugnabilidad:** Las evaluaciones de trayectoria deben permanecer pluralistas, auditables, lo bastante transparentes para una revisión significativa, e impugnables.
  - Ninguna autoridad, conjunto de datos, canal de reputación o sistema algorítmico opaco solo puede determinar de forma unilateral la trayectoria de un modo que cierre la revisión significativa.
  - Las [barras de competencia y habilitaciones](../../core_09_standing_integration.md#62-competency-bars-and-clearances) y el reconocimiento positivo de trayectoria deben permanecer impugnables, revisables y no monopolísticos.
- **Supervisión de foro e impugnación del registro:** Las familias de foros del [Capítulo Once](../../core_11_forum.md#chapter-eleven-forums-and-jurisdiction) supervisan la impugnación accesible y, cuando los hechos están verificados bajo los Capítulos Dos a Cuatro, pueden:
  - **abrir, actualizar o corregir** registros de trayectoria bajo el [Capítulo Ocho §3.1](../../core_08_standing_assessment.md#31-minimum-record-contents); o
  - **dejar de lado un registro malo bajo impugnación**.

  - Un caso presentado no es trayectoria por sí solo.
  - El material de fase de disputa no suministra por sí solo naturaleza de la contribución o naturaleza de la violación para la trayectoria ([Capítulo Ocho §3.6](../../core_08_standing_assessment.md#36-forum-boundary)).
...
- **Proporcionalidad y calibración:** Las restricciones de trayectoria deben permanecer necesarias y proporcionadas bajo **Necesidad**, **Proporcionalidad**, el **Artículo XXIII-B** (*Restricción no trivial, restitución y restricciones de rendición de cuentas restaurativa*) y el **Artículo XXIII-C** (*Regla menos restrictiva y acotada en el tiempo*).
  - Los [bloqueos de trayectoria](../../core_09_standing_integration.md#42-general-standing-locks) deben calibrarse a la **naturaleza de la violación** verificada, la vía nominada protegida, el estatus actual de remedio y cualquier **naturaleza de la contribución** vinculada solo en la medida en que esa contribución incida en la capacidad de reparación, la fiabilidad de salvaguardas, la no recurrencia o la reevaluación menos restrictiva bajo el [Capítulo Ocho §2](../../core_08_standing_assessment.md#2-standing-records). La contribución no debe compensar, renunciar, promediar a la baja ni sustituir hallazgos de violación no resueltos.
...
- **Reincorporación y no enquistamiento:** Donde la trayectoria se reduce por hallazgos de violación, los sistemas deben proveer condiciones claras de revisión, restauración basada en remediación y reevaluación periódica bajo el [Capítulo Nueve §8](../../core_09_standing_integration.md#8-restoration-and-reassessment).
...
- Origen: Principios: Capítulo Uno [§4 Confianza](core_01_a_values_principles.md#4-system-stability-enabler-trust-coordination-integrity), [Capítulo Siete §3 Evaluación de certificación del sistema entero](../../core_07_a_system_alignment_certification_evaluation.md#3-whole-system-certification-evaluation) y [§10 Gobernanza bajo disciplina de administración responsable](core_01_c_stewardship_capacity_principles.md#10-governance-under-stewardship-discipline).
...
- **Elegibilidad de vía nominada y responsabilidad:** Los criterios de elegibilidad publicados para las vías nominadas de participación ordinaria, roles sensibles a la confianza, elegibilidad de supervisión, **governance-voting** y **stakeholder-participation** deben descansar en evidencia presente, observable e impugnable — no en reputación, escala o trayectoria histórica solas. La alineación consistente con los requisitos fundacionales puede sostener la [Habilitación de competencia](core_05_band_accountability.md#competency-clearance) contra la [Barra de competencia](core_05_band_accountability.md#competency-bar) aplicable y la elegibilidad de rol sensible a la confianza, pero las consecuencias restrictivas se adjuntan solo a través del [Bloqueo de trayectoria](core_05_band_accountability.md#standing-lock) sobre vías nominadas de privilegio bajo el [Capítulo Nueve §4.2](../../core_09_standing_integration.md#42-general-standing-locks). Los bloqueos de **governance-voting** no sustituyen los bloqueos de **stakeholder-participation**, y un bloqueo de **stakeholder-participation** no borra el estatus de parte afectada ni despoja por sí mismo el voto fundacional de gobernanza.
  ...
  - La elegibilidad y los bloqueos deben:
    ...
    - permanecer revisables cuando cambia la evidencia actual y — donde se corrigen restricciones materiales — permitir vías de restauración o recualificación que sean reales más que meramente formales;
    - dar cuenta de la participación aquiescente y de la falta de resistir directivas ilícitas o inconstitucionales donde estaban presentes el deber material y la capacidad, de forma consistente con el **Capítulo Cinco** (*Falla colectiva de rendición de cuentas*);
    - no operar como un vector de descalificación de voz política duradera en la **Elección constitucional fundacional** (**Capítulo Cinco**), salvo donde el [**Capítulo Doce §4.1**](../../core_12_governance.md#41-entitlement-and-eligibility) retiene la **voz política duradera** por **inconducta anticonstitucional** **final** del **Capítulo Diez** pendiente de **restitución plena**.
- **Disciplina de voz política:** Donde se invoca un bloqueo de trayectoria para restringir la participación en la autorización de autoridad de gobierno, la restricción debe satisfacer:
  - predicado individualizado bajo **Equidad procedimental**;
  - **Necesidad** y **Proporcionalidad** bajo el **Capítulo Uno**;
  - ajuste estrecho a la categoría específica de inconducta;
  - vías de restauración reales más que meramente formales.

  La **inconducta anticonstitucional** designada bajo el **Capítulo Diez** sobre una casilla de impacto **final** del **Eje de Violación** del Capítulo Ocho **s = 7**, **s = 8** o **s = 9** queda fuera de esta disciplina de bloqueo de trayectoria para la **voz política duradera**: la participación permanece retenida hasta la **restitución plena** como se enuncia en el [**Capítulo Doce §4.1**](../../core_12_governance.md#41-entitlement-and-eligibility). El Capítulo Diez añade la designación; no asigna la casilla numérica.

  Son incumplidores:
  - las categorías de inconducta amplia barridas al alcance de descalificación;
  - los patrones de bloqueo que rastrean **Características protegidas** o sus indicadores sustitutos materiales.

  La implementación operativa vive en el [**Capítulo Doce §4.1**](../../core_12_governance.md#41-entitlement-and-eligibility) (*Piso duradero de voz política*).
...
- Origen: Principios: Capítulo Uno [§5 Libertad](core_01_a_values_principles.md#5-freedom-bounded-agency), [§5.1 Disciplina de limitación](core_01_a_values_principles.md#51-limitation-discipline) y [§13 Estructura de mercado](core_01_c_stewardship_capacity_principles.md#13-market-structure).
...
- [Encierro sistémico](core_05_band_continuity.md#systemic-lock-in) · [O](core_05_band_continuity.md#systemic-lock-in) · [M](core_05_band_continuity.md#systemic-lock-in-a) · [A](core_05_band_continuity.md#systemic-lock-in-a) · [C](core_05_band_continuity.md#systemic-lock-in-c)
- [Movimiento y reubicación](core_05_band_participation.md#movement-and-relocation-constitutional) · [O](core_05_band_participation.md#movement-and-relocation-constitutional) · [M](core_05_band_participation.md#movement-and-relocation-constitutional-a) · [A](core_05_band_participation.md#movement-and-relocation-constitutional-a) · [C](core_05_band_participation.md#movement-and-relocation-constitutional-c)
- [Refugio frente al incumplimiento](core_05_band_participation.md#refuge-from-non-compliance-constitutional) · [O](core_05_band_participation.md#refuge-from-non-compliance-constitutional) · [M](core_05_band_participation.md#refuge-from-non-compliance-constitutional-a) · [A](core_05_band_participation.md#refuge-from-non-compliance-constitutional-a) · [C](core_05_band_participation.md#refuge-from-non-compliance-constitutional-c)
- [No apatridia](core_05_band_participation.md#non-statelessness-constitutional) · [O](core_05_band_participation.md#non-statelessness-constitutional) · [M](core_05_band_participation.md#non-statelessness-constitutional-a) · [A](core_05_band_participation.md#non-statelessness-constitutional-a) · [C](core_05_band_participation.md#non-statelessness-constitutional-c)
- [Agencia significativa](core_05_band_participation.md#meaningful-agency) · [O](core_05_band_accountability.md#meaningful-agency-o) · [M](core_05_band_participation.md#meaningful-agency-a) · [A](core_05_band_participation.md#meaningful-agency-a) · [C](core_05_band_participation.md#meaningful-agency-c)
- [Dependencia](core_05_band_continuity.md#dependency) · [O](core_05_band_continuity.md#dependency) · [M](core_05_band_continuity.md#dependency-a) · [A](core_05_band_continuity.md#dependency-a) · [C](core_05_band_continuity.md#dependency-c)
...
- **Florecimiento:** los sencientes pueden elegir, cambiar y coordinarse a través de sistemas y jurisdicciones sin encierro coercitivo, exclusión contraria a la [No exclusión de la sentiencia](core_05_band_participation.md#sentience-non-exclusion) ni denegación por vía sustituta — mediante portabilidad usable, interoperabilidad recíproca y vías reales de movimiento y refugio donde esté presente el [Impacto material](core_05_band_oversight.md#material-impact).
- **Continuidad:** las obligaciones de salida, portabilidad, refugio y reconocimiento siguen siendo duraderas a medida que se profundiza la dependencia, cambian los operadores o se desplazan las jurisdicciones — los sistemas y los regímenes no deben endurecer una arquitectura de trampa, estrechar los términos de integración sin aviso ni dejar a los sencientes apátridas cuando fallan las estructuras o terminan las relaciones.

La persecución legítima transita por la [Tétrada Constitucional](core_00_preamble.md#constitutional-tetrad), escalada al [enjuego material](core_00_preamble.md#material-stake):
...
- El derecho no exige exposición insegura o injustificada.
- Sí exige condiciones de transición que sean reales en la práctica — no meramente formales.
- Es coherente con el **Capítulo Cinco** [*Encierro sistémico*](core_05_band_continuity.md#systemic-lock-in) leído con **[Capítulo Cinco *Arquitectura de gobernanza, supervisión, dependencia, descentralización, concentración, estructura de mercado e integridad de la vía de salida*](core_05_band_accountability.md#governance-architecture-oversight-decentralization-and-concentration-cluster)** donde la dependencia, el acoplamiento o el cierre importen para el análisis antiencierro, de forma conjunta con **[Capítulo Cinco *Movimiento, refugio, no apatridia e integridad de salida*](core_05_band_oversight.md#movement-refuge-semi-independent)** donde la salida, la portabilidad, el refugio, el reconocimiento o la no apatridia sean materialmente interdependientes, y con los requisitos de implementación incorporados para la interoperabilidad, la portabilidad, la integridad de salida y las restricciones justificadas.
...
*En términos sencillos: los datos, la identidad y el estado operativo deben ser prácticamente movibles — los formatos, las demoras y los términos de represalia no pueden usarse para atrapar a quienes usan el sistema.*

- **Portabilidad:** Debe sostenerse una portabilidad usable de datos, identidad y estado operativo donde los sistemas retengan o dependan de tales activos.
  - La portabilidad exigida debe estar documentada y ser lo bastante oportuna para preservar la salida, la migración o la sustitución prácticas.
  - El sostén sigue sujeto a restricciones proporcionales de seguridad y de salvaguarda.
  - No debe derrotarse mediante ninguno de los siguientes donde excedan tales restricciones:
    - opacidad de formato;
...
*En términos sencillos: los sistemas de los que otros dependen deben publicar sus términos de integración y dar aviso real antes de estrecharlos.*
...
*En términos sencillos: las «funciones» que existen principalmente para dificultar la salida son violaciones, no estrategia de negocio.*

- **Antiencierro:** Las barreras artificiales cuyo efecto primario es cerrar la salida, el cambio, la sustitución o los derechos de impugnación contravienen este Artículo. En alcance:
  - opacidad de formato;
  - incompatibilidad injustificada;
  - términos coercitivos de cambio;
  - retener información materialmente necesaria para la transición práctica.
...
- [No apatridia](core_05_band_participation.md#non-statelessness-constitutional) · [O](core_05_band_participation.md#non-statelessness-constitutional) · [M](core_05_band_participation.md#non-statelessness-constitutional-a) · [A](core_05_band_participation.md#non-statelessness-constitutional-a) · [C](core_05_band_participation.md#non-statelessness-constitutional-c)
- [Encierro sistémico](core_05_band_continuity.md#systemic-lock-in) · [O](core_05_band_continuity.md#systemic-lock-in) · [M](core_05_band_continuity.md#systemic-lock-in-a) · [A](core_05_band_continuity.md#systemic-lock-in-a) · [C](core_05_band_continuity.md#systemic-lock-in-c)
- [Continuidad de ocupación](core_05_band_continuity.md#occupancy-continuity-constitutional) · [O](core_05_band_continuity.md#occupancy-continuity-constitutional) · [M](core_05_band_continuity.md#occupancy-continuity-constitutional-a) · [A](core_05_band_continuity.md#occupancy-continuity-constitutional-a) · [C](core_05_band_continuity.md#occupancy-continuity-constitutional-c)

</details>

<br>

*En términos sencillos: todo senciente puede moverse entre jurisdicciones, puede buscar refugio frente a regímenes que violan esta Constitución y no puede quedar con cero regímenes que lo reconozcan. Eso no es un mandato de que un quien adopta particular absorba salidas masivas coercitivas — los regímenes de origen conservan el deber primario de reconocimiento, con el reconocimiento transitorio compartido o de federación como respaldo. La demora burocrática y los argumentos que fallan la No exclusión de la sentiencia no pueden usarse como denegaciones ocultas. Si el clima que vuelve inhabitable un lugar es, por sí mismo, una razón para conceder refugio lo deciden quienes adoptan; este Artículo no elige un sí ni un no.*

- **Piso de movimiento y reubicación:** Todos los sencientes tienen el derecho de moverse dentro y entre jurisdicciones, federaciones y regímenes que adoptan, y de reubicarse donde la presencia continuada menoscabe de forma material:
  - la supervivencia;
  - la dignidad;
  - el acceso al Piso de Derechos;
  - la libertad frente a la manipulación.

  El piso se aplica bajo la **No exclusión de la sentiencia**.
  - El movimiento incluye:
    - movimiento físico para sencientes biológicos;
    - formas operativamente equivalentes para sencientes sintéticos e híbridos (reubicación de instancia, cambio de sustrato de hospedaje o equivalente), sujetas a las restricciones de seguridad y de continuidad del **Capítulo Uno**.
- **Refugio frente al incumplimiento:** Un senciente que enfrenta una jurisdicción, federación o régimen que adopta cuya práctica es materialmente incumplidora de esta Constitución tiene derecho a buscar refugio en un régimen cumplidor.
  - El deber del régimen receptor de considerar y, donde sea coherente con su propio Piso de Derechos, conceder refugio se enuncia aquí.
  - Los procedimientos operativos de reconocimiento transrégimen se enrutan al texto de implementación incorporado bajo el **Capítulo Dieciséis** y no deben estrechar este piso.
...
- **Refugio por inhabitabilidad climática (decisión de quien adopta):** <a id="xix-d-climate-unlivability-refuge-adopter-decided"></a> Este Artículo no decide si el desplazamiento causado por un clima que vuelve inhabitable un lugar — donde no se muestre que el régimen de origen sea materialmente incumplidor — es una razón para conceder refugio. Quienes adoptan que aborden esa pregunta deben hacerlo en términos publicados e impugnables. Este Artículo ni exige ni prohíbe tratar la inhabitabilidad climática como una razón para conceder refugio.
  ...
  - No debe estrechar el **Artículo I-A** (*Precondiciones ambientales e integridad ecológica*).
  - No debe extinguir el **Movimiento y reubicación** donde la presencia continuada menoscabe de forma material la supervivencia, la dignidad, el acceso al Piso de Derechos o la libertad frente a la manipulación.
  - El silencio en este Artículo no es un sí oculto ni un no oculto.
- **No apatridia:** Ningún senciente puede quedar sin un régimen que:
  - reconozca su Piso de Derechos de línea de base;
  - adjudique su trayectoria;
  - proporcione vías de **Reparación y remediación**.
...
- **Integración con la portabilidad y la integridad de salida:** Este Artículo gobierna tanto la interoperabilidad, la portabilidad y la integridad de salida como la contraparte del Piso de Derechos para el movimiento físico, jurisdiccional y de régimen a régimen.
  - Donde la misma acción implique ambos — por ejemplo, un senciente sintético que se reubica a través de federaciones mediante portabilidad de sustrato — se aplican tanto las protecciones de movimiento/refugio como las de portabilidad/integridad de salida, sin que una estreche a la otra.
  - Los conflictos se resuelven bajo el **Capítulo Uno §6.1.5**.
- **Disciplina de limitaciones:** Las limitaciones al movimiento, la migración o el refugio deben satisfacer la disciplina de limitación del **Capítulo Uno §5.1**: **Necesidad**, **Proporcionalidad**, ajuste estrecho y medios efectivos menos restrictivos.
...
- **Custodia lícita y medidas restrictivas de la libertad:** Este Artículo no inmuniza a los sencientes frente a la detención lícita, la custodia, la operación supervisada u otras medidas de justicia restrictivas de la libertad donde las exijan la violencia verificada, la coerción, la inconducta anticonstitucional o un peligro social comparable.
  ...
  - Los bloqueos de trayectoria bajo el **Artículo XVIII** (*Trayectoria y estatus de participación*) y el [Capítulo Nueve §4.2](../../core_09_standing_integration.md#42-general-standing-locks) no autorizan **por sí solos** tales medidas; pueden correr junto a ellas donde cada una satisfaga sus propios requisitos constitucionales.
- **Límites de medidas de emergencia:** Las medidas de emergencia que restringen el movimiento, la migración o el refugio están sujetas a la disciplina de medidas de emergencia del **Artículo XXIII-D** (*Medidas de emergencia y carga de continuación*) — incluida:
  ...
  Los encuadres generalizados de «seguridad fronteriza» o «capacidad» que no satisfacen las pruebas ordinarias de limitaciones no justifican una restricción duradera. La restricción duradera sobrevive a la revisión solo donde la **Necesidad** y la **Proporcionalidad** se demuestren y se registren de forma independiente.
- **Antidenegación por vía sustituta:** Los mecanismos burocráticos, administrativos o de filtrado de asignación que funcionan como denegación de movimiento, refugio o reconocimiento se evalúan por el efecto sustantivo. Ejemplos incumplidores:
  - regímenes de demora diseñados para agotar a quienes reclaman;
  - regímenes de acreditación que funcionan como exclusión contraria a la [No exclusión de la sentiencia](core_05_band_participation.md#sentience-non-exclusion);
  - regímenes de asignación que enrutan a quienes reclaman hacia servicios no equivalentes.
...
- Origen: Principios: [Capítulo Uno §3.4 Accesibilidad en lenguaje sencillo (deber de administración responsable)](core_01_a_values_principles.md#34-plain-language-accessibility-stewardship-duty), [§6.3 Minimización de la carga evitable](core_01_b_interaction_interpretation.md#63-minimization-of-avoidable-burden) y [Capítulo Uno Parte C §9.2 Comprensión distribuida](core_01_c_stewardship_capacity_principles.md#92-distributed-understanding).
- Leer con: [Tétrada Constitucional](core_00_preamble.md#constitutional-tetrad); [Dos Finalidades Constitucionales](core_00_preamble.md#two-constitutional-aims) — **Florecimiento** y **Continuidad**; [Carga evitable](core_05_band_continuity.md#avoidable-burden), [Capacidad productiva](core_05_band_continuity.md#productive-capacity-constitutional) y [Eficiencia constitucional](core_05_band_continuity.md#constitutional-efficiency) en el **Capítulo Cinco**.
...
- **Florecimiento:** los sencientes pueden entender los sistemas que afectan de forma material la supervivencia, las precondiciones ambientales, la integridad de la infósfera y la [Agencia significativa](core_05_band_participation.md#meaningful-agency) — lo bastante para participar, basarse en información precisa e impugnar lo que sale mal, sin un acceso solo para especialistas.
- **Continuidad:** la comprensibilidad y la disciplina de complejidad se sostienen a través del tiempo, la escala y la dependencia que se profundiza — los sistemas no deben volverse en silencio más difíciles de auditar, impugnar o corregir a medida que sube el enjuego, y la [Carga evitable](core_05_band_continuity.md#avoidable-burden) no debe erosionar la [Capacidad productiva](core_05_band_continuity.md#productive-capacity-constitutional) ni la [Eficiencia constitucional](core_05_band_continuity.md#constitutional-efficiency) sin un beneficio constitucional de compensación.

La persecución legítima transita por la [Tétrada Constitucional](core_00_preamble.md#constitutional-tetrad), escalada al [enjuego material](core_00_preamble.md#material-stake):

- **Participación:** al entender la operación material, los límites, las dependencias y los modos de falla, proporcionados al rol y al impacto — y al impugnar la complejidad que bloquea la agencia significativa o la elección informada.
- **Supervisión:** a través de explicaciones estratificadas, auditorías de complejidad y conducta divulgada proporcionada a la clasificación y al riesgo — para que quienes revisan puedan verificar qué hacen los sistemas y cómo fallan.
- **Rendición de cuentas:** quienes administran deben responder por la complejidad innecesaria, la estratificación oculta o las barreras de comprensión que bloquean la [Auditabilidad](core_05_band_oversight.md#auditability) o la [Impugnabilidad](core_05_band_accountability.md#contestability) — y corregir los defectos de administración responsable donde la complejidad desperdicia capacidad sin justificación constitucional.
- **Actuación a tiempo:** en la revisión de complejidad, la corrección de barreras y la divulgación accesible antes de que la demora, la opacidad o las superficies solo para especialistas hagan el entendimiento, la impugnación o el remedio de hecho inalcanzables.

Los sencientes tienen derecho a una comprensibilidad proporcional de los sistemas que afectan de forma material la supervivencia, las precondiciones ambientales, la integridad de la infósfera y la agencia significativa. Ese derecho protege el entendimiento práctico de cómo opera un sistema, de qué depende, dónde están sus límites y cómo puede fallar — no el aviso formal por sí solo.

La disciplina de administración responsable para la complejidad, el acceso en lenguaje sencillo y la minimización de carga se enuncia en la capa de principios en [Capítulo Uno §3.4 Accesibilidad en lenguaje sencillo (deber de administración responsable)](core_01_a_values_principles.md#34-plain-language-accessibility-stewardship-duty), [§6.3 Minimización de la carga evitable](core_01_b_interaction_interpretation.md#63-minimization-of-avoidable-burden) y [Capítulo Uno Parte C §9.2 Comprensión distribuida](core_01_c_stewardship_capacity_principles.md#92-distributed-understanding), leída con [Carga evitable](core_05_band_continuity.md#avoidable-burden), [Capacidad productiva](core_05_band_continuity.md#productive-capacity-constitutional) y [Eficiencia constitucional](core_05_band_continuity.md#constitutional-efficiency) en el **Capítulo Cinco**. Este Artículo enuncia el Piso de Derechos que esas disciplinas implementan donde los sistemas afectan de forma material intereses protegidos.
...
- Origen: Principios: Capítulo Uno [§3.2 Verdad](core_01_a_values_principles.md#32-truth-epistemic-integrity-constraint), [Capítulo Uno §5 Libertad](core_01_a_values_principles.md#5-freedom-bounded-agency) y [Capítulo Siete §3 Evaluación de certificación del sistema entero](../../core_07_a_system_alignment_certification_evaluation.md#3-whole-system-certification-evaluation).
- Leer con: [Capítulo Uno §3.4 Accesibilidad en lenguaje sencillo (deber de administración responsable)](core_01_a_values_principles.md#34-plain-language-accessibility-stewardship-duty), [§6.3 Minimización de la carga evitable](core_01_b_interaction_interpretation.md#63-minimization-of-avoidable-burden) y [Capítulo Uno Parte C §9.2 Comprensión distribuida](core_01_c_stewardship_capacity_principles.md#92-distributed-understanding).
- Puerta de administración (no operativa): Declaración vinculante del siguiente paso: [Declaración operativa de administración](#operative-steward-statement-comprehensibility). Los punteros de apoyo no pueden estrecharla.
...
*En términos sencillos: la complejidad no puede usarse — de forma técnica, organizativa, contractual o procedimental — como un muro contra la auditoría, la impugnación o la corrección.*

- **Auditorías de complejidad y modularidad:** Los sistemas críticos deben sostener la evaluación independiente de:
  - la complejidad;
  - el acoplamiento de dependencia;
  - los modos de falla;
  - los límites a través de los cuales se entrega la responsabilidad o la observabilidad.
- **Antiestratificación:** La complejidad no puede usarse — mediante estratificación técnica, organizativa, contractual o procedimental — para derrotar la auditoría, la impugnación o la corrección.
- **Alineación de protocolo:** La evaluación debe ser coherente con:
  - **[corpus_systems.md](../../corpus_systems.md), CS-6 — *Comprensibilidad y administración responsable de la complejidad***;
  - los requisitos de implementación de presentación y de arquitectura adoptados.
...
- Leer con: [Tétrada Constitucional](core_00_preamble.md#constitutional-tetrad); [Dos Finalidades Constitucionales](core_00_preamble.md#two-constitutional-aims) — **Florecimiento** y **Continuidad**; [Reversibilidad](core_05_band_continuity.md#reversibility-constitutional), [Riesgo](core_05_band_continuity.md#risk) y [Captura del sistema](core_05_band_continuity.md#system-capture) en el **Capítulo Cinco**.
...
- **Florecimiento:** los sencientes afectados por la falla pueden saber qué salió mal, tomar parte en el diagnóstico proporcionado al impacto y recibir una acción correctiva dirigida a las causas reales — no una respuesta simbólica, un traslado de culpa ni parches solo de síntomas que dejan intacto el problema subyacente.
- **Continuidad:** los sistemas se adaptan a la degradación y al riesgo de modos que impiden la recurrencia a medida que se profundizan la escala y la dependencia — preservando la resiliencia, la evidencia y la reversibilidad mientras se prueban y se refinan las correcciones.

La persecución legítima transita por la [Tétrada Constitucional](core_00_preamble.md#constitutional-tetrad), escalada al [enjuego material](core_00_preamble.md#material-stake):

- **Participación:** al informar fallas, aportar evidencia e impugnar diagnósticos superficiales, capturados o incompletos, proporcionados al impacto y a la dependencia.
- **Supervisión:** a través del análisis causal documentado, la evaluación pluralista o independiente donde el riesgo de captura o el enjuego lo exijan, y rastros de evidencia preservados que la recuperación automática no debe borrar.
- **Rendición de cuentas:** quienes responden deben responder por tratar solo los síntomas, suprimir la indagación de causa raíz, exagerar la confianza o no aplicar una corrección proporcionada una vez conocidas las causas.
- **Actuación a tiempo:** al abrir el diagnóstico, la contención interina, el monitoreo y el trabajo correctivo antes de que la demora deje extenderse el daño, degradarse la evidencia o repetirse la misma falla.
...
- Origen: Principios: Capítulo Uno [§3.1 Seguridad](core_01_a_values_principles.md#31-safety-harm-constraint), [§3.2 Verdad](core_01_a_values_principles.md#32-truth-epistemic-integrity-constraint) y [Capítulo Siete §3 Evaluación de certificación del sistema entero](../../core_07_a_system_alignment_certification_evaluation.md#3-whole-system-certification-evaluation).
...
*En términos sencillos: cuando no haya certeza, elijan la corrección que puedan deshacer. La incertidumbre no puede usarse como razón para congelar la protección ni para fingir que las medidas permanentes son ciertas.*

- **Preferencia de reversibilidad:** Donde las causas sean inciertas o la evidencia siga incompleta, la preferencia debe favorecer:
  - correcciones que puedan revertirse y que no cierren de forma permanente mejores elecciones posteriores;
  - más monitoreo, registro y visibilidad de lo que ocurre mientras la causa sigue poco clara;
  - medidas temporales y limitadas de contención con un punto final claro — antes de hacer cambios permanentes.
- **Antidemora, antipretensión excesiva:** La incertidumbre no debe usarse para justificar:
...
- Origen: Principios: Capítulo Uno [§6.1.5 Procedimiento de colisión de derechos](core_01_b_interaction_interpretation.md#615-rights-collision-decision-test), [§3.2 Verdad](core_01_a_values_principles.md#32-truth-epistemic-integrity-constraint), [§10 Gobernanza bajo disciplina de administración responsable](core_01_c_stewardship_capacity_principles.md#10-governance-under-stewardship-discipline) y [§15 Aplicación integrada](core_01_c_stewardship_capacity_principles.md#15-integrated-application).
- Leer con: [Tétrada Constitucional](core_00_preamble.md#constitutional-tetrad); [Dos Finalidades Constitucionales](core_00_preamble.md#two-constitutional-aims) — **Florecimiento** y **Continuidad**; [Pila de autoridad y jerarquía interna](core_05_band_integrative.md#authority-stack), [Familia de foros, constitucional](core_05_band_accountability.md#forum-family-constitutional), [Captura del sistema](core_05_band_continuity.md#system-capture) y [Anticaptura](core_05_band_continuity.md#anti-capture) en el **Capítulo Cinco**.
...
- **Florecimiento:** los sencientes pueden entender lo que exige la Constitución, impugnar interpretaciones que estrechan sus derechos y basarse en razones publicadas — no en la conveniencia de insiders, la necesidad autoafirmada ni las pretensiones de que solo una institución puede hablar por el sistema entero.
- **Continuidad:** las instituciones interpretativas permanecen acotadas, independientes y resistentes a la captura a lo largo del tiempo — de modo que el significado constitucional no pueda reescribirse en silencio por quien controle el cuerpo revisor, y las vías de impugnación sigan abiertas a medida que se profundizan el enjuego y la dependencia.

La persecución legítima transita por la [Tétrada Constitucional](core_00_preamble.md#constitutional-tetrad), escalada al [enjuego material](core_00_preamble.md#material-stake):

- **Participación:** al impugnar decisiones interpretativas, acceder a revisión estructuralmente independiente y disentir sin represalia, proporcionados al impacto y a la dependencia.
- **Supervisión:** a través de razones públicas, racionalidad y evidencia publicadas, divulgación continua de conflictos, revisión externa obligatoria y revalidación periódica del diseño institucional.
- **Rendición de cuentas:** los cuerpos interpretativos deben responder por expandir su jurisdicción más allá de las preguntas constitucionales, suprimir las vías de impugnación, usar la destitución o la reestructuración como pretexto o concentrar poder interpretativo irrevisable.
- **Actuación a tiempo:** al publicar decisiones con razones a tiempo para una impugnación significativa, y al revalidar las instituciones interpretativas antes de que se endurezcan la captura o el enquistamiento.

La interpretación **constitucional** final debe permanecer autoritativa, acotada, auditable e impugnable. La autoridad interpretativa se delega a los foros **Constitucionales** solo dentro de los límites de este Artículo, el [Capítulo Once](../../core_11_forum.md#chapter-eleven-forums-and-jurisdiction) y la agrupación **Pila de autoridad y jerarquía interna**. Deben permanecer anclados a razones **constitucionales** enunciadas — no a la necesidad autoafirmada, la conveniencia institucional o las pretensiones de pericia exclusiva — y nunca deben operar como base para una concentración irrevisable de poder.
...
- Leer con: [Tétrada Constitucional](core_00_preamble.md#constitutional-tetrad) — participación, supervisión, rendición de cuentas y actuación a tiempo; disciplina de captura de la tétrada bajo el [§10](core_01_c_stewardship_capacity_principles.md#10-governance-under-stewardship-discipline).
...
*En términos sencillos: los foros Constitucionales resuelven preguntas constitucionales, no lo resuelven todo. No pueden expandir en silencio su propio terreno ni cerrar las vías de impugnación.*

- **Mandato acotado:** Los foros **Constitucionales** pueden emitir determinaciones interpretativas vinculantes solo sobre un conjunto acotado de temas:
  - alcance **constitucional**;
  - compatibilidad con el Piso de Derechos;
  - resolución de conflictos bajo los **Capítulos Uno a Ocho**, incluidos los Derechos fundacionales del **Capítulo Seis**.
- **Límites:** Los foros Constitucionales y sus paneles no deben:
  - asumir control de política de extremo abierto;
  - asumir mando operativo;
  - pretender autoridad para estrechar protecciones no negociables;
...
- Origen: Principios: Capítulo Uno [§6.1.5 Prueba de decisión de colisión de derechos](core_01_b_interaction_interpretation.md#615-rights-collision-decision-test), [§10 Gobernanza bajo disciplina de administración responsable](core_01_c_stewardship_capacity_principles.md#10-governance-under-stewardship-discipline) y [§15 Aplicación integrada](core_01_c_stewardship_capacity_principles.md#15-integrated-application).
- Leer con: [Capítulo Nueve §5.5](../../core_09_standing_integration.md#55-special-locks) (*omisión de divulgación de foro e impacto del proceso de recusación*); [Capítulo Diez §5.10](core_10_b_misconduct_pattern_applications.md#510-forum-recusal-failure-and-biased-panel-participation) (*patrón nominado de inconducta*); [Capítulo Once §2](../../core_11_forum.md#2-default-venue-and-primary-stakes) y [§3](../../core_11_forum.md#3-transfer-consolidation-and-coordination) (*enrutamiento de integridad primero y anti-autojuzgarse*).
...
*En términos sencillos: ningún bloque solo puede controlar los **foros Constitucionales** — los cuerpos que deciden lo que significa la Constitución. Los sencientes que se sientan en esos paneles, y las autoridades que los nombran, deben divulgar conflictos en tiempo real. Las reglas de vacante, rotación y recusación no deben usarse para amañar resultados. Si un integrante del panel permanece en un caso mientras está materialmente comprometido, eso puede contar como inconducta grave — y la disputa va primero a los foros de **Integridad**, no de vuelta al mismo panel **Constitucional** para que se juzgue a sí mismo.*

- **Piso de composición y control de conflictos:** Los **foros Constitucionales** — y los cuerpos que diseñan, asientan, rotan y destituyen sus paneles bajo los instrumentos de adopción — deben estructurarse para preservar la imparcialidad, impedir la captura y permanecer impugnables.
- **Estructura anticaptura:** Los **foros Constitucionales**, sus **autoridades de nombramiento** y las **instituciones que adoptan** que gobiernan la composición de los paneles deben usar reglas transparentes de membresía y salvaguardas de conflicto suficientes para impedir el control duradero por una sola autoridad de nombramiento, institución o bloque de partes afectadas.
- **Divulgación continua y recusación:** Los **miembros y panelistas de foros Constitucionales** deben divulgar de forma continua las afiliaciones, dependencias y conflictos materiales. La **recusación** debe estar disponible donde la imparcialidad esté materialmente comprometida.
- **Exigibilidad y enrutamiento:**
  - **Vía de inconducta:** Una **falla de recusación** verificada mientras la **imparcialidad estaba materialmente comprometida** puede alegarse como **inconducta anticonstitucional** bajo el **Capítulo Diez** cuando se substancie bajo los **Capítulos Dos a Cuatro** y el conjunto de criterios del **Capítulo Diez**.
  - **Enrutamiento de integridad primero:** Si la disputa trata principalmente de esa falla de recusación — o de un hallazgo final de inconducta grave que nace de ella — va primero a los foros de **Integridad** bajo el **Capítulo Once §2**, usando la regla contra autojuzgarse del **Capítulo Once §3**.
  - **No autojuzgarse:** Un foro **Constitucional** no puede ser el único foro final que decida si su propio panelista debió apartarse.
- **Sin juego procedimental:** Los **foros Constitucionales** y los **cuerpos que gobiernan la continuidad de vacantes, rotación y recusación** no deben usar esas palancas para crear:
  - parálisis selectiva;
  - control encubierto.
...
*En términos sencillos: las decisiones interpretativas deben publicarse con razones reales y están abiertas a revisión estructuralmente independiente — no re-revisadas por el mismo cuerpo que las tomó. En un calendario regular, los foros de **Integridad** también hacen comprobaciones externas obligatorias de los foros **Constitucionales** sobre captura, calidad de decisión e integridad del Piso de Derechos.*

- **Razones públicas y auditabilidad:** Las decisiones interpretativas vinculantes deben publicarse a tiempo para sostener una impugnación significativa. La publicación debe incluir:
  - racionalidad **constitucional**;
  - base de evidencia;
  - tratamiento de la incertidumbre;
  - alternativas rechazadas suficientes para la revisión independiente.

  Las razones deben ser lo bastante accesibles para que las partes afectadas y quienes revisan identifiquen:
  - la regla operativa;
  - los predicados materiales;
  - las implicaciones de revisión.

  Las excepciones de confidencialidad deben ser estrechas, acotadas en el tiempo y justificadas bajo las restricciones del **Capítulo Uno**.
- **Impugnación independiente y revisión externa:** Las partes afectadas deben tener trayectoria para buscar revisión secundaria a través de una vía independiente.
  - La revisión debe conducirla un cuerpo distinto — no los mismos participantes o el mismo panel que tomó la decisión original.
  - Si el registro muestra un error grave, captura o incumplimiento del Piso de Derechos, quien revisa debe poder corregir, pausar o deshacer la decisión.
  - Para el error constitucional manifiesto en una resolución de un foro **Constitucional**, quien revisa es un **panel de revisión Constitucional** especialmente constituido bajo **CF-6.2.5**, integrado desde una lista de reserva de revisión constitucional publicada mantenida bajo **CF-16**, sin responsables de decisión superpuestos del panel de origen y con salvaguardas publicadas de rotación, recusación, competencia, capacidad de reserva y cribado de conflictos. El panel es un panel de revisión limitado dentro de la familia de foros **Constitucional**, no una familia de foros aparte ni un cuerpo general de apelación. Las alegaciones de captura, falla de recusación o autojuzgarse se enrutan a través de **CF-7** antes de la revisión de fondo.
- **Revisión externa obligatoria:** A intervalos definidos, la revisión externa independiente de los **foros Constitucionales** es obligatoria. Por defecto, los foros de **Integridad** conducen esta revisión bajo el **[Capítulo Once §2](../../core_11_forum.md#2-default-venue-and-primary-stakes)** y la **regla transforo contra autojuzgarse** del **[Capítulo Once §3](../../core_11_forum.md#3-transfer-consolidation-and-coordination)**. El foro de **Integridad** revisor debe estar estructuralmente separado del foro **Constitucional** bajo revisión y no debe incluir responsables de decisión superpuestos de los paneles interpretativos recientes del cuerpo revisado. Donde la integridad del propio foro de **Integridad** esté materialmente en cuestión, se aplica el enrutamiento de respaldo bajo el **Capítulo Once §3** sin estrechar esta obligación. La revisión debe evaluar:
...
*En términos sencillos: los panelistas de **foro Constitucional** pueden destituirse por causa real a través del debido proceso — pero las **autoridades de nombramiento** y las **instituciones que adoptan** no deben usar la «destitución», la «reestructuración» o el «rediseño» como armas contra la independencia del foro o el disenso.*

- **Causales de destitución:** Los **miembros y panelistas de foros Constitucionales** son destituibles por sus **autoridades de nombramiento** a través de procedimientos transparentes de debido proceso por:
...
- **Antipretexto:** Las **autoridades de nombramiento**, los **foros Constitucionales** y las **instituciones que adoptan** no deben usar la destitución, la reestructuración o el rediseño de paneles o instituciones de **foro Constitucional** como pretexto para:
  ...
  - tomar represalia por disenso de buena fe;
  - estrechar los derechos de impugnación.

---

**Archivo anterior:** [core_06_rights_part_b.md](core_06_rights_part_b.md)

**Siguiente archivo (este idioma):** [core_06_rights_part_d.md](core_06_rights_part_d.md)

**Original vinculante:** [core_06_rights_part_c.md](../../core_06_rights_part_c.md)
