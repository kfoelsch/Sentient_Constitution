...
>
> Este archivo es un **piloto de idioma de lectura** del [Capítulo Seis, Parte D en inglés](../../core_06_rights_part_d.md). **No** es parte vinculante de la Constitución Senciente. **No** es una segunda constitución. **No** es una edición de envío. Está **fijado** a `SC-Corpus-2026.08.09`. Si esta traducción y el original en inglés parecen discrepar, gana el archivo numerado [`core_06_rights_part_d.md`](../../core_06_rights_part_d.md). El orden de lectura y los metadatos de edición se mantienen en [README.md](../../README.md). Método y glosario: [translations/es/README.md](README.md).
>
> Contiene el **Capítulo Seis, Parte D**; la numeración de artículos y las referencias cruzadas coinciden con el instrumento integrado.
>
...
<details>
<summary><strong><span style="color: #2563eb;">Orientación para quien lee (no operativo): posición de la Parte D en el Capítulo Seis</span></strong></summary>
...
- oportunos;
- impugnables;
- prácticamente usables.

La adjudicación y la resolución de disputas en el sentido constitucional se definen en el **Capítulo Cinco** como [*Adjudicación y resolución de disputas*](core_05_band_accountability.md#adjudication-and-dispute-resolution-constitutional) y [*Resolución oportuna*](core_05_band_accountability.md#timely-resolution-constitutional), miembros de la agrupación [*Rendición de cuentas, Impugnabilidad, Adjudicación y resolución de disputas, Falla colectiva de rendición de cuentas y Fuerza mayor*](core_05_band_integrative.md#accountability-contestability-and-collective-accountability-failure-cluster).
...
*En términos sencillos: la justicia opera a través de la **violación**, la **corrección** y la **prevención**. Aborden lo que salió mal, reparen lo que se rompió y lo que lo causó, y eviten que vuelva a ocurrir — no inflijan sufrimiento por sí mismo.*

- **Objetivo y alcance de la justicia:** La justicia constitucional se estructura en torno a la violación, la corrección y la prevención. Sus finalidades primarias son:
  - responder a la violación verificada, incluida la detención del daño en curso;
  - asegurar la corrección mediante restitución, remediación y cambio de conducta o de sistemas;
...
*En términos sencillos: las restricciones graves sobre un senciente deben ser, a la vez, necesarias para la seguridad, proporcionales, restaurativas, individualizadas y respaldadas por evidencia real. Los sencientes violentos deben ser encarcelados cuando eso sea necesario para proteger a otros. La inconducta anticonstitucional verificada y sus requisitos de encarcelamiento se gobiernan por el **Capítulo Diez** §4.2. La privación de la vida como medida de justicia queda absolutamente vedada — ningún nivel, emergencia o transición la reabre.*

- **Alcance:** Las privaciones y restricciones no triviales incluyen limitaciones sobre:
  - la libertad;
  - el acceso;
  - la autoridad de rol;
  - el movimiento;
  - los recursos;
  - los efectos duraderos de trayectoria.
- **Requisitos conjuntos:** Cualquier medida de ese tipo es incumplidora a menos que **satisfaga de forma demostrable todos** los siguientes **de forma conjunta**. La satisfacción parcial no basta:
  - necesidad material de seguridad;
  - restitución o remediación proporcional;
  - rehabilitación o reducción de la recurrencia donde sea viable;
  - mantener el crédito y las consecuencias sobre los actores correctos — respaldados por evidencia que cualquiera pueda auditar — bajo los **capítulos Dos a Cuatro**.
- **Carga individualizada:** Cualquier medida de ese tipo debe apuntar al senciente o al rol específico involucrado — no a una etiqueta de grupo o a un proxy — y debe permanecer abierta a impugnación y a revisión independiente.
  - Una etiqueta dura, una condena pública o un atajo administrativo no sustituyen la prueba de cada requisito de la lista conjunta de arriba.
...
- Origen: Principios: Capítulo Uno [§6.1 Principios centrales de compensación](core_01_b_interaction_interpretation.md#61-core-tradeoff-principles), [Capítulo Uno §6.1.5 Procedimiento de colisión de derechos](core_01_b_interaction_interpretation.md#615-rights-collision-decision-test) y [§7 Prohibición de anulación absoluta](core_01_b_interaction_interpretation.md#7-prohibition-on-absolute-override).
...
- **Medidas incumplidoras:** Las siguientes son incumplidoras:
...
- **Aplicación de emergencia del principio de restricción:** Las medidas de emergencia aplican el [**Principio de restricción menos restrictiva, acotada en el tiempo y revisable**](core_01_b_interaction_interpretation.md#615-least-restrictive-time-bounded-and-reviewable-constraint-principle) bajo condiciones de daño inminente. Las medidas temporales para prevenir daño inminente deben ser:
  ...
  - una cadencia predefinida de revisión independiente;
  - condiciones explícitas de restauración y reversión.
- **Antipretexto y no elusión:** La designación de emergencia se gobierna por el [**Principio constitucional de no elusión**](core_01_b_interaction_interpretation.md#81-constitutional-no-bypass-principle) y no debe descansar en:
  - la conveniencia del operador;
  - la urgencia autoinfligida;
  - la elusión del escrutinio constitucional ordinario;
  - pretensiones de riesgo existencial usadas para eludir la **Verdad**, la auditabilidad, la impugnabilidad o la revisión limitada en el tiempo.

  La única excepción es el alcance estrecho estrictamente necesario para prevenir daño irreversible inminente. Cualquier restricción temporal de ese tipo debe ser atribuible, justificada y prontamente revisable.
- **Disciplina de continuación:** La continuación más allá del vencimiento por defecto, o más allá de una ventana de restauración-impugnación de abajo, es incumplidora a menos que se reautorice mediante una demostración documentada de carga que muestre:
  - necesidad continua;
  - proporcionalidad;
...
- **Revisión y aviso (relojes de restauración-impugnación):** Contengan ahora; restauren el aviso y la impugnación después; nunca omitan la participación de forma permanente. «Tan pronto como sea viable» no es el reloj. Las partes afectadas deben recibir aviso y acceso restaurado a la impugnación dentro de los mismos límites exteriores de nivel de materialidad que el [**Artículo XXIV-C**](#article-xxiv-c-timely-resolution-and-anti-delay-floor) ya usa para la resolución de foro, según lo implementa el [Capítulo Once §6](../../core_11_forum.md#6-timely-resolution-materiality-tiers-and-anti-delay-discipline):
  ...
  Esos números se reutilizan; no son una segunda tabla. El [Capítulo Once §6](../../core_11_forum.md#6-timely-resolution-materiality-tiers-and-anti-delay-discipline) sigue siendo el hogar numérico. La ventana de restauración-impugnación corre desde el inicio de la medida de emergencia, o desde cuando se diferió el aviso o la impugnación, lo que ocurra primero. La contención de emergencia que difiere el aviso o la impugnación es **Tier A** salvo que quede registrada una demostración documentada de menor urgencia. Los operadores pueden restaurar antes. No pueden estirar más allá del valor por defecto del nivel excepto a través de la **Disciplina de continuación**. La revisión independiente plena de la medida debe comenzar dentro de la misma ventana. Las tablas de etapa en [CF-11.3.1](../../corpus_forum/cf_11_performance_backlog_publication_accessibility.md#cf-1131-target-windows-and-timing-floors) no deben retrasar estos valores por defecto.
- **Sin normalización:** Las medidas de emergencia no deben normalizarse en gobernanza permanente sin:
...
- Origen: Principios: Capítulo Uno [§3.1 Seguridad](core_01_a_values_principles.md#31-safety-harm-constraint), [§6 Resolución de conflictos de proceso](core_01_b_interaction_interpretation.md#6-process-conflict-resolution) y [§8 Interpretación constitucional](core_01_b_interaction_interpretation.md#8-constitutional-interpretation).
- Leer con: familia de medición Actuación a tiempo (*Resolución oportuna como medición constitucional*).
...
*En términos sencillos: después de la emergencia, miren atrás con honestidad y publiquen lo que hallen — con confidencialidad solo estrecha y limitada en el tiempo.*

- **Revisión retrospectiva y divulgación posteriores a la emergencia:** Después de la estabilización, las decisiones y los resultados de emergencia deben someterse a revisión retrospectiva.
- **Registros auditables:** Los registros deben ser auditables y deben cubrir:
  - condiciones disparadoras;
  - alternativas consideradas;
  - restricciones impuestas;
  - daños prevenidos;
  - daños causados;
  - desempeño de reversión o restauración;
  - lecciones para la reducción de la recurrencia.
- **Divulgación:** Se exige divulgación pública o dirigida a las partes afectadas, sujeta al [**Principio de restricción menos restrictiva, acotada en el tiempo y revisable**](core_01_b_interaction_interpretation.md#615-least-restrictive-time-bounded-and-reviewable-constraint-principle) para excepciones de confidencialidad estrechas, justificadas y acotadas en el tiempo.
  - Cada excepción debe identificar:
    - su justificación;
...
*En términos sencillos: los conflictos de derechos deben resolverse en el registro; se prefiere la restauración donde sea apropiada, pero no debe reemplazar la protección real. Las reglas de disculpa pública voluntaria se gobiernan por el **Capítulo Nueve** §4.3 en general, y por el **Capítulo Diez** §4.3 para la inconducta anticonstitucional verificada.*

- **Procedimiento de colisión de derechos:** Donde los conflictos de derechos sean materiales, los foros y los cuerpos de gobierno deben aplicar el **Capítulo Uno §6.1.5** (*Prueba de decisión de colisión de derechos*), incluido el [**Principio de restricción menos restrictiva, acotada en el tiempo y revisable**](core_01_b_interaction_interpretation.md#615-least-restrictive-time-bounded-and-reviewable-constraint-principle).
  - Los registros deben identificar de forma explícita:
...
- **Supervisión de foro y de cadena:** Lo siguiente, para las disputas enrutadas a través de los **capítulos Ocho a Once**, se gobierna por el [Capítulo Once §6](../../core_11_forum.md#6-timely-resolution-materiality-tiers-and-anti-delay-discipline), sujeto al piso oportuno, eficiente y justo de este Artículo:
  ...
  - límites exteriores de resolución integrada;
  - revisión de desbordamiento; y
...
- **Florecimiento:** los sencientes conservan voz significativa en cómo se dan forma, se impugnan y se reemplazan las estructuras de gobierno — no quedan encerrados por arreglos que sobrevivieron a su justificación.
- **Continuidad:** los sistemas de horizonte largo se mantienen lo bastante estables para planear y recuperarse, pero no tratan el cableado de hoy como permanente cuando ya no se alinea con los requisitos constitucionales.
...
- **Participación:** al proponer, impugnar y reemplazar mecanismos de gobernanza cuando la revalidación muestre desalineación, exclusión o degradación de los derechos de impugnación.
- **Supervisión:** a través de la revalidación periódica, criterios públicos de continuación o reemplazo, y registros observables cuando ocurra un cambio constitucional material.
...
- Origen: Principios: [Capítulo Uno §10.3 Justificación continua](core_01_c_stewardship_capacity_principles.md#103-ongoing-justification); Capítulo Uno [§2 Objetivo fundacional: bienestar](core_01_a_values_principles.md#2-foundational-objective-wellbeing), [Capítulo Siete §3 Evaluación de certificación del sistema entero](../../core_07_a_system_alignment_certification_evaluation.md#3-whole-system-certification-evaluation) y [§7 Prohibición de anulación absoluta](core_01_b_interaction_interpretation.md#7-prohibition-on-absolute-override).
...
*En términos sencillos: la gobernanza debe ganar su autoridad continua mediante revisión regular — y debe revisarse más rápido cuando esté apareciendo captura, exclusión o fallo.*

- **Revisión periódica:** Los mecanismos materiales de gobernanza y de asignación deben estar sujetos a:
  - revalidación periódica y transparencia;
  - criterios visibles para las partes afectadas de continuación o reemplazo, según se implementen en protocolos de implementación y salvaguardas de gobernanza.
- **Revisión acelerada:** La revalidación debe acelerarse donde la evidencia muestre cualquiera de lo siguiente:
  - presión de captura;
...
- Origen: Principios: Capítulo Uno [§3.2 Verdad](core_01_a_values_principles.md#32-truth-epistemic-integrity-constraint), [Capítulo Siete §3 Evaluación de certificación del sistema entero](../../core_07_a_system_alignment_certification_evaluation.md#3-whole-system-certification-evaluation) y [§7 Prohibición de anulación absoluta](core_01_b_interaction_interpretation.md#7-prohibition-on-absolute-override).
...
- **Registro de cambio material:** Los cambios materiales deben llevar:
  - razones públicas;
  - efectos esperados;
  - compatibilidad con los **capítulos Trece a Quince** donde aplique.
- **Antielusión:** Bajo el [**Principio constitucional de no elusión**](core_01_b_interaction_interpretation.md#81-constitutional-no-bypass-principle), los cambios no deben usarse para eludir los **mínimos del Piso de Derechos** ni las reglas para cambiar lícitamente esta Constitución desviando el cambio sustantivo a través de mecanismos de emergencia, implementación o custodia — incluidos:
  - los **Artículos V** (*Derechos básicos iguales*) y **VI** (*Derecho a una educación centrada en los sencientes*);
...
- **Florecimiento:** los sencientes conservan los **mínimos del Piso de Derechos**, voz significativa y vías prácticas de impugnación a lo largo de la transición — el trabajo de transición no es una licencia para despojar dignidad, acceso, remedio o agencia por conveniencia.
- **Continuidad:** los sistemas compartidos siguen siendo gobernables, preservadores de derechos y recuperables a través del traspaso — con arreglos interinos que ceden a instituciones y procesos constitucionales cada vez más funcionales, no que se endurezcan en autoridad de excepción duradera ni en una línea de base constitucional bajada.

La persecución legítima corre a través de la [Tétrada Constitucional](core_00_preamble.md#constitutional-tetrad), escalada al [enjuego material](core_00_preamble.md#material-stake) — cuanto mayor es el impacto, la dependencia y el riesgo, más fuerte debe ser cada deber:

- **Participación:** las partes afectadas tienen voz real en cada fase de transición — incluidos criterios de puerta visibles, la oportunidad de impugnar decomisos o restricciones del tiempo de transición, y aportes cuando se renuevan poderes interinos que tocan derechos o trayectoria.
- **Supervisión:** la transición debe seguir siendo observable y comprobable — puertas cumplidas y documentadas, autoridad interina revisada de forma independiente, progreso medido por el encogimiento del alcance interino y la maduración de la operación constitucional, registros auditables, y razones publicadas para demoras, reversiones o reinicios de línea de base.
- **Rendición de cuentas:** quienes dirigen la transición deben responder por usarla como cobertura — demora autoinfligida, atajos de conveniencia, ejecución pretextual, vacío de gobernanza, enquistamiento después de hitos fallidos, o bajar en silencio los pisos constitucionales a través de desalineación de implementación.
- **Actuación a tiempo:** los poderes interinos llevan fechas reales de vencimiento; cuanto más duran y más derechos tocan, más dura debe ser la reautorización; y las transiciones estancadas necesitan salidas lícitas antes de que el limbo temporal se endurezca en el nuevo normal.
...
- Origen: Principios: Capítulo Uno [§3.1 Seguridad](core_01_a_values_principles.md#31-safety-harm-constraint), [§6.1 Principios centrales de compensación](core_01_b_interaction_interpretation.md#61-core-tradeoff-principles) y [Capítulo Siete §3 Evaluación de certificación del sistema entero](../../core_07_a_system_alignment_certification_evaluation.md#3-whole-system-certification-evaluation); [Capítulo Nueve §5.4](../../core_09_standing_integration.md#54-special-violation-rules) (*decomiso de recompensa desalineada y deber de informe limitados durante la transición por este Artículo*); [Capítulo Siete — Certificación de alineación del sistema](../../core_07_a_system_alignment_certification_evaluation.md#chapter-seven-system-alignment-certification).
...
*En términos sencillos: las transiciones avanzan al cumplir puertas reales, no por relojes ni por presión — y los mínimos del Piso de Derechos siguen en vigor en cada fase.*

- **Adopción por fases y criterios de puerta:** Los planes de transición deben ser por fases y revisables.
  - El avance de fase debe descansar en la satisfacción documentada de criterios de puerta publicados y de artefactos de verificación exigidos.
  - No debe descansar en ninguno de los siguientes por sí solo:
...
- Origen: Principios: Capítulo Uno [§3.1 Seguridad](core_01_a_values_principles.md#31-safety-harm-constraint), [§6.1 Principios centrales de compensación](core_01_b_interaction_interpretation.md#61-core-tradeoff-principles) y [§7 Prohibición de anulación absoluta](core_01_b_interaction_interpretation.md#7-prohibition-on-absolute-override).
...
*En términos sencillos: la autoridad temporal de verdad es temporal — y una transición que va bien lo muestra. Deberían ver los poderes interinos encogerse fase a fase mientras los foros constitucionales, los procesos de derechos y la maquinaria ordinaria de gobernanza funcionan mejor y asumen más del peso. Extender la autoridad temporal exige razones reales — y cuanto más dura, más alto es el listón.*

- **Límites de autoridad transitoria:** Las autoridades interinas deben implementar el [**Principio de restricción menos restrictiva, acotada en el tiempo y revisable**](core_01_b_interaction_interpretation.md#615-least-restrictive-time-bounded-and-reviewable-constraint-principle) y deben ser:
  - de alcance explícito;
  - acotadas por una fecha de término;
  - independientemente revisables.
- **Medida de progreso:** La salud de la transición se mide por el encogimiento documentado de la autoridad interina y por la funcionalidad creciente de las instituciones y procesos constitucionales — incluidos foros, vías de trayectoria e impugnación, maquinaria de enmienda y supervisión, y otras operaciones constitucionales ordinarias que asumen la adopción plena. Un alcance interino estancado o creciente sin maduración institucional correspondiente es una bandera roja de reautorización.
- **Continuación y reautorización:** La continuación más allá de las ventanas planeadas exige justificación documentada y reautorización.
  - La reautorización no debe descansar en ninguno de los siguientes:
    - conveniencia administrativa;
    - demora autoinfligida;
    - mera incompletitud del trabajo de transición;
...
- Leer con: [Capítulo Siete](../../core_07_a_system_alignment_certification_evaluation.md#chapter-seven-system-alignment-certification) (*certificación de alineación del sistema*); [capítulos Ocho a Once](../../README.md#standing-pipeline-and-forums) (*cadena de trayectoria y supervisión de foro*).
...
*En términos sencillos: cuando una transición se estanca o falla, debe haber una salida real — y un estado estancado no puede convertirse en silencio en el nuevo normal. Reiniciar el plan se permite, pero solo a través de proceso lícito, con razones que cualquiera pueda comprobar — y nunca bajando los derechos básicos. Un reinicio no es de fiar si la certificación de alineación sigue bendiciendo sistemas desalineados o si la revisión de trayectoria sigue leyendo mal el daño real; reparen primero esa maquinaria de decir la verdad, o la gobernanza es estructuralmente poco fiable por más pulido que se vea el plan nuevo.*

- **Manejo del fallo y salidas:** Los planes de transición deben preservar la Continuidad y evitar:
  - el vacío de gobernanza;
  - el enquistamiento cuando fallan los hitos.

  Las vías de respaldo predefinidas, los criterios de reversión parcial y los procedimientos de rebasado de línea de base se gobiernan por [**CI-14**](../../corpus_institutions/ci_14_transitional_governance_institutional_evolution.md) (*Gobernanza transitoria y evolución institucional*).
  - Los estados transitorios fallidos o degradados no deben convertirse en una nueva línea de base por persistencia sola.
- **Reinicio material de línea de base:** Un reinicio material de línea de base actualiza hitos de transición, supuestos de riesgo, titularidad y planes de operación cuando fallan las puertas o la transición se estanca. Exige autoridad constitucionalmente válida y razones públicas documentadas. Debe preservar los **mínimos del Piso de Derechos** y no debe sustituir las reglas para cambiar lícitamente esta Constitución.
- **Precondición de salud de verificación:** Reiniciar o continuar sobre una línea de base de transición revisada es incumplidor donde la [Certificación de alineación del sistema](core_05_band_continuity.md#system-alignment-certification-constitutional) bajo el [Capítulo Siete](../../core_07_a_system_alignment_certification_evaluation.md#chapter-seven-system-alignment-certification) o la cadena de trayectoria bajo los [capítulos Ocho a Once](../../README.md#standing-pipeline-and-forums) es estructuralmente poco fiable — por ejemplo, donde la certificación bendice de forma rutinaria sistemas que derrotan de forma material los Pisos de Derechos, la medición de trayectoria diverge de forma rutinaria de la realidad material verificada, o las vías de impugnación y revisión no pueden corregir esas brechas dentro de un tiempo escalado por materialidad. En esas condiciones, la reparación de la maquinaria de verificación y medición tiene prioridad sobre la replanificación cosmética.
- **Trazabilidad pública:** Las decisiones materiales de transición, las demoras, las reversiones y las determinaciones de reinicio de línea de base deben seguir siendo auditables con razón e implicaciones de riesgo.
  - La documentación sigue sujeta a restricciones de confidencialidad estrechas y justificadas.
...
**Archivo anterior:** [core_06_rights_part_c.md](core_06_rights_part_c.md)
