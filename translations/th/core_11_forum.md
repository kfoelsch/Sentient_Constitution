...
>
> ไฟล์นี้เป็น **โครงการนำร่องด้านภาษาสำหรับผู้อ่าน** ของ [บทที่สิบเอ็ดภาษาอังกฤษ](../../core_11_forum.md) **ไม่ใช่** ส่วนที่มีผลผูกพันของรัฐธรรมนูญของผู้มีความรู้สึก **ไม่ใช่** รัฐธรรมนูญฉบับที่สอง **ไม่ใช่** ฉบับจัดส่ง **ตรึงไว้** กับ `SC-Corpus-2026.08.09` หากคำแปลนี้กับต้นฉบับภาษาอังกฤษดูเหมือนไม่ตรงกัน ให้ไฟล์ที่มีหมายเลข [`core_11_forum.md`](../../core_11_forum.md) เป็นฝ่ายชนะ ลำดับการอ่านและข้อมูลฉบับคงไว้ใน [README.md](../../README.md) วิธีทำและอภิธานศัพท์: [translations/th/README.md](README.md)
>
...
>
> **ก่อนหน้า (ยังเป็นภาษาอังกฤษ):** [core_10_b_misconduct_pattern_applications.md](../../core_10_b_misconduct_pattern_applications.md#chapter-ten-part-b-anti-constitutional-misconduct-pattern-applications)
>
> **ถัดไป (ยังเป็นภาษาอังกฤษ):** [core_08-11_application_vignettes.md](../../core_08-11_application_vignettes.md#chapters-eight-eleven-application-vignettes)
...
- ปลายทาง: [corpus_forum.md](../../corpus_forum.md) (*หลักคำสอนปฏิบัติการของเวที*); [บทที่สิบสอง](../../core_12_governance.md#chapter-twelve-constitutional-contract-legitimacy-authorization-and-stewardship) ในที่ที่ความชอบธรรมของการปกครองโต้ตอบกับบทบาทชี้ขาด; [บทที่สิบหก](../../core_16_incorporation.md#chapter-sixteen-incorporation-bridge) (*วินัยการรับเป็นของตน* สำหรับชั้นวิธีพิจารณาที่รับเป็นของตน)
...
- เวที **ความครบถ้วน** **ทางรัฐธรรมนูญ** และ **สิ่งแวดล้อม** และ **โดเมนเวทีทางเทคนิค** เมื่อพวกมันฟังการชี้ขาดสถานะความเป็นผู้มีความรู้สึก ต้องการการแต่งตั้งที่ **เผยแพร่** **ถูกโต้แย้งได้** **หมุนได้** หรือการตรวจความเป็นอิสระที่เทียบภายใต้ [บทที่สิบสอง §1.2](../../core_12_governance.md#12-eligibility-contested-selection-and-democratic-minimums) การแต่งตั้งไม่พอหรือทุนไม่พอของคณะพิจารณาเหล่านั้นเป็นความล้มเหลว [บทที่เก้า §9](core_09_standing_integration.md#9-enforcement-realism)
...
งบประมาณ **ทั้งระบบ** ทุนวิจัยข้ามแนว และโครงการมาตราส่วนการปกครอง ยังอยู่ภายใต้ [บทที่สิบสอง — การปกครอง](../../core_12_governance.md#chapter-twelve-constitutional-contract-legitimacy-authorization-and-stewardship) **[corpus_systems.md](../../corpus_systems.md)** และกฎสูงสุดอื่นในที่ที่ใช้ ผลตอบแทน กฎต้นทุน และเครื่องมือสิ่งจูงใจที่คล้าย **ต้องไม่** แทนที่:
...
**การพิทักษ์มาตรฐาน.** **โดเมนเวทีทางเทคนิค** รักษามาตรฐานที่ทบทวนได้ที่ใช้ทำให้หมวดการวัด [คำปรารภ §2](core_00_preamble.md#2-the-measurements) และบ้านบทนิยาม [บทที่ห้า](core_05__definitions_home.md#chapter-five-foundational-definitions) ปฏิบัติการ — รวมมาตรฐานที่ใช้ประเมินความสอดคล้องของระบบ — ภายในขอบที่ชอบด้วยกฎหมาย:
- วิธีการวัด;
- พิธีการทดสอบ;
- มาตรฐานหลักฐานผู้เชี่ยวชาญ;
- ข้อกำหนดทางเทคนิค;
...
**ไฟล์ก่อนหน้า (ยังเป็นภาษาอังกฤษ):** [core_10_b_misconduct_pattern_applications.md](../../core_10_b_misconduct_pattern_applications.md#chapter-ten-part-b-anti-constitutional-misconduct-pattern-applications)

**ไฟล์ถัดไป (ยังเป็นภาษาอังกฤษ):** [core_08-11_application_vignettes.md](../../core_08-11_application_vignettes.md#chapters-eight-eleven-application-vignettes)

**ต้นฉบับที่มีผลผูกพัน:** [core_11_forum.md](../../core_11_forum.md)
