...
>
> Berkas ini adalah **uji coba bahasa pembaca** atas [Bab Sebelas bahasa Inggris](../../core_11_forum.md). **Bukan** bagian mengikat Konstitusi Makhluk Sadar. **Bukan** konstitusi kedua. **Bukan** edisi kirim. **Disematkan** pada `SC-Corpus-2026.08.09`. Jika terjemahan ini dan sumber bahasa Inggris tampak berselisih, berkas bernomor [`core_11_forum.md`](../../core_11_forum.md) yang menang. Urutan baca dan metadata edisi tetap di [README.md](../../README.md). Metode dan glosarium: [translations/id/README.md](README.md).
>
...
>
> **Sebelumnya (masih bahasa Inggris):** [core_10_b_misconduct_pattern_applications.md](../../core_10_b_misconduct_pattern_applications.md#chapter-ten-part-b-anti-constitutional-misconduct-pattern-applications)
>
> **Berikutnya (masih bahasa Inggris):** [core_08-11_application_vignettes.md](../../core_08-11_application_vignettes.md#chapters-eight-eleven-application-vignettes)
...
<details>
<summary><strong><span style="color: #2563eb;">Panduan pembaca (non-operatif): di mana Bab Sebelas hidup dan apa yang tetap di sini</span></strong></summary>
...
- Hilir: [corpus_forum.md](../../corpus_forum.md) (*doktrin forum operatif*); [Bab Dua Belas](../../core_12_governance.md#chapter-twelve-constitutional-contract-legitimacy-authorization-and-stewardship) di mana keabsahan tata kelola berinteraksi dengan peran ajudikatif; [Bab Enam Belas](../../core_16_incorporation.md#chapter-sixteen-incorporation-bridge) (*disiplin inkorporasi* bagi lapisan prosedur yang diadopsi).
...
```mermaid
flowchart TD
  dispute[Sengketa biasa dalam sistem yang sudah diizinkan]
  challengePath[Jalur gugatan Partisipasi Sistemik Pihak Terdampak yang diterbitkan]
  stillOpen["Masih disengketakan, hilang, dikuasai, atau tidak dapat memberi pemulihan"]
  ch11[Bab Sebelas merute menurut taruhan primer]
  lead["Keluarga pimpinan: Makhluk sadar, Teknis, Kelembagaan, Lingkungan, Integritas, atau Konstitusional"]
  direct["Akses langsung jika tunda membahayakan hak, bukti, independensi, atau restorasi"]
...
Anggaran **sepanjang-sistem**, pendanaan riset lintas-potong, dan program skala-tata-kelola tetap tunduk pada [Bab Dua Belas — Tata Kelola](../../core_12_governance.md#chapter-twelve-constitutional-contract-legitimacy-authorization-and-stewardship), **[corpus_systems.md](../../corpus_systems.md)**, dan aturan supremasi lain di mana berlaku. Imbalan, aturan biaya, dan alat insentif serupa **tidak** boleh mengambil tempat:
...
**Berkas sebelumnya (masih bahasa Inggris):** [core_10_b_misconduct_pattern_applications.md](../../core_10_b_misconduct_pattern_applications.md#chapter-ten-part-b-anti-constitutional-misconduct-pattern-applications)

**Berkas berikutnya (masih bahasa Inggris):** [core_08-11_application_vignettes.md](../../core_08-11_application_vignettes.md#chapters-eight-eleven-application-vignettes)

**Sumber mengikat:** [core_11_forum.md](../../core_11_forum.md)
