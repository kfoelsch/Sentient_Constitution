...
>
> Berkas ini adalah **uji coba bahasa pembaca** atas [Bab Enam, Bagian D bahasa Inggris](../../core_06_rights_part_d.md). **Bukan** bagian mengikat Konstitusi Makhluk Sadar. **Bukan** konstitusi kedua. **Bukan** edisi kirim. **Disematkan** pada `SC-Corpus-2026.08.09`. Jika terjemahan ini dan sumber bahasa Inggris tampak berselisih, berkas bernomor [`core_06_rights_part_d.md`](../../core_06_rights_part_d.md) yang menang. Urutan baca dan metadata edisi tetap di [README.md](../../README.md). Metode dan glosarium: [translations/id/README.md](README.md).
>
> Berisi **Bab Enam, Bagian D**; penomoran pasal dan rujukan silang cocok dengan instrumen terpadu.
>
...
<details>
<summary><strong><span style="color: #2563eb;">Panduan pembaca (non-operatif): letak Bagian D dalam Bab Enam</span></strong></summary>
...
- [Adjudikasi dan penyelesaian sengketa](core_05_band_accountability.md#adjudication-and-dispute-resolution-constitutional) · [O](core_05_band_accountability.md#adjudication-and-dispute-resolution-constitutional) · [M](core_05_band_accountability.md#adjudication-and-dispute-resolution-constitutional-a) · [A](core_05_band_accountability.md#adjudication-and-dispute-resolution-constitutional-a) · [C](core_05_band_accountability.md#adjudication-and-dispute-resolution-constitutional-c)
...
- tepat waktu;
- dapat digugat;
- praktis dapat dipakai.

Adjudikasi dan penyelesaian sengketa dalam arti konstitusional didefinisikan di **Bab Lima** sebagai [*Adjudikasi dan penyelesaian sengketa*](core_05_band_accountability.md#adjudication-and-dispute-resolution-constitutional) dan [*Penyelesaian tepat waktu*](core_05_band_accountability.md#timely-resolution-constitutional), anggota [klaster Pertanggungjawaban, Dapat Digugat, Adjudikasi dan penyelesaian sengketa, Kegagalan pertanggungjawaban kolektif, dan Keadaan kahar](core_05_band_integrative.md#accountability-contestability-and-collective-accountability-failure-cluster).
...
*Dalam bahasa sederhana: keadilan bekerja melalui **pelanggaran**, **koreksi**, dan **pencegahan**. Tangani apa yang salah, perbaiki apa yang rusak dan apa yang menyebabkannya, dan cegah terulang — jangan menimpakan penderitaan demi penderitaan itu sendiri.*

- **Tujuan dan lingkup keadilan:** Keadilan konstitusional disusun di sekitar pelanggaran, koreksi, dan pencegahan. Tujuan primernya adalah:
  - menjawab pelanggaran terverifikasi, termasuk menghentikan bahaya yang sedang berjalan;
  - mengamankan koreksi melalui restitusi, remediasi, dan perubahan perilaku atau sistem;
...
*Dalam bahasa sederhana: pembatasan serius atas makhluk sadar harus sekaligus perlu bagi keselamatan, proporsional, restoratif, terindividualisasi, dan ditopang bukti nyata. Makhluk sadar yang melakukan kekerasan harus dipenjara ketika itu perlu untuk melindungi yang lain. Salah laku anti-konstitusi terverifikasi dan persyaratan pemenjaraannya diatur oleh **Bab Sepuluh** §4.2. Pencabutan nyawa sebagai ukuran keadilan mutlak terlarang — tidak ada tingkat, darurat, atau transisi yang membukanya kembali.*

- **Lingkup:** Pencabutan dan pembatasan non-trivial mencakup batasan atas:
  - kebebasan;
  - akses;
  - wewenang peran;
  - gerak;
  - sumber daya;
  - akibat jejak yang tahan.
- **Persyaratan bersama:** Setiap ukuran semacam itu tidak patuh kecuali ia **secara dapat ditunjukkan memenuhi semua** yang berikut **secara bersama**. Pemenuhan sebagian tidak cukup:
  - keperluan keselamatan material;
  - restitusi atau remediasi yang proporsional;
  - rehabilitasi atau pengurangan terulang di mana layak;
  - menjaga kredit dan akibat pada pelaku yang tepat — ditopang bukti yang siapa pun dapat audit — di bawah **Bab Dua sampai Empat**.
- **Beban terindividualisasi:** Setiap ukuran semacam itu harus diarahkan pada makhluk sadar atau peran spesifik yang terlibat — bukan label kelompok atau proksi — dan harus tetap terbuka bagi gugatan dan tinjauan independen.
  - Label keras, kecaman publik, atau jalan pintas administratif tidak menggantikan pembuktian setiap persyaratan dalam daftar bersama di atas.
...
- Hulu: Prinsip: Bab Satu [§6.1 Prinsip Tukar-Guling Inti](core_01_b_interaction_interpretation.md#61-core-tradeoff-principles), [Bab Satu §6.1.5 disiplin catatan keputusan](core_01_b_interaction_interpretation.md#615-rights-collision-decision-test), dan [§7 Larangan Penimpaan Mutlak](core_01_b_interaction_interpretation.md#7-prohibition-on-absolute-override).
...
- **Penerapan keadilan atas prinsip batasan:** Ukuran keadilan, penahanan, dan pertanggungjawaban restoratif menerapkan [**Prinsip Batasan Paling Longgar, Berbatas Waktu, dan Dapat Ditinjau**](core_01_b_interaction_interpretation.md#615-least-restrictive-time-bounded-and-reviewable-constraint-principle). Di mana intervensi dituntut, setiap ukuran harus mencakup:
  ...
  - irama tinjauan;
  - syarat restorasi.
- **Ukuran tidak patuh:** Yang berikut tidak patuh:
...
- Minimum **Pasal V** (*Hak Dasar yang Setara*) berlaku sepanjang waktu: pembatasan, pengecualian, atau ukuran keadilan sebanding harus mematuhi **Pasal V** (*Hak Dasar yang Setara*), [**Prinsip Minimum Lantai Hak**](core_01_b_interaction_interpretation.md#rightsfloor-minimums-principle), dan [**Prinsip Anti-Proses-Mendegradasi**](core_01_b_interaction_interpretation.md#anti-degrading-process-principle) sepanjang pengenaan, tinjauan, dan pelaksanaan setiap pembatasan, penahanan, atau ukuran pertanggungjawaban restoratif di bawah pasal ini dan **Pasal XXIII-B** (*Pembatasan Non-Trivial, Restitusi, dan Batasan Pertanggungjawaban Restoratif*).
...
- **Penerapan darurat atas prinsip batasan:** Tindakan darurat menerapkan [**Prinsip Batasan Paling Longgar, Berbatas Waktu, dan Dapat Ditinjau**](core_01_b_interaction_interpretation.md#615-least-restrictive-time-bounded-and-reviewable-constraint-principle) di bawah kondisi bahaya yang segera. Tindakan sementara untuk mencegah bahaya yang segera harus:
  ...
  - kedaluwarsa bawaan;
  - irama tinjauan independen yang sudah ditetapkan;
  - syarat restorasi dan pembalikan yang tegas.
- **Anti-dalih dan tidak-ada-pengelakan:** Penunjukan darurat diatur oleh [**Prinsip Tidak-Ada-Pengelakan Konstitusional**](core_01_b_interaction_interpretation.md#81-constitutional-no-bypass-principle) dan tidak boleh berpijak pada:
  - kenyamanan operator;
  - urgensi yang diciptakan sendiri;
  - penghindaran pemeriksaan konstitusional biasa;
  - klaim risiko eksistensial yang dipakai untuk mengelak **Kebenaran**, dapat-diaudit, dapat-digugat, atau tinjauan berbatas waktu.

  Satu-satunya pengecualian adalah lingkup sempit yang ketat perlu untuk mencegah bahaya tidak-dapat-dibalik yang segera. Setiap pembatasan sementara semacam itu harus dapat diatribusi, beralasan, dan segera dapat ditinjau.
- **Disiplin kelanjutan:** Kelanjutan melewati kedaluwarsa bawaan, atau melewati jendela restorasi-gugatan di bawah, adalah tidak patuh kecuali diotorisasi-ulang melalui demonstrasi beban yang terdokumentasi yang menunjukkan:
...
- Hulu: Prinsip: Bab Satu [§3.1 Keselamatan](core_01_a_values_principles.md#31-safety-harm-constraint), [§6 Penyelesaian Konflik Proses](core_01_b_interaction_interpretation.md#6-process-conflict-resolution), dan [§8 Tafsir Konstitusional](core_01_b_interaction_interpretation.md#8-constitutional-interpretation).
- Baca bersama: keluarga pengukuran Ketepatan waktu (*Penyelesaian tepat waktu sebagai pengukuran konstitusional*).
...
*Dalam bahasa sederhana: setelah darurat, tinjau ke belakang dengan jujur dan terbitkan apa yang ditemukan — dengan kerahasiaan hanya yang sempit dan berbatas waktu.*

- **Tinjauan retrospektif dan pengungkapan pasca-darurat:** Setelah stabilisasi, keputusan dan hasil darurat harus menjalani tinjauan retrospektif.
- **Catatan yang dapat diaudit:** Catatan harus dapat diaudit dan harus mencakup:
  - kondisi pemicu;
  - alternatif yang dipertimbangkan;
  - pembatasan yang dikenakan;
  - bahaya yang dicegah;
  - bahaya yang disebabkan;
  - kinerja pembalikan atau restorasi;
  - pelajaran bagi pengurangan terulang.
- **Pengungkapan:** Pengungkapan publik atau menghadap pihak terdampak dituntut, tunduk pada [**Prinsip Batasan Paling Longgar, Berbatas Waktu, dan Dapat Ditinjau**](core_01_b_interaction_interpretation.md#615-least-restrictive-time-bounded-and-reviewable-constraint-principle) bagi pengecualian kerahasiaan yang sempit, beralasan, dan berbatas waktu.
  - Setiap pengecualian harus mengidentifikasi:
    - justifikasinya;
...
*Dalam bahasa sederhana: konflik hak harus diselesaikan di catatan; restorasi lebih disukai di mana sesuai, tetapi tidak boleh menggantikan perlindungan nyata. Aturan permintaan maaf publik sukarela diatur oleh **Bab Sembilan** §4.3 secara umum, dan oleh **Bab Sepuluh** §4.3 bagi salah laku anti-konstitusi terverifikasi.*

- **Prosedur tabrakan hak:** Di mana konflik hak material, forum dan badan pemerintahan harus menerapkan **Bab Satu §6.1.5** (*disiplin catatan keputusan*), termasuk [**Prinsip Batasan Paling Longgar, Berbatas Waktu, dan Dapat Ditinjau**](core_01_b_interaction_interpretation.md#615-least-restrictive-time-bounded-and-reviewable-constraint-principle).
  - Catatan harus secara tegas mengidentifikasi:
    - hak yang tegang;
...
- **Berkembang:** makhluk sadar mempertahankan suara bermakna dalam bagaimana struktur pemerintahan dibentuk, digugat, dan diganti — tidak dikunci oleh pengaturan yang sudah hidup lebih lama dari justifikasinya.
- **Kesinambungan:** sistem berhorizon-panjang tetap cukup stabil untuk merencana dan pulih, tetapi tidak memperlakukan kabel hari ini sebagai permanen ketika ia tidak lagi selaras dengan persyaratan konstitusional.
...
- **Partisipasi:** dalam mengusulkan, menggugat, dan mengganti mekanisme tata kelola ketika revalidasi menunjukkan ketidakselarasan, pengecualian, atau degradasi hak menggugat.
- **Pengawasan:** melalui revalidasi berkala, kriteria publik bagi kelanjutan atau penggantian, dan catatan yang dapat diamati ketika perubahan konstitusional material terjadi.
...
- [Pertanggungjawaban](core_05_apex_accountability_leg.md#accountability) · [O](core_05_apex_accountability_leg.md#accountability) · [M](core_05_apex_accountability_leg.md#accountability-m) · [A](core_05_apex_accountability_leg.md#accountability-a) · [C](core_05_apex_accountability_leg.md#accountability-c)
- [Transparansi](core_05_band_oversight.md#transparency) · [O](core_05_band_oversight.md#transparency) · [M](core_05_band_oversight.md#transparency-a) · [A](core_05_band_oversight.md#transparency-a) · [C](core_05_band_oversight.md#transparency-c)
- [Pihak Terdampak](core_05_band_participation.md#stakeholder) · [O](core_05_band_participation.md#stakeholder) · [M](core_05_band_participation.md#stakeholder-a) · [A](core_05_band_participation.md#stakeholder-a) · [C](core_05_band_participation.md#stakeholder-c)

</details>

<br>

*Dalam bahasa sederhana: tata kelola harus meraih wewenang berkelanjutannya melalui tinjauan berkala — dan harus ditinjau lebih cepat ketika penguasaan, pengecualian, atau kegagalan sedang muncul.*

- **Tinjauan berkala:** Mekanisme tata kelola dan alokasi material harus tunduk pada:
  - revalidasi berkala dan transparansi;
  - kriteria yang terlihat bagi pihak terdampak bagi kelanjutan atau penggantian, sebagaimana diimplementasikan dalam protokol implementasi dan pagar pengaman tata kelola.
- **Tinjauan dipercepat:** Revalidasi harus dipercepat di mana bukti menunjukkan salah satu dari yang berikut:
  - tekanan penguasaan;
...
- **Catatan perubahan material:** Perubahan material harus membawa:
  ...
  - kesesuaian dengan **Bab Tiga Belas sampai Lima Belas** di mana berlaku.
- **Anti-pengelakan:** Di bawah [**Prinsip Tidak-Ada-Pengelakan Konstitusional**](core_01_b_interaction_interpretation.md#81-constitutional-no-bypass-principle), perubahan tidak boleh dipakai untuk mengelak **minimum Lantai Hak** atau aturan untuk mengubah Konstitusi ini secara sah dengan mengalihkan perubahan substantif melalui mekanisme darurat, implementasi, atau kustodi — termasuk:
  - **Pasal V** (*Hak Dasar yang Setara*) dan **VI** (*Hak atas Pendidikan Berpusat pada Makhluk Sadar*);
...
- **Berkembang:** makhluk sadar mempertahankan **minimum Lantai Hak**, suara bermakna, dan jalur gugatan yang praktis sepanjang transisi — kerja transisi bukan izin untuk menelanjangi martabat, akses, pemulihan, atau keagenan demi kenyamanan.
- **Kesinambungan:** sistem bersama tetap dapat diperintah, pelestari-hak, dan dapat dipulihkan menembus serah-terima — dengan pengaturan interim yang menyerah kepada lembaga dan proses konstitusional yang semakin berfungsi, bukan mengeras menjadi wewenang pengecualian tahan atau garis dasar konstitusional yang diturunkan.

Pengejaran yang sah berjalan melalui [Tetrad Konstitusional](core_00_preamble.md#constitutional-tetrad), diskalakan ke [taruhan material](core_00_preamble.md#material-stake) — semakin besar dampak, ketergantungan, dan risiko, semakin kuat setiap kewajiban harus:

- **Partisipasi:** pihak terdampak mendapat suara nyata di setiap fase transisi — termasuk kriteria gerbang yang terlihat, kesempatan menggugat penyitaan atau pembatasan masa transisi, dan masukan ketika kekuasaan interim yang menyentuh hak atau jejak diperbarui.
- **Pengawasan:** transisi harus tetap dapat diamati dan dapat diperiksa — gerbang terpenuhi dan terdokumentasi, wewenang interim ditinjau secara independen, kemajuan diukur dari menyusutnya lingkup interim dan matangnya operasi konstitusional, catatan dapat diaudit, dan alasan diterbitkan bagi tunda, pembalikan, atau penetapan-ulang garis dasar.
- **Pertanggungjawaban:** yang menjalankan transisi harus menjawab atas memakainya sebagai kedok — tunda yang diciptakan sendiri, jalan pintas kenyamanan, penegakan berdalih, kekosongan tata kelola, penanaman setelah tonggak gagal, atau diam-diam menurunkan lantai konstitusional melalui ketidakselarasan implementasi.
- **Ketepatan waktu:** kekuasaan interim membawa tanggal kedaluwarsa nyata; semakin lama berjalan dan semakin banyak hak tersentuh, semakin keras otorisasi-ulang harus; dan transisi yang mandek membutuhkan jalur keluar yang sah sebelum limbo sementara mengeras menjadi normal baru.
...
*Dalam bahasa sederhana: transisi maju dengan memenuhi gerbang nyata, bukan oleh jam atau tekanan — dan minimum Lantai Hak tetap berlaku di setiap fase.*

- **Adopsi bertahap dan kriteria gerbang:** Rencana transisi harus bertahap dan dapat ditinjau.
  - Kemajuan fase harus berpijak pada pemenuhan terdokumentasi atas kriteria gerbang yang diterbitkan dan artefak verifikasi yang dituntut.
  - Ia tidak boleh berpijak pada salah satu dari yang berikut semata:
    - waktu yang berlalu;
    - kenyamanan;
    - tekanan politik.
...
- Hulu: Prinsip: Bab Satu [§3.1 Keselamatan](core_01_a_values_principles.md#31-safety-harm-constraint), [§6.1 Prinsip Tukar-Guling Inti](core_01_b_interaction_interpretation.md#61-core-tradeoff-principles), dan [§7 Larangan Penimpaan Mutlak](core_01_b_interaction_interpretation.md#7-prohibition-on-absolute-override).
...
*Dalam bahasa sederhana: wewenang sementara sungguh sementara — dan transisi yang berjalan baik menunjukkannya. Kekuasaan interim harus tampak menyusut fase demi fase sementara forum konstitusional, proses hak, dan mesin tata kelola biasa bekerja lebih baik dan menanggung lebih banyak beban. Memperpanjang wewenang sementara menuntut alasan nyata — dan semakin lama berjalan, semakin tinggi latnya.*

- **Batas wewenang transisional:** Otoritas interim harus mengimplementasikan [**Prinsip Batasan Paling Longgar, Berbatas Waktu, dan Dapat Ditinjau**](core_01_b_interaction_interpretation.md#615-least-restrictive-time-bounded-and-reviewable-constraint-principle) dan harus:
  - berlingkup tegas;
  - berbatas tanggal berakhir;
  - dapat ditinjau secara independen.
- **Ukuran kemajuan:** Kesehatan transisi diukur dari penyusutan terdokumentasi wewenang interim dan fungsionalitas yang meningkat dari lembaga dan proses konstitusional — termasuk forum, jalur jejak dan gugatan, mesin amandemen dan pengawasan, dan operasi konstitusional biasa lain yang mengandaikan adopsi penuh. Lingkup interim yang mandek atau membesar tanpa pematangan kelembagaan yang sesuai adalah bendera merah otorisasi-ulang.
- **Kelanjutan dan otorisasi-ulang:** Kelanjutan melewati jendela yang direncanakan menuntut justifikasi terdokumentasi dan otorisasi-ulang.
  - Otorisasi-ulang tidak boleh berpijak pada salah satu dari yang berikut:
    - kenyamanan administratif;
    - tunda yang diciptakan sendiri;
    - ketidaksempurnaan semata kerja transisi;
...
*Dalam bahasa sederhana: ketika transisi mandek atau gagal, harus ada jalur keluar nyata — dan keadaan mandek tidak boleh diam-diam menjadi normal baru. Menetapkan-ulang rencana diizinkan, tetapi hanya melalui proses yang sah, dengan alasan yang siapa pun dapat periksa — dan tidak pernah dengan menurunkan hak dasar. Penetapan-ulang tidak dapat dipercaya jika sertifikasi keselarasan terus memberkati sistem yang tidak selaras atau tinjauan jejak terus salah membaca bahaya nyata; perbaiki dulu mesin yang mengatakan kebenaran itu, atau tata kelola secara struktural tidak andal betapa pun mengilap rencana baru.*

- **Penanganan kegagalan dan jalur keluar:** Rencana transisi harus melestarikan Kesinambungan dan menghindari:
  - kekosongan tata kelola;
  - penanaman ketika tonggak gagal.
