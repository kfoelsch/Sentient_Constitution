...
>
> يحمل **الجزء أ** في [core_06_rights_part_a.md](core_06_rights_part_a.md) رصّة القيد الافتراضية لكل الفصل، وترتيب القراءة الكوكب أولًا، ومراكز التفسير. يعرض **الجزء د** **المواد XXIII–XXVI**، بما في ذلك الانتقال وإعادة خط الأساس في **المادة XXVI** (*حوكمة الانتقال والاستمرارية وإعادة خط الأساس*).
...
*بعبارات بسيطة: يغطي الجزء د العدل وانضباط المراجعة والحل والتطور الدستوري والانتقال — المواد XXIII إلى XXVI، بما في ذلك إعادة خط الأساس تحت **المادة XXVI** (*حوكمة الانتقال والاستمرارية وإعادة خط الأساس*).*

<a id="article-xxiii-conflict-resolution-escalation-and-emergency-proportionality"></a>
### المادة XXIII: حل النزاع والتصعيد والتناسب الطارئ
...
- **أرضية حسن التوقيت:** سرعة الحل وانضباط منع التأخير ومعالم مستويات الأهمية المادية تحكمها **المادة XXIV-C** (*الحل في وقته وأرضية منع التأخير*)، مُنفَّذة عبر [الفصل الحادي عشر §6](core_11_forum.md#6-timely-resolution-materiality-tiers-and-anti-delay-discipline).
- **الانتصاف في وقته:** يُقرأ مع [**المادة XII-B** (*الحق في الطعن والمراجعة والانتصاف*)](core_06_rights_part_c.md#article-xii-b-right-to-challenge-review-and-redress) (*الوصول إلى الانتصاف في وقته*).
...
#### المادة XXIII-A: هدف العدل ونطاقه
<details>
<summary><strong><span style="color: #2563eb;">التتبع</span></strong></summary>
...
#### المادة XXIII-B: القيد غير التافه والاسترداد وقيود المساءلة الترميمية
<details>
<summary><strong><span style="color: #2563eb;">التتبع</span></strong></summary>
...
#### المادة XXIII-C: القاعدة الأقل تقييدًا والمحدودة زمنيًا
<details>
<summary><strong><span style="color: #2563eb;">التتبع</span></strong></summary>
...
- **الحرمان من الحياة:** الحرمان من الحياة بوصفه تدبير عدل **محظور فئويًا** تحت **المادة XXIII-B** (*القيد غير التافه والاسترداد وقيود المساءلة الترميمية*).
  - يُطلب **السجن بسبب العنف** تحت **المادة XXIII-B** (*القيد غير التافه والاسترداد وقيود المساءلة الترميمية*) والسجن تحت **الفصل العاشر** §4.1 حين تنطبق تلك الأحكام، خاضعًا لحدود المدة وجدول المراجعة وشروط الاستعادة ومحفّزات إعادة التقييم القابلة للتدقيق أعلاه.
- تنطبق حدود **المادة V** (*الحقوق الأساسية المتساوية*) في كل حين: يجب أن تمتثل القيود أو الاستبعادات أو تدابير العدل المماثلة لـ**المادة V** (*الحقوق الأساسية المتساوية*) و[**مبدأ حدّ أدنى أرضية الحقوق**](core_01_b_interaction_interpretation.md#rightsfloor-minimums-principle) و[**مبدأ منع الإجراء المهين**](core_01_b_interaction_interpretation.md#anti-degrading-process-principle) عبر فرض أي قيد أو احتواء أو تدبير مساءلة ترميمية ومراجعته وتنفيذه تحت هذه المادة و**المادة XXIII-B** (*القيد غير التافه والاسترداد وقيود المساءلة الترميمية*).
...
- أعلى: المبادئ: الفصل الأول [§3.1 السلامة](core_01_a_values_principles.md#31-safety-harm-constraint)، و[§6.1 مبادئ المقايضة الجوهرية](core_01_b_interaction_interpretation.md#61-core-tradeoff-principles)، و[الفصل الأول §6.1 انضباط سجل القرار](core_01_b_interaction_interpretation.md#615-rights-collision-decision-test).
- يُقرأ مع: **المادة I-D** (*المخاطر الوجودية وقدرة الاستعادة البيئية*) حيث يكون تدقيق المخاطر الوجودية متورطًا ماديًا؛ رجلا **المشاركة** و**حسن التوقيت** في [الرباعية الدستورية](core_00_preamble.md#constitutional-tetrad)؛ [المادة XXIV-C](#article-xxiv-c-timely-resolution-and-anti-delay-floor) (*الحل في وقته وأرضية منع التأخير*)؛ [الفصل الحادي عشر §6](core_11_forum.md#6-timely-resolution-materiality-tiers-and-anti-delay-discipline) (*الحدود الخارجية لمستوى الأهمية المادية معاد استخدامها افتراضيات استعادة-طعن*).
...
- **تطبيق الطوارئ لمبدأ القيد:** تطبق تدابير الطوارئ [**مبدأ القيد الأقل تقييدًا والمحدود زمنيًا والقابل للمراجعة**](core_01_b_interaction_interpretation.md#615-least-restrictive-time-bounded-and-reviewable-constraint-principle) تحت شروط ضرر وشيك. يجب أن تكون التدابير المؤقتة لمنع ضرر وشيك:
  - محدودة زمنيًا؛
  - موثَّقة؛
  - متسقة مع قيود **المواد V** و**XX** و**الفصل الأول**.
...
- **المراجعة والإخطار (ساعات استعادة-الطعن):** احتووا الآن؛ وأعيدوا الإخطار والطعن لاحقًا؛ ولا تُسقطوا المشاركة إسقاطًا دائمًا. «في أقرب وقت عملي» ليست الساعة. يجب أن تتلقى الأطراف المتأثرة إخطارًا ووصول طعن مُعادًا داخل الحدود الخارجية نفسها لمستوى الأهمية المادية التي تستخدمها [**المادة XXIV-C**](#article-xxiv-c-timely-resolution-and-anti-delay-floor) أصلًا لحل المنتدى، كما ينفّذها [الفصل الحادي عشر §6](core_11_forum.md#6-timely-resolution-materiality-tiers-and-anti-delay-discipline):
...
### المادة XXIV: المراجعة اللاحقة في وقتها والمواءمة الاستعادية
...
*بعبارات بسيطة: **المادة XXIV** (*المراجعة اللاحقة في وقتها والمواءمة الاستعادية*) رفيق المراجعة والحل لـ**المادة XXIII** (*حل النزاع والتصعيد والتناسب الطارئ*). بعد الطوارئ أو نزاعات حقوق جسيمة، يجب أن تنظر الأنظمة إلى الوراء بأمانة، وتفصح عما يمكن الإفصاح عنه، وتحل تصادمات الحقوق في السجل، وتُبقي الاستعادة مربوطة بحماية حقيقية — على ساعات تطابق ما هو على المحك. يربط [حسن التوقيت](core_05_apex_timeliness_leg.md#timeliness-constitutional) كل خطوة: من دونه تفرغ الواجبات الأخرى بينما يجلس الضرر بلا حل.*

تطبّق هذه المادة [الرباعية الدستورية](core_00_preamble.md#constitutional-tetrad) على دورة حياة الحل بعد قواعد التدخل في **المادة XXIII** (*حل النزاع والتصعيد والتناسب الطارئ*) أو إلى جانبها، تحت [المقصدين الدستوريين](core_00_preamble.md#two-constitutional-aims) — **الازدهار** و**الاستمرارية** — مقيسة على [الرهان المادي](core_00_preamble.md#material-stake):

- **الرقابة** عبر المراجعة اللاحقة وقابلية التدقيق (**المادة XXIV-A** (*المراجعة اللاحقة والإفصاح*))؛
- **المشاركة** عبر مسارات تصادم حقوق ومواءمة استعادية قابلة للاستعمال (**المادة XXIV-B** (*إجراء تصادم الحقوق والمواءمة الاستعادية*))؛
- **المساءلة** عبر سجلات معلَّلة ومعالجة متناسبة وعدم إحلال الإصلاح الرمزي (**المادة XXIV-B** (*إجراء تصادم الحقوق والمواءمة الاستعادية*)).

يقطع [حسن التوقيت](core_05_apex_timeliness_leg.md#timeliness-constitutional) الأرجل أعلاه وينفّذها: يجب أن تتحرك المشكلات المادية داخل نوافذ مقيسة على الأهمية المادية تحت **المادة XXIV-C** (*الحل في وقته وأرضية منع التأخير*). لا تستوفي بنى المشاركة أو الرقابة أو المساءلة الشكلية هذه المادة إذا توقفت المراجعة أو حل التصادم أو الانتصاف من دون تبرير مشروع ([حسن التوقيت](core_05_apex_timeliness_leg.md#timeliness-constitutional-a)، الفصل الخامس).

<a id="article-xxiv-a-retrospective-review-and-disclosure"></a>
#### المادة XXIV-A: المراجعة اللاحقة والإفصاح
<details>
<summary><strong><span style="color: #2563eb;">التتبع</span></strong></summary>
...
#### المادة XXIV-B: إجراء تصادم الحقوق والمواءمة الاستعادية
<details>
<summary><strong><span style="color: #2563eb;">التتبع</span></strong></summary>
...
- **المواءمة الاستعادية:** حيث ينطبق، يجب أن يوائم الحل معايير ترميمية وتعاونية (**المادة X-A** (*عدم الفرض والموافقة في الارتباط*)؛ *العدل الترميمي*، **الفصل الخامس**).
...
- أسفل: [الفصل الحادي عشر §6](core_11_forum.md#6-timely-resolution-materiality-tiers-and-anti-delay-discipline) (*مستويات الأهمية المادية ومعالم السلسلة وانضباط منع التأخير*)؛ [المادة XXIII-D](#xxiii-d-restore-challenge-clocks) (*الحدود الخارجية نفسها نوافذ افتراضية لاستعادة-الطعن بعد احتواء الطوارئ*).
...
> **بيان الإدارة المسؤولة التشغيلي.** **المالك:** المادة XXIV-C. الموطن الرقمي: الفصل الحادي عشر §6. التعريف: الحل في وقته. **الحركة المحظورة:** لا تضف إجراءً أو عدد hop أو «اقرأ مزيدًا من المرفقات» على نحو يأكل نافذة المستوى. لا تعامل هدف تدفق مستوفى حلًا في وقته حين يبقى الضرر. **الساعة:** طبّق الحد الخارجي للفصل الحادي عشر §6 للمستوى المطابق. ثم خذ بطاقة الخطوة التالية القائمة. لا تضف إجراءً يأكل النافذة.

- **مقصد التنسيق:** يعمل العدل الدستوري تحت **المادة XXIII-A** (*هدف العدل ونطاقه*) عبر **نظام تنسيق وحل دستوري** — تحققوا الوقائع، وقيسوا الوضعية، وادمجوا العواقب، واستعيدوا حيث يكون ذلك مجديًا — لا عبر تأخير خصومي إلى أجل غير مسمى أو تسجيل سمعة أو عقاب لذاته.
...
- **استعادة-الطعن بعد الطوارئ:** الحدود الخارجية للمستوى نفسها هي النوافذ الافتراضية لإعادة الإخطار والطعن بعد احتواء الطوارئ تحت [**المادة XXIII-D**](#xxiii-d-restore-challenge-clocks). الاستمرار بعد تلك النوافذ يطلب إظهار الضرورة الموثَّق لتلك المادة. لا تخلق هذه المادة ساعة طوارئ أبطأ.

<a id="article-xxv-constitutional-evolution-and-non-entrenchment"></a>
### المادة XXV: التطور الدستوري ومنع التحصين
...
تبقى قواعد الحوكمة وآليات المشاركة ونماذج الوزن وبنى التمويل خاضعة لانضباط التبرير المستمر في [الفصل الأول §10.3 التبرير المستمر](core_01_c_stewardship_capacity_principles.md#103-ongoing-justification). تبيّن **المادة XXV-A** (*منع التحصين وقابلية المراجعة*) و**المادة XXV-B** (*إعادة المصادقة الدورية والتغيير الشفاف*) أرضيات منع التحصين وإعادة المصادقة والتغيير الشفاف التشغيلية.

<a id="article-xxv-a-non-entrenchment-and-revisability"></a>
#### المادة XXV-A: منع التحصين وقابلية المراجعة
<details>
<summary><strong><span style="color: #2563eb;">التتبع</span></strong></summary>
...
#### المادة XXV-B: إعادة المصادقة الدورية والتغيير الشفاف
<details>
<summary><strong><span style="color: #2563eb;">التتبع</span></strong></summary>
...
- **التغيير الشفاف:** يجب أن يبقى تطور الأنظمة الدستورية قابلًا للرصد وقابلًا للتدقيق وقابلًا للطعن تحت **المادتين XIII** و**XVIII**.
...
توجد الحوكمة الانتقالية لتأمين الاستمرارية وعدم التراجع. **ولا** يجوز أن تخلق سلطة استثناء دائمة أو تعديلًا دستوريًا فعليًا أو خفضًا عمليًا للأرضية الدستورية عبر عدم مواءمة التنفيذ. تبيّن **المواد XXVI-A** إلى **XXVI-D** أرضيات التبني المرحلي وحد السلطة ومخرج الفشل والمعالجة ذات النطاق الانتقالي التشغيلية.
...
#### المادة XXVI-A: التبني المرحلي واستمرارية أرضية الحقوق
<details>
<summary><strong><span style="color: #2563eb;">التتبع</span></strong></summary>
...
- **الاستنساخات القائمة — ساعة انتقال، لا انتهاكًا رجعيًا:** الأنظمة والكيانات المشتقة المستنسَخة أصلًا حين يدخل صك هيئة معتمِدة حيّز النفاذ ليست، بذلك الواقع وحده، انتهاكات موافقة استنساخ لـ**المادة VII-D.1** (*الاشتقاق والاستنساخ والعلاقة مع النظام الأصل*).
  - يبدأ تشغيلها المستمر بعد تاريخ النفاذ ساعة منشورة، مبيَّنة في خطة الانتقال ومقيسة على فئة النظام، لإدخالها ضمن **المادة VII-D** (*الأسرة وعلاقات الرعاية والاستقلال الإنجابي وعدم الفصل*) و**المادة V-E** (*أرضية الفصل في مركز الوعي*) والمسار المنطبق في الفصل السابع.
  - من تاريخ النفاذ، ينطبق بند استمرارية أرضية الحقوق أعلاه وافتراضي الحفظ أدناه كاملين؛ تؤجّل الساعة عمل الامتثال لا الحماية.
  - تفويت الساعة من دون إظهار موثَّق لـ**المادة XXVI-B** (*حدود السلطة الانتقالية وإعادة التفويض*) فشل معلم انتقال ويفتح المسار العادي للفصل الثامن.
...
#### المادة XXVI-B: حدود السلطة الانتقالية وإعادة التفويض
<details>
<summary><strong><span style="color: #2563eb;">التتبع</span></strong></summary>
...
#### المادة XXVI-C: مخارج الفشل وإعادة خط الأساس وقابلية التتبع
<details>
<summary><strong><span style="color: #2563eb;">التتبع</span></strong></summary>
...
#### المادة XXVI-D: الملكية والأنظمة غير الممتثلة؛ حوافز النقل الطوعي
<details>
<summary><strong><span style="color: #2563eb;">التتبع</span></strong></summary>
...
- **قاعدة الأثر التقييدي:** حرمان أو قيد يتجاوز أثره الأولي المعالجة أو الاسترداد أو الحفظ أو الحماية إلى الأمام يحرّك **المادة XXIII-B** (*القيد غير التافه والاسترداد وقيود المساءلة الترميمية*) و**المادة XXIII-C** (*القاعدة الأقل تقييدًا والمحدودة زمنيًا*).
- **أرضية التصرف التدميري:** يجوز للانتقال أن يحجر ملكية أو يحتفظ بها لوقف الضرر — لكن نزع شيء نزعًا دائمًا أو تدميره أو محو الرهان الاقتصادي لكائن واعٍ شريط أعلى كثيرًا. يطلب:
  ...
  حيث تكون الملكية نظامًا يكون مؤشر وعي موثوق له في السجل أو تكون قضية مركز مفتوحة تحت **المادة V-E** (*أرضية الفصل في مركز الوعي*)، التصرف التدميري لمكوّناته الحاملة للحالة غير متاح؛ يحكم افتراضي الحفظ في **المادة XXVI-A** (*التبني المرحلي واستمرارية أرضية الحقوق*) والتدبير المتوافق هو الاحتواء تحت حراسة مختومة.
...
- **أرضية الحافز الطوعي:** يجوز إدراج حوافز محدودة زمنيًا ومنشورة للنقل الطوعي بحسن نية أو الإبلاغ المتحقَّق في خطط الانتقال فقط حين تستبعد ادعاءات مُكرَهة أو سيئة النية، وتطلب إعادة تفويض **المادة XXVI-B** (*حدود السلطة الانتقالية وإعادة التفويض*) للاستمرار، وتوائم **المادة XII-B** (*الحق في الطعن والمراجعة والانتصاف*) وضمانات الإبلاغ المحمي المعتمَدة، وتفصل بتّ الحافز عن تنفيذ الإنفاذ حيث يكون ذلك عمليًا، حتى لا تتحكم حوافز الدفع في قرارات المصادرة أو الحراسة.
- **حراسة التنفيذ:** تنتمي المحفّزات التشغيلية والتقييم وميكانيكا الاستئناف وسلسلة الحراسة وحوكمة الصناديق والمراجعة الخصومية وإجراء التدابير المسموحة وتشغيل البرنامج الطوعي إلى **CI-14.1** إلى **CI-14.3** وصكوك الاعتماد. **ولا** يجوز أن تضيّق هذه المادة أو **الفصل الثامن** أو **المادة XXIII-B** (*القيد غير التافه والاسترداد وقيود المساءلة الترميمية*) و**المادة XXIII-C** (*القاعدة الأقل تقييدًا والمحدودة زمنيًا*).
