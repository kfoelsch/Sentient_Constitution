...
>
> هذا المجلد **تجريب بلغة القارئ**. **ليس** دستور الكائنات الواعية. **لا** يستطيع تغيير ملفات `core_*` المرقّمة. **ليس** طبعة إرسال. قراءته **ليست** [اعتمادًا لهذا الدستور](../../core_16_amendment_ratification.md#10-ratification-and-adoption). إذا بدا أن ترجمةً والأصل الإنجليزي يختلفان، تفوز ملفات `core_*` المرقّمة بالإنجليزية إلى أن تقول طبعة لاحقة غير ذلك. انظر [Reader-language editions](../../doc_architecture.md#reader-language-editions).
>
> **مثبّت على طبعة المتن:** `SC-Corpus-2026.08.09` (نافذة من 2026-08-09؛ [README.md](../../README.md)). **قبل الإصدار.**

</details>

<br>

*بعبارات بسيطة: هذا مسوّدة بالعربية لقياس التكلفة والمنهج، لا نصًا دستوريًا ثانيًا.*

**المحلّ.** العربية الفصحى الحديثة (الشكل الكتابي المشترك). لا تثبّت لهجةً محكية، ولا بلدًا. المصرية والشامية والمغربية وغيرها تبقى أبوابًا منفصلة إن جاءت لاحقًا.

**الشريحة الأولى حسب العمارة.** ترتيب الإرسال يطلب أولًا موجزات الدخول السهل، ورقة أرضية الحقوق، والباب العام. هذا التجريب يترجم [الديباجة](core_00_preamble.md) و[الفصل الأول، الجزء أ](core_01_a_values_principles.md) عمدًا لقياس تكلفة ملف `core_*` مرقّم. العربية هي الخانة (3) بعد الإسبانية والهندية.
...
مصطلحات بيتية ثابتة في عربية التجريب. ليست تعريفات؛ التعريفات تبقى في الفصل الخامس بالإنجليزية.

| الإنجليزية (المصدر) | العربية (التجريب) | ملاحظة |
|---|---|---|
| Sentient Constitution | دستور الكائنات الواعية | اسم الصك |
| sentient / sentients | كائن واعٍ / كائنات واعية | صنف، لا «أشخاص» |
| Constitutional Tetrad | الرباعية الدستورية | المشاركة · الرقابة · المساءلة · حسن التوقيت |
| Two Constitutional Aims | المقصدان الدستوريان | الازدهار والاستمرارية |
| Flourishing | الازدهار | |
| Continuity | الاستمرارية | |
| material stake | الرهان المادي | الأثر والاعتماد والمخاطر |
| Rights Floor | أرضية الحقوق | |
| oversight | الرقابة | ليست محكمة ولا هيئة قضائية |
| accountability | المساءلة | |
| timeliness | حسن التوقيت | واجب؛ ليس «فرصة» |
| forum / forums / forum family | المنتدى / المنتديات / أسرة المنتديات | أبدًا *محكمة* أو *هيئة قضائية* مؤسسية |
| standing records / measurement / effects / lock | سجلات / قياس / آثار / قفل الوضعية | ليست *الصفة الإجرائية* |
| named pathway | المسار المسمّى | |
| Constitutional Contract Layer | طبقة العقد الدستوري | من يجوز له أن يحكم |
| Stakeholder System Participation | المشاركة النظامية للأطراف المتأثرة | الصوت داخل أنظمة سبق الترخيص لها |
| stewardship | الإدارة المسؤولة | غير *الحفظ* / حفظ الطبعة |
| Due Process | الإجراءات الواجبة | |
| Contestability | قابلية الطعن | وللسوق: قابلية المنافسة |
| Key Practical Process Pipelines | سلاسل الإجراءات العملية الرئيسية | |
| positive owner register | سجل المالكين الإيجابي | |
| Anti-Constitutional Trust Lock | قفل الثقة المضاد للدستور | |
| In plain terms | بعبارات بسيطة | |

**الملف التالي:** [core_00_preamble.md](core_00_preamble.md)
