...
>
> Tệp này là một **thử nghiệm ngôn ngữ đọc** của [Chương Bảy, Phần A tiếng Anh](../../core_07_a_system_alignment_certification_evaluation.md). **Không** phải phần ràng buộc của Hiến pháp Hữu tri. **Không** phải một hiến pháp thứ hai. **Không** phải một ấn bản phát hành. Nó được **ghim** vào `SC-Corpus-2026.08.09`. Nếu bản dịch này và nguyên bản tiếng Anh có vẻ lệch nhau, tệp đánh số [`core_07_a_system_alignment_certification_evaluation.md`](../../core_07_a_system_alignment_certification_evaluation.md) thắng. Thứ tự đọc và siêu dữ liệu ấn bản được giữ ở [README.md](../../README.md). Phương pháp và bảng thuật ngữ: [translations/vi/README.md](README.md).
>
...
- **Phân hạng sai và khiếm khuyết:**
  ...
  - nơi sự kiện nâng đỡ, cùng vấn đề phân hạng cũng có thể đếm vào phát hiện quỹ đạo bất lợi ở [Chương Tám](../../core_08_standing_assessment.md#chapter-eight-compliance-violation-and-standing-model).
...
- **[Chương Mười Hai §5 Vai trò được ủy quyền, phát triển năng lực, và đóng góp](../../core_12_governance.md#5-authorized-roles-competency-development-and-contribution)** và **[corpus_systems.md](../../corpus_systems.md), CS-4 — Quản trị có trách nhiệm hệ thống then chốt** — sàn định nghĩa vai trò, năng lực, và truy vết vận hành nơi có trọng;
...
**Nguyên bản ràng buộc:** [core_07_a_system_alignment_certification_evaluation.md](../../core_07_a_system_alignment_certification_evaluation.md)
