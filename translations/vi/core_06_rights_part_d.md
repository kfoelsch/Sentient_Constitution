...
>
> Tệp này là một **thử nghiệm ngôn ngữ đọc** của [Chương Sáu, Phần D tiếng Anh](../../core_06_rights_part_d.md). **Không** phải phần ràng buộc của Hiến pháp Hữu tri. **Không** phải một hiến pháp thứ hai. **Không** phải một ấn bản phát hành. Nó được **ghim** vào `SC-Corpus-2026.08.09`. Nếu bản dịch này và nguyên bản tiếng Anh có vẻ lệch nhau, tệp đánh số [`core_06_rights_part_d.md`](../../core_06_rights_part_d.md) thắng. Thứ tự đọc và siêu dữ liệu ấn bản được giữ ở [README.md](../../README.md). Phương pháp và bảng thuật ngữ: [translations/vi/README.md](README.md).
>
> Nó chứa **Chương Sáu, Phần D**; đánh số điều và tham chiếu chéo khớp công cụ tích hợp.
>
...
<details>
<summary><strong><span style="color: #2563eb;">Hướng dẫn cho người đọc (không vận hành): vị trí Phần D trong Chương Sáu</span></strong></summary>
...
- Thượng nguồn: Nguyên tắc: Chương Một [§2 Mục tiêu nền tảng: phúc lợi](core_01_a_values_principles.md#2-foundational-objective-wellbeing), [§3.1 An toàn](core_01_a_values_principles.md#31-safety-harm-constraint), [§5 Tự do](core_01_a_values_principles.md#5-freedom-bounded-agency), [§6 Giải quyết xung đột quy trình](core_01_b_interaction_interpretation.md#6-process-conflict-resolution), và [§10 Quản trị dưới kỷ luật quản trị có trách nhiệm](core_01_c_stewardship_capacity_principles.md#10-governance-under-stewardship-discipline).
...
- kịp thời;
- tranh biện được;
- dùng được trong thực tiễn.

Phân xử và giải quyết tranh chấp theo nghĩa hiến pháp được định ở **Chương Năm** là [*Phân xử và giải quyết tranh chấp*](core_05_band_accountability.md#adjudication-and-dispute-resolution-constitutional) và [*Giải quyết kịp thời*](core_05_band_accountability.md#timely-resolution-constitutional), thành viên của [*cụm Trách nhiệm giải trình, Khả năng tranh biện, Phân xử và giải quyết tranh chấp, Thất bại trách nhiệm giải trình tập thể, và Bất khả kháng*](core_05_band_integrative.md#accountability-contestability-and-collective-accountability-failure-cluster).
...
*Nói thẳng: công lý vận hành qua **vi phạm**, **sửa**, và **phòng**. Xử điều đã sai, sửa điều bị gãy và điều gây ra, và ngăn nó xảy lại — đừng gây khổ vì chính nó.*

- **Mục tiêu và phạm vi công lý:** Công lý hiến pháp được cấu trúc quanh vi phạm, sửa, và phòng. Mục đích sơ cấp là:
  - đáp vi phạm đã xác minh, kể cả dừng hại đang diễn;
  - bảo đảm sửa qua hoàn trả, sửa chữa, và đổi hành vi hoặc hệ thống;
...
*Nói thẳng: hạn chế nghiêm trên một hữu tri phải đồng thời cần cho an toàn, tương xứng, phục hồi, cá thể hóa, và có bằng chứng thật. Hữu tri bạo lực phải bị giam khi đó cần để bảo vệ người khác. Hành vi sai phản hiến pháp đã xác minh và yêu cầu giam do **Chương Mười** §4.2 quản trị. Tước sự sống như biện pháp công lý bị cấm tuyệt đối — không bậc, khẩn cấp, hay chuyển tiếp nào mở lại.*

- **Phạm vi:** Tước đoạt và hạn chế không tầm thường gồm giới hạn trên:
  - tự do;
  - lối vào;
  - thẩm quyền vai trò;
  - đi lại;
  - nguồn lực;
  - hiệu ứng quỹ đạo bền.
- **Yêu cầu đồng thời:** Mọi biện pháp như vậy không tuân thủ trừ khi **chứng minh được thỏa tất cả** các điều sau **đồng thời**. Thỏa từng phần không đủ:
  - sự cần thiết an toàn có trọng;
  - hoàn trả hoặc sửa chữa tương xứng;
  - phục hồi hoặc giảm tái diễn nơi khả thi;
  - giữ công trạng và hệ quả trên đúng tác nhân — có bằng chứng ai cũng kiểm được — dưới **Chương Hai đến Bốn**.
- **Gánh cá thể hóa:** Mọi biện pháp như vậy phải nhắm hữu tri hoặc vai trò cụ thể liên quan — không nhãn nhóm hay chỉ số thay — và phải còn mở cho tranh biện và rà soát độc lập.
  - Nhãn khắc nghiệt, lên án công, hoặc lối tắt hành chính không thay chứng minh mọi yêu cầu trong danh sách đồng thời trên.
...
- Thượng nguồn: Nguyên tắc: Chương Một [§6.1 Nguyên tắc đánh đổi cốt](core_01_b_interaction_interpretation.md#61-core-tradeoff-principles), [Chương Một §6.1.5 Thủ tục va chạm quyền](core_01_b_interaction_interpretation.md#615-rights-collision-decision-test), và [§7 Cấm phủ quyết tuyệt đối](core_01_b_interaction_interpretation.md#7-prohibition-on-absolute-override).
...
- **Áp dụng nguyên tắc ràng buộc cho công lý:** Biện pháp công lý, kiềm chế, và trách nhiệm giải trình phục hồi áp [**Nguyên tắc ràng buộc hạn chế nhẹ nhất, có hạn thời gian, và rà soát được**](core_01_b_interaction_interpretation.md#615-least-restrictive-time-bounded-and-reviewable-constraint-principle). Nơi can thiệp được đòi, mỗi biện pháp phải gồm:
  ...
  - nhịp rà soát;
  - điều kiện khôi phục.
- **Biện pháp không tuân thủ:** Các điều sau không tuân thủ:
  - hạn chế nặng vô hạn;
...
- **Áp dụng nguyên tắc ràng buộc cho khẩn cấp:** Biện pháp khẩn cấp áp [**Nguyên tắc ràng buộc hạn chế nhẹ nhất, có hạn thời gian, và rà soát được**](core_01_b_interaction_interpretation.md#615-least-restrictive-time-bounded-and-reviewable-constraint-principle) dưới điều kiện hại sắp xảy. Biện pháp tạm để ngăn hại sắp xảy phải:
  ...
  - hạn mặc định;
  - nhịp rà soát độc lập định trước;
  - điều kiện khôi phục và hoàn rõ.
- **Chống cớ và không lách:** Chỉ định khẩn cấp do [**Nguyên tắc hiến pháp không lách**](core_01_b_interaction_interpretation.md#81-constitutional-no-bypass-principle) quản trị và không được dựa trên:
  - tiện của người vận hành;
  - độ khẩn tự tạo;
  - tránh rà soát hiến pháp thường;
  - tuyên rủi ro tồn tại dùng để lách **Sự thật**, khả năng kiểm toán, khả năng tranh biện, hoặc rà soát có hạn thời gian.

  Ngoại lệ duy nhất là phạm vi hẹp tuyệt đối cần để ngăn hại không đảo ngược sắp xảy. Mọi hạn chế tạm như vậy phải gán được, có biện minh, và rà soát kịp được.
- **Kỷ luật tiếp tục:** Tiếp tục quá hạn mặc định, hoặc quá cửa sổ khôi-tranh biện dưới đây, là không tuân thủ trừ khi được tái ủy qua chứng minh gánh có hồ sơ:
  - sự cần thiết tiếp;
  - tính tương xứng;
...
- Thượng nguồn: Nguyên tắc: Chương Một [§3.1 An toàn](core_01_a_values_principles.md#31-safety-harm-constraint), [§6 Giải quyết xung đột quy trình](core_01_b_interaction_interpretation.md#6-process-conflict-resolution), và [§8 Diễn giải hiến pháp](core_01_b_interaction_interpretation.md#8-constitutional-interpretation).
- Đọc cùng: gia đình đo lường Kịp thời (*Giải quyết kịp thời như đo lường hiến pháp*).
...
- Thượng nguồn: Nguyên tắc: Chương Một [§3.2 Sự thật](core_01_a_values_principles.md#32-truth-epistemic-integrity-constraint), [§6.2 Ràng buộc công bố nhận thức](core_01_b_interaction_interpretation.md#62-epistemic-disclosure-constraints), và [§15 Áp dụng tích hợp](core_01_c_stewardship_capacity_principles.md#15-integrated-application).
...
*Nói thẳng: sau khẩn cấp, nhìn lại thành thật và công bố điều bạn tìm — chỉ với bí mật hẹp, có hạn thời gian.*

- **Rà soát hồi cố và công bố sau khẩn cấp:** Sau ổn định, quyết định và kết cục khẩn cấp phải chịu rà soát hồi cố.
- **Hồ sơ kiểm được:** Hồ sơ phải kiểm được và phải bao:
  - điều kiện cò;
  - phương án đã xét;
  - hạn chế đã áp;
  - hại đã ngăn;
  - hại đã gây;
  - hiệu suất hoàn hoặc khôi phục;
  - bài học giảm tái diễn.
- **Công bố:** Công bố công hoặc hướng bên bị ảnh hưởng được đòi, chịu [**Nguyên tắc ràng buộc hạn chế nhẹ nhất, có hạn thời gian, và rà soát được**](core_01_b_interaction_interpretation.md#615-least-restrictive-time-bounded-and-reviewable-constraint-principle) cho ngoại lệ bí mật hẹp, có biện minh, và có hạn thời gian.
  - Mỗi ngoại lệ phải xác định:
    - biện minh của nó;
    - phạm vi bảo vệ;
...
*Nói thẳng: xung đột quyền phải được giải trên hồ sơ; khôi phục được ưa nơi thích hợp nhưng không được thay bảo vệ thật. Quy tắc xin lỗi công tự nguyện do **Chương Chín** §4.3 quản trị nói chung, và do **Chương Mười** §4.3 cho hành vi sai phản hiến pháp đã xác minh.*

- **Thủ tục va chạm quyền:** Nơi xung đột quyền có trọng, diễn đàn và cơ quan quản trị phải áp **Chương Một §6.1.5** (*Thử quyết định va chạm quyền*), kể cả [**Nguyên tắc ràng buộc hạn chế nhẹ nhất, có hạn thời gian, và rà soát được**](core_01_b_interaction_interpretation.md#615-least-restrictive-time-bounded-and-reviewable-constraint-principle).
  - Hồ sơ phải xác định rõ:
    - quyền đang căng;
...
- **Hưng thịnh:** hữu tri giữ tiếng nói có ý nghĩa về cách cấu trúc quản trị được định hình, tranh biện, và thay — không bị khóa bởi sắp xếp đã hết biện minh.
- **Liên tục:** hệ thống chân trời dài đủ ổn để hoạch và phục hồi, nhưng không coi dây hôm nay là vĩnh viễn khi nó không còn thẳng hàng yêu cầu hiến pháp.

Theo đuổi hợp pháp chạy qua [Tứ diện Hiến pháp](core_00_preamble.md#constitutional-tetrad), chia tỷ lệ theo [lợi hại vật chất](core_00_preamble.md#material-stake):

- **Tham gia:** trong đề, tranh biện, và thay cơ chế quản trị khi tái xác nhận cho thấy lệch hàng, loại trừ, hoặc suy quyền tranh biện.
- **Giám sát:** qua tái xác nhận định kỳ, tiêu chí công cho tiếp tục hoặc thay, và hồ sơ quan sát được khi đổi hiến pháp có trọng xảy ra.
...
- [Trách nhiệm giải trình](core_05_apex_accountability_leg.md#accountability) · [O](core_05_apex_accountability_leg.md#accountability) · [M](core_05_apex_accountability_leg.md#accountability-m) · [A](core_05_apex_accountability_leg.md#accountability-a) · [C](core_05_apex_accountability_leg.md#accountability-c)
- [Minh bạch](core_05_band_oversight.md#transparency) · [O](core_05_band_oversight.md#transparency) · [M](core_05_band_oversight.md#transparency-a) · [A](core_05_band_oversight.md#transparency-a) · [C](core_05_band_oversight.md#transparency-c)
- [Bên bị ảnh hưởng](core_05_band_participation.md#stakeholder) · [O](core_05_band_participation.md#stakeholder) · [M](core_05_band_participation.md#stakeholder-a) · [A](core_05_band_participation.md#stakeholder-a) · [C](core_05_band_participation.md#stakeholder-c)

</details>

<br>

*Nói thẳng: quản trị phải kiếm thẩm quyền tiếp qua rà soát đều — và phải được rà nhanh hơn khi chiếm, loại trừ, hoặc thất đang hiện.*

- **Rà soát định kỳ:** Cơ chế quản trị và phân bổ có trọng phải chịu:
  - tái xác nhận định kỳ và minh bạch;
  - tiêu chí bên bị ảnh hưởng thấy được cho tiếp tục hoặc thay, như triển khai trong nghị định triển khai và bảo vệ quản trị.
- **Rà soát tăng tốc:** Tái xác nhận phải tăng tốc nơi bằng chứng cho bất kỳ điều nào sau:
  - áp lực chiếm;
...
- **Hồ sơ đổi có trọng:** Đổi có trọng phải mang:
  - lý do công;
  - hiệu ứng kỳ vọng;
  - tương thích với **Chương Mười Ba đến Mười Lăm** nơi áp.
- **Chống lách:** Dưới [**Nguyên tắc hiến pháp không lách**](core_01_b_interaction_interpretation.md#81-constitutional-no-bypass-principle), đổi không được dùng để lách **tối thiểu Sàn Quyền** hoặc quy tắc đổi Hiến pháp này hợp pháp bằng cách định tuyến đổi thực chất qua cơ chế khẩn cấp, triển khai, hoặc lưu giữ — kể cả:
  - **Điều V** (*Quyền cơ bản bình đẳng*) và **VI** (*Quyền giáo dục lấy hữu tri làm trung tâm*);
...
- **Hưng thịnh:** hữu tri giữ **tối thiểu Sàn Quyền**, tiếng nói có ý nghĩa, và đường tranh biện thực tiễn suốt chuyển tiếp — công việc chuyển tiếp không phải giấy phép lột phẩm giá, lối vào, biện pháp khắc phục, hoặc quyền năng vì tiện.
- **Liên tục:** hệ thống chung còn quản trị được, giữ quyền, và phục hồi được suốt bàn giao — với sắp xếp tạm nhường cho thể chế và quy trình hiến pháp ngày càng chức năng, không cứng thành thẩm quyền ngoại lệ bền hay đường cơ sở hiến pháp hạ.

Theo đuổi hợp pháp chạy qua [Tứ diện Hiến pháp](core_00_preamble.md#constitutional-tetrad), chia tỷ lệ theo [lợi hại vật chất](core_00_preamble.md#material-stake) — tác động, phụ thuộc, và rủi ro càng lớn, mỗi nghĩa vụ càng phải mạnh:

- **Tham gia:** bên bị ảnh hưởng có tiếng nói thật ở mỗi pha chuyển tiếp — kể cả tiêu chí cổng thấy được, cơ hội tranh biện tịch thu hoặc hạn chế thời chuyển tiếp, và ý kiến khi quyền lực tạm chạm quyền hoặc quỹ đạo được gia hạn.
- **Giám sát:** chuyển tiếp phải còn xem được và kiểm được — cổng đạt và có hồ sơ, thẩm quyền tạm được rà độc lập, tiến độ đo bằng thu hẹp phạm vi tạm và trưởng thành vận hành hiến pháp, hồ sơ kiểm được, và lý do công bố cho trì hoãn, hoàn, hoặc đặt lại đường cơ sở.
- **Trách nhiệm giải trình:** người chạy chuyển tiếp phải trả lời vì dùng nó làm vỏ — trì hoãn tự tạo, lối tắt tiện, cưỡng chế lấy cớ, chân không quản trị, khóa sau mốc thất, hoặc lặng hạ sàn hiến pháp qua lệch hàng triển khai.
- **Kịp thời:** quyền lực tạm mang ngày hết hạn thật; chúng chạy càng lâu và chạm càng nhiều quyền, tái ủy càng phải khó; và chuyển tiếp đứng cần lối ra hợp pháp trước khi limbo tạm cứng thành bình thường mới.
...
*Nói thẳng: chuyển tiếp tiến bằng đạt cổng thật, không bằng đồng hồ hay áp lực — và tối thiểu Sàn Quyền còn hiệu lực mọi pha.*

- **Tiếp nhận theo pha và tiêu chí cổng:** Kế hoạch chuyển tiếp phải theo pha và rà soát được.
  - Tiến pha phải dựa trên thỏa có hồ sơ tiêu chí cổng đã công bố và hiện vật xác minh đòi.
  - Nó không được dựa trên bất kỳ điều nào sau một mình:
    - thời gian trôi;
    - tiện;
    - áp lực chính trị.
...
- Thượng nguồn: Nguyên tắc: Chương Một [§3.1 An toàn](core_01_a_values_principles.md#31-safety-harm-constraint), [§6.1 Nguyên tắc đánh đổi cốt](core_01_b_interaction_interpretation.md#61-core-tradeoff-principles), và [§7 Cấm phủ quyết tuyệt đối](core_01_b_interaction_interpretation.md#7-prohibition-on-absolute-override).
...
*Nói thẳng: thẩm quyền tạm thật sự tạm — và chuyển tiếp đang tốt cho thấy. Bạn nên thấy quyền lực tạm thu nhỏ từng pha trong khi diễn đàn hiến pháp, quy trình quyền, và máy quản trị thường làm việc tốt hơn và gánh nhiều hơn. Gia hạn thẩm quyền tạm đòi lý do thật — và chạy càng lâu, thanh càng cao.*

- **Hạn thẩm quyền chuyển tiếp:** Thẩm quyền tạm phải triển khai [**Nguyên tắc ràng buộc hạn chế nhẹ nhất, có hạn thời gian, và rà soát được**](core_01_b_interaction_interpretation.md#615-least-restrictive-time-bounded-and-reviewable-constraint-principle) và phải:
  - phạm vi rõ;
  - có biên hoàng hôn;
  - rà soát độc lập được.
- **Thước tiến độ:** Sức khỏe chuyển tiếp đo bằng thu hẹp có hồ sơ thẩm quyền tạm và chức năng tăng của thể chế và quy trình hiến pháp — kể cả diễn đàn, đường dẫn được đặt tên quỹ đạo và tranh biện, máy tu chính và giám sát, và vận hành hiến pháp thường khác giả định tiếp nhận đầy. Phạm vi tạm đứng hoặc lớn mà không trưởng thành thể chế tương ứng là cờ đỏ tái ủy.
- **Tiếp tục và tái ủy:** Tiếp tục quá cửa sổ đã hoạch đòi biện minh có hồ sơ và tái ủy.
  - Tái ủy không được dựa trên bất kỳ điều nào sau:
    - tiện hành chính;
    - trì hoãn tự tạo;
    - chỉ chưa xong công việc chuyển tiếp;
...
*Nói thẳng: khi chuyển tiếp đứng hoặc thất, phải có lối ra thật — và trạng thái đứng không được lặng thành bình thường mới. Đặt lại kế hoạch được phép, nhưng chỉ qua quy trình hợp pháp, với lý do ai cũng kiểm được — và không bao giờ bằng hạ quyền cơ bản. Lần đặt lại không đáng tin nếu chứng nhận thẳng hàng cứ ban phước hệ thống lệch hàng hoặc rà quỹ đạo cứ đọc sai hại thật; sửa máy nói thật đó trước, không thì quản trị cấu trúc không tin được dù kế hoạch mới bóng đến đâu.*

- **Xử thất và lối ra:** Kế hoạch chuyển tiếp phải giữ liên tục và tránh:
  - chân không quản trị;
  - khóa khi mốc thất.
