...
>
> Tệp này là một **thử nghiệm ngôn ngữ đọc** của [Chương Mười Một tiếng Anh](../../core_11_forum.md). **Không** phải phần ràng buộc của Hiến pháp Hữu tri. **Không** phải một hiến pháp thứ hai. **Không** phải một ấn bản phát hành. Nó được **ghim** vào `SC-Corpus-2026.08.09`. Nếu bản dịch này và nguyên bản tiếng Anh có vẻ lệch nhau, tệp đánh số [`core_11_forum.md`](../../core_11_forum.md) thắng. Thứ tự đọc và siêu dữ liệu ấn bản được giữ ở [README.md](../../README.md). Phương pháp và bảng thuật ngữ: [translations/vi/README.md](README.md).
>
...
>
> **Trước (vẫn tiếng Anh):** [core_10_b_misconduct_pattern_applications.md](../../core_10_b_misconduct_pattern_applications.md#chapter-ten-part-b-anti-constitutional-misconduct-pattern-applications)
>
> **Tiếp theo (vẫn tiếng Anh):** [core_08-11_application_vignettes.md](../../core_08-11_application_vignettes.md#chapters-eight-eleven-application-vignettes)
...
<details>
<summary><strong><span style="color: #2563eb;">Hướng dẫn cho người đọc (không vận hành): nơi Chương Mười Một sống và điều gì ở lại đây</span></strong></summary>
...
>
> **Kiến trúc — đặt *Nói thẳng*:** Mỗi dòng *Nói thẳng* xuất hiện ngay sau khối điều hướng Dấu vết (và `<br>` theo sau khi có), và **trước** các đoạn vận hành và danh sách gạch đầu dòng của mục đó. Chỉ chú giải hướng người đọc; không thêm, bớt hay thu hẹp văn bản ràng buộc.
...
- Hạ nguồn: [corpus_forum.md](../../corpus_forum.md) (*học thuyết diễn đàn vận hành*); [Chương Mười Hai](../../core_12_governance.md#chapter-twelve-constitutional-contract-legitimacy-authorization-and-stewardship) nơi tính chính đáng quản trị giao vai trò phân xử; [Chương Mười Sáu](../../core_16_incorporation.md#chapter-sixteen-incorporation-bridge) (*kỷ luật tiếp nhận* cho tầng thủ tục đã tiếp nhận).
...
```mermaid
flowchart TD
  dispute[Tranh chấp thường trong hệ thống đã được ủy quyền]
  challengePath[Đường tranh biện Tham gia hệ thống của bên bị ảnh hưởng đã công bố]
  stillOpen["Vẫn bị tranh, thiếu, bị chiếm, hoặc không cấp được cứu trợ"]
  ch11[Chương Mười Một định tuyến theo lợi hại chính]
  lead["Họ dẫn: Hữu tri, Kỹ thuật, Thể chế, Môi trường, Toàn vẹn, hoặc Hiến pháp"]
  direct["Lối vào trực tiếp nếu trì hoãn gây nguy quyền, bằng chứng, độc lập, hoặc phục hồi"]
...
- Diễn đàn **Toàn vẹn**, **Hiến pháp**, và **Môi trường**, và **Lĩnh vực Diễn đàn Kỹ thuật** khi chúng nghe phân xử trạng thái hữu tri, đòi bổ nhiệm **đã công bố**, **bị tranh**, **luân phiên được** hoặc kiểm độc lập tương đương dưới [Chương Mười Hai §1.2](../../core_12_governance.md#12-eligibility-contested-selection-and-democratic-minimums). Thiếu bổ nhiệm hoặc thiếu tài trợ những ghế đó là thất [Chương Chín §9](core_09_standing_integration.md#9-enforcement-realism).
...
Ngân sách **toàn hệ thống**, tài trợ nghiên cứu cắt ngang, và chương trình quy mô quản trị vẫn chịu [Chương Mười Hai — Quản trị](../../core_12_governance.md#chapter-twelve-constitutional-contract-legitimacy-authorization-and-stewardship), **[corpus_systems.md](../../corpus_systems.md)**, và quy tắc tối cao khác nơi áp. Thanh toán, quy tắc chi phí, và công cụ khuyến khích tương tự **không được** thế chỗ:
...
**Tệp trước (vẫn tiếng Anh):** [core_10_b_misconduct_pattern_applications.md](../../core_10_b_misconduct_pattern_applications.md#chapter-ten-part-b-anti-constitutional-misconduct-pattern-applications)

**Tệp tiếp theo (vẫn tiếng Anh):** [core_08-11_application_vignettes.md](../../core_08-11_application_vignettes.md#chapters-eight-eleven-application-vignettes)

**Nguyên bản ràng buộc:** [core_11_forum.md](../../core_11_forum.md)
