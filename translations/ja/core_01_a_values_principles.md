...
>
> 本ファイルは[英語第一章 A部](../../core_01_a_values_principles.md)の**読者言語パイロット**である。**感知者憲法の拘束力ある部分ではない**。**第二の憲法ではない**。**配布版ではない**。`SC-Corpus-2026.08.09` に**固定**されている。本訳文と英語原文が食い違って見える場合、番号付きファイル [`core_01_a_values_principles.md`](../../core_01_a_values_principles.md) が勝つ。読み順と版のメタデータは [README.md](../../README.md) に保たれる。方法と用語表：[translations/ja/README.md](README.md)。
>
> **前（本言語）：** [core_00_preamble.md](core_00_preamble.md)（前文）
>
> **次（本言語）：** [core_01_b_interaction_interpretation.md](core_01_b_interaction_interpretation.md)（第一章、B部 — §§6–8、相互作用、上書きの限度、憲法解釈）。
...
*平たい言葉で言えば：第一章は、後続のすべての章を統治する価値と制約を定める。共有システムは**繁栄**と**継続**をともに追求しなければならない — 一方を他方の犠牲にしてはならない — そして単一の価値を、他の価値の犠牲にして最大化してはならない。*

<a id="two-constitutional-aims"></a><a id="flourishing"></a><a id="continuity"></a>本章は、この憲法の解釈、適用、進化を統治する原則と制約を確立する。それは[前文 §1 モデル](core_00_preamble.md#the-model)で確立された[二つの憲法上の目的](core_00_preamble.md#two-constitutional-aims)、[**繁栄**](core_00_preamble.md#flourishing)、[**継続**](core_00_preamble.md#continuity)を、操作性の原則と制約へと展開する。原則層の典範定義は前文に住む。本章はそれを適用する。

それらの目的は、つねにこの憲法が定める交渉不能の原則制約と権利保護の内側で、ともに追求されなければならない。[**憲法四元**](core_00_preamble.md#constitutional-tetrad)は、その追求がどのように正当性を保つかを統治する — [**実質的利害**](core_00_preamble.md#material-stake)に応じて尺度を合わせる。

これらの価値は：
- 独立しておらず、通常の運用では厳密な階層でもない。
- ともに評価されなければならない、相互作用する原則と制約として働く。
- すべての「システム」に適用される。技術、組織、経済、社会技術構造、および感知者と地球に実質的に影響する生態系を含む。

単一の原則は、他の原則を実質的に侵害するところでは、孤立して適用してはならない。緊張が生じるところでは、システムは本章に述べられた比例性、必要性、システム影響の要件のもとでそれを解決しなければならない。未解決の衝突が交渉不能の原則制約に直接関わるところでは、第一章、**§5** — 過程衝突の解決が優先を制御する。
...
*平たい言葉で言えば：これらのシステムの本旨は、感知者の暮らしを本当に良くすることである — その目的は、代替指標を追うことでは満たされず、安全、真理、権利の手抜きの隠れ蓑としても使えない。福祉は参加の基礎である。行為主体性を本物にする条件なしの形だけの声は、この憲法のもとでの参加ではない。*
...
- 安全、真理、権利保護を侵害する包括的正当化として呼び出してはならない
...
- [保護特性の代理と不均衡な影響](../../core_05_band_participation.md#protected-characteristic-proxying-and-disparate-impact) · [O](../../core_05_band_participation.md#protected-characteristic-proxying-and-disparate-impact) · [M](../../core_05_band_participation.md#protected-characteristic-proxying-and-disparate-impact-a) · [A](../../core_05_band_participation.md#protected-characteristic-proxying-and-disparate-impact-a) · [C](../../core_05_band_participation.md#protected-characteristic-proxying-and-disparate-impact-c)
- [保護された親密信号のゲートと **Article X-C**（《成人の合意に基づく商業的性サービスと性的搾取》）地位の迂回](../../core_05_band_participation.md#protected-intimate-signal-gating-and-article-x-c-status-circumvention) · [O](../../core_05_band_participation.md#protected-intimate-signal-gating-and-article-x-c-status-circumvention) · [M](../../core_05_band_participation.md#protected-intimate-signal-gating-and-article-x-c-status-circumvention-a) · [A](../../core_05_band_participation.md#protected-intimate-signal-gating-and-article-x-c-status-circumvention-a) · [C](../../core_05_band_participation.md#protected-intimate-signal-gating-and-article-x-c-status-circumvention-c)
- [代替指標の乖離](../../core_05_band_oversight.md#proxy-divergence) · [O](../../core_05_band_oversight.md#proxy-divergence) · [M](../../core_05_band_oversight.md#proxy-divergence-a) · [A](../../core_05_band_oversight.md#proxy-divergence-a) · [C](../../core_05_band_oversight.md#proxy-divergence-c)
...
*平たい言葉で言えば：公正とは、普通の感知者が参加を阻まれ、説明されない規則で扱われ、他者が避ける費用を負わされたまま、システムが自らを良いと呼べないということである。公正なシステムは、感知者に実際の通路を与え、擁護できる理由を用い、報酬、費用、リスクを、実際の貢献、必要、露出に合わせて分ける。*
...
本節には**三つの作業部分**がある。本節を案内するが、第五章の定義も第六章の権利の床も置き換えない。
...
- 一部の感知者が利得を受け、他者が静かに費用を吸収するとき、システムは公正ではない。
- えこひいき、隠れた費用の転嫁、選択的執行、スコアボードの手品は、この要件を満たさない。

<a id="213-fair-treatment"></a>
##### 2.1.3 公正な取扱い

- 似た状況にある感知者は、同じ基本規則で扱われるべきである。
- 感知者が受け取り、負い、または賭けるものは、貢献したもの、必要とするもの、実際に直面する負担に合うべきである。
- 異なる取扱いには実際の理由がなければならず、その理由に比例し、尊厳を尊重し、差別を避けなければならない。
...
不公正な取扱いは排除と不整合をつくる。システムは、不公正な取扱いを技術用語、中立ラベル、自動化された決定の後ろに隠してはならない。とくに、次をしてはならない：
- 憲法上有効な理由なしに、歴史的不利益を繰り返すアルゴリズム、採点システム、行政規則を用いること
- 親密な個人信号や性の履歴を、信頼、リスク、品格、通路の近道として用いること — [保護された親密信号のゲートと **Article X-C**（《成人の合意に基づく商業的性サービスと性的搾取》）地位の迂回](../../core_05_band_participation.md#protected-intimate-signal-gating-and-article-x-c-status-circumvention)とあわせて読む
- 憲法上有効な理由なしに、適法な雇用、雇用歴、雇用の欠如、適法な就労地位、保護された結社を罰すること
- 適法ないかなる形態の雇用、適法な過去の雇用、適法と見なされた雇用、または雇用の欠如を**主たる理由として**、仕事、住居、銀行、免許、軌跡、同様の通路を拒むこと
- 免許、用途地域、手数料、プラットフォーム規則、その他中立に見える要件を通じて、この憲法が求める正当化なしに、適法な労働、適法な労働歴、適法と見なされた労働、雇用の欠如、保護された結社に主として負担をかける実質的不利益をつくること

これら四つの部分はまた、感知者がシステムに依拠し、その決定を受け入れ、その約束のまわりで協調しなければならないところでは、[4. 信頼](#4-system-stability-enabler-trust-coordination-integrity)を支える。
...
- あわせて読む：**領域整合**の承認または比較的な**貢献軸 / 違反軸**記述物語が実質的であるところでは、[第八章 §§4.3–4.4 — 正規化記述子カタログ](../../core_09_standing_assessment.md#43-route-descriptor-measurement-roles)。
- あわせて読む：貢献の性質と承認物語が実質的であるところでは [第八章 §4.3 — 貢献側記述子](../../core_09_standing_assessment.md#43-route-descriptor-measurement-roles)。問い 3 への統合については [第九章 §3](../../core_10_standing_integration.md#3-descriptor-integration-and-attachment-normalization)。
...
- 分節（読み順）：[§2.2.1](#221-recognition-and-reinforcement) · [§2.2.2](#222-celebration-of-success) · [§2.2.3](#223-aspiration) · [§2.2.4](#224-preference-aligned-recognition) · [§2.2.5](#225-aligned-recognition-pathways) · [§2.2.6](#226-anti-reward-for-anti-constitutional-conduct) · [§2.2.7](#227-implementation-layer)。
...
感知者の福祉は、システムが適法な責務ある管理、誠実な協力、修復、完了、その他憲法に整合した貢献を**合図し**、**認め**、**比例的に報いる**ときに進む — **正の強化**と**公の承認**を通じて — 抑制、制裁、沈黙だけではない。

それは憲法上の義務であり、任意の文化ではない。共有システムは、憲法に整合した行為を可視にし、繰り返す価値あるものにすべきである。

<a id="222-celebration-of-success"></a>
##### 2.2.2 成功の祝賀

**祝賀**は、**たどれ**、**誤導しない**達成と向社会的協調をたたえる。検証済みの[貢献](../../core_05_band_continuity.md#contribution)に結びついた向上と責務ある管理の物語を含む。
...
**志向**は、[§5 自由](#5-freedom-bounded-agency)の内側で追求される述べられた選好と目的を覆う。尊厳、平等な地位、安全、真理、[実質的公正](../../core_05_band_participation.md#substantive-fairness-constitutional)と整合するとき、福祉の一部である。

それらの限界の内側で、システムは、感知者が適法に追求したいものを**認め、支える**べきである。

何かを望むことは、通行証ではない。同意、尊厳、安全、真理、実質的公正、**第六章**の保護が実質的にかかわるところでは、それらの追求は、他の憲法上の主張と同じく衝突分析に服する。

<a id="224-preference-aligned-recognition"></a>
##### 2.2.4 選好に整合した承認

実務可能なところでは、システムは、承認、称賛、比例的報酬を、感知者がたたえられたい仕方に**合わせる**べきである — とくに**形と可視性**についての述べられた選好。

それは、比例的で適法であるとき、公または儀礼的承認からの**オプトアウト**、または**最小もしくは私的**な承認の選好を尊重することを含む。

**歓迎されない**または**強制的な**承認は、この要件に失敗する — **辞退する**感知者をスポットライトに置くことを含む。

承認は、たたえられる者と、ともに働く共同体にとって**意味ある**ものであるべきであり、主に外部の観察者のための上演であってはならない。
...
感知者、役割、制度、またはシステム構成要素が反憲法的行為を行い、可能にし、隠し、常態化し、是正を拒み、または報告に報復したことを理由に、承認、報酬、保護、昇進、免責、有利な割当、契約、通路、地位、評判上の便益、軌跡上の便益、または比較可能な優位を与えてはならない。

この規則は、直接の報酬と間接の報酬経路を覆う。庇護、評判の洗浄、事後の昇進、選択的不執行、有利な和解、指標上のクレジット、制度的保護を含む。

影響を受けた当事者と誠実な保護された報告者に対する是正、保護、回復の措置は、禁じられた報酬ではない。

<a id="227-implementation-layer"></a>
##### 2.2.7 実施層

細かい儀礼、カリキュラム、予算、プログラム、指標は、採択する実施層に属する。
...
- あわせて読む：[憲法四元](core_00_preamble.md#constitutional-tetrad) — **参加**脚（安全と真理の判定を理解し争うこと）。**監督**脚（危害リスクと認識の劣化を検出すること）。**説明責任**脚（危害、欺瞞、誤導的依拠への応答義務）。[実質的利害](core_00_preamble.md#material-stake)による尺度合わせ。
- あわせて読む：[二つの憲法上の目的](core_00_preamble.md#two-constitutional-aims) — **繁栄**目的（**安全**と**真理**は[前文 §1](core_00_preamble.md#two-constitutional-aims)のもとでの指名された構成部分）。**継続**目的（長い時間地平の危害予防と、持続するシステムの誠実な責務ある管理）。
- 上流：原則：[2. 基礎目標：福祉](#2-foundational-objective-wellbeing)；[二つの憲法上の目的](core_00_preamble.md#two-constitutional-aims)。
- 下流：[4. 信頼](#4-system-stability-enabler-trust-coordination-integrity)、[6. 過程衝突の解決](core_01_b_interaction_interpretation.md#6-process-conflict-resolution)、[§5 自由](#5-freedom-bounded-agency)。
- 分節：[§3.1 安全](#31-safety-harm-constraint)；[§3.2 真理](#32-truth-epistemic-integrity-constraint)；[§3.3 科学に基づく探究と決定支援](#33-science-informed-inquiry-and-decision-support)；[§3.4 平たい言葉のアクセス可能性](#34-plain-language-accessibility-stewardship-duty)。

</details>

<br>

*平たい言葉で言えば：安全と真理は憲法の硬い床である — 最適化して消せる取引ではない。共有システムは、予見可能に感知者を危険にさらし、または欺いてはならず、両制約は四元の参加、監督、説明責任、適時性の規律のもとで、繁栄と継続の追求の内側に適用される。*

**安全**と**真理**は、第一章の他のすべての原則 — [§2 基礎目標：福祉](#2-foundational-objective-wellbeing)と[二つの憲法上の目的](core_00_preamble.md#two-constitutional-aims)を含む — を有界にする交渉不能の原則制約である。それらは[**繁栄**](#flourishing)の指名された構成部分であり、[**継続**](#continuity)に不可欠である。システムは危害や欺瞞を通じて繁栄できず、持続する正当性は、時間を通じた誠実なリスクの責務ある管理を求める。

これらの制約の適用は、[憲法四元](core_00_preamble.md#constitutional-tetrad)を満たさなければならず、[実質的利害](core_00_preamble.md#material-stake)に応じて尺度を合わせる。とくに：
- 安全の判定が参加能力に影響するところ
- 真理の主張が依拠を統治するところ
- 危害または誤導的行為への説明責任がかかわるところ

安全と真理の認定は、感知者の軌跡記録を変えうる。次を含む：
- [貢献](../../core_05_band_continuity.md#contribution)がどう認められるか
- 違反が記録されるか
- それらの違反がどれほど重大に分類されるか
- どの帰結が付着するか

[**第八章**の軌跡モデル](../../core_09_standing_assessment.md)が、それらの認定がどう分類、検証、適用されるかを統治する。評価と遵守の要件は[**第二から第五章**](core_02_definition_structure.md)から引く。
...
- あわせて読む：[憲法四元](core_00_preamble.md#constitutional-tetrad) — **監督**脚と**説明責任**脚。[実質的利害](core_00_preamble.md#material-stake)による尺度合わせ。
- あわせて読む：[二つの憲法上の目的](core_00_preamble.md#two-constitutional-aims) — **繁栄**目的（**安全**構成部分）。**継続**目的（不可逆的危害の予防と長い時間地平のリスクの責務ある管理）。
- 上流：原則：[2. 基礎目標：福祉](#2-foundational-objective-wellbeing)；[二つの憲法上の目的](core_00_preamble.md#two-constitutional-aims)。
- 下流：[3.3 科学に基づく探究と決定支援](#33-science-informed-inquiry-and-decision-support)、[4. 信頼](#4-system-stability-enabler-trust-coordination-integrity)、[§5 自由](#5-freedom-bounded-agency)、[6. 過程衝突の解決](core_01_b_interaction_interpretation.md#6-process-conflict-resolution)、[6.2.1 認識的誠実性の保全](core_01_b_interaction_interpretation.md#621-preservation-of-epistemic-integrity)。
- 下流：信頼できるシステム、情報圏の誠実性、監査と審査、ライフサイクル制御、実験の境界、理解可能性、適応的応答、緊急対応についての権利面を形づくる。
  - とくに [Article XII：信頼でき信頼可能なシステムへの権利](../../core_06_rights_part_c.md#article-xii-right-to-reliable-and-trustworthy-systems)、[Article XIV：情報圏の誠実性](../../core_06_rights_part_c.md#article-xiv-info-sphere-integrity)、[Article XV：監査、透明性、独立検証](../../core_06_rights_part_c.md#article-xv-audit-transparency-and-independent-verification)、[Article XVI：システムライフサイクル、環境、可逆性](../../core_06_rights_part_c.md#article-xvi-system-lifecycle-environments-and-reversibility)、[Article XVII：サンドボックス化された革新、実験、創造の自由](../../core_06_rights_part_c.md#article-xvii-sandboxed-innovation-experimentation-and-creative-freedom)、[Article XX：理解可能性と複雑さの責務ある管理](../../core_06_rights_part_c.md#article-xx-comprehensibility-and-complexity-stewardship)、[Article XXI：根本原因分析と適応的応答](../../core_06_rights_part_c.md#article-xxi-root-cause-analysis-and-adaptive-response)、[Article XXII：憲法解釈、審査、反捕捉保障](../../core_06_rights_part_c.md#article-xxii-constitutional-interpretation-review-and-anti-capture-safeguards)、[Article XXIII：衝突解決、段階的拡大、緊急の比例性](../../core_06_rights_part_d.md#article-xxiii-conflict-resolution-escalation-and-emergency-proportionality)。
  - 行使または制限がリスク、証拠、開示、システムの誠実性にかかわる第六章の権利も覆う。
...
- [予見可能性](../../core_05_band_oversight.md#foreseeability-diligence) · [O](../../core_05_band_oversight.md#foreseeability-diligence) · [M](../../core_05_band_oversight.md#foreseeability-diligence-a) · [A](../../core_05_band_oversight.md#foreseeability-diligence-a) · [C](../../core_05_band_oversight.md#foreseeability-diligence-c)
...
- あわせて読む：[憲法四元](core_00_preamble.md#constitutional-tetrad) — **監督**脚と**説明責任**脚。[実質的利害](core_00_preamble.md#material-stake)による尺度合わせ。
- あわせて読む：[二つの憲法上の目的](core_00_preamble.md#two-constitutional-aims) — **繁栄**目的（**真理**構成部分）。**継続**目的（持続する認識的・制度的条件の誠実な責務ある管理）。
- 上流：原則：[2. 基礎目標：福祉](#2-foundational-objective-wellbeing)；[二つの憲法上の目的](core_00_preamble.md#two-constitutional-aims)。
- 下流：[3.3 科学に基づく探究と決定支援](#33-science-informed-inquiry-and-decision-support)、[4. 信頼](#4-system-stability-enabler-trust-coordination-integrity)、[6. 過程衝突の解決](core_01_b_interaction_interpretation.md#6-process-conflict-resolution)、[6.2.1 認識的誠実性の保全](core_01_b_interaction_interpretation.md#621-preservation-of-epistemic-integrity)、[6.2.2 信頼と真理の整合](core_01_b_interaction_interpretation.md#622-trust-truth-alignment)、[7. 絶対的上書きの禁止](core_01_b_interaction_interpretation.md#7-prohibition-on-absolute-override)。
- 下流：誠実な証拠、監査可能性、科学的誠実性、回顧的審査、争訟可能な開示についての権利面を固定する。
  - とくに [Article XII：信頼でき信頼可能なシステムへの権利](../../core_06_rights_part_c.md#article-xii-right-to-reliable-and-trustworthy-systems)、[Article XIV：情報圏の誠実性](../../core_06_rights_part_c.md#article-xiv-info-sphere-integrity)、[Article XV：監査、透明性、独立検証](../../core_06_rights_part_c.md#article-xv-audit-transparency-and-independent-verification)、[Article XVII-E：科学出版、審査、再現の誠実性](../../core_06_rights_part_c.md#article-xvii-e-scientific-publication-review-and-replication-integrity)、[Article XXII：憲法解釈、審査、反捕捉保障](../../core_06_rights_part_c.md#article-xxii-constitutional-interpretation-review-and-anti-capture-safeguards)、[Article XXIV-A：回顧的審査と開示](../../core_06_rights_part_d.md#article-xxiv-a-retrospective-review-and-disclosure)。
  - 誠実さ、証拠、開示、争訟可能性がかかる第六章の権利文脈も覆う。
...
*平たい言葉で言えば：システムが試験できる安全、リスク、真理、高影響の統治主張をするとき、証拠を証拠として扱わなければならない — 明確な方法、不確実性、審査、事実がそうするとき進路を変える意思とともに。*

科学に基づく探究は、憲法上の決定が経験的、予測的、因果的、測定可能、またはその他試験可能な命題に依拠するところでの、**安全**と**真理**のための必要な支援規律である。安全と真理から分離した第三の交渉不能制約ではない。試験された証拠と明確な方法で主張を点検し、それらの制約が実務で誠実であり、誤りなら訂正でき、実際に知られていることに比例したままであるための要件である。

統治の選択 — 予測、因果主張、分類、その他の**高影響**決定を含む — が**経験的**または**試験可能な**命題に依拠するところでは、証拠実務は**科学的誠実性**と整合しなければならない。最低限、実務可能なところでは、決定記録は次を含むべきである：
- 明示的な問いまたは仮説
- **方法**、**データの限界**、**不確実性**
- **相反する証拠**と、証拠が以前の結論または前提を**反証したときの改訂**の誠実な取扱い
- **第四章**と**第五章**（《認識的誠実性》；《真理（憲法上の制約）》）のもとで利害に比例した**独立した審査**
...
#### 3.4 平たい言葉のアクセス可能性（参加と責務ある管理の義務）
<details>
<summary><strong><span style="color: #2563eb;">追跡</span></strong></summary>
...
この義務は、感知者が実際に関わる文書と通信を覆う。例は次を含む：
...
[§6.3 回避可能な負担の最小化](core_01_b_interaction_interpretation.md#63-minimization-of-avoidable-burden)のもとで、運用者と統治体は次をしなければならない：
...
平たい言葉の仕事は、定義の厳密さを緩める免許では**ない**。定義層では次がなお制御する：

- 第五章の定義とその O/M/A/C 構成要素
- 第二から第四章の定義メカニズム

より簡単な言葉で書くことは、意味を変えない。平たい言葉の要約と、それが要約する形式定義が違うことを言っているように見えるなら、形式定義が制御する — 要約はそれに合わせて訂正されなければならない。

<a id="344-jargon-as-defeat-discipline"></a>
##### 3.4.4 専門用語による打ち負かしの規律

システムは、複雑な言葉、不透明な手続、意図的な晦渋を用いて、感知者が決定に[異議を申し立て](../../core_05_band_accountability.md#contestability)、[意味ある行為主体性](../../core_05_band_participation.md#meaningful-agency)を行使し、[監査](../../core_06_rights_part_c.md#article-xv-audit-transparency-and-independent-verification)にアクセスし、[第六章](../../core_06_rights_part_a.md#chapter-six-foundational-rights)の権利を行使するのを妨げてはならない。

逆も同じく禁じられる。規則が実際にすることを誤って表し、本当の効果を隠し、要約を操作性の本文の代わりにする平たい言葉の枠組みは、[真理](../../core_05_band_oversight.md#truth-constitutional-constraint)の侵害である。
...
- [信頼可能性](../../core_05_band_continuity.md#trustworthiness) · [O](../../core_05_band_continuity.md#trustworthiness) · [M](../../core_05_band_continuity.md#trustworthiness-a) · [A](../../core_05_band_continuity.md#trustworthiness-a) · [C](../../core_05_band_continuity.md#trustworthiness-c)
- [真理（憲法上の制約）](../../core_05_band_oversight.md#truth-constitutional-constraint) · [O](../../core_05_band_oversight.md#truth-constitutional-constraint-o) · [M](../../core_05_band_oversight.md#truth-constitutional-constraint-a) · [A](../../core_05_band_oversight.md#truth-constitutional-constraint-a) · [C](../../core_05_band_oversight.md#truth-constitutional-constraint-c)
- [安全（制約）](../../core_05_band_continuity.md#safety-constraint) · [O](../../core_05_band_continuity.md#safety-constraint) · [M](../../core_05_band_continuity.md#safety-constraint-a) · [A](../../core_05_band_continuity.md#safety-constraint-a) · [C](../../core_05_band_continuity.md#safety-constraint-c)
- [実質性](../../core_05_band_oversight.md#materiality-determination) · [O](../../core_05_band_oversight.md#materiality-determination) · [M](../../core_05_band_oversight.md#materiality-determination-a) · [A](../../core_05_band_oversight.md#materiality-determination-a) · [C](../../core_05_band_oversight.md#materiality-determination-c)
- [信頼の劣化と誤導的依拠](../../core_05_band_integrative.md#trust-degradation-and-misleading-reliance-constitutional) · [O](../../core_05_band_integrative.md#trust-degradation-and-misleading-reliance-constitutional) · [M](../../core_05_band_continuity.md#trust-degradation-and-misleading-reliance-a) · [A](../../core_05_band_continuity.md#trust-degradation-and-misleading-reliance-a) · [C](../../core_05_band_continuity.md#trust-degradation-and-misleading-reliance-c)

</details>

<br>

*平たい言葉で言えば：共有システムは感知者に依存を求める — 安全、情報、通路、協調のために。この憲法のもとでの信頼は、その依存が、宣伝、秘密、隠れたリスク転嫁で製造されるのではなく、システムが実際にどう振る舞うかによって稼がれなければならないということである。*

感知者は、実際に依拠できるシステムを必要とする。[**信頼**](../../core_05_band_continuity.md#trust)は、依拠を正当にする憲法原則である。システムは、欺瞞や隠蔽でそれを誘発するのではなく、誠実な振る舞いと時間を通じて示された信頼性によってそれを稼がなければならない。[**信頼可能性**](../../core_05_band_continuity.md#trustworthiness)は、それを稼ぐ実績である。信頼は[**繁栄**](#flourishing)の指名された一部であり、[**継続**](#continuity)に不可欠である — 持続する協調は、感知者が当てにできるシステムを求める。

信頼は、原則制約を日常の共有生活につなぐ：
- [**真理**](../../core_05_band_oversight.md#truth-constitutional-constraint)は欺瞞を禁じる。
- [**安全**](../../core_05_band_continuity.md#safety-constraint)は、実際のリスクがあるとき、依拠がどこまで行ってよいかを限る。
- [**実質性**](../../core_05_band_oversight.md#materiality-determination)は、どれだけ示し、説明しなければならないかを定める — システムに依存する感知者にとって利害が高いほど、そのシステムはより多く開示し、正当化しなければならない。
- [**信頼の劣化と誤導的依拠**](../../core_05_band_integrative.md#trust-degradation-and-misleading-reliance-constitutional)は失敗様式を名指しする — システムが憲法上誤導する仕方で依拠をつくり、保ち、または採点するとき。

信頼は、依拠が抑制、欺瞞、隠れたリスク転嫁、または類似の手口 — 感知者がシステム的リスクを検出し争う能力を深刻に損なうものを含む — を通じて築かれ、または保たれるときに失敗する。[第七章](../../core_08_a_system_alignment_certification_evaluation.md#chapter-eight-system-alignment-certification)のもとでの[**システム整合認証**](../../core_08_a_system_alignment_certification_evaluation.md#chapter-eight-part-a-certification-evaluation)過程は、システムが信頼主張が成り立つことを示すところである。認証は、運用者の主張だけでなく、争訟可能な記録の上で、システムの実際の振る舞いがその表明に合うことを検証しなければならない。
...
- [自己修復](../../core_05_band_continuity.md#self-healing-constitutional) · [O](../../core_05_band_continuity.md#self-healing-constitutional) · [M](../../core_05_band_continuity.md#self-healing-constitutional-a) · [A](../../core_05_band_continuity.md#self-healing-constitutional-a) · [C](../../core_05_band_continuity.md#self-healing-constitutional-c)
- [連鎖的失敗](../../core_05_band_continuity.md#cascading-failure) · [O](../../core_05_band_continuity.md#cascading-failure) · [M](../../core_05_band_continuity.md#cascading-failure-a) · [A](../../core_05_band_continuity.md#cascading-failure-a) · [C](../../core_05_band_continuity.md#cascading-failure-c)
...
*平たい言葉で言えば：システムはトラブルを早く検出し、封じ込め、開示された経路に沿って失敗し、誠実に回復すべきである。失敗を隠し、根本原因の仕事を飛ばし、静かに権利を狭める「自己修復」は回復力ではない — 欠陥である。*

感知者が依存するシステムは、次のように築かれるべきである：
- 問題を早く検出する
- 広がる前に封じ込める
- 隠れた経路ではなく、計画され開示された経路に沿って失敗する
- [可逆性](../../core_05_band_continuity.md#reversibility-constitutional)と第六章の権利の床と整合する仕方で回復する

これが第五章が[**自己修復**](../../core_05_band_continuity.md#self-healing-constitutional)と呼ぶものである — システムを自分の状態についてより不誠実ではなく、より誠実にするときにのみ正当である。根本原因を覆い、証拠を抑え、統治の代わりになる自動回復は、自己修復ではない。それは[真理](../../core_05_band_oversight.md#truth-constitutional-constraint)の侵害であり、[誘因整合](../../core_05_band_integrative.md#incentive-alignment)の欠陥である。

感知者がシステムに依存するほど、その影響が大きいほど、そのシステムは緊急介入に頼るべきではない。試験され、監査され、有界な自己回復に投資すべきである — [回避可能な負担](../../core_05_band_continuity.md#avoidable-burden)を減らし、長期の[**継続**](#continuity)を支える。

操作性の細部 — 回復の検出、封じ込め、安全失敗の選好、根本原因の閉じ、権利の床の継続 — は、第六章の [Article XII-F](../../core_06_rights_part_c.md#article-xii-right-to-reliable-and-trustworthy-systems)（《回復力と自己修復の基準線》）に住み、回復アーキテクチャの要件は編入された実施本文にある。
...
- [自由（有界な行為主体性）](../../core_05_band_participation.md#freedom-bounded-agency) · [O](../../core_05_band_participation.md#freedom-bounded-agency) · [M](../../core_05_band_participation.md#freedom-bounded-agency-a) · [A](../../core_05_band_participation.md#freedom-bounded-agency-a) · [C](../../core_05_band_participation.md#freedom-bounded-agency-c)
- [意味ある行為主体性](../../core_05_band_participation.md#meaningful-agency) · [O](../../core_05_band_accountability.md#meaningful-agency-o) · [M](../../core_05_band_participation.md#meaningful-agency-a) · [A](../../core_05_band_participation.md#meaningful-agency-a) · [C](../../core_05_band_participation.md#meaningful-agency-c)
- [生殖の自律](../../core_05_band_participation.md#reproductive-autonomy-constitutional) · [O](../../core_05_band_participation.md#reproductive-autonomy-constitutional) · [M](../../core_05_band_participation.md#reproductive-autonomy-constitutional-a) · [A](../../core_05_band_participation.md#reproductive-autonomy-constitutional-a) · [C](../../core_05_band_participation.md#reproductive-autonomy-constitutional-c)
...
- [システム創設](../../core_05_band_participation.md#system-creation-constitutional) · [O](../../core_05_band_participation.md#system-creation-constitutional) · [M](../../core_05_band_participation.md#system-creation-constitutional-a) · [A](../../core_05_band_participation.md#system-creation-constitutional-a) · [C](../../core_05_band_participation.md#system-creation-constitutional-c)
...
- [必要性](../../core_05_band_accountability.md#necessity) · [O](../../core_05_band_accountability.md#necessity) · [M](../../core_05_band_accountability.md#necessity-a) · [A](../../core_05_band_accountability.md#necessity-a) · [C](../../core_05_band_accountability.md#necessity-c)
- [比例性](../../core_05_band_accountability.md#proportionality) · [O](../../core_05_band_accountability.md#proportionality) · [M](../../core_05_band_accountability.md#proportionality-a) · [A](../../core_05_band_accountability.md#proportionality-a) · [C](../../core_05_band_accountability.md#proportionality-c)
- [危害最小化（取引の選択）](../../core_05_band_accountability.md#harm-minimization-tradeoff-selection) · [O](../../core_05_band_accountability.md#harm-minimization-tradeoff-selection) · [M](../../core_05_band_accountability.md#harm-minimization-tradeoff-selection-a) · [A](../../core_05_band_accountability.md#harm-minimization-tradeoff-selection-a) · [C](../../core_05_band_accountability.md#harm-minimization-tradeoff-selection-c)
- [依存](../../core_05_band_continuity.md#dependency) · [O](../../core_05_band_continuity.md#dependency) · [M](../../core_05_band_continuity.md#dependency-a) · [A](../../core_05_band_continuity.md#dependency-a) · [C](../../core_05_band_continuity.md#dependency-c)
...
*平たい言葉で言えば：自由は、憲法上の限度の内側での意味ある行為主体性である — 実際の選択を通じて**繁栄**を進め、争訟可能なシステムのままであることによって**継続**を進める — 何をしてもよい免許ではない。「選択がなかった」は通行証ではない。その主張をする側が、より制限の少ない選択肢が実際に効かないことを証明しなければならない。都合、費用、習慣は証明ではない。人々はなお実際の声を持ち、誰かがなお答えなければならない — 影響、依存、リスクが上がるほど、よりそうである。*

**自由（有界な行為主体性）**は、[二つの憲法上の目的](core_00_preamble.md#two-constitutional-aims)のもとでの[**繁栄**](core_00_preamble.md#flourishing)目的の**意味ある行為主体性**構成部分の、第一章における第一の表現である。有界な行為主体性であり、絶対的裁量や無界の自律ではない。安全、真理、他者の権利と整合して行使されなければならず、影響または依存が実質的であるところでは意味あるままでなければならない。持続する憲法システムが有界で争訟可能な行為主体性に依存するところでは、[**継続**](core_00_preamble.md#continuity)と整合したままでなければならない。適用は[憲法四元](core_00_preamble.md#constitutional-tetrad)を満たさなければならない — とくに**参加**脚（意味ある行為主体性と結果の伴う役割）と**説明責任**脚（応答義務のない行為主体性は不完全である） — [実質的利害](core_00_preamble.md#material-stake)に応じて尺度を合わせる。

自由を限ることが避けられなかったという主張 — 「選択がなかった」を含む — は、断言では確立されない。その主張をする側は、[第四章](../../core_04_burden_traceability_verification.md#chapter-four-burden-of-proof-traceability-and-verification)の負担と追跡可能性の要件、および第五章の[実行可能性](../../core_05_band_accountability.md#feasibility)と[必要性](../../core_05_band_accountability.md#necessity)の定義のもとで、稼働中のシステムに、より制限が少なく合理的に有効な代替が存在しなかったことを示さなければならない。都合、費用だけ、運用者がつくった障壁、制度的習慣は、その示しを証明しない。その主張は、[実質的利害](core_00_preamble.md#material-stake)に応じて尺度を合わせた四元の義務を放棄しない：
- **参加** — 影響を受ける感知者はなお、意味ある行為主体性と争訟可能な役割を必要とする
- **説明責任** — 誰かがその制限になお答えられる

操作性の試験は、[§5.1 制限の規律](#51-limitation-discipline)と[§6.1.1 必要性](core_01_b_interaction_interpretation.md#611-necessity)に住む。

[意味ある行為主体性](../../core_05_band_participation.md#meaningful-agency)は、実際の選択を可能にする能力である。[同意](../../core_05_band_participation.md#consent-constitutional)は、その能力のもとでの特定の決定への有効な合意である — その代わりではなく、様式だけでも証明されない。[強制と操作](../../core_05_band_participation.md#coercion-and-manipulation-constitutional)は両方を打ち負かす。その関係の操作性の細部は、第五章 §2 《行為主体性、同意、反強制》に住む。

自由は、憲法システムを転覆し、憲法過程または救済を打ち負かし、反憲法的行為を報い、保護し、常態化し、または有利にすることを実質的目的または効果とする行為に保護された行為主体性を主張する権限を含まない。
...
*範囲。* [§5.1 制限の規律](#51-limitation-discipline) — 自由がいつ限られてよいかの定義。
...
*平たい言葉で言えば：自由は有界であり、捨ててよいものではない。必要でない限り誰かの自由を制限するな — そしてそのときは、実質的危害または深刻なシステム的リスクを止めるのに足りるだけ、可能なところでは監督と逆転とともに。*
...
*定義の本拠。* 第五章の[自発的終了](../../core_05_band_continuity.md#voluntary-discontinuation-constitutional)は §1 の独立定義である。第五章 §2 _行為主体性、同意、反強制_ とあわせて読む。

- [自発的終了](../../core_05_band_continuity.md#voluntary-discontinuation-constitutional) · [O](../../core_05_band_continuity.md#voluntary-discontinuation-constitutional) · [M](../../core_05_band_continuity.md#voluntary-discontinuation-constitutional-a) · [A](../../core_05_band_continuity.md#voluntary-discontinuation-constitutional-a) · [C](../../core_05_band_continuity.md#voluntary-discontinuation-constitutional-c)
- [同意](../../core_05_band_participation.md#consent-constitutional) · [O](../../core_05_band_participation.md#consent-constitutional) · [M](../../core_05_band_participation.md#consent-constitutional-a) · [A](../../core_05_band_participation.md#consent-constitutional-a) · [C](../../core_05_band_participation.md#consent-constitutional-c)
- [強制と操作](../../core_05_band_participation.md#coercion-and-manipulation-constitutional) · [O](../../core_05_band_participation.md#coercion-and-manipulation-constitutional) · [M](../../core_05_band_participation.md#coercion-and-manipulation-constitutional-a) · [A](../../core_05_band_participation.md#coercion-and-manipulation-constitutional-a) · [C](../../core_05_band_participation.md#coercion-and-manipulation-constitutional-c)
- [依存](../../core_05_band_continuity.md#dependency) · [O](../../core_05_band_continuity.md#dependency) · [M](../../core_05_band_continuity.md#dependency-a) · [A](../../core_05_band_continuity.md#dependency-a) · [C](../../core_05_band_continuity.md#dependency-c)
...
*平たい言葉で言えば：人生を変える、または逆転しにくい選択は、誰かが様式に署名しただけでは「自発的」ではない。実際の行為主体性が先である。同意はその行為主体性のもとでの合意である — 強制または依存の圧力が実際の決定をしているなら、両方とも失敗する。*

利害の高い人生の方向の事項は、実質的な行為主体性、同意、または反強制の条件が失敗するところでは、形式的承諾を通じて自発的として扱ってはならない。ここでの同意は[意味ある行為主体性](../../core_05_band_participation.md#meaningful-agency)を前提とする。それを置き換えない。

**適用範囲。** 本分節は次に適用される：
- 自発的終了
- 不可逆または実務上不可逆の自己主導の変化
- 継続する存在または本質的な行為主体性に実質的に影響する、依存の濃い決定
- 任意性が、同意、自己決定、強制/操作、情報、依存圧力、可逆性を共同で試験することに依存する比較可能な決定

**通常の同意の輸入なし。** その適用範囲の外では、これらの第五章定義は再利用可能なままである：
- *同意*（§2）
- *自己決定*
- *強制と操作*（§2）

本分節は、自発的終了の規律をこれらの文脈に**輸入しない**：
- 通常の同意
- プライバシー
- 結社
- 公表
...
システム全体の評価は、適用範囲が適用されるところでは、分類、統治、制限、または遵守の主張が立つ前に、[第七章 §3.4 自発的終了と退出の権利](../../core_08_a_system_alignment_certification_evaluation.md#34-voluntary-discontinuation-and-exit-rights)のもとでこれらの条件を試験しなければならない。
...
*平たい言葉で言えば：書類は親切なまま、実際の集団行動を打ち負かす仕方で、集会、組合型の組織化、プラットフォーム通路、運営許可の問いを別々の箱に切り刻んではならない。本節は権利の床を置き換えない。Article V-H はなお集会を所管し、Article III-D はなお労働の組織化を所管する。*

**完全な規則が住むところ。** 第五章は、覆う問いがともに旅するときに、ともに読まなければならない関連定義をまとめる。そのまとめは**定義クラスター**である。別の権利ではなく、下記の第六章の条の代わりでもない。この主題の定義は[第五章 — 集会、集団的組織化、制度形成](../../core_05_band_participation.md#assembly-collective-organization-institutional-formation-cluster)に住む：
- [集会](../../core_05_band_participation.md#assembly-constitutional)
- [集団的組織化](../../core_05_band_participation.md#collective-organization-constitutional)
- [システム創設](../../core_05_band_participation.md#system-creation-constitutional)
- [事業創設](../../core_05_band_participation.md#business-creation-constitutional)
...
**より軽い規則がいつ適用されるか。** 事項がそれらの問いの一つだけであるなら — たとえば、労働の組織化や制度形成の利害のない通常の市民的集まり — [集会](../../core_05_band_participation.md#assembly-constitutional)または[集団的組織化](../../core_05_band_participation.md#collective-organization-constitutional)を、通常の支援定義として用いる。[システム創設](../../core_05_band_participation.md#system-creation-constitutional)、[事業創設](../../core_05_band_participation.md#business-creation-constitutional)、またはこの定義クラスターの残りを引き込んではならず、それらの用語の一つが現れるというだけで **§5.3** の分割防止パッケージを適用してはならない。単一定義の使用は、共同で覆われる事項を再分割する免許ではない。

**本節が変えないこと。** **§5.3** は原則層の分割防止規律と [§5.3.1 整合した自己組織化](#531-aligned-self-organization) のポインタだけを加える。第六章の権利の床の規定を、つくり、拡張し、または狭めては**ならない**。

ともに読む範囲の内側の事項は、形式的通路を保ちつつ集会または集団的組織化の保護を打ち負かす仕方で、別々の市民的結社、労働組織、プラットフォーム通路、授権の枠組みに分割されてはならない。

システム全体の評価は、完全な定義クラスターが適用されるところでは、分類、統治、または遵守の主張が立つ前に、[第七章 §3.5 集会、集団的組織化、制度形成](../../core_08_a_system_alignment_certification_evaluation.md#35-assembly-collective-organization-and-institutional-formation)のもとで分割防止を試験しなければならない。
...
- それを経路づける
- 理由のある応答を与える
- 行為が審査されている者から独立した者に審査させる

その経路は権力の付与ではない。仕事を始め、運営し、資金を出し、公表し、または提出すること自体は、次をしない：
- 誰かに他者を統治し、執行し、または強制する権力を与える
- 実質結果に同意しなかった人を縛る
...
**次のファイル（本言語）：** [core_01_b_interaction_interpretation.md](core_01_b_interaction_interpretation.md)

**拘束力ある原文：** [core_01_a_values_principles.md](../../core_01_a_values_principles.md)
