...
>
> یہ فائل [انگریزی باب یازدهم](../../core_11_forum.md) کا **قارئین کی زبان کا پائلٹ** ہے۔ یہ شعوری آئین کا **پابند حصہ نہیں**۔ یہ **دوسرا آئین نہیں**۔ یہ **ارسال ایڈیشن نہیں**۔ یہ `SC-Corpus-2026.08.09` پر **پن** ہے۔ اگر یہ ترجمہ اور انگریزی اصل میں اختلاف نظر آئے تو نمبر والی [`core_11_forum.md`](../../core_11_forum.md) جیتتی ہے۔ پڑھنے کا ترتیب اور ایڈیشن میٹاڈیٹا [README.md](../../README.md) میں رہتے ہیں۔ طریقہ اور لغت: [translations/ur/README.md](README.md)۔
>
...
>
> **پچھلا (ابھی انگریزی میں):** [core_10_b_misconduct_pattern_applications.md](../../core_10_b_misconduct_pattern_applications.md#chapter-ten-part-b-anti-constitutional-misconduct-pattern-applications)
>
> **اگلا (ابھی انگریزی میں):** [core_08-11_application_vignettes.md](../../core_08-11_application_vignettes.md#chapters-eight-eleven-application-vignettes)
...
- زیریں: [corpus_forum.md](../../corpus_forum.md) (*عملی فورم عقیدہ*)؛ [باب دوازدہم](../../core_12_governance.md#chapter-twelve-constitutional-contract-legitimacy-authorization-and-stewardship) جہاں حکمرانی مشروعیت فیصلہ جاتی کردار سے ملتی ہے؛ [باب شانزدہم](../../core_16_incorporation.md#chapter-sixteen-incorporation-bridge) (*اختیار شدہ طریقہ کار تہوں کے لیے شمولیت ضبط*)۔
...
- **سالمیت**، **آئینی**، اور **ماحول** فورم، اور **تکنیکی فورم دائرے** جب وہ شعوریت کی حیثیت کا فیصلہ سنیں، [باب دوازدہم §1.2](../../core_12_governance.md#12-eligibility-contested-selection-and-democratic-minimums) کے تحت **شائع شدہ**، **چیلنج شدہ**، **قابلِ گردش** تقرری یا مساوی آزادی جانچ مانگتے ہیں۔ ان بینچوں کی کم تقرری یا کم فنڈنگ [باب نہم §9](core_09_standing_integration.md#9-enforcement-realism) ناکامی ہے۔
...
**نظام بھر** بجٹ، کراس کٹنگ تحقیقی فنڈنگ، اور حکمرانی-پیمانہ پروگرام [باب دوازدہم — حکمرانی](../../core_12_governance.md#chapter-twelve-constitutional-contract-legitimacy-authorization-and-stewardship)، **[corpus_systems.md](../../corpus_systems.md)**، اور دیگر فوقیت قواعد کے تابع رہتے ہیں جہاں لاگو ہوں۔ ادائیگی، لاگت قواعد، اور ملتے جلتے محرک اوزار ان کی **جگہ نہیں** لے سکتے:
...
- زیریں: [§6](#6-timely-resolution-materiality-tiers-and-anti-delay-discipline) (*مادیت درجات اور تاخیر مخالف ضبط*)؛ [§7](#7-forum-support-before-during-and-after-review) (*بلندی اور سرٹیفیکیشن کے لیے چیلنج کے قابل فورم سہارا*)؛ [باب شانزدہم](../../core_16_incorporation.md) (* **دفعہ V-E** (*شعوریت کی حیثیت کے فیصلے کی تہہ*) نفاذ ڈیزائن کے لیے نفاذ رخ بندی*)۔
...
**پچھلی فائل (ابھی انگریزی میں):** [core_10_b_misconduct_pattern_applications.md](../../core_10_b_misconduct_pattern_applications.md#chapter-ten-part-b-anti-constitutional-misconduct-pattern-applications)

**اگلی فائل (ابھی انگریزی میں):** [core_08-11_application_vignettes.md](../../core_08-11_application_vignettes.md#chapters-eight-eleven-application-vignettes)

**پابند اصل:** [core_11_forum.md](../../core_11_forum.md)
