...
**معیارات حراست۔** **تکنیکی فورم دائرے** جائزے کے قابل معیارات رکھتے ہیں جو [تمہید §2](core_00_preamble.md#2-measurements-overview) پیمائش اقسام اور [باب پنجم](core_05__definitions_home.md#chapter-five-foundational-definitions) تعریف گھروں کو عملی بناتے ہیں — بشمول نظام ہم آہنگی جانچنے والے معیارات — جائز دائرے میں:
- پیمائش طریقے؛
- جانچ پروٹوکول؛
- ماہر-ثبوت معیارات؛
- تکنیکی وضاحتیں؛
