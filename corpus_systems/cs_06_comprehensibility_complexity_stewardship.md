# CS-6: Comprehensibility and complexity stewardship
...
>
> This file is **binding incorporated implementation text** where [`corpus_systems.md`](../corpus_systems.md) is incorporated under [Chapter Seventeen](../core_17_incorporation.md). It must satisfy the Sentient Constitution and does not override or narrow it. It holds **CS-6** (*Comprehensibility and complexity stewardship*).
>
...
*In plain terms: what this file covers, which constitutional text it implements, and what to read alongside it.*
