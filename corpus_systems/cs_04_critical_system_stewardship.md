...
**Role-scoped observability and silence.** This log follows the work of the role, not the steward as an individual — human or AI. It implements, and must not narrow, [Chapter One §10.3](../core_01_c_stewardship_capacity_principles.md#103-role-scoped-observability) (*Role-scoped observability*):
