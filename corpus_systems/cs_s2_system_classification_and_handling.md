...
Where ambiguity exists, default to the level that protects **Foundational Rights** (**Chapter Ten, Articles V through IX**), subject to **CJS-5.11** (*distributed and proportional authority terms*) and **CJS-5.7** (*quorum and participatory legitimacy terms*).
