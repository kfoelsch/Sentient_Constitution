...
> - Steward next-step screen, self-application sitting, and first-adopter kit (process support; **cannot narrow** this layer or core text; not a second CS front door; not adoption): [`implementation/STEWARD_ENTRY_DOORS.md`](../implementation/STEWARD_ENTRY_DOORS.md); [`evaluation/self_application/`](../evaluation/self_application/); [`implementation/FIRST_ADOPTER_KIT.md`](../implementation/FIRST_ADOPTER_KIT.md).
