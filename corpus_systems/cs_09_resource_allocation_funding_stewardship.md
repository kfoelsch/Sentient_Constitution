...
- consider the availability of alternative providers;
- consider the impact of underfunding on system integrity.
...
Systems must maintain a documented representation of their material dependencies and dependents (“dependent systems map”).
...
- be aggregated across the ecosystem where feasible;
...
- disclose allocation logic and distribution mechanisms;
...
Funding structures must:
- be designed to resist excessive concentration of resources and self-reinforcing allocation loops;
- resist mechanisms that entrench power or exclude new participants;
- resist dependencies on singular or highly concentrated funding sources where such dependencies may compromise constitutional alignment.

**Systems must**:
- monitor for funding imbalances;
- disclose emerging concentration risks;
...
**Systems must**:
- avoid perpetual revenue claims disconnected from ongoing contribution;
- avoid funding structures that concentrate long-term control or influence;
...
- include a defined transition or grace period proportionate to the scale, impact, and dependency of the system;
- allow affected participants time to adapt, exit, or renegotiate.

**Where feasible, systems should**:
- implement time-bound funding commitments;
- implement vesting or decay-based allocation models;
...
- assess effectiveness and fairness;
- remain open to modification or replacement.
...
- define how participation is structured;
- define how outcomes are determined.
...
No default allocation model is permanent or universally required.
...
One such reference model includes:
- a portion allocated to builders and maintainers over a defined period;
- a portion reserved for ongoing system sustainability and upgrades;
...
- consider **operations, security, and upgrades: 30–50%**;
...
**Where disparities in incentives emerge**, mechanisms should:
- be considered to provide supplemental support to substrate systems;
- recognize their foundational role in enabling higher-layer value creation;
...
Systems that operate at higher layers (e.g., applications, tools, creative systems, and local coordination environments) may adopt more flexible funding models. Those models may **incentivize innovation and rapid iteration**. They may **reward builders and contributors more directly**. They may **allow for competitive and diverse allocation structures**.
...
**All changes must**:
- **remain consistent with [Constitutional Constraints](../core_05_band_integrative.md#constitutional-constraint)**;
...
Where humans hold authority over allocation, enforcement, classification, or oversight, structures must **mitigate personal enrichment** from decisions those same roles approve, delay, or fail to rectify.
