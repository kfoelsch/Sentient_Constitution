...
**8. Self-healing under decentralized continuity (Article XII-F implementation profile).** This section applies **Protocol A**, subsection **H** (*Self-healing and recovery-path integrity*) to the four continuity modes defined in section **1** — **Normal**, **Degraded-Partitioned**, **Offline-Sovereign**, and **Rejoin-Reconciliation**. It is not a second self-healing profile. Detection, containment, safe-failure preference, non-masking, Rights-Floor continuity, autonomy scaling, and root-cause closure remain governed by Protocol A subsection **H**, **Sentient Constitution Chapter Ten, Article XII-F**, **Chapter One §10.1**, and **Chapter Five** [*Self-Healing*](../core_05c_continuity_definitions.md#self-healing-constitutional). This section adds only the decentralized-continuity cross-checks below.
