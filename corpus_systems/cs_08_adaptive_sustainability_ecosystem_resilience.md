# CS-8: Adaptive sustainability and ecosystem resilience
...
>
> This file is **binding incorporated implementation text** where [`corpus_systems.md`](../corpus_systems.md) is incorporated under [Chapter Seventeen](../core_17_incorporation.md). It must satisfy the Sentient Constitution and does not override or narrow it. It holds **CS-8** (*Adaptive sustainability and ecosystem resilience*).
>
...
<a id="33-uncertainty-and-multi-cause-conditions"></a>
### 3.3 Uncertainty and multi-cause conditions
...
- Root-cause analysis under **§3.1** must not let adaptive reallocation suppress, overwrite, obscure, or repeatedly silence the fault signals that triggered it. Recurrence across cycles remains a single open root-cause obligation under **§3.1** and **Article XXI-A** (*Diagnostic Rigor and Causal Attribution*).
...
**Previous file:** [cs_07_justice_safeguards_restitution_rehabilitation.md](cs_07_justice_safeguards_restitution_rehabilitation.md)

**Next file:** [cs_09_resource_allocation_funding_stewardship.md](cs_09_resource_allocation_funding_stewardship.md)
