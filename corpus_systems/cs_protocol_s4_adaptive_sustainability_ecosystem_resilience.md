...
**H. Governance integration.** Adaptive allocation remains subject to **Article XV-A** (*Auditability and Observable Evidence*), **Article XVI-A** (*Lifecycle Governance and Environment Separation*), and **Article XII-B** (*Right to Challenge, Review, and Redress*) where auditability, lifecycle governance, or challenge rights are implicated. No automated or adaptive mechanism may override [Constitutional Constraints](../core_05_band_integrative.md#constitutional-constraint) or eliminate auditability or contestability.
