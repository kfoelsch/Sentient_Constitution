...
> Maintainer and audit surface. Stable row IDs (**CJS-R01** (*Delegated binding bodies and hybrid composition (non-forum institutions)*)–**CJS-R21** (*Capacity-failure routing*)) are **corpus-local** labels; they are **not** Sentient Constitution article numbers.
