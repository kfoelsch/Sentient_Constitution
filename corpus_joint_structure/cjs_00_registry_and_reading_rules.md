...
>
> **Status**
> - This is **not** a core constitutional file. It is still part of the constitutional **Corpus** where [Chapter Five](../core_05_band_integrative.md#corpus) and [Chapter Seventeen](../core_17_incorporation.md#chapter-seventeen-incorporation-bridge) say implementation text is binding when adopted.
...
| **CJS-R02** | Forum chambers, divisions, and designated panels (Chapter Twelve families) | [**CF-3.5**–**CF-3.8**](../corpus_forum/cf_03_forum_formation_chamber_structure.md) | **CJS-2.1**, **CJS-2.5**, **CJS-3.13** (*Accountability: procedural integrity and adjudication terms*); [**CI-9.3**](../corpus_institutions/ci_09_classification_linked_institutional_obligations.md); [**CS-3**](../corpus_systems/cs_03_a_system_classification_machinery.md), **CS-4 — Critical system stewardship**; `core_12_forum.md` **Chapter Twelve** |
| **CJS-R03** | Lawful panel formation, disclosure, recusal, substitution, inability-to-form | [**CF-4**](../corpus_forum/cf_04_panel_formation_disclosure_recusal_bench_constitution.md) | **CJS-2.5**, **CJS-3.13** (*Accountability: procedural integrity and adjudication terms*); [**CI-4**](../corpus_institutions/ci_04_appointment_competency_rotation_removal.md), **CI-5**; `core_10_standing_integration.md` **Chapter Ten §5.5** (*Special locks*), **§6.2** (*Competency bars and clearances*), and **§8** (*Restoration and reassessment*); `core_12_forum.md` **Chapter Twelve**; the CJS implementation layer **CJS-3.13 — Procedural Integrity and Adjudication** |
| **CJS-R04** | Routing, intake, transfer, certification, representative treatment | [**CF-5**](../corpus_forum/cf_05_routing_operations_transfer_certification_representative_treatment.md) | **CJS-2.5**, **CJS-3.13** (*Accountability: procedural integrity and adjudication terms*); `core_12_forum.md` **Chapter Twelve**; [**CI-8**](../corpus_institutions/ci_08_transparency_participation_accessible_pathways.md) |
...
| **CJS-R06** | Forum integrity operations, anti-capture, anti-self-judging support | [**CF-7**](../corpus_forum/cf_07_integrity_safeguards_anti_capture_anti_self_judging.md) | [**CI-5**](../corpus_institutions/ci_05_conflict_integrity_anti_capture_anti_corruption.md), **CI-7.3**; `core_12_forum.md` **Chapter Twelve** |
...
| **CJS-R20** | Remedy parity and lock-to-remedy capacity | [**CI-27**](../corpus_institutions/ci_27_remedy_systems_institutional_redress_capacity.md) | [**CF-11**](../corpus_forum/cf_11_performance_backlog_publication_accessibility.md); `core_10_standing_integration.md` **Chapter Ten §4.4** (*Remedy parity and lock preconditions*) and **§9.2** (*Remedy-parity funding floor*); `core_12_forum.md` **Chapter Twelve** capacity-failure routing |
| **CJS-R21** | Capacity-failure routing | [**CF-5**](../corpus_forum/cf_05_routing_operations_transfer_certification_representative_treatment.md) | [**CF-11**](../corpus_forum/cf_11_performance_backlog_publication_accessibility.md); [**CI-27**](../corpus_institutions/ci_27_remedy_systems_institutional_redress_capacity.md); `core_12_forum.md` **Chapter Twelve §3** capacity-failure routing; `core_10_standing_integration.md` **Chapter Ten §4.4** |
| **CJS-R22** | Standing-record custody, opening authority, and segregation of duties | [**CI-3**](../corpus_institutions/ci_03_institutional_design_separation_of_powers.md) (*CI-3.2 lane map — the fallback when a Charter is silent; CI-3.6 Charter field — standing-record custody*) | **CJS-3.11** (*Accountability: distributed and proportional authority terms — Constitutional lane and functional separation; segregation of duties*); [**CF-9**](../corpus_forum/cf_09_independent_investigative_service_prosecution_interface.md) (*CF-9.6 / CF-9.8 independent verifier when the operator is the subject*); **CS-4 — Critical system stewardship** (*§10 logging is not record entry*); `core_09_standing_assessment.md` **Chapter Nine §3.7** (*Record custody and opening authority*); `core_05_band_continuity.md` **Chapter Five** (*Charter*) |
| **CJS-R23** | Seat types, local role maps, and wrong-seat routing | [**CI-4**](../corpus_institutions/ci_04_appointment_competency_rotation_removal.md) (*CI-4.6 seat catalog — the nine seat types, their operational boundaries, and the wrong-seat rule; CI-4.5 role maps instantiate them*) | **CJS-3.0** (*Cross-band: Role-definition preface*); **CJS-3.11** (*Accountability: distributed and proportional authority terms — Constitutional lane and functional separation*); [**CI-3**](../corpus_institutions/ci_03_institutional_design_separation_of_powers.md) (*CI-3.2 lane map places the seats; CI-3.3 delegation keeps the boundary*); **CS-4 — Critical system stewardship** (*§10 the "who authorized" element names the seat*); `core_01_c_stewardship_capacity_principles.md` **Chapter Seven §2** (*Segregation of duties*); `core_13_governance.md` **Chapter Thirteen**, section **5** (*Authorized roles*) |
