...
> Maintainer and audit surface. Stable row IDs (**CJS-R01** (*Delegated binding bodies and hybrid composition (non-forum institutions)*)–**CJS-R22** (*Standing-record custody and opening authority*)) are **corpus-local** labels; they are **not** Sentient Constitution article numbers.
...
| **CJS-R22** | Standing-record custody and opening authority | [**CI-3**](../corpus_institutions/ci_03_institutional_design_separation_of_powers.md) (*CI-3.6 Charter field — standing-record custody*) | [**CF-9**](../corpus_forum/cf_09_independent_investigative_service_prosecution_interface.md) (*CF-9.6 / CF-9.8 independent verifier when the operator is the subject*); **CS-4 — Critical system stewardship** (*§10 logging is not record entry*); `core_08_standing_assessment.md` **Chapter Eight §3.7** (*Record custody and opening authority*); `core_05_band_continuity.md` **Chapter Five** (*Charter*) |
