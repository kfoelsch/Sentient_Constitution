...
**CJS-2** states the joint interlocks. Local operative rules remain in the companion that owns the domain:
...
|---|---|
| [**CJS-2.1**](#cjs-21-hybrid-delegated-authority-delegated-binding-bodies) (*Hybrid delegated authority*) | Who sits on delegated binding bodies, and how attachment durations are published |
| [**CJS-2.3**](#cjs-23-cross-implementation-trust-integrity-joint-operation-model) (*Cross-implementation trust integrity*) | A trust claim fails if any file in the same chain still blocks observation, verification, or challenge |
| [**CJS-2.4**](#cjs-24-class-scaled-lane-staffing-and-competency-redundancy) (*Class-scaled lane staffing*) | High-impact lanes need enough qualified sentients, backup, and spread of knowledge |
| [**CJS-2.5**](#cjs-25-shared-procedural-abstractions-for-delegated-bodies-and-forum-routing) (*Shared procedural abstractions*) | Shared baseline words for delegated bodies, lawful independent forums, backup routing, and representative treatment |
| [**CJS-1.9**](cjs_06_support_hosting_classification.md#cjs-19-boundary-between-support-roles-and-merits-decisions)–[**CJS-1.11**](cjs_06_support_hosting_classification.md#cjs-111-classification-alignment-for-supervised-scope) (*Support, hosting, classification*) | Support roles must not decide merits; hosting a forum does not control it; published class must match how the system is run |
...
<a id="cjs-21-hybrid-delegated-authority-delegated-binding-bodies"></a>
<details>
<summary><strong><span style="color: #2563eb;">Trace</span></strong></summary>
...
In everyday reading: publish how long rotating members serve, how home-member terms work, and that those lengths are not changed in secret. Sample formulas are illustrations unless a **primary owner** makes them mandatory. Home-based term rules do not need to copy rotating attachment rules.

## CJS-2.3 Cross-implementation trust integrity (joint operation model)
<a id="cjs-23-cross-implementation-trust-integrity-joint-operation-model"></a>
<details>
<summary><strong><span style="color: #2563eb;">Trace</span></strong></summary>
...
<a id="cjs-24-class-scaled-lane-staffing-and-competency-redundancy"></a>
<details>
<summary><strong><span style="color: #2563eb;">Trace</span></strong></summary>
...
For **CI-9.3** (*Delegated subunits, institutional design class, and attachment discipline*), a **delegated subunit** is the institutional application of **Delegated binding body**: a standing or recurring internal body — a division, chamber, committee, designated panel, or regional or functional office with decision rights — that exercises materially binding delegated authority for the parent institution and is not the institution's sole governing plenary.

Forum-specific detail, including forum families, routing, appeals, and specialist chamber doctrine, remains in [**CF-3**](../corpus_forum/cf_03_forum_formation_chamber_structure.md) (*Forum formation, forum-structure mapping, and chamber structure*) and related **CF** sections. Where **CF-3.6** (*Chamber authority composition and service mechanics*) states forum-specific delegated-authority duties or illustrations, **CF** text governs for **Chapter Twelve** forums. Where **CI** and **CF** obligations overlap, the stricter clearly adopted rule governs under [Chapter One §8.4.3](../core_01_b_interaction_interpretation.md#843-incorporation-layer) (*Incorporation layer*, including cross-file stricter-wins).
...
**Previous file:** [cjs_05_odef_parse_mechanics.md](cjs_05_odef_parse_mechanics.md)

**Next file:** [cjs_06_support_hosting_classification.md](cjs_06_support_hosting_classification.md)
