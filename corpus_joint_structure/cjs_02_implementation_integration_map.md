...
|--------|--------|---------------|---------------------|
| **CJS-R01** | Delegated binding bodies and hybrid composition (non-forum institutions) | `corpus_institutions.md` **CI-9.3** | **CJS-4.1**, **CJS-4.7**, **CJS-5A.6**; `corpus_systems.md` **Chapter S2**, **Chapter S3**; `corpus_institutions.md` **CI-2**; the CJS implementation layer **CJS-5A.1 and CJS-5C.1 — Distributed and Proportional Authority**, **CJS-5A.4 — Burden of Justification and Constraint** (as cited in owner text) |
| **CJS-R02** | Forum chambers, divisions, and designated panels (Chapter Nine families) | `corpus_forum.md` **CF-2.5**–**CF-2.8** | **CJS-4.1**, **CJS-4.7**, **CJS-5A.6**; `corpus_institutions.md` **CI-9.3**; `corpus_systems.md` **Chapter S2**, **Chapter S3**; `core_09-09_forum.md` **Chapter Nine** |
...
| **CJS-R07** | Forum forensic and analytical support | `corpus_forum.md` **CF-7** | `corpus_institutions.md` **CI-7**, **CI-7.3** |
| **CJS-R08** | Independent investigative service and prosecution interface | `corpus_forum.md` **CF-8** | `corpus_institutions.md` **CI-8** |
| **CJS-R09** | Technical forums and specialist chambers | `corpus_forum.md` **CF-9** | `corpus_institutions.md` **CI-17**; `core_09-09_forum.md` **Chapter Nine** |
...
| **CJS-R11** | Forum continuity | `corpus_forum.md` **CF-11** | `corpus_systems.md` **Protocol A — System Design, Testing, Verification, and Deployment**; `corpus_institutions.md` **CI-14** (where transition or continuity interfaces apply); `core_09-09_forum.md` **Chapter Nine** |
...
| **CJS-R13** | Forum staffing, shared administration, structural review, structural records | `corpus_forum.md` **CF-15** | `corpus_institutions.md` **CI-4**, **CI-5**; **CI-9.3** where delegated forum subunits apply |
