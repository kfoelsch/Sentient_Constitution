...
| **CJS-R02** | Forum chambers, divisions, and designated panels (Chapter Nine families) | `corpus_forum.md` **CF-3.5**–**CF-3.8** | **CJS-4.1**, **CJS-4.5**, **CJS-5.13** (*Accountability: procedural integrity and adjudication terms*); `corpus_institutions.md` **CI-9.3**; `corpus_systems.md` **CS-4 — System classification and handling**, **CS-5 — Critical system stewardship**; `core_09-09_forum.md` **Chapter Nine** |
| **CJS-R03** | Lawful panel formation, disclosure, recusal, substitution, inability-to-form | `corpus_forum.md` **CF-4** | **CJS-4.5**, **CJS-5.13** (*Accountability: procedural integrity and adjudication terms*); `corpus_institutions.md` **CI-4**, **CI-5**; `core_09-09_forum.md` **Chapter Nine**; the CJS implementation layer **CJS-5.13 — Procedural Integrity and Adjudication** |
| **CJS-R04** | Routing, intake, transfer, certification, representative treatment | `corpus_forum.md` **CF-5** | **CJS-4.5**, **CJS-5.13** (*Accountability: procedural integrity and adjudication terms*); `core_09-09_forum.md` **Chapter Nine**; `corpus_institutions.md` **CI-8** |
