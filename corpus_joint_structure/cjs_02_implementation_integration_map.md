...
| **CJS-R03** | Lawful panel formation, disclosure, recusal, substitution, inability-to-form | `corpus_forum.md` **CF-3** | **CJS-4.7**, **CJS-5A.6**; `corpus_institutions.md` **CI-4**, **CI-5**; `core_09-09_forum.md` **Chapter Nine**; the CJS implementation layer **PROT6 — Procedural Integrity and Adjudication** (**CP-PCH4**) |
...
| **CJS-R05** | Appeal, secondary review, exhaustion | `corpus_forum.md` **CF-5** | `corpus_institutions.md` **CI-6**; **CP-PCH4 — PROT Governance Labels** (including **PROT6 — Procedural Integrity and Adjudication**) |
