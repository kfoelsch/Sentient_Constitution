...
|--------|--------|---------------|---------------------|
| **CJS-R01** | Delegated binding bodies and hybrid composition (non-forum institutions) | `corpus_institutions.md` **CI-9.1B** | **CJS-4.1**, **CJS-4.7**, **CJS-5.21**; `corpus_systems.md` **Chapter S2**, **Chapter S3**; `corpus_institutions.md` **CI-2**; the CJS implementation layer **PROT1 — Distributed and Proportional Authority**, **PROT4 — Burden of Justification and Constraint** (as cited in owner text) |
...
| **CJS-R03** | Lawful panel formation, disclosure, recusal, substitution, inability-to-form | `corpus_forum.md` **CF-3** | **CJS-4.7**, **CJS-5.21**; `corpus_institutions.md` **CI-4**, **CI-5**; `core_09-09_forum.md` **Chapter Nine**; the CJS implementation layer **PROT6 — Procedural Integrity and Adjudication** (Implementation Group Four) |
