...
| **CJS-R10** | Forum performance, backlog requirements, publication timeliness, accessibility | `corpus_forum.md` **CF-11** | `corpus_institutions.md` **CI-7.3**; Sentient Constitution **Article XV** themes in `core_06-06_rights_part_*.md` **Chapter Six** |
