...
When multiple implementation layers apply to the same facts, use this default reading stack: **CJS** joint rules first (**CJS-2.1** and **CJS-3**), then **CS** for system classification and stewardship scale, **CI** for institutional governance and assurance, and **CF** for **Chapter Nine** forum-family doctrine. Within that stack, read only what **CJS-2.1** (*Topic router (stable IDs)*) routes for the topic.
...
- Read implementation obligations through [Chapter One](../core_01_stewardship_capacity_principles.md#chapter-01-principles-and-constraints) — including the [Constitutional Triad](../core_00_preamble.md#constitutional-triad) (**oversight**, **participation**, **accountability** scaled to [material stake](../core_00_preamble.md#material-stake)) and [Two Constitutional Aims](../core_01_values_principles.md#two-constitutional-aims) (**Flourishing** and **Continuity**). Implementation text must not hollow the Triad below material-stake requirements.
