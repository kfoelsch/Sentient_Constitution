...
- section-identifier and parse-mechanics rules for this corpus (**CJS-1.11** through **CJS-1.13**);
- reusable joint operational definitions (**CJS-3** (*operational cluster library*));
- cross-implementation topic routing and domain-specific joint rules (**CJS-0.1**, **CJS-1.6** through **CJS-1.10**, and **CJS-2**). Applicability, combined satisfaction, and stricter-wins for jointly applicable incorporated obligations live in [Chapter One §8.4.4](../core_01_b_interaction_interpretation.md#844-combined-satisfaction) and [Chapter One §8.4.3](../core_01_b_interaction_interpretation.md#833-incorporation-layer).
...
- Downstream: **CJS-1.1**; **CJS-1.2**; [CJS-0.1](cjs_00_registry_and_reading_rules.md#cjs-01-cross-file-routing); **CS-1**; **CI-1**; **CF-1**.
...
- Read with: **CJS-1.1**; [CJS-0.1](cjs_00_registry_and_reading_rules.md#cjs-01-topic-router-stable-ids); **CJS-1.8**–**CJS-1.10**; **CJS-3**; **CJS-1.2**.
...
|------------------------|---------|
| Apply more than one of **CJS**, **CS**, **CI**, and **CF** to the same facts | **Default reading stack:** **CJS** first ([Chapter One §8.4.4](../core_01_b_interaction_interpretation.md#844-combined-satisfaction) combined satisfaction and [Chapter One §8.4.3](../core_01_b_interaction_interpretation.md#833-incorporation-layer) stricter-wins; domain-specific joint rules in **CJS-1.8**–**CJS-1.10**; topic ownership via [CJS-0.1](cjs_00_registry_and_reading_rules.md#cjs-01-cross-file-routing) and owner-file Trace), then **CS** (system classification and stewardship scale), then **CI** (institutional governance and assurance), then **CF** (Chapter Eleven forum-family doctrine). Within that order, read only what the topic routing for the facts requires. Editors and auditors use **CJS-0.1** for the authoritative row table. |
...
| Look up a shared cross-layer how-to term | Use **CJS-3** for reusable joint operational definitions; coordinate reads through [CJS-0.1](cjs_00_registry_and_reading_rules.md#cjs-01-cross-file-routing) and **CJS-1.2**. These terms cover routing, interlock, overlap, and shared-fact evaluation — they are not constitutional definitions. Combined satisfaction and stricter-wins live in [Chapter One §8.4.4](../core_01_b_interaction_interpretation.md#844-combined-satisfaction) and [Chapter One §8.4.3](../core_01_b_interaction_interpretation.md#833-incorporation-layer). |
| Place or parse joint operational text | Do not redefine constitutional terms — see **CJS-1.2**. How to read **OP-O** / **OP-E** / **OP-C** cluster lines: **CJS-1.12** and **CJS-1.13**. Where to put a definition: constitutional terms in **Chapter Five**; reusable joint fit-together terms in **CJS-3**; two-tier shared ideas under **CJS-1.7** (editors/auditors). |
...
## CJS-1.6: Intentional overlap (non-duplication discipline)

<a id="cjs-16-intentional-overlap-non-duplication-discipline"></a>
<details>
<summary><strong><span style="color: #2563eb;">Trace</span></strong></summary>

- Upstream: [CJS-1.2](cjs_01_scope_purpose_boundary_interface.md#cjs-12-shared-implementation-corpus-preamble-contract) shared implementation-corpus contract; [CJS-0.1](cjs_00_registry_and_reading_rules.md#cjs-01-topic-router-stable-ids) topic router; [Chapter Sixteen](../core_16-16_incorporation.md#chapter-sixteen-incorporation-bridge) incorporation discipline and [Chapter Five](../core_05__definitions_home.md#chapter-five-foundational-definitions) canonical definitions.
- Read with: **CJS-1.6**; [CJS-0.1](cjs_00_registry_and_reading_rules.md#cjs-01-topic-router-stable-ids).
...
- do **not** restate **CJS-3** (*Implementation and cross-implementation operational cluster library*) OP clusters, **CS-2/CS-3** tables, or **CF-** / **CI-** checklists except in brief **quote** or **summary pointer** form when needed for coherence.
...
## CJS-1.7: Two-tier definition contract (binding abstraction + owner detail)

<a id="cjs-17-two-tier-definition-contract-binding-abstraction--owner-detail"></a>
<details>
<summary><strong><span style="color: #2563eb;">Trace</span></strong></summary>
...
- Read with: **CJS-1.8**; **CJS-3.13** (*Accountability: procedural integrity and adjudication terms*); [Merits Determination](../core_05_band_accountability.md#merits-determination).
...
## CJS-1.9: Institution-hosted or forum-adjacent operations
<a id="cjs-19-institution-hosted-or-forum-adjacent-operations"></a>
...
## CJS-1.10: Classification alignment for supervised scope
<a id="cjs-110-classification-alignment-for-supervised-scope"></a>
...
## CJS-1.11: Section identifiers and article references
<a id="cjs-111-section-identifiers-and-article-references"></a>
<details>
<summary><strong><span style="color: #2563eb;">Trace</span></strong></summary>

- Upstream: [CJS-1.2](cjs_01_scope_purpose_boundary_interface.md#cjs-12-shared-implementation-corpus-preamble-contract) shared implementation-corpus contract; [CJS-0.1](cjs_00_registry_and_reading_rules.md#cjs-01-topic-router-stable-ids) topic router; [Chapter Sixteen](../core_16-16_incorporation.md#chapter-sixteen-incorporation-bridge) incorporation discipline and [Chapter Five](../core_05__definitions_home.md#chapter-five-foundational-definitions) canonical definitions.
- Read with: **CJS-1.11**; **CJS-1**; **CJS-3**; [CJS-0.1](cjs_00_registry_and_reading_rules.md#cjs-01-topic-router-stable-ids).

</details>

<br>

*In plain terms: Labels like **CJS-1.11** or **CF-4** are navigation addresses inside the implementation corpus. They are not Article numbers in the Constitution itself, and the two should never be confused when citing.*
...
Within this file, headings use **CJS-1** (*Scope, purpose, and boundary interface*) through **CJS-3** (*Implementation and cross-implementation operational cluster library*), meaning *Corpus joint structure* section *n*. Subsections use **CJS-*n*.*m***, such as **CJS-0.1** (*Topic router (stable IDs)*). The abbreviation **CJS** means the *Corpus joint structure* implementation layer ([corpus_joint_structure.md](../corpus_joint_structure.md)).

Unless a section says otherwise, **Article** labels with Roman numerals that point to the Sentient Constitution Chapter Six part files (`core_06-06_rights_part_*.md`) refer to the canonical `### Article ...` headings in those files.

<details>
<summary><strong><span style="color: #2563eb;">Implementation parse mechanics (read when using CJS-3 operational clusters)</span></strong></summary>

> The following subsections state binding parse and application rules for **CJS-3** (*Implementation and cross-implementation operational cluster library*) **OP-O** / **OP-E** / **OP-C** entries. General readers may defer them until cross-domain operational clusters are in scope.

## CJS-1.12: Operational structure and subsection-local terminology
<a id="cjs-112-operational-structure-and-subsection-local-terminology"></a>
<details>
<summary><strong><span style="color: #2563eb;">Trace</span></strong></summary>

- Upstream: [CJS-1.2](cjs_01_scope_purpose_boundary_interface.md#cjs-12-shared-implementation-corpus-preamble-contract) shared implementation-corpus contract; [CJS-0.1](cjs_00_registry_and_reading_rules.md#cjs-01-topic-router-stable-ids) topic router; [Chapter Sixteen](../core_16-16_incorporation.md#chapter-sixteen-incorporation-bridge) incorporation discipline and [Chapter Five](../core_05__definitions_home.md#chapter-five-foundational-definitions) canonical definitions.
- Read with: **CJS-1.12**; **CJS-1.13**.
...
## CJS-1.13: Operational clusters
<a id="cjs-113-operational-clusters"></a>
<details>
<summary><strong><span style="color: #2563eb;">Trace</span></strong></summary>

- Upstream: [CJS-1.2](cjs_01_scope_purpose_boundary_interface.md#cjs-12-shared-implementation-corpus-preamble-contract) shared implementation-corpus contract; [CJS-0.1](cjs_00_registry_and_reading_rules.md#cjs-01-topic-router-stable-ids) topic router; [Chapter Sixteen](../core_16-16_incorporation.md#chapter-sixteen-incorporation-bridge) incorporation discipline and [Chapter Five](../core_05__definitions_home.md#chapter-five-foundational-definitions) canonical definitions.
- Read with: **CJS-1.13**; **CJS-1.12**.
