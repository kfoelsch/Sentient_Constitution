...
- Downstream: **CJS-1.0**, **CJS-1.1**, and **CJS-1.3** in this file; [CJS-1.7](cjs_01_drafting_contracts.md#cjs-17-intentional-overlap-non-duplication-discipline) through [CJS-1.8.1](cjs_01_drafting_contracts.md#cjs-181-implementation-boundary-primary-owner-to-cjs-seam); [CJS-1.9](cjs_02_support_hosting_classification.md#cjs-19-boundary-between-support-roles-and-merits-decisions) through [CJS-1.11](cjs_02_support_hosting_classification.md#cjs-111-classification-alignment-for-supervised-scope); [CJS-1.13](cjs_01_odef_parse.md#cjs-113-operational-structure-and-subsection-local-terminology) through [CJS-1.14](cjs_01_odef_parse.md#cjs-114-operational-clusters).
...
- section-identifier, **Def.*** / **oDef** home, and parse-mechanics rules for this corpus (**CJS-1.1** (*Section identifiers and article references*), and **CJS-1.13** (*Operational structure and subsection-local terminology*) through **CJS-1.14** (*Operational clusters*) in [cjs_01_odef_parse.md](cjs_01_odef_parse.md));
- reusable joint operational definitions (**oDef** / **CJS-3** (*operational cluster library*));
- cross-implementation topic routing and domain-specific joint rules (**CJS-0.1** (*Cross-file routing*), **CJS-1.7** (*Intentional overlap*) through **CJS-1.11** (*Classification alignment for supervised scope*), and **CJS-2** (*Specific joint interlocks*)). Drafting contracts: [cjs_01_drafting_contracts.md](cjs_01_drafting_contracts.md). Support, hosting, and classification seams: [cjs_02_support_hosting_classification.md](cjs_02_support_hosting_classification.md). Applicability, combined satisfaction, the default **CJS → CS → CI → CF** reading stack, and stricter-wins for jointly applicable incorporated obligations live in [Chapter One §8.4.4](../core_01_b_interaction_interpretation.md#844-combined-satisfaction) and [Chapter One §8.4.3](../core_01_b_interaction_interpretation.md#833-incorporation-layer).
...
|---|---|---|
| **CJS** (this layer) | [Joint structure](../corpus_joint_structure.md) | Shared glue and cross-file interfaces (default reading stack: [Chapter One §8.4.4](../core_01_b_interaction_interpretation.md#844-combined-satisfaction)) |
...
This file (**CJS-1**) is the **binding gateway** for that set. Use it when you need the shared contract, identifier and **Def.*** / **oDef** homes, or the map into domain doors. The default **CJS → CS → CI → CF** reading stack lives in [Chapter One §8.4.4](../core_01_b_interaction_interpretation.md#844-combined-satisfaction). It does **not** replace [Chapter One §1 Purpose and Role](../core_01_a_values_principles.md#1-purpose-and-role) — that section states why the Constitution itself exists.
...
How to read guidepost **oDef** entries (**What it is** / **How to measure and assess** / **What must hold**): [CJS-1.13](cjs_01_odef_parse.md#cjs-113-operational-structure-and-subsection-local-terminology) and [CJS-1.14](cjs_01_odef_parse.md#cjs-114-operational-clusters). Where to put a definition: constitutional **Def.*** terms in **Chapter Five**; reusable joint **oDef** clusters in **CJS-3**; two-tier shared ideas under [CJS-1.8](cjs_01_drafting_contracts.md#cjs-18-two-tier-definition-contract-binding-abstraction--owner-detail) (editors/auditors).
...
**Next file:** [cjs_01_drafting_contracts.md](cjs_01_drafting_contracts.md)
