...
This file is the joint-structure reader guide. It is reader guidance only.

*In plain terms: this page tells you how to enter the joint-structure layer, how labels work, and which file to open next — without adding any duties.*

You do **not** need to read this folder front to back. Most readers open one cited section, or follow a topic, and leave.
...
|---|---|---|
| **CJS** (this layer) | [Joint structure](../corpus_joint_structure.md) | Shared glue and cross-file interfaces |
...
| Label family | Example headers | What they are |
|---|---|---|
| **CJS** (this layer) | **CJS-1**, **CJS-1.1**, **CJS-0.1**, **CJS-2.3** | Joint-structure sections |
| **CS** | **CS-1** through **CS-12** | Systems families |
| **CI** | **CI-1**, **CI-7.2**, **CI-9** | Institutions sections |
| **CF** | **CF-1**, **CF-4**, **CF-7.2** | Forum sections |
...
| Apply more than one of **CJS**, **CS**, **CI**, and **CF** to the same facts | [Chapter One §8.4.4](../core_01_b_interaction_interpretation.md#844-combined-satisfaction-of-jointly-applicable-incorporated-obligations) and [CJS-1.3](cjs_01_scope_purpose_boundary_interface.md#cjs-13-shared-implementation-corpus-preamble-contract) |

## When more than one layer applies

The default reading stack and combined-satisfaction rule live in [Chapter One §8.4.4 Combined satisfaction of jointly applicable incorporated obligations](../core_01_b_interaction_interpretation.md#844-combined-satisfaction-of-jointly-applicable-incorporated-obligations). Stricter-wins among jointly applicable incorporated obligations lives in [Chapter One §8.4.3 Incorporation layer](../core_01_b_interaction_interpretation.md#843-incorporation-layer). The shared implementation-corpus contract that **CS**, **CI**, and **CF** cite is [CJS-1.3](cjs_01_scope_purpose_boundary_interface.md#cjs-13-shared-implementation-corpus-preamble-contract).

This guide does not restate those duties.

## How to read an oDef entry

Each **oDef** entry uses three reader-facing headers:

- **What it is** — what the rule covers
- **How to measure and assess** — what evidence to check and how reviewers verify it
- **What must hold** — the binding failure modes
...
Come back to a CJS family file when a citation sends you there, when you need to know which file owns a topic, or when you are editing or auditing cross-file routing. Day-to-day domain doctrine lives in **CS**, **CI**, and **CF**.
