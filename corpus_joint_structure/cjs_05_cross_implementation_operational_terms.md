...
**Chapter Zero measurement routing (non-operative).** Operational **CJS-5** (*cross-implementation operational terms*) clusters implement [Chapter Zero §2–§3](../core_00_preamble.md#measurements-overview) constitutional measurement categories — not a separate taxonomy. Default orientation: **Oversight** clusters → [Chapter Zero §3.5 Measuring Oversight](../core_00_preamble.md#measuring-oversight); **Participation** clusters → [Chapter Zero §3.4 Measuring Participation](../core_00_preamble.md#measuring-participation); **Accountability** clusters → [Chapter Zero §3.6 Measuring Accountability](../core_00_preamble.md#measuring-accountability) and [Chapter Zero §3.7 Measuring Timeliness](../core_00_preamble.md#measuring-timeliness) where resolution-pathway discipline applies; **Continuity** band clusters → [Chapter Zero §3.3 Measuring Continuity](../core_00_preamble.md#measuring-continuity). [Materiality](../core_00_preamble.md#measuring-threshold-and-scaling) scales all categories. Technical measurement methods must remain traceable to these categories via [Chapter Seven](../core_07-07_system_alignment_certification.md#chapter-seven-system-alignment-certification) and [Chapter Zero §4.1](../core_00_preamble.md#from-measurement-to-evidence-and-remedy).
