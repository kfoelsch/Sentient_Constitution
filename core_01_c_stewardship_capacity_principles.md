...
**Misaligned reward consequences.** Material rewards obtained through prohibited pathways above are subject to forfeiture and reporting under the standing model. Read [Chapter Nine §3.12.1 Reporting duty and exclusions](core_09-09_standing_integration.md#3121-misaligned-reward-reporting-duty-and-exclusions), [§3.12.2 Forfeiture and retention](core_09-09_standing_integration.md#3122-misaligned-reward-forfeiture-and-retention), and [§3.12.3 Correction, records, and routing](core_09-09_standing_integration.md#3123-misaligned-reward-correction-records-and-routing).
...
When concentration is used to subvert the Constitution, that misconduct is judged under [Chapter Ten §6](core_10-10_misconduct.md#61-concentration-based-subversion-criteria-interaction). Creating, maintaining, or exploiting concentration above the **§13** floor is reached through Chapter Ten **criteria 3, 4, and 6** for designation review where Chapter Eight has assigned Violation Axis **s = 7, 8, or 9** by proportional LEQU impact. **§13.1** states principle-layer threshold direction; it does not itself assign impact slots or misconduct designations.
