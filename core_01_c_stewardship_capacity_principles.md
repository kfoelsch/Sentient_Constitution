...
- Downstream: [6. Process Conflict Resolution](core_01_b_interaction_interpretation.md#6-process-conflict-resolution) (including [§6.3 Minimization of Avoidable Burden](core_01_b_interaction_interpretation.md#63-minimization-of-avoidable-burden)); [Chapter Eight §3 Whole-System Certification Evaluation](core_08_a_system_alignment_certification_evaluation.md#3-whole-system-certification-evaluation); [§11.1.3 Stewardship and Operator Application](#1113-stewardship-and-operator-application).
...
- Downstream: [§9.1.2 Symmetric Costly Constraints](#912-symmetric-costly-constraints); [§9.1.3 Role-Scoped Observability](#913-role-scoped-observability); [Chapter Thirteen §5 — Authorized Roles, Competency Development, and Contribution](core_13_governance.md#5-authorized-roles-competency-development-and-contribution); [Chapter Seventeen](core_17_incorporation.md) (*companions implement; they do not replace*); [§11.1.3 Stewardship and Operator Application](#1113-stewardship-and-operator-application).
...
- **Logging vs standing records:** Default mixed-crew inspectability and the log-is-not-a-record rule live in [§9.1.3](#913-role-scoped-observability); standing measurement remains Chapter Nine.
...
- Read with: [Safety (Constraint)](core_05_band_continuity.md#safety-constraint); [Truth (Constitutional Constraint)](core_05_band_oversight.md#truth-constitutional-constraint); [Auditability](core_05_band_oversight.md#auditability); [Contestability](core_05_band_accountability.md#contestability); [§11 Incentive Alignment and System Capture](#11-incentive-alignment-and-system-capture); [Chapter Ten §5.4 Duty to resist](core_10_standing_integration.md#54-duty-to-resist-unlawful-or-unconstitutional-instructions).
- Downstream: [Chapter Nine — Contribution, Violation, and Standing Model](core_09_standing_assessment.md#chapter-nine-compliance-violation-and-standing-model) (*verified costly-case failures record on the same axes*); [§9.1.3 Role-Scoped Observability](#913-role-scoped-observability).
...
- Downstream: [§11 Incentive Alignment and System Capture](#11-incentive-alignment-and-system-capture); [§12 Shared-System Capacity](#12-shared-system-capacity); [Chapter Thirteen](core_13_governance.md) (*Constitutional Contract Layer* operationalization); [Article XXII](core_06_rights_part_c.md#article-xxii-constitutional-interpretation-review-and-anti-capture-safeguards) (*forum-member floors*).
...
This principle binds human and AI stewards alike under [§9.1.1 Shared Stewardship Standard](#911-shared-stewardship-standard). It is the seat-independence half of a pair with [§11.3 *Plural detection and review*](#113-misalignment-detection): plurality keeps oversight from being cornered by one actor; Chapter Seven keeps oversight from being performed by the actor under review.
...
- Downstream: [§11.3 Misalignment Detection](#113-misalignment-detection); [§11.3.1 Escalation Triggers](#1131-escalation-triggers); [§11.4 Misalignment Correction and Capture Response](#114-misalignment-correction-and-capture-response); [§6.2 Epistemic Disclosure Constraints](core_01_b_interaction_interpretation.md#62-epistemic-disclosure-constraints); [Chapter Eight §3 Whole-System Certification Evaluation](core_08_a_system_alignment_certification_evaluation.md#3-whole-system-certification-evaluation); `corpus_systems.md` classification and stewardship scaling; `corpus_institutions.md` conflict and integrity expectations.
...
- Downstream: **CJS-3.11.2 — Anti-domination conduct and remediation catalog** (operative conduct patterns and remedies); [§13.3 Consolidation Ceiling](#133-consolidation-ceiling); [Chapter Eleven §5](core_11_b_misconduct_pattern_applications.md#51-concentration-based-subversion-criteria-interaction).
