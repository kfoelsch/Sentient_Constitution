...
**Relationship to Chapter Six.** **Chapter Six** supplies the shared machinery: the Contribution and Violation axes, the **section 2.1** standing-slot index, the **section 3.1** primary slot defaults, the general **section 3.3** violation-severity ladder, **section 5** process / response character, and the general standing-effect rules. Those rules remain active background for the record.

For final classification of anti-constitutional misconduct, this chapter controls. Chapter Six classifications may explain context, safeguards, or standing consequences, but they do not replace this chapter's unified-incident criteria or final slot safeguards. Chapter Six **§2.1** supplies the shared escalating grammar only, the final three categories of which are defined here.
...
- Upstream map: [Chapter Six §2.1](core_06-06_standing_classification.md#21-two-axis-map) (*standing-slot foundation*).
