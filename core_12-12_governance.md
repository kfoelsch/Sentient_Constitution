...
>
> This file is **part of the Sentient Constitution** and is **binding only together** with the other numbered `core_*` files read as one instrument. It contains **Chapter Twelve**, the **Constitutional Contract Layer** — constitutional legitimacy and stewardship requirements for governing authority, distinct from **Stakeholder System Participation** in already-authorized systems ([Preamble](core_00_preamble.md#chapter-00-preamble--foundational-requirements)). Amendment and adoption validity controls continue in [Chapters Thirteen through Fifteen](core_13-15_amendment.md#chapter-thirteen-non-regression-and-substantive-amendment-validity). Chapter numbering and cross-references match the integrated instrument. Reading order, the binding/support split, and corpus edition metadata are maintained in [README.md](README.md).
...
- **General** standing measurement under **Chapter Eight** (Contribution Axis and Violation Axis — contribution **state**, violation nature, and every numeric impact slot) remains **Chapter Eight**-anchored. **Final anti-constitutional-misconduct designation** for qualifying **Violation Axis s = 7, 8, or 9** findings remains anchored in **Chapter Ten**; Chapter Ten does not assign or move the numeric slot.
...
- **Democratic-institution minimum checks:** Any legitimacy mechanism that purports to authorize governing authority must, at a minimum, provide all of the following:
    ...
    - These checks apply to [**Foundational Constitutional Choice**](core_05defs_integrative.md#foundational-constitutional-choice) (Chapter Five) and to any other authorization action within the mechanism's scope.
...
- **High-impact alignment:** Recall-class votes that would change **Foundational Constitutional Choice** outcomes or the governance-layer mechanism itself remain subject to **Article XI-C** (*Legitimacy Gate and Anti-Token Participation*) and **§2** requirements where applicable.
...
- Upstream: Principles: [3. Foundational Objective: Wellbeing](core_01_a_values_principles.md#2-foundational-objective-wellbeing), [4. Non-Negotiable Constraints: Safety and Truth](core_01_a_values_principles.md#3-non-negotiable-constraints-safety-and-truth); [Chapter Twelve §1](#1-authorization-and-legitimacy-of-governing-authority) authorization scope for stewardship within rule-making power.
- Downstream: Subsections [3.1](#31-stewardship-direction) and [3.2](#32-ecosystem-value-orientation); canonical definitions for stewardship requirements in [*Strategic Stewardship Obligation*](core_05defs_continuity.md#strategic-stewardship-obligation-constitutional), [*Review and Correction Duty*](core_05defs_continuity.md#review-and-correction-duty-constitutional), [*Burden-Reduction Duty*](core_05defs_continuity.md#burden-reduction-duty-constitutional), and [*Stewardship Defect*](core_05defs_continuity.md#stewardship-defect-constitutional), read through the [Chapter Five Chapter One §8.13 stewardship compound cluster](core_05defs_continuity.md#stewardship-governance-discipline-and-shared-system-capacity-cluster), including cross-references to [Chapter One §6.3](core_01_b_interaction_interpretation.md#63-minimization-of-avoidable-burden) and ([*Avoidable Burden*](core_05defs_continuity.md#avoidable-burden); [*Productive Capacity*](core_05defs_continuity.md#productive-capacity-constitutional); [*Constitutional Efficiency*](core_05defs_continuity.md#constitutional-efficiency)) where applicable.
- Read with: [Chapter Six](core_06-06_rights_part_a.md#chapter-six-foundational-rights) Rights Floor; [Chapter Five](core_05_definitions_home.md#chapter-five-foundational-definitions) for [*Productive Capacity*](core_05defs_continuity.md#productive-capacity-constitutional), [*Constitutional Efficiency*](core_05defs_continuity.md#constitutional-efficiency), [*Avoidable Burden*](core_05defs_continuity.md#avoidable-burden), and stewardship-duty definitions named in text.
...
Stewardship requirements for this section are stated in **Chapter Five** under the following titles; they are binding here for stewards within that authorized scope. **Strategic Stewardship Obligation** and **Stewardship Defect** are read together through the [Stewardship, Governance Discipline, and Shared-System Capacity](core_05defs_continuity.md#stewardship-governance-discipline-and-shared-system-capacity-cluster) compound cluster.
...
- Read with: [*Productive Capacity*](core_05defs_continuity.md#productive-capacity-constitutional) and related bounding definitions in [Chapter Five](core_05_definitions_home.md#chapter-five-foundational-definitions).
...
Productive capacity enters ecosystem value as an **instrumental good** supporting the other outcomes named in this subsection. It does not rank with Safety, Truth, or the Rights Floor in **Chapter Six**, and it is not satisfied by raw throughput, utilization, headcount, revenue, or other proxies that diverge from the underlying outcomes ([*Proxy Divergence*](core_05defs_oversight.md#proxy-divergence); [*Constitutional Efficiency*](core_05defs_continuity.md#constitutional-efficiency); [*Avoidable Burden*](core_05defs_continuity.md#avoidable-burden)).
...
**Sentients** are entitled to participate in **governance voting** when published eligibility criteria are met and no applicable [standing lock](core_09-09_standing_integration.md#42-general-standing-locks) blocks the **governance-voting** pathway. Eligibility criteria remain contestable under **Article XVIII-A** (*Standing Distinction*) and **Article XVIII-C** (*Pathway Eligibility, Responsibility, and Continuous Audit*), together with any designated incorporated criteria. Those criteria may not narrow constitutional limits.

The same entitlement applies to comparable legitimacy-mechanism **binding collective choice** procedures. Such procedures must be conducted under the adopter's **documented legitimacy mechanism** (section 1 of this chapter). Suspension or limitation of that participation requires an applicable standing lock on the **governance-voting** pathway, recorded under [Chapter Nine §5.1](core_09-09_standing_integration.md#51-definition-and-attachment).

**governance-voting** does **not** include stake-weighted stakeholder voice inside an already-authorized system, institution, or bounded decision domain. Those Stakeholder System Participation pathways use the **stakeholder-participation** lock under [Chapter Nine §4.2](core_09-09_standing_integration.md#42-general-standing-locks). Verified corruption, capture, false-stake abuse, or coercive gaming of stakeholder voice triggers the [Stakeholder-Participation Standing Lock](core_09-09_standing_integration.md#55-special-locks) under [Chapter Nine §5.5](core_09-09_standing_integration.md#55-special-locks). A **stakeholder-participation** lock does not by itself strip **governance-voting** or **Foundational Constitutional Choice**, and a **governance-voting** lock does not by itself strip stake-weighted stakeholder voice.

**Calendar age or life stage alone** must not disqualify eligibility. Competency, capacity, or role-fitness requirements must satisfy **Chapters Two through Five** ([**Substantive Fairness**](core_05defs_participation.md#substantive-fairness-constitutional), [**Proportionality**](core_05defs_accountability.md#proportionality), and [**Necessity**](core_05defs_accountability.md#necessity)) and must not operate as **disguised age discrimination**. Suspension and restoration of this participation **track attachment and lifting of the applicable standing lock** under the same constitutional and incorporated criteria.
...
- **Durable political-voice floor (anti-disenfranchisement):** A standing lock on the **governance-voting** pathway may suspend ordinary governance-voting entitlement. It must not be used as a **durable-political-voice** disqualification vector.
  - **Anti-constitutional misconduct — restitution precondition:** A **final designation** of **anti-constitutional misconduct** for a **Violation Axis s = 7**, **s = 8**, or **s = 9** finding under **Chapter Ten** (*Anti-Constitutional Misconduct*) withholds **durable political voice** — including participation in **Foundational Constitutional Choice** — until **full restitution** is satisfied: proportionate [**Redress and Remediation**](core_05defs_accountability.md#redress-and-remediation-constitutional) (Chapter Five), including **restitution** for material harm from the offense where owed, is **fully discharged** as finally determined under **Chapter Eleven** and applicable incorporated procedure, consistent with **Chapter Ten** due-process safeguards and **Article XXIII-A** (*Justice Objective and Scope*).
  ...
  - **Partial and conditional restoration:** Where **full** discharge is **impossible** after **good-faith effort** (for example, certain harms are not reversibly compensable, or no party can locate necessary counterparties), **Chapter Eleven** and applicable incorporated procedure may adopt **partial** or **conditional** restoration milestones that **materially satisfy** [**Redress and Remediation**](core_05defs_accountability.md#redress-and-remediation-constitutional) for what can feasibly be done; upon satisfaction of those milestones, **durable political voice** must be **restored** unless **Chapter Ten** safeguards and **Article XXIII-A** (*Justice Objective and Scope*) still require further specific duties that remain **feasible** and **not pretextual**. These routes remain **fully contestable**; they do **not** authorize token gestures in place of genuine restoration where restoration remains practicable.
  ...
  - Where a standing lock or restitution withholding is invoked to restrict participation in foundational constitutional choice (authorization of governing authority, or reauthorization pathways), the restriction must satisfy:
    - (a) an individualized predicate under [**Procedural Fairness**](core_05defs_participation.md#procedural-fairness-constitutional);
    - (b) [**Necessity**](core_05defs_accountability.md#necessity) and [**Proportionality**](core_05defs_accountability.md#proportionality) under Chapter One;
  ...
  - Broad-misconduct categories swept into disqualification scope, or lock patterns that track [**Protected Characteristics**](core_05defs_participation.md#protected-characteristics-constitutional) or their material proxies, are non-compliant.
  - Cross-reference: **Chapter Six, **Article XVIII** (*Standing and Participation Status*)**; **Chapter Ten** (*Anti-Constitutional Misconduct*) for **final anti-constitutional-misconduct designation** on qualifying **Violation Axis s = 7, 8, or 9** findings and safeguards tied to the **anti-constitutional misconduct — restitution precondition** clause.

#### 4.2 Records, gates, and method neutrality
<details>
<summary><strong><span style="color: #2563eb;">Trace</span></strong></summary>

- Upstream: [Chapter One §8.1](#41-entitlement-and-eligibility) eligibility, governance-voting standing locks, and political-equality floors for foundational constitutional choice.
- Downstream: [§11.3](#43-decision-resolution-requirements-for-binding-collective-choice) deliberation and rights-collision sequence; binding-effect and legitimacy gates keyed to [Article XI-A: Stakeholder System Participation and Representation](core_06-06_rights_part_b.md#article-xi-a-stakeholder-system-participation-and-representation) and related **Article XI** (*Stakeholder System Participation, Representation, and Due Process*) subarticles in operative text.
...
- Read with: [Chapter Five Chapter One §8.16 Binding Stakeholder Choice](core_05defs_participation.md#binding-stakeholder-choice-cluster), including [Binding Stakeholder Choice — Decision-Resolution Requirements](core_05defs_participation.md#binding-collective-choice-decision-resolution-process), [Stakeholder Representation and Participation-Weight Limits (Binding Stakeholder Choice)](core_05defs_participation.md#stakeholder-representation-and-participation-weight-limits-binding-collective-choice), and [Stakeholder Rights-Collision Record (Binding Stakeholder Choice)](core_05defs_participation.md#rights-collision-record-binding-stakeholder-choice); read also with [Chapter Six: Foundational Rights](core_06-06_rights_part_a.md#chapter-six-foundational-rights) for materially rights-affecting process design and [Emergency Pre-Deliberation Action (Binding Collective Choice)](core_05defs_continuity.md#emergency-pre-deliberation-action-binding-collective-choice).
...
- **Structured sequence, local deliberation first, plural evaluation, reopening:** [Binding Stakeholder Choice — Decision-Resolution Requirements](core_05defs_participation.md#binding-collective-choice-decision-resolution-process).
- **Stakeholder representation and participation-weight limits:** [Stakeholder Representation and Participation-Weight Limits (Binding Stakeholder Choice)](core_05defs_participation.md#stakeholder-representation-and-participation-weight-limits-binding-collective-choice) (also cross-referenced from [Chapter One §8.1](#41-entitlement-and-eligibility)).
- **Stakeholder rights-collision discipline:** [Stakeholder Rights-Collision Record (Binding Stakeholder Choice)](core_05defs_participation.md#rights-collision-record-binding-stakeholder-choice) — read with **Article XXIV-B** (*Rights-Collision Procedure and Restorative Alignment*) and [Chapter One §6.3](core_01_b_interaction_interpretation.md#63-rights-collision-procedure).
...
**Cross-reference (Chapter Twelve):** Instruments of **constitutional adoption** and amendment validity appear in **Chapter Sixteen**. **Supremacy relative to external law**, **stricter external protections**, and disputes involving external tribunals appear in **Chapter Fourteen**. **Non-regression** substantive limits appear in **Chapter Thirteen**.
...
**Previous file:** [core_06-06_rights_part_d.md](core_06-06_rights_part_d.md)

**Next file:** [core_13-15_amendment.md](core_13-15_amendment.md)
