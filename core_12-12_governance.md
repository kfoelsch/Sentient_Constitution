...
**Sentients** are entitled to participate in **governance voting** when they are in **good standing**. Good standing is a form of **Participant Standing** under **Article XVIII-A** (*Standing Distinction*) and **Article XVIII-C** (*Good Standing, Responsibility, and Continuous Audit*), together with any designated incorporated criteria. Those criteria remain contestable and may not narrow constitutional limits.
...
- **Durable political-voice floor (good-standing anti-disenfranchisement):** Loss of **good standing** under **Article XVIII-A** (*Standing Distinction*) / **Article XVIII-C** (*Good Standing, Responsibility, and Continuous Audit*) may suspend ordinary governance-voting entitlement through the usual standing-loss pathways. It must not be used as a **durable-political-voice** disqualification vector.
  ...
  - Where loss of standing is invoked to restrict participation in foundational constitutional choice (authorization of governing authority, or reauthorization pathways), the restriction must satisfy:
    ...
    - (d) restoration pathways that are real rather than merely formal, consistent with **Article XVIII-C** (*Good Standing, Responsibility, and Continuous Audit*) continuous-audit and restoration-or-requalification discipline.
  - Broad-misconduct categories swept into disqualification scope, or standing-loss patterns that track [**Protected Characteristics**](core_05defs_participation.md#protected-characteristics-constitutional) or their material proxies, are non-compliant.
  - Cross-reference: **Chapter Six, **Article XVIII** (*Standing and Participation Status*)** (*Standing and Participation Status*); **Chapter Ten** (*Anti-Constitutional Misconduct*) for **final anti-constitutional-misconduct designation** on qualifying **Violation Axis s = 7, 8, or 9** findings and safeguards tied to the **anti-constitutional misconduct — restitution precondition** clause.
