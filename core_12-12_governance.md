...
The same entitlement applies to comparable **binding collective choice** procedures. Such procedures must be conducted under the adopter's **documented legitimacy mechanism** (section 1 of this chapter). Suspension or limitation of that participation requires an applicable standing lock on the **governance-voting** or comparable binding-collective-choice pathway, recorded under [Chapter Nine §5.1](core_09-09_standing_integration.md#51-definition-and-attachment).
