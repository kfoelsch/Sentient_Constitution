...
- [**Integrity**](core_11-11_forum.md#45-integrity-forums), [**Constitutional**](core_11-11_forum.md#46-constitutional-forums), and [**Environment**](core_11-11_forum.md#44-environment-forums) forums, and [**Technical Forum Domains**](core_11-11_forum.md#42-technical-forum-domains) when they hear sentience-status adjudication, must be staffed through **published**, **contested**, **rotatable** appointment or an equivalent independence check (sortition, federated designation, or comparable).
- This floor is **mechanism-neutral**: it does not mandate a single polity type or a single appointment method.
- Failure to appoint or fund those benches to the [Chapter Nine §9.2](core_09-09_standing_integration.md#92-remedy-system-durability) remedy-system durability floor is a legitimacy and remedy failure, not a gap that implementation may leave open.
...
- Read with: [Chapter Six](core_06-06_rights_part_a.md#chapter-six-foundational-rights) Rights Floor; [Chapter Five](core_05__definitions_home.md#chapter-five-foundational-definitions) for [*Productive Capacity*](core_05_band_continuity.md#productive-capacity-constitutional), [*Constitutional Efficiency*](core_05_band_continuity.md#constitutional-efficiency), [*Avoidable Burden*](core_05_band_continuity.md#avoidable-burden), and stewardship-duty definitions named in text.
