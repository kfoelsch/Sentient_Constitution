...
- C: Non-compliant when: **Continuity** is used to forever put off fixes; "stability" rests on hidden risk dumping, irreversible harm, or shifting ecological burdens onto others; ordinary "keep the lights on" talk is used to block [Contestability](core_05defs_accountability.md#contestability) or [Timely Resolution](core_05defs_accountability.md#timely-resolution-constitutional); or **Continuity** is pursued in a way that materially defeats [Flourishing](core_05apex_flourishing_aim.md#flourishing-constitutional) without clear permission under [Chapter One §9](core_01_b_interaction_interpretation.md#6-process-conflict-resolution).
...
- **Sustainability** — [Sustainability](core_05defs_continuity.md#sustainability), [Ecological Footprint](core_05defs_continuity.md#ecological-footprint); [*Ecological Integrity, Footprint, and Sustainability*](core_05defs_participation.md#ecological-footprint-semi-independent)
