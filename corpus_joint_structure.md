...
**Compatibility entrypoint:** this root file is the stable navigation wrapper for the joint-structure companion. Substantive CJS text now lives in the `corpus_joint_structure/` subfiles listed below. Broad references to `corpus_joint_structure.md` continue to mean the joint-structure companion as a whole.
