...
**2026-04-30:** [architecture_primer.md](architecture_primer.md) marked **Locked** (`2026-04-30`) with cross-reference alignment in **Chapters Eleven–Fourteen** routing. Publish prep for public GitHub: reconciled drifted **Corpus edition** / **Effective date** stamps to **`SC-Corpus-2026.04.32`** / **2026-04-24**; README companion list deduped. **`make regression`** and **`make best-practices-check`** green; **`make regression-full`** still fails **`readability-audit`** (`very-long-sentence` findings—see [README.md](README.md)). **P3** holistic redundancy sweep **waived** for this cut ([TODO.md](TODO.md)). Post-cut continuation: normalized companion **constitutional chapter owner** phrasing in `corpus_systems.md` (full-owner **`Sentient Constitution Chapter …`** style where shorthand identified constitutional sources) and aligned **`corpus_joint_structure.md`** Failure Integrity / **PRIM1** anchors; **`make reference-audit`**, **`make corpus-markdown-audit`**, and **`make lexical-vocabulary-audit`** green (regression/evidence still deferred per [TODO.md](TODO.md)). **Addendum 9:** extended the same owner normalization across companion gaps (**institutions**, **forum**, **joint structure PRIM6–PRIM8**) per [TODO.md](TODO.md) continuation; same three non-regression audits green. **Addendum 10:** **PRIM6**/**PRIM7** read-with owner tightening; **PROT3** clause **Chapter Six**/**Nine** labels; **`corpus_systems.md`** *Enforcement Realism Anchors* pointer corrected from **Chapter Four** to **Chapter Six**; same three non-regression audits green. **LICENSE** (CC BY 4.0) and **`.gitignore`** added. Earlier continuation narrative: `1819cbc` → [archive/MEMLOG_ARCHIVED_2026-04-30.md](archive/MEMLOG_ARCHIVED_2026-04-30.md). Deferred **P1** in [TODO.md](TODO.md).
