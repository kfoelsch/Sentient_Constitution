...
Authoritative normative state is in the binding corpus files named in [README.md](../README.md). Retired root `TODO.md` / `MEMLOG.md` snapshots: [TODO_ROOT_RETIRED_2026-05-01.md](TODO_ROOT_RETIRED_2026-05-01.md), [MEMLOG_ROOT_RETIRED_2026-05-01.md](MEMLOG_ROOT_RETIRED_2026-05-01.md). [doc_architecture.md](../doc_architecture.md) and implementation worklists are process aids only.
