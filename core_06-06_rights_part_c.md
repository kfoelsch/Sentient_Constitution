...
- **Proportionality and calibration:** Restrictions on standing must remain necessary and proportionate under **Necessity**, **Proportionality**, **Article XXIII-B** (*Non-Trivial Restriction, Restitution, and Restorative-Accountability Constraints*), and **Article XXIII-C** (*Least-Restrictive and Time-Bounded Rule*).
  ...
  - **Formal Non-Compliance** findings alone ([Chapter Eight section 5.3.2](core_08-08_standing_assessment.md#92-violation-axis-severity-ladder)) do not justify durable exclusion absent repeated pattern evidence, evasion, or material harm linkage.
...
- Read with: [Chapter Eight §5.3.3](core_08-08_standing_assessment.md#93-forum-disclosure-and-recusal-process-impact) (*measurement discipline*); [Chapter Ten §6.10](core_10-10_misconduct.md#610-forum-recusal-failure-and-biased-panel-participation) (*named misconduct pattern*); [Chapter Eleven §2](core_11-11_forum.md#2-default-venue-and-primary-stakes) and [§5](core_11-11_forum.md#6-transfer-consolidation-and-coordination) (*Integrity-first routing and anti-self-judging*).
