...
- Upstream: [Constitutional Tetrad](core_00_preamble.md#constitutional-tetrad); [Two Constitutional Aims](core_00_preamble.md#two-constitutional-aims); [material stake](core_00_preamble.md#material-stake); [Preamble §6 Key Practical Process Pipelines](core_00_preamble.md#6-key-practical-process-pipelines) (*Chapters Eight through Twelve chain*).
- Upstream: [Chapter One](core_01_c_stewardship_capacity_principles.md#chapter-01-principles-and-constraints) (*Plain-Language Accessibility* stewardship reflected in section-level gloss); [Chapter One §9 — Stewardship In Depth](core_01_c_stewardship_capacity_principles.md#9-stewardship-in-depth) (*principle-layer foundation for competence-linked, traceable standing — trust, roles, and recognition*); [Chapters Two through Four](core_02_definition_structure.md) (*integrity, records, and verification*); [Chapter Five](core_05__definitions_home.md#chapter-five-foundational-definitions) (*definitions and supremacy read with Chapters Two through Four*).
...
| --- | --- | --- |
| **1. What happened?** | Which facts are verified, about whom or what, during what period, and with what record and challenge status? | [Section 2](#2-question-1--what-happened) |
...
- Upstream: [Chapter One §9 — Stewardship In Depth](core_01_c_stewardship_capacity_principles.md#9-stewardship-in-depth); [Chapters Two through Four](core_02_definition_structure.md); [Chapter Five](core_05__definitions_home.md#chapter-five-foundational-definitions).
- Downstream: [§2](#2-question-1--what-happened) (*Question 1*); [§3](#3-standing-record-operational-requirements) (*verification and record requirements*); [§4](#4-standing-measurement-evaluation-dimensions) (*Question 2 measurement*); [§5](#5-slot-grammar-and-lequ-calibration) (*slot grammar and shared scaling*); [§6](#6-constitutional-inputs-to-axis-assignment) (*constitutional-source routing*); [§7](#7-unified-proportional-lequ-scale--contribution-and-violation-axes) (*unified proportional LEQU scale for both axes*); [Chapter Ten](core_10_standing_integration.md#chapter-ten-standing-effects-and-integration) (*Question 3*).
...
- Downstream: [§2.2](#22-linked-records-and-no-offset-bridge) (*linked-record no-offset bridge*); [§2.3](#23-question-1-event-type-guide--what-kind-of-help-or-harm-occurred) (*event-type guide*); [§3](#3-standing-record-operational-requirements) (*verified-input gate and forum boundary*); [§4](#4-standing-measurement-evaluation-dimensions) (*Question 2 measurement*); [§5](#5-slot-grammar-and-lequ-calibration) (*slot grammar and shared scaling*); [§6](#6-constitutional-inputs-to-axis-assignment) (*constitutional-source routing*); [§7](#7-unified-proportional-lequ-scale--contribution-and-violation-axes) (*unified proportional LEQU scale for both axes*); [Chapter Ten](core_10_standing_integration.md#chapter-ten-standing-effects-and-integration) (*Question 3*).
...
- A record opens only on a verified trigger under **section 3**, with entry authorized by a named record-opening authority and performed by a separate record custodian under **section 3.7**; it is never opened:
...
- Upstream: [§2.1](#21-what-question-1-must-establish) (*separate contribution and violation records*).
...
- **Contribution standing records and competency clearances:**
  - Verified contribution may support applicable **competency clearances** against published **competency bars** and support trust-, role-, or recognition-linked eligibility where current and role-relevant.
...
- Upstream: [§2](#2-question-1--what-happened) (*Question 1 records and event-type guide*); [Chapters Two through Four](core_02_definition_structure.md) (*record, verification, and traceability of definitions to results*).
...
- the **record-opening authority** that verified the factual basis and authorized entry, and the separate **record custodian** that entered and holds the record, each named under **section 3.7**;
...
Forum families under [Chapter Twelve](core_12_forum.md#chapter-twelve-forums-and-jurisdiction) **supervise** how concrete disputes traverse the standing pipeline. The dispute-phase file a forum keeps for that supervision is the [**forum case record**](core_05_band_accountability.md#forum-case-record) under [Chapter Twelve §2.3 Forum case records, standing records, and contests](core_12_forum.md#23-forum-case-records-standing-records-and-contests); it is **not** itself a standing record. Forums supply accessible challenge, independent review, forensic support, remediation sequencing, and tier-default clocks under [Chapter Twelve §6 Timely resolution, materiality tiers, and anti-delay discipline](core_12_forum.md#6-timely-resolution-materiality-tiers-and-anti-delay-discipline) and [Article XXIV-C](core_06_rights_part_d.md#article-xxiv-c-timely-resolution-and-anti-delay-floor) (*Timely Resolution and Anti-Delay Floor*), and when those findings satisfy the verified-input gate under Chapters Two through Four they may **open, update, or correct** standing records under **section 3.1** — or **set a bad record aside on challenge**.
...
- Upstream: [Chapter Seven §2 *Four-seat constitutional floor*](core_07_functional_independence_segregation_of_duties.md#2-four-seat-constitutional-floor) (*principle-layer floor this section applies to standing records; may not be narrowed here*); [Chapter One §12.3 *Plural detection and review*](core_01_c_stewardship_capacity_principles.md#123-misalignment-detection); [§2.1](#21-silence-is-the-default) (*verified trigger; notice to the subject*); [§3.1](#31-minimum-record-contents) (*minimum contents and verified-input gate*); [§3.4](#34-versioning) (*versioning*); [§3.6](#36-forum-boundary) (*forums may open, update, correct, or set aside*); [Chapters Two through Four](core_02_definition_structure.md) (*record, verification, and traceability*); [Evidence Preservation](core_05_band_oversight.md#evidence-preservation) (*chain of custody for evidence*).
...
| --- | --- | --- |
| **Request** | asking that a record be opened, corrected, expired, or superseded, including the subject's or a claimant's own request | execution (or the requesting party, who holds no seat) |
| **Verify** | establishing the factual basis under Chapters Two through Four to the **section 3.1** gate — the record-opening authority's act | assurance and audit |
| **Enter and hold** | writing the version under **section 3.4**, holding the record, publishing the challenge path — the record custodian's act | publication and evidence |
| **Contest** | hearing a challenge to the record and setting it aside, correcting it, or confirming it under **section 3.6** | challenge and review |

No office holds two of these seats on the same record unless the institution has published a merged-hosting safeguard for that pairing under **CJS-3.11** (*Accountability: distributed and proportional authority terms*) and **CI-3.2** (*Functional separation lanes*) that is auditable and contestable, and **no office ever both verifies and enters** the same record, or both verifies and hears the contest of it. The office that runs the system a record concerns holds the execution lane for that system and therefore never verifies records about it. Merged hosting under a published safeguard is a class-scaled exception for small adopters, not the default; where the material stake or system class is high, the seats are separate offices.

<a id="37-lane-map-fallback"></a>

**Fallback when the Charter is silent.** Where a Charter fails to name the record-opening authority or custodian for a scope, that silence is a Charter defect under **CI-3.6** (*Charter contents, review, and formation template*) to be logged and corrected — and it is not a reason the record cannot move. The institution's published lane map under **CI-3.2** (*Functional separation lanes*) governs in the meantime: the record-opening authority is the office holding the assurance and audit lane for that scope, the custodian is the office holding the publication and evidence lane, and neither may be the office holding the execution lane for the system concerned. Where no lane map exists either, the record routes to independent verification under *No self-custody* below — or, for informal and small-scope records, to the relying body under *Informal and small-scope records* next. A steward asked to fill a seat the lane map does not give them declines the seat, logs the request and the gap, and routes; they do not enter the record because they can.
...
**Record custodian.** Every standing record has a named **record custodian** that holds the record, controls versioning under **section 3.4**, publishes the challenge path under **section 3.1**, and answers for the record's continuity. The custodian is a separate seat from the record-opening authority under *Segregation of duties* above: it enters what the authority verified, and does not verify. Custody must not lapse: when a custodian is dissolved, conflicted, or replaced, custody transfers with the full audit trail under [Evidence Preservation](core_05_band_oversight.md#evidence-preservation) to the successor the Charter or designation names, or, where none is named, to the supervising forum under **section 3.6**.
...
**Conflicted custodian on a single record.** Where the named custodian is excluded under *No self-custody* for one record but not for the scope — commonly because the claimant, subject, or challenger sits in the custodian's reporting line — the exclusion is per record and lasts as long as the conflict, and it is answered by substitute custody: not by the custodian abstaining while the record sits, and not by transferring the whole store. The excluded custodian logs the request and the conflict on the record under *Attributed entry* below, preserves the record and its evidence unchanged under [Evidence Preservation](core_05_band_oversight.md#evidence-preservation), keeps the published challenge path open, and enters no version. Custody of that record passes, with its full audit trail, to the substitute holder the Charter or lane map names for the scope (**CI-3.6** (*Charter contents, review, and formation template*) field 11; the **CI-3.2** (*Functional separation lanes*) publication-and-evidence lane outside the control line), or, where none is named, to the supervising forum under **section 3.6**, which holds the record or designates a holder. The substitute is named on the record. When the conflict ends — the interested party leaves the control line, or the record closes for its decision context — custody may return by a logged transfer under *Record custodian* above. A custodian who keeps entering versions on the view that the conflict is only formal commits the *No self-custody* failure; that is not a proportionality judgment open to them. An institution whose lane map leaves every custodian for a system inside the reporting line of the office that runs it has a **CI-3.2** defect to correct, and its records route to the forum in the meantime.
...
How much a recorder statement weighs is a Chapters Two through Four question for the verify seat, not a custody question. The verifier reads it as offered in [Good Faith](core_05_band_accountability.md#good-faith) absent contrary indication, but good faith goes to candour, not to accuracy; accuracy is established by corroboration under [Chapter Four §5](core_04_burden_traceability_verification.md#5-compliance-evidence-standard). A statement that agrees with contemporaneous logs, prior versions, audits, or independent validation carries the weight of those materials. A statement that stands alone is an attestation and does not by itself carry the burden. A statement from a claimant, subject, challenger, or an office in their control line is self-attestation for that purpose. Where the statement explains *why* the record was left as it was — as when a prior recorder says an item was omitted because it had not been verified — it is evidence of the record's state at that time and of what was unverified then; it does not decide whether the omitted fact has since been verified, which the verify seat answers on the present materials.
...
- Upstream: [§2](#2-question-1--what-happened) (*Question 1 — standing records and verified facts*); [§3](#3-standing-record-operational-requirements) (*verified-input gate and record requirements*); [§1](#1-the-three-questions) (*three-question frame*).
- Downstream: [§5](#5-slot-grammar-and-lequ-calibration) (*slot grammar and shared scaling*); [§6](#6-constitutional-inputs-to-axis-assignment) (*constitutional-source routing*); [§7](#7-unified-proportional-lequ-scale--contribution-and-violation-axes) (*Contribution and Violation Axis assignment*); [Chapter Ten §6.2](core_10_standing_integration.md#62-competency-bars-and-clearances) (*contribution Question 3 — safe delegation*); [Chapter Ten §4.2](core_10_standing_integration.md#42-prevention--general-standing-locks) (*prevention locks*); [Chapter Ten §5](core_10_standing_integration.md#5-lock-design-and-enforcement) (*lock design and enforcement*).
...
**Sentience-status bridge (read with Article V-E).** Standing measurement does **not** decide whether an entity is a **sentient**. Status disputes route to [Sentience Status Adjudication](core_05_band_participation.md#sentience-status-adjudication-constitutional) and [Article V-E](core_06_rights_part_b.md#article-v-e-sentience-status-adjudication-floor) (*Sentience-Status Adjudication Floor*), not to LEQU scores or classification records. While status is live-contested under [Contested-Sentient Life](core_05_band_participation.md#contested-sentient-life-constitutional), Article V-E default inclusion preserves standing-measurement eligibility and standing-record filing capacity pending adjudication — operators must not treat unresolved status alone as standing ineligibility. Affirmed [Sentient](core_05_band_participation.md#sentient) status, or a reviewable narrowing or restoration after adjudication, updates standing-record subject identity going forward; wrongful exclusion must not be backdated to erase interim standing-measurement eligibility without [Redress and Remediation](core_05_band_accountability.md#redress-and-remediation-constitutional).
...
| --- | --- | --- |
| **Constitutional outcome magnitude (LEQU)** | Primary benefit anchor — integrated verified constitutional gain | [Chapter Nine §7](#7-unified-proportional-lequ-scale--contribution-and-violation-axes); `s` = 7 begins at ≥1 LEQU saved or transformed |
...
| **Dimension** | **Role in Q2** | **Corpus anchor** |
| --- | --- | --- |
| **Constitutional outcome magnitude (LEQU)** | Primary and controlling slot input — integrated verified constitutional loss | [Chapter Nine §7](#7-unified-proportional-lequ-scale--contribution-and-violation-axes); Chapter Eleven designation remains separate |
| **Sentient scope (count, depth, vulnerability)** | Modulates LEQU assessment and materiality | [Chapter Nine §5.2](#52-shared-impact-scaling-rules); [Materiality Determination](core_05_band_oversight.md#materiality-determination) |
...
| **Harm-route stack** | Names routes of verified harm; stackable | [**Harm-route descriptor catalog**](#44-violation-route-descriptor-catalog-and-measurement-roles) |
| **Conduct-character stack** | How harm was caused; separately recorded from impact | Duty, negligence, deception, concealment, obstruction of accountability, coercion, violence, intent, cruelty, and structural enablement inform attribution, safeguards, and response but do not move the LEQU slot |
...
**Harm-route descriptors — Question 2 measurement role.** Question 3 integration and attachment rules: [Chapter Ten §3 Descriptor integration and attachment normalization](core_10_standing_integration.md#3-descriptor-integration-and-attachment-normalization). Question 3 prevention and lock design: [Chapter Ten §4.2 Prevention — general standing locks](core_10_standing_integration.md#42-prevention--general-standing-locks); [Chapter Ten §5 Lock design and enforcement](core_10_standing_integration.md#5-lock-design-and-enforcement).
...
| **Deception / concealment / evasion** | Violation conduct-character application in **§4.2** | [Chapter Ten §4.2](core_10_standing_integration.md#42-prevention--general-standing-locks) — concealment / evasion escalated lock |
| **Obstruction of accountability** | Violation conduct-character application in **§4.2** and **Accountability Obstruction Misconduct** in **§4.4** | [Chapter Ten §4.2](core_10_standing_integration.md#42-prevention--general-standing-locks) and [§5.4](core_10_standing_integration.md#54-special-violation-rules) — named-pathway-scoped locks; [Chapter Ten §10.13](core_10_standing_integration.md#1013-obstruction-of-accountability) (*Question 3 pattern*); Chapter Eleven designation only via the Anti-Constitutional Misconduct Review gateway under [Chapter Ten §10.8](core_10_standing_integration.md#108-anti-constitutional-misconduct-allegation) |
| **Violence / coercion / liberty danger** | Violation conduct-character application in **§4.2** and **Violent Misconduct** in **§4.4** | [Chapter Ten §4.2](core_10_standing_integration.md#42-prevention--general-standing-locks) — protective and safeguard locks |
| **Cruelty** | Violation conduct-character application in **§4.2**; [Cruelty](core_05_band_accountability.md#cruelty) | [Chapter Ten §4.2](core_10_standing_integration.md#42-prevention--general-standing-locks) — protective and safeguard locks; [Chapter Ten §4.3](core_10_standing_integration.md#43-voluntary-public-accountability-expression) — non-degrading restorative expression where used |
| **Persistence / pattern / recurrence after notice** | Violation conduct-character application in **§4.2** | [Chapter Ten §4.2](core_10_standing_integration.md#42-prevention--general-standing-locks) — recurrence-persistence lock |
...
| **Diffusion of responsibility or control** | Violation conduct-character application in **§4.2**; actor-specific linkage under **§§3.1 and 3.3** | [Chapter Ten §4.2](core_10_standing_integration.md#42-prevention--general-standing-locks) — broader named pathway scope or institutional-vehicle consideration |
| **System / structural enablement** | Contribution conduct-quality application in **§4.1**; violation conduct character in **§4.2** and **System Misconduct** in **§4.4** | [Chapter Ten §6.2](core_10_standing_integration.md#62-competency-bars-and-clearances) and [Chapter Ten §4.2](core_10_standing_integration.md#42-prevention--general-standing-locks) — delegation safeguards or institutional-vehicle locks |
| **Acquiescent participation / failure to resist** | Violation conduct-character application in **§4.2** | [Chapter Ten §4.2](core_10_standing_integration.md#42-prevention--general-standing-locks) — named-pathway scope and recurrence-persistence effects |
...
| **Accessibility defeat / participation-barrier injury** | **Accessibility and Participation-Barrier Misconduct** in **§4.4** | [Chapter Ten §4.2](core_10_standing_integration.md#42-prevention--general-standing-locks) — named participation- and accessibility-pathway blocks |
| **Privacy / self-ownership injury** | **Privacy and Self-Ownership Misconduct** in **§4.4** | [Chapter Ten §4.2](core_10_standing_integration.md#42-prevention--general-standing-locks) — data-, likeness-, publication-, or internal-state named pathway blocks |
| **Exit / lock-in risk or foreclosure** | Contribution conduct-quality application in **§4.1**; **Exit and Lock-In Misconduct** in **§4.4** | [Chapter Ten §6.2](core_10_standing_integration.md#62-competency-bars-and-clearances) and [Chapter Ten §4.2](core_10_standing_integration.md#42-prevention--general-standing-locks) — delegation safeguards or exit-path blocks |
| **Lifecycle / irreversibility concealment** | **Lifecycle and Irreversibility Misconduct** in **§4.4** | [Chapter Ten §4.2](core_10_standing_integration.md#42-prevention--general-standing-locks) — deployment and lifecycle-authority blocks |
...
| --- | --- | --- |
| **Delay in responding to or escalating the original problem** | **Delay in starting or carrying out the remedy** | The first helps measure Question 2 under **§§4.1–4.2**. The second is a later Question 3 fact under [Chapter Ten §9.5](core_10_standing_integration.md#95-timely-implementation). |
...
**Seats under section 3.7.** The four members are the subjects and, because they seek recognition, the claimants; the member who kept the planting log is its recorder and a witness, not its verifier. The watershed council's designated office — disinterested in the repair and holding published authority to rely on the record — is the record-opening authority under *Informal and small-scope records*; the neighbors are beneficiaries whose attestations enter as inputs. The council's separate records office enters and holds the verified record. The council may host both offices under its published lane map and independence safeguards, but neither office nor any sentient may both verify and enter this record. No forum is needed to open the record; a contest of it, if one comes, goes to the council's challenge lane or a forum under **section 3.6**, not back to the verifying office.
...
**Q2 outputs recorded:** stacked **Ecological Stewardship** and **Diligence** benefit-route descriptors; LEQU and scope inputs ready for calibration and slot assignment under **[section 7](#7-unified-proportional-lequ-scale--contribution-and-violation-axes)**. No standing effects apply in Chapter Nine.
...
*In plain terms: this section gives consistent names to nine possible positions on each of two separate axes and explains how impact scales across them. One axis records verified contribution; the other records verified violations. Sharing a slot number does not combine the axes or offset harm with help. The unified scale in **section 7** assigns both axes by proportional LEQU impact.*
...
**Table 1** names the nine slots and shows the Contribution Axis and Violation Axis display labels side by side. It supplies display language only; slot assignment occurs under the unified scale in **section 7**.

|  `s` | Contribution Axis display label | Violation Axis display label |
| ---: | --- | --- |
|    1 | **Basic Baseline Contribution** | **Minimal Constitutional Impact** |
|    2 | **Strengthened Baseline Contribution** | **Limited Constitutional Impact** |
|    3 | **Verified Positive Contribution** | **Material Constitutional Impact** |
|    4 | **Material Positive Contribution** | **Significant Constitutional Impact** |
|    5 | **Established Stewardship-Positive Contribution** | **Major Constitutional Impact** |
|    6 | **Major Stewardship-Positive Contribution** | **Severe Constitutional Impact** |
|    7 | **Recognized Champion** | **Serious Constitutional Impact** |
...
- a revision must be evidence-based, published, and contestable, and may not be used to suppress recognition of a class of work, a community, or a group, or to ratchet a standard down faster than the verified efficiency gain it rests on ([Chapter One §12 Incentive Alignment and System Capture](core_01_c_stewardship_capacity_principles.md#12-incentive-alignment-and-system-capture));
...
Use the following rules to interpret both axes in **section 7**:
...
*In plain terms: before choosing a slot, identify the constitutional sources that say what baseline, benefit, duty, harm, or violation is being measured. Use the links below to apply those sources at their canonical homes; do not turn this routing step into another score or a substitute definition.*

Before assigning a slot under **section 7**, the standing record must identify:

- the applicable constitutional baseline, duty, constraint, or protected interest;
- the provisions that establish the verified benefit, adverse outcome, harm, or violation being measured;
- the definitions, principles, and Rights-Floor Articles that materially affect magnitude or conduct character; and
- why each identified source applies and how it affects the axis assignment.

The routing tables below are non-exhaustive. Every additional definition, principle, or Article triggered by the verified facts remains applicable and must be identified in the standing record. Each linked canonical home controls; these tables do not restate or narrow it.
...
| --- | --- | --- |
| [Standing State, Contribution, and Violation](core_05_band_accountability.md#standing-state-contribution-and-violation-cluster) | Supplies the joint definition interface for contribution nature, verified inputs, and axis-pure standing records. | Supplies the joint definition interface for violation nature, standing records, and Anti-Constitutional Misconduct Review routing. |
...
| Principle source | Axis-assignment role |
| --- | --- |
| [Constitutional Tetrad](core_00_preamble.md#constitutional-tetrad), [Two Constitutional Aims](core_00_preamble.md#two-constitutional-aims), and [material stake](core_00_preamble.md#material-stake) | Establish the participation, oversight, accountability, and timeliness discipline; the Flourishing and Continuity outcomes; and the scaling frame for every assignment. |
| [Wellbeing](core_01_a_values_principles.md#2-foundational-objective-wellbeing) and [Recognition, Reinforcement, and Aspiration](core_01_a_values_principles.md#22-recognition-reinforcement-and-aspiration) | Ground rights-consistent benefit and proportionate recognition on the Contribution Axis without converting prestige or reward into proof of contribution. |
| [Safety](core_01_a_values_principles.md#31-safety-harm-constraint) and [Truth](core_01_a_values_principles.md#32-truth-epistemic-integrity-constraint) | Bound both axes: benefit produced through harm or deception is not fully countable, and verified safety or truth defeat may establish adverse magnitude or character. |
| [Stewardship In Depth](core_01_c_stewardship_capacity_principles.md#9-stewardship-in-depth) and [Governance Under Stewardship Discipline](core_01_c_stewardship_capacity_principles.md#11-governance-under-stewardship-discipline) | Inform durable contribution, role-linked duty, institutional repair, supervision, and responsibility where the verified facts trigger those principles. |
| [Core Tradeoff Principles](core_01_b_interaction_interpretation.md#61-core-tradeoff-principles) and [Constitutional Floors, Safety, and Process-Character Constraints](core_01_b_interaction_interpretation.md#614-constitutional-floors-safety-and-process-character-constraints) | Apply where the measured conduct invokes necessity, harm minimization, proportionality, a rights collision, or a restriction; they do not independently authorize a consequence. |

<a id="63-rights-floor-and-article-inputs"></a>

#### 6.3 Rights-Floor and Article inputs

| Article source | Axis-assignment role or boundary |
| --- | --- |
| The factually applicable [Chapter Six Rights Floor](core_06_rights_part_a.md#chapter-six-foundational-rights), including every Article materially implicated by the verified record | Establishes the substantive floor, protected interest, duty, benefit, or violation. No Article is excluded because it is not separately listed below. |
| [Article XVIII — Standing and Participation Status](core_06_rights_part_c.md#article-xviii-standing-and-participation-status) | Preserves the distinction between standing, dignity, Rights-Floor minimums, stakeholder status, reputation, and later participation-status effects. |
| [Article XII-B — Right to Challenge, Review, and Redress](core_06_rights_part_c.md#article-xii-b-right-to-challenge-review-and-redress), [Article XIV-B — Transparency, Auditability, and Contestability](core_06_rights_part_c.md#article-xiv-b-transparency-auditability-and-contestability), and [Article XV — Audit, Transparency, and Independent Verification](core_06_rights_part_c.md#article-xv-audit-transparency-and-independent-verification) | Apply where record integrity, disclosure, verification, challenge access, or correction is part of the verified benefit or violation. |
...
<details>
<summary><strong><span style="color: #2563eb;">Reader guidance (non-operative): how the five-times progression works</span></strong></summary>
...
| ---: | --- | --- | --- |
| 1 | Less than about **9 days** | **Basic Baseline Contribution** — verified satisfaction of the constitutional floor for the assessed scope; any measurable uplift remains below `s` = 2. | **Minimal Constitutional Impact** — verified loss or operational impairment below `s` = 2, including a formal defect without proven substantive harm. |
| 2 | About **9–47 days** | **Strengthened Baseline Contribution** — reliable, bounded performance above the minimum floor within this impact level. | **Limited Constitutional Impact** — verified bounded loss at this impact level. |
| 3 | About **47 days–8 months** | **Verified Positive Contribution** — demonstrable benefit beyond baseline at this impact level. | **Material Constitutional Impact** — verified material loss at this impact level. |
| 4 | About **8 months–3.2 years** | **Material Positive Contribution** — deeper, lasting, repeated, vulnerability-responsive, or broader verified benefit. | **Significant Constitutional Impact** — verified significant constitutional loss. |
| 5 | About **3.2–16 years** | **Established Stewardship-Positive Contribution** — durable stewardship, coordination, maintenance, repair, or comparable sustained benefit. | **Major Constitutional Impact** — verified major constitutional loss. |
| 6 | About **16–80 years** | **Major Stewardship-Positive Contribution** — major verified benefit approaching one LEQU. | **Severe Constitutional Impact** — severe verified loss approaching one LEQU. |
