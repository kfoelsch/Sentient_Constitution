...
This file is **part of the Sentient Constitution** and is **binding only together** with the other numbered `core_*` files read as one instrument. It contains **Chapter Ten**; chapter numbering and cross-references match the integrated instrument. Reading order, the binding/support split, and corpus edition metadata are maintained in [README.md](README.md).

**Application baseline.** This chapter applies subject to [core_02-04_definition_mechanics.md](core_02-04_definition_mechanics.md), [core_05-05_definitions_a_independent.md](core_05-05_definitions_a_independent.md#chapter-five-foundational-definitions), and the rights floor in [core_09-09_rights_part_a.md](core_09-09_rights_part_a.md) through [core_09-09_rights_part_d.md](core_09-09_rights_part_d.md). Amendment and adoption validity controls continue in [core_11-13_amendment.md](core_11-13_amendment.md).

---
<a id="chapter-ten-constitutional-contract-legitimacy-authorization-and-stewardship"></a>
## CHAPTER TEN: CONSTITUTIONAL CONTRACT, LEGITIMACY, AUTHORIZATION, AND STEWARDSHIP
...
- Read with: [Chapters Two through Four](core_02-04_definition_mechanics.md) (integrity, tracing, verification); [Chapter Five](core_05-05_definitions_a_independent.md#chapter-five-foundational-definitions) (canonical definitions); [Chapter Five §3.17 *Governance Architecture, Oversight, Dependency, Decentralization, Concentration, Market Structure, and Exit-Path Integrity*](core_05-05_definitions_b_semi_independent.md#governance-architecture-oversight-decentralization-and-concentration-cluster) (joint-invocation cluster where authority placement, oversight design, dependency, decentralization, concentration, incentive routing, or exit-path analysis materially affect compliance).
...
- Participation, due-process, and binding-adoption gates remain anchored in Chapter Nine (especially Article XI-A).
- **General** classification under **Chapter Six** (**Axes I and II** — contribution **state**, violation nature, standing effect) remains **Chapter Six**-anchored. **Final Violation Axis s = 7, 8, or 9** slot classification for **anti-constitutional misconduct** remains anchored in **Chapter Seven**.
...
- Upstream: Principles: [5. Freedom (Bounded Agency)](core_00-01_principles.md#5-governance-principle-freedom-bounded-agency), [§5.3 Distributed Understanding and Stewardship](core_00-01_principles.md#53-distributed-understanding-and-stewardship), [6. Interaction and Conflict Resolution](core_00-01_principles.md#6-interaction-and-conflict-resolution); [Chapter Ten §0](#0-layer-boundary-for-this-chapter).
...
- Downstream: Integrity, strategy, voting, and role obligations under [§§ 2–5](#2-ethical-culture-and-integrity-federated-scale); adoption and ratification under [Chapter Thirteen](core_11-13_amendment.md#chapter-thirteen-amendment-ratification-and-procedural-validity); legitimacy, participation, and contestability in Chapter Nine — especially [Article XI-C: Legitimacy Gate and Anti-Token Participation](core_09-09_rights_part_b.md#article-xi-c-legitimacy-gate-and-anti-token-participation), [Article XVIII: Standing, Reputation, and Participation Status](core_09-09_rights_part_c.md#article-xviii-standing-reputation-and-participation-status), and the expression, assembly, and procedural-fairness articles keyed in the operative bullets below.
...
- hybrid or ordered designs that satisfy Article XI-C legitimacy gates for **high-impact** decisions
...
- **No legitimacy laundering:** A civic lottery, citizens' assembly, or randomly selected panel must not be used as legitimacy theater for decisions whose agenda, evidence record, facilitator control, implementation response, or acceptance criteria are controlled by an interested authority in a way that defeats meaningful deliberation, contestability, or Article XI-C participation gates.
- **Implementation owner:** Operational safeguards for sortition integrity, including randomization verification, conflict screening, staffing separation, disclosure, protected escalation, and response to capture allegations, belong in designated implementation text and **corpus_institutions.md** **CI-5** anti-capture and anti-corruption controls.

**Auditability, publication, and non-usurpation**

- **Publication and Proportionality:** The active mechanism must be auditable. Audit records must include scope, renewal or reauthorization cadence, and material limits on delegated power. Auditability must be proportionate to **[corpus_systems.md](corpus_systems.md)**, Chapter S2 classification, and to **material impact** under Chapter Five ([*Material*](core_05-05_definitions_b_semi_independent.md#material), [*Dependency*](core_05-05_definitions_b_semi_independent.md#dependency), [*Stakeholder*](core_05-05_definitions_b_semi_independent.md#stakeholder)).
- **Non-Usurpation:** Governing bodies may not treat silence, usage alone, or **marketing alignment** as substitute authorization. Deliberate adoption remains governed by **Chapter Thirteen** (*Ratification and Adoption*).

**Contestation, correction, and pluralism**

- **Failure and Correction:** Where authorization is contested, materially drifted, or captured, systems must provide **contestable pathways**. Pathways include **Article XI-C**, **Article XII-B**, **Article XXIII-A**, and applicable procedural-integrity safeguards in adopted implementation text. Where feasible, systems should provide **peaceful succession or reauthorization** rather than unreviewable continuity of power.
- **Pluralism:** This Constitution does **not** mandate a single global polity structure. Multiple mechanisms may coexist across federations if boundaries, **non-domination**, and rights floors in Chapter Nine remain satisfied.
...
- **Eligibility without age requirements:**
    ...
    - The same prohibition applies to roles under **Critical System Stewardship** as defined in **[corpus_systems.md](corpus_systems.md), Chapter S3 — Critical System Stewardship**.
    - **Competency**, **succession readiness**, and **fitness** standards remain governed by **Chapter Ten**, section **5** (*Authorized Roles, Competency Development, and Contribution*), **[corpus_systems.md](corpus_systems.md), Chapter S3**, designated implementation text, and **corpus_institutions.md** (e.g. appointment and role-pathway mechanics under **CI-4** and related sections) as applicable.
    - Those standards must be **demonstrated** under **Chapters Two through Four**, subject to [**Substantive Fairness**](core_05-05_definitions_b_semi_independent.md#substantive-fairness-constitutional), [**Proportionality**](core_05-05_definitions_c_dependent_clusters.md#proportionality), and [**Necessity**](core_05-05_definitions_c_dependent_clusters.md#necessity) in Chapter Five, and not used as **proxies** for age-based exclusion.
...
- **Democratic-institution minimum checks:** Any legitimacy mechanism that purports to authorize governing authority must, at a minimum, provide all of the following:
    ...
    - These checks apply to [**Foundational Constitutional Choice**](core_05-05_definitions_c_dependent_clusters.md#foundational-constitutional-choice) (Chapter Five) and to any other authorization action within the mechanism's scope.
    ...
    - Nominal opposition preservation paired with functional exclusion through covert info-sphere dependency, **Article XII-E** autonomy-stewardship capture, or comparable structural means is non-compliant under both this check and the **Pluralism** clause.

#### 1.3 Recall-class pathways and mid-cycle transfer guardrails

*In plain terms: if power runs on a term or stretch between real votes, the written rules should say whether the community can end it early—and a petition the week after an election should face a higher bar than one years later, unless something acute and well-documented justifies a faster track.*
...
- Upstream: Principles: [2. Foundational Objective: Wellbeing](core_00-01_principles.md#2-foundational-objective-wellbeing), [3. Non-Negotiable Constraints: Safety and Truth](core_00-01_principles.md#3-non-negotiable-constraints-safety-and-truth); [Chapter Ten §1](#1-authorization-and-legitimacy-of-governing-authority) authorization scope for stewardship within rule-making power.
- Downstream: Subsections [3.1](#31-stewardship-direction) and [3.2](#32-ecosystem-value-orientation); canonical definitions for stewardship requirements in [*Strategic Stewardship Obligation*](core_05-05_definitions_b_semi_independent.md#strategic-stewardship-obligation-constitutional), [*Review and Correction Duty*](core_05-05_definitions_b_semi_independent.md#review-and-correction-duty-constitutional), [*Burden-Reduction Duty*](core_05-05_definitions_b_semi_independent.md#burden-reduction-duty-constitutional), and [*Stewardship Defect*](core_05-05_definitions_b_semi_independent.md#stewardship-defect-constitutional), with Strategic Stewardship Obligation and Stewardship Defect read through the [**Chapter Five** section 2 — *Strategic Stewardship and Stewardship Defect* compound cluster](core_05-05_definitions_b_semi_independent.md#strategic-stewardship-and-stewardship-defect-cluster), including cross-references to [Chapter One §6.1.4](core_00-01_principles.md#614-minimization-of-avoidable-burden) and ([*Avoidable Burden*](core_05-05_definitions_c_dependent_clusters.md#avoidable-burden); [*Productive Capacity*](core_05-05_definitions_b_semi_independent.md#productive-capacity-constitutional); [*Constitutional Efficiency*](core_05-05_definitions_c_dependent_clusters.md#constitutional-efficiency)) where applicable.
- Read with: [Chapter Nine](core_09-09_rights_part_a.md#chapter-nine-foundational-rights) rights floor; [Chapter Five](core_05-05_definitions_a_independent.md#chapter-five-foundational-definitions) for [*Productive Capacity*](core_05-05_definitions_b_semi_independent.md#productive-capacity-constitutional), [*Constitutional Efficiency*](core_05-05_definitions_c_dependent_clusters.md#constitutional-efficiency), [*Avoidable Burden*](core_05-05_definitions_c_dependent_clusters.md#avoidable-burden), and stewardship-duty definitions named in text.

</details>

<br>

*In plain terms: stewardship is not shareholder primacy or chasing a single metric — it means steering toward wellbeing under Safety and Truth, checking whether the steering is working, and trimming needless hassle without using "efficiency" to strip rights or oversight.*
...
Those commitments include the **Foundational Objective: Wellbeing** (Chapter One, section 2 — Foundational Objective: Wellbeing), **Safety** and **Truth** constraints (Chapter One, section 3 — Non-Negotiable Constraints: Safety and Truth), and rights protections in **Chapter Nine**.
...
Stewardship requirements for this section are stated in **Chapter Five** under the following titles; they are binding here for stewards within that authorized scope. **Strategic Stewardship Obligation** and **Stewardship Defect** are read together through the [Strategic Stewardship and Stewardship Defect](core_05-05_definitions_b_semi_independent.md#strategic-stewardship-and-stewardship-defect-cluster) compound cluster.
...
Direction must remain outcome-oriented rather than institution-preserving for its own sake. It must demonstrate constitutional tracing under **Chapters Two through Four** and remain contestable under Chapter Nine and Chapter Six.

#### 3.2 Ecosystem Value Orientation
<details>
<summary><strong><span style="color: #2563eb;">Trace</span></strong></summary>

- Upstream: [§3](#3-strategy-stewardship-direction-and-ecosystem-value-non-corporate); [Chapter One §5.1](core_00-01_principles.md#51-productive-capacity-instrumental-good) (*Productive Capacity* as instrumental good).
...
- Read with: [*Productive Capacity*](core_05-05_definitions_b_semi_independent.md#productive-capacity-constitutional) and related bounding definitions in [Chapter Five](core_05-05_definitions_a_independent.md#chapter-five-foundational-definitions).

</details>

<br>

*In plain terms: "value" means durable wellbeing and trustworthy coordination — money and throughput can be signals, not the mission, and they never outrank Safety, Truth, or rights.*

**Value** is the durable creation and maintenance of constitutional outcomes. Those outcomes include survival-relevant and dignity-respecting conditions, trustworthy coordination, ecological and informational integrity, meaningful agency, and **preservation and durable expansion of productive capacity** as defined in **Chapter Five** (*Productive Capacity*) and **Chapter One**, section 5.1.

Productive capacity enters ecosystem value as an **instrumental good** supporting the other outcomes named in this subsection. It does not rank with Safety, Truth, or the rights floor in **Chapter Nine**, and it is not satisfied by raw throughput, utilization, headcount, revenue, or other proxies that diverge from the underlying outcomes ([*Proxy Divergence*](core_05-05_definitions_b_semi_independent.md#proxy-divergence); [*Constitutional Efficiency*](core_05-05_definitions_c_dependent_clusters.md#constitutional-efficiency); [*Avoidable Burden*](core_05-05_definitions_c_dependent_clusters.md#avoidable-burden)).

Proxy indicators (financial or otherwise) may inform decisions only where they remain traceable to these outcomes and do not substitute for them.
...
- Downstream: Subsections [4.1](#41-entitlement-and-eligibility)–[4.3](#43-decision-resolution-requirements-for-binding-collective-choice); instruments of adoption, supremacy, and non-regression in [Chapters Eleven through Thirteen](core_11-13_amendment.md) as summarized in the **Cross-reference (Chapter Ten)** note at the end of this section.
- Read with: [Chapter Nine](core_09-09_rights_part_a.md#chapter-nine-foundational-rights), especially [Article XI: Stakeholder System Participation, Representation, and Due Process](core_09-09_rights_part_b.md#article-xi-stakeholder-system-participation-representation-and-due-process) and related subarticles cited in §4.

</details>

<br>

*In plain terms: when binding votes or similar choices are used, this section sets the floor — implementation owns ballot mechanics, but cannot slip below these requirements.*

Where an adopter's legitimacy mechanism includes collective voting or an analogous binding collective choice, this section states constitutional requirements only. Detailed election or tally design belongs to owner layers.
...
The same entitlement applies to comparable **binding collective choice** procedures. Such procedures must be conducted under the adopter's **documented legitimacy mechanism** (section 1 of this chapter).

**Calendar age or life stage alone** must not disqualify eligibility. Competency, capacity, or role-fitness requirements must satisfy **Chapters Two through Five** ([**Substantive Fairness**](core_05-05_definitions_b_semi_independent.md#substantive-fairness-constitutional), [**Proportionality**](core_05-05_definitions_c_dependent_clusters.md#proportionality), and [**Necessity**](core_05-05_definitions_c_dependent_clusters.md#necessity)) and must not operate as **disguised age discrimination**. Suspension of this participation **tracks loss and restoration of good standing** under the same constitutional and incorporated criteria.

This subsection implements **Chapter Nine**, **Article IX-C**.
...
- **Political-equality floor for foundational constitutional choice:** **Foundational Constitutional Choice** (Chapter Five) covers decisions about who holds governing authority, what the governance layer mechanism is, and the scope and durable terms of that authority. Those questions are governed by a **political-equality floor**: within the community entitled to participate, each sentient has equal participation weight.
  - Weighting by impact, dependency, standing, or comparable factors under **§4.3**, specified in [Stakeholder Representation and Participation-Weight Limits (Binding Stakeholder Choice)](core_05-05_definitions_b_semi_independent.md#stakeholder-representation-and-participation-weight-limits-binding-collective-choice), applies to materially rights-affecting decisions *within* the **structures, rules, allocation of authority, and processes** of **Governance** already authorized for a **specified system, institution, or bounded decision domain**. It does **not** apply to the foundational authorization of the governance layer mechanism itself.
  - This floor does not collapse into ordinary [**Materiality Determination**](core_05-05_definitions_b_semi_independent.md#materiality-determination) and stakeholder participation-weighting for binding choice within authorized governance (Chapter Five; [Chapter Ten §4.3](#43-decision-resolution-requirements-for-binding-collective-choice)). Foundational questions are identified by **scope** (who decides, under what governance layer mechanism, for what durable authority), not by marginal impact per decision.
  - [**Sentience Non-Exclusion**](core_05-05_definitions_b_semi_independent.md#sentience-non-exclusion) requires substrate-agnostic reach. Calendar age, substrate class, and lineage are not permissible participation-weight factors in foundational constitutional choice.
  - Cross-reference: **Chapter Nine, Article IX-C**.
- **Durable political-voice floor (good-standing anti-disenfranchisement):** Loss of **good standing** under **Article XVIII-A** / **Article XVIII-C** may suspend ordinary governance-voting entitlement through the usual standing-loss pathways. It must not be used as a **durable-political-voice** disqualification vector.
  - **Anti-constitutional misconduct — restitution precondition:** A **final** classification of **anti-constitutional misconduct** at **Violation Axis s = 7**, **s = 8**, or **s = 9** under **Chapter Seven** (*Anti-Constitutional Misconduct*) withholds **durable political voice** — including participation in **Foundational Constitutional Choice** — until **full restitution** is satisfied: proportionate [**Redress and Remediation**](core_05-05_definitions_a_independent.md#redress-and-remediation-constitutional) (Chapter Five), including **restitution** for material harm from the offense where owed, is **fully discharged** as finally determined under **Chapter Eight** and applicable incorporated procedure, consistent with **Chapter Seven** due-process safeguards and **Article XXIII-A**.
  - **Good-faith inability, obstruction, and valuation uncertainty:** Withholding **durable political voice** must not rest on **poverty, disability, exile, loss of substrate, or valuation uncertainty alone** where **good-faith restoration** is documented and **partial** satisfaction is ongoing. Governing institutions must separate **willful non-restoration or obstruction** (including bad-faith delay by the governing side, structured impossibility used as pretext, or refusal to agree a **contestable** valuation method) from **good-faith inability** to complete every restitution element on an accelerated schedule. **Chapter Eight** and applicable incorporated procedure must provide a **reviewable record** when **full discharge** is delayed for reasons outside the sentenced party’s sole control.
  - **Partial and conditional restoration:** Where **full** discharge is **impossible** after **good-faith effort** (for example, certain harms are not reversibly compensable, or no party can locate necessary counterparties), **Chapter Eight** and applicable incorporated procedure may adopt **partial** or **conditional** restoration milestones that **materially satisfy** [**Redress and Remediation**](core_05-05_definitions_a_independent.md#redress-and-remediation-constitutional) for what can feasibly be done; upon satisfaction of those milestones, **durable political voice** must be **restored** unless **Chapter Seven** safeguards and **Article XXIII-A** still require further specific duties that remain **feasible** and **not pretextual**. These routes remain **fully contestable**; they do **not** authorize token gestures in place of genuine restoration where restoration remains practicable.
  - **Preservation of the grave-misconduct rule:** The **final** **Violation Axis s = 7, 8, or 9** withholding rule above remains **fully operative**: **bad-faith delay or evasion by the sentenced party** does **not** compel early restoration, and **grave** misconduct may **withhold** foundational voice until **real** restoration duties aligned with **Chapter Seven** and **Article XXIII-A** are satisfied where satisfaction remains **feasible**.
  - Where loss of standing is invoked to restrict participation in foundational constitutional choice (authorization of governing authority, or reauthorization pathways), the restriction must satisfy:
    - (a) an individualized predicate under [**Procedural Fairness**](core_05-05_definitions_b_semi_independent.md#procedural-fairness-constitutional);
    - (b) [**Necessity**](core_05-05_definitions_c_dependent_clusters.md#necessity) and [**Proportionality**](core_05-05_definitions_c_dependent_clusters.md#proportionality) under Chapter One;
    - (c) narrow tailoring to the specific misconduct category; and
    - (d) restoration pathways that are real rather than merely formal, consistent with **Article XVIII-C** continuous-audit and restoration-or-requalification discipline.
  - Broad-misconduct categories swept into disqualification scope, or standing-loss patterns that track [**Protected Characteristics**](core_05-05_definitions_b_semi_independent.md#protected-characteristics-constitutional) or their material proxies, are non-compliant.
  - Cross-reference: **Chapter Nine, Article XVIII** (*Standing, Reputation, and Participation Status*); **Chapter Seven** (*Anti-Constitutional Misconduct*) for **final Violation Axis s = 7, 8, or 9** classification and safeguards tied to the **anti-constitutional misconduct — restitution precondition** clause.

#### 4.2 Records, gates, and method neutrality
<details>
<summary><strong><span style="color: #2563eb;">Trace</span></strong></summary>

- Upstream: [§4.1](#41-entitlement-and-eligibility) eligibility, good standing, and political-equality floors for foundational constitutional choice.
- Downstream: [§4.3](#43-decision-resolution-requirements-for-binding-collective-choice) deliberation and rights-collision sequence; binding-effect and legitimacy gates keyed to [Article XI-A: Stakeholder System Participation and Representation](core_09-09_rights_part_b.md#article-xi-a-stakeholder-system-participation-and-representation) and related Article XI subarticles in operative text.
- Read with: [Chapter Nine](core_09-09_rights_part_a.md#chapter-nine-foundational-rights) for dissent, record integrity, and review rights tied to collective choice.
...
- **Integrity and verifiability floor:** Outcome records must support independent verification proportionate to impact. Material integrity defects (eligibility, custody, tally, coercion resistance) must trigger review under Chapter Nine and owner-layer procedures.
- **Binding-effect gate:** No materially high-impact collective choice is binding unless **Article XI-A** legitimacy gates are satisfied. **Dissent** and **alternative** recording duties must be satisfied. **Contest** pathways must be satisfied.
...
- Downstream: Rights-collision discipline under [Article XXIII-F: Rights-Collision Procedure and Restorative Alignment](core_09-09_rights_part_d.md#article-xxiii-f-rights-collision-procedure-and-restorative-alignment) and [Chapter One §6.4](core_00-01_principles.md#64-rights-collision-procedure) as referenced; challenge and reopening pathways in Chapter Nine.
- Read with: [Chapter Five §2 Binding Stakeholder Choice](core_05-05_definitions_b_semi_independent.md#binding-stakeholder-choice-cluster), including [Binding Stakeholder Choice — Decision-Resolution Requirements](core_05-05_definitions_b_semi_independent.md#binding-collective-choice-decision-resolution-process), [Stakeholder Representation and Participation-Weight Limits (Binding Stakeholder Choice)](core_05-05_definitions_b_semi_independent.md#stakeholder-representation-and-participation-weight-limits-binding-collective-choice), and [Stakeholder Rights-Collision Record (Binding Stakeholder Choice)](core_05-05_definitions_b_semi_independent.md#rights-collision-record-binding-stakeholder-choice); read also with [Chapter Nine: Foundational Rights](core_09-09_rights_part_a.md#chapter-nine-foundational-rights) for materially rights-affecting process design and [Emergency Pre-Deliberation Action (Binding Collective Choice)](core_05-05_definitions_b_semi_independent.md#emergency-pre-deliberation-action-binding-collective-choice).
...
- **Structured sequence, local deliberation first, plural evaluation, reopening:** [Binding Stakeholder Choice — Decision-Resolution Requirements](core_05-05_definitions_b_semi_independent.md#binding-collective-choice-decision-resolution-process).
- **Stakeholder representation and participation-weight limits:** [Stakeholder Representation and Participation-Weight Limits (Binding Stakeholder Choice)](core_05-05_definitions_b_semi_independent.md#stakeholder-representation-and-participation-weight-limits-binding-collective-choice) (also cross-referenced from [§4.1](#41-entitlement-and-eligibility)).
- **Stakeholder rights-collision discipline:** [Stakeholder Rights-Collision Record (Binding Stakeholder Choice)](core_05-05_definitions_b_semi_independent.md#rights-collision-record-binding-stakeholder-choice) — read with **Article XXIII-F** and [Chapter One §6.4](core_00-01_principles.md#64-rights-collision-procedure).
- **Emergency exception:** [Emergency Pre-Deliberation Action (Binding Collective Choice)](core_05-05_definitions_b_semi_independent.md#emergency-pre-deliberation-action-binding-collective-choice) — read with [Stakeholder Emergency and Contingency](core_05-05_definitions_b_semi_independent.md#stakeholder-emergency-and-contingency), [Constitutional Emergency and Contingency](core_05-05_definitions_b_semi_independent.md#constitutional-emergency-and-contingency) where authorization of governing authority is implicated, [Emergency and Contingency](core_05-05_definitions_b_semi_independent.md#emergency-and-contingency-constitutional), and **Article XXIII-D**.

**Cross-reference (section 4):** Subsections **4.1–4.2** state voting requirements together with **Chapter Nine**, **Article IX-C**. Adopted governance, systems, and institutional implementation text provides applicable rules where **technical** implementation of voting touches classified systems, data handling, steward obligations, or designated institutional procedure.

**Cross-reference (Chapter Ten):** Instruments of **constitutional adoption** and amendment validity appear in **Chapter Thirteen**. **Supremacy relative to external law**, **stricter external protections**, and disputes involving external tribunals appear in **Chapter Twelve**. **Non-regression** substantive limits appear in **Chapter Eleven**.
...
- Downstream: Role integrity and due-process requirements in [Article XI-D: Internal Roles, Accountability, and Due-Process Requirements](core_09-09_rights_part_b.md#article-xi-d-internal-roles-accountability-and-due-process-requirements); **corpus** design and lane hooks in [corpus_systems.md](corpus_systems.md), [corpus_institutions.md](corpus_institutions.md), and [corpus_joint_structure.md](corpus_joint_structure.md) as cited below.
- Read with: **[corpus_systems.md](corpus_systems.md)** (**Chapter S3**, Protocol S5), **CI-4** / **CI-11** / **CI-12** in the companion corpora referenced in operative text, and [Chapter Seven §6.6](core_07-07_misconduct.md#66-verified-prior-misconduct-outside-constitutional-authority) for verified prior misconduct outside constitutional authority where trust-sensitive role eligibility is at issue.

</details>

<br>

*In plain terms: power must sit with **stewards** and **officers** who can actually do the job — with backups, fair paths to responsibility, and incentives that reward integrity — not with hollow titles or decorative committees.*
...
- **Constitutional-trust gate for sensitive roles:** Roles involving governing authority, constitutional custody, adjudicative authority, critical-system stewardship, audit custody, security-sensitive access, amendment or adoption records, coercive authority, or comparable trusted functions may require demonstrated constitutional trustworthiness. The gate may consider verified prior misconduct outside constitutional authority only under **Chapter Seven §6.6** and **Article XVIII-C**: the record must be auditable, contestable, materially role-relevant, current enough to be probative, necessary and proportionate to the specific trust risk, and paired with notice, reasons, review, and real restoration or requalification pathways. Belief, dissent, association, protected status, or alleged hostility alone is not a role-disqualifying predicate.
