<a id="chapter-thirteen-constitutional-contract-legitimacy-authorization-and-stewardship"></a>
...
>
> This file is **part of the Sentient Constitution** and is **binding only together** with the other numbered `core_*` files read as one instrument. It contains **Chapter Thirteen**, the **Constitutional Contract Layer** — constitutional legitimacy and stewardship requirements for governing authority, distinct from **Stakeholder System Participation** in already-authorized systems ([Preamble](core_00_preamble.md#chapter-00-preamble--foundational-requirements)). Amendment and adoption validity controls continue in [Chapters Fourteen through Sixteen](core_14_non_regression.md#chapter-fourteen-non-regression-and-substantive-amendment-validity). Chapter numbering and cross-references match the integrated instrument. Reading order, the binding/support split, and corpus edition metadata are maintained in [README.md](README.md).
...
Chapter Thirteen is the constitutional owner of **constitutional-contract legitimacy, stewardship direction, concentration, and democratic checks**.
...
- Downstream: [§§ 1–5](#1-authorization-and-legitimacy-of-governing-authority) (stewardship and collective-choice requirements in this chapter); [Chapter Nine](core_09_standing_assessment.md#chapter-nine-compliance-violation-and-standing-model) general **contribution, violation, and standing** measurement (Contribution Axis and Violation Axis), including all numeric impact slots; [Chapter Eleven](core_11_a_misconduct_designation.md#chapter-eleven-anti-constitutional-misconduct) final anti-constitutional-misconduct designation for qualifying **Violation Axis s = 7, 8, or 9** findings.
...
- **Eligibility without age requirements:**
    ...
    - **Competency**, **succession readiness**, and **fitness** standards remain governed by **Chapter Thirteen**, section **5** (*Authorized Roles, Competency Development, and Contribution*), **[corpus_systems.md](corpus_systems.md), CS-4 — Critical system stewardship**, designated implementation text, and **corpus_institutions.md** (e.g. appointment and role-pathway mechanics under **CI-4** (*Appointment, competency, rotation, and removal*) and related sections) as applicable.
...
- Downstream: Legitimacy sufficiency ties to [§3](#3-strategy-stewardship-direction-and-ecosystem-value-non-corporate); observable integrity feeds **Axis I / II** evaluation under [Chapter Nine](core_09_standing_assessment.md#chapter-nine-compliance-violation-and-standing-model) where applicable.
...
Direction must remain outcome-oriented rather than institution-preserving for its own sake. It must demonstrate constitutional traceability under **Chapters Two through Four** and remain contestable under Chapter Six and Chapter Nine.

#### 3.2 Ecosystem Value Orientation
<details>
<summary><strong><span style="color: #2563eb;">Trace</span></strong></summary>

- Upstream: [§3](#3-strategy-stewardship-direction-and-ecosystem-value-non-corporate); [Chapter One §13.1](core_01_c_stewardship_capacity_principles.md#131-productive-capacity-instrumental-good) (*Productive Capacity* as instrumental good).
...
**Sentients** are entitled to participate in **governance voting** when published eligibility criteria are met and no applicable [standing lock](core_10_standing_integration.md#42-prevention--general-standing-locks) blocks the **governance-voting** pathway. Eligibility criteria remain contestable under **Article XVIII-A** (*Standing Distinction*) and **Article XVIII-C** (*Named-Pathway Eligibility, Responsibility, and Continuous Audit*), together with any designated incorporated criteria. Those criteria may not narrow constitutional limits.
...
- **Durable political-voice floor (anti-disenfranchisement):** A standing lock on the **governance-voting** pathway may suspend ordinary governance-voting entitlement. It must not be used as a **durable-political-voice** disqualification vector.
  ...
  - Where a standing lock or restitution withholding is invoked to restrict participation in foundational constitutional choice (authorization of governing authority, or named reauthorization pathways), the restriction must satisfy:
    ...
    - (d) restoration pathways that are real rather than merely formal, consistent with **Article XVIII-C** (*Named-Pathway Eligibility, Responsibility, and Continuous Audit*) continuous-audit and restoration-or-requalification discipline.
...
- **Authorized-role and competency floor:** Adopters must maintain documented, auditable, and challengeable role definitions and competency or succession capacity proportionate to impact and classification. A role definition states, act by act, which seats the role holds under [Chapter Seven §2 Four-Seat Constitutional Floor](core_07_functional_independence_segregation_of_duties.md#2-four-seat-constitutional-floor), and states its operational boundary. Those seats are who may:
  - request;
  - verify;
  - record;
  - hear a challenge;
