...
**Sentients** are entitled to participate in **governance voting** when published eligibility criteria are met and no applicable [standing lock](core_10_standing_integration.md#42-prevention--general-standing-locks) blocks the **governance-voting** pathway. Eligibility criteria remain contestable under **Article XVIII-A** (*Standing Distinction*) and **Article XVIII-C** (*Pathway Eligibility, Responsibility, and Continuous Audit*), together with any designated incorporated criteria. Those criteria may not narrow constitutional limits.
