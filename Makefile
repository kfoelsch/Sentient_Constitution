...
nested-list-candidates:
	$(PYTHON) tools/ch5_nested_list_candidate_audit.py --root . --chapter 5 --chapter 6 --chapter 7 --chapter 8 --chapter 9 --chapter 10 --chapter 11 --chapter 12
