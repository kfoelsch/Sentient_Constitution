...
nested-list-candidates:
	$(PYTHON) tools/ch5_nested_list_candidate_audit.py --root . --chapter 0 --chapter 1 --chapter 2 --chapter 3 --chapter 4 --chapter 5 --chapter 6 --chapter 7 --chapter 8 --chapter 9 --chapter 10 --chapter 11 --chapter 12 --chapter 13 --chapter 14 --chapter 15 --chapter 16
