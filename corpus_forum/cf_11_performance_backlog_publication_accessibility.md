# CF-11: Forum performance, backlog requirements, publication timeliness, and accessibility
...
This section applies to all forum families recognized in `core_11_forum.md` **Chapter Eleven**, including any specialist chamber or designated technical panel operating within those families.
...
*In plain terms: Performance is measured by what an affected party can actually do: find out where the matter stands, reach a forum without unreasonable delay, and challenge a decision while the remedy still matters.*
...
## CF-11.2 Urgency-scaled service requirements (notice through remediation closure)
<details>
<summary><strong><span style="color: #2563eb;">Trace</span></strong></summary>
...
*In plain terms: Timing requirements scale with urgency and cover the whole span — from first notice through to remediation actually being closed out, not merely ordered.*

### CF-11.2.1 Purpose and owner boundary
<details>
<summary><strong><span style="color: #2563eb;">Trace</span></strong></summary>
...
- remediation ownership, reassessment, and closure where a threshold condition or forum-caused harm is found.

### CF-11.2.3 Minimum urgency levels
<details>
<summary><strong><span style="color: #2563eb;">Trace</span></strong></summary>
...
## CF-11.3 Metric registry and reporting taxonomy
...
Forum-damage ratings must identify severity, affected population, reversibility, dependency exposure, Rights Floor implications, causal link to forum action or inaction, and whether the harm is isolated, recurring, systemic, or structurally unremediable. The constitutional-alignment score is an operational performance measure only: it may incorporate Chapter Eight and Chapter Nine standing-record outputs where verified, but it must not merge Contribution Axis and Violation Axis inputs into a substitute standing effect, reputation label, or Chapter Ten classification.

### CF-11.3.1 Target windows and timing floors
<details>
<summary><strong><span style="color: #2563eb;">Trace</span></strong></summary>

- Upstream: [CJS-1.3](../corpus_joint_structure/cjs_01_scope_purpose_boundary_interface.md#cjs-13-shared-implementation-corpus-preamble-contract) shared implementation-corpus contract; [CJS-0.1](../corpus_joint_structure/cjs_00_registry_and_reading_rules.md#cjs-01-topic-router-stable-ids) topic router; [Chapter Eleven §6](../core_11_forum.md#6-timely-resolution-materiality-tiers-and-anti-delay-discipline) (*materiality tiers and pipeline milestones*); [Article XXIV-C](../core_06_rights_part_d.md#article-xxiv-c-timely-resolution-and-anti-delay-floor) (*Timely Resolution and Anti-Delay Floor*); [Chapter Sixteen](../core_16_incorporation.md#chapter-sixteen-incorporation-bridge) incorporation discipline; and [Chapter Five](../core_05__definitions_home.md#chapter-five-foundational-definitions) canonical definitions.
...
**Article XXIV-C** (*Timely Resolution and Anti-Delay Floor*) tier-default windows (adopter floor). This table implements [Chapter Eleven §6](../core_11_forum.md#6-timely-resolution-materiality-tiers-and-anti-delay-discipline) and **Article XXIV-C** (*Timely Resolution and Anti-Delay Floor*). Until a forum family publishes calibrated targets, the following **maximum** windows apply from the triggering event (filing, protected report, or lawful agency referral) unless a narrower window is required by **Rights-Floor** urgency or **Force Majeure** is documented:
...
| **Question 1** — verified finding → **standing record** opened ([Chapter Eight §2](../core_08_standing_assessment.md#2-standing-records)) | ≤ 3 calendar days | ≤ 7 calendar days | ≤ 21 calendar days | ≤ 45 calendar days | ≤ 60 calendar days |
| **Question 2** — measurement ([Chapter Eight §4](../core_08_standing_assessment.md#4-standing-measurement-evaluation-dimensions)) | ≤ 1 calendar day after verified inputs complete | ≤ 5 calendar days | ≤ 14 calendar days | ≤ 30 calendar days | ≤ 45 calendar days |
| **Question 3** — integration ([Chapter Nine](../core_09_standing_integration.md#chapter-nine-standing-effects-and-integration)) | ≤ 2 calendar days after Q2 | ≤ 7 calendar days | ≤ 21 calendar days | ≤ 30 calendar days | ≤ 45 calendar days |
...
**Outer-bound rule.** Stage windows above must fit inside the tier’s integrated-resolution outer bound. Those outer bounds implement [Chapter Eleven §6](../core_11_forum.md#6-timely-resolution-materiality-tiers-and-anti-delay-discipline) (one week / three weeks / two months / four months / six months). Going past any outer bound requires documented extension under **Article XXIII-D** (*Continuation discipline*) with continuing necessity, proportionality, and absence of less-restrictive feasible alternatives.

**Complexity-extended later stages.** Where a classified **Tier A** or **Tier B** matter requires multi-party, cross-border, or consolidated fact-development, later-stage windows (**Question 1** through integrated resolution) may use the next slower column’s numbers under documented **Article XXIII-D** continuation discipline. Intake, evidence preservation, and interim protection stay at the classified tier. That use is a time-scale extension, not a reclassification. Final Chapter Eight **Violation Axis s = 7, 8, or 9** review or corresponding **Chapter Ten** designation is typically **Tier A**, not a reason to apply **Tier C** clocks.

**Restore-challenge after emergency.** The same outer bounds are the default restore-challenge windows after [**Article XXIII-D**](../core_06_rights_part_d.md#xxiii-d-restore-challenge-clocks) containment. The clock starts at containment or deferral, not at later filing. Stage windows above must not slow that restoration.
...
### CF-11.3.2 Publication timeliness
...
### CF-11.3.3 Restricted-evidence timing
<details>
<summary><strong><span style="color: #2563eb;">Trace</span></strong></summary>
...
## CF-11.4 Performance thresholds and alerts
...
- accuracy concern threshold triggers review of affected decisions, reviewing-pathway patterns, evidence handling, training, doctrine, independence, and corrective-record practices;
...
- the affected KPI or threshold category, including forum-damage rating and constitutional-alignment score where the threshold crossing affects either measure;
...
## CF-11.6 Forum-performance review cadence

*In plain terms: Performance must be reviewed on a fixed schedule and compared against earlier periods, so a slow slide is visible before it becomes a crisis.*
...
Forum families must avoid unnecessary legal or institutional jargon in public-facing procedure maps, notices, standard forms, routing explanations, and reasoned decisions.

Where technical or legal terms are necessary, they must come with accurate plain-language explanations. Everyday sentients must be able to understand what is happening, what choices or obligations they have, and what review or challenge path remains available.
...
## CF-11.8 Contest-integrity monitoring interface
...
*In plain terms: Named failure shapes that are presumed non-compliant — chronic delay concentrated in emergency matters, backlogs that predictably defeat remedy, and unexplained publication delay on significant rulings.*
...
## CF-11.10 Lived conditions during restriction and re-entry alignment (cross-layer)
<details>
<summary><strong><span style="color: #2563eb;">Trace</span></strong></summary>
...
**Previous file:** [cf_10_technical_specialist_forums_specialist_chambers.md](cf_10_technical_specialist_forums_specialist_chambers.md)

**Next file:** [cf_12_forum_continuity.md](cf_12_forum_continuity.md)
