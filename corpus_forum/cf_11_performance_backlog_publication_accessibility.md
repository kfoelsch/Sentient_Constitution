...
| **Remedy parity and lock-to-remedy capacity** | General locks issued, remedies commenced, remedies completed, restorations decided, and reassessments pending, by lock class; the ratio of locks issued to remedies commenced and restorations decided; whether the [Chapter Ten §4.4](../core_10_standing_integration.md#44-remedy-parity-and-lock-preconditions) tripwire is armed. | Forum family, lock class, **CF-11.2** urgency level, and period. | Shows whether lock capacity is outrunning remedy, restoration, and reassessment capacity. |
...
Forum-damage ratings must identify severity, affected population, reversibility, dependency exposure, Rights Floor implications, causal link to forum action or inaction, and whether the harm is isolated, recurring, systemic, or structurally unremediable. The constitutional-alignment score is an operational performance measure only: it may incorporate Chapter Nine and Chapter Ten standing-record outputs where verified, but it must not merge Contribution Axis and Violation Axis inputs into a substitute standing effect, reputation label, or Chapter Eleven classification.

### CF-11.3.1 Target windows and timing floors
<details>
<summary><strong><span style="color: #2563eb;">Trace</span></strong></summary>

- Upstream: [CJS-1.3](../corpus_joint_structure/cjs_01_scope_purpose_boundary_interface.md#cjs-13-shared-implementation-corpus-preamble-contract) shared implementation-corpus contract; [CJS-0.1](../corpus_joint_structure/cjs_00_registry_and_reading_rules.md#cjs-01-topic-router-stable-ids) topic router; [Chapter Twelve §6](../core_12_forum.md#6-timely-resolution-materiality-tiers-and-anti-delay-discipline) (*materiality tiers and pipeline milestones*); [Article XXIV-C](../core_06_rights_part_d.md#article-xxiv-c-timely-resolution-and-anti-delay-floor) (*Timely Resolution and Anti-Delay Floor*); [Chapter Seventeen](../core_17_incorporation.md#chapter-seventeen-incorporation-bridge) incorporation discipline; and [Chapter Five](../core_05__definitions_home.md#chapter-five-foundational-definitions) canonical definitions.
...
**Article XXIV-C** (*Timely Resolution and Anti-Delay Floor*) tier-default windows (adopter floor). This table implements [Chapter Twelve §6](../core_12_forum.md#6-timely-resolution-materiality-tiers-and-anti-delay-discipline) and **Article XXIV-C** (*Timely Resolution and Anti-Delay Floor*). Until a forum family publishes calibrated targets, the following **maximum** windows apply from the triggering event (filing, protected report, or lawful agency referral) unless a narrower window is required by **Rights-Floor** urgency or **Force Majeure** is documented:
...
**Outer-bound rule.** Stage windows above must fit inside the tier’s integrated-resolution outer bound. Those outer bounds implement [Chapter Twelve §6](../core_12_forum.md#6-timely-resolution-materiality-tiers-and-anti-delay-discipline) (one week / three weeks / two months / four months / six months). Going past any outer bound requires documented extension under **Article XXIII-D** (*Continuation discipline*) with continuing necessity, proportionality, and absence of less-restrictive feasible alternatives.

**Complexity-extended later stages.** Where a classified **Tier A** or **Tier B** matter requires multi-party, cross-border, or consolidated fact-development, later-stage windows (**Question 1** through integrated resolution) may use the next slower column’s numbers under documented **Article XXIII-D** continuation discipline. Intake, evidence preservation, and interim protection stay at the classified tier. That use is a time-scale extension, not a reclassification. Final Chapter Nine **Violation Axis s = 7, 8, or 9** review or corresponding **Chapter Eleven** designation is typically **Tier A**, not a reason to apply **Tier C** clocks.
...
- remedy-parity tripwire threshold records a [Chapter Ten §9.2](../core_10_standing_integration.md#92-remedy-system-durability) durability failure and routes the capacity-failure claim under **CF-5.4**, outside the family or system whose capacity is in question; the starved body supplies its published figures and may give evidence, but must not be the sole finder of fact;
...
- lock capacity that outruns remedy, restoration, or reassessment capacity on the same lock class, including a tripped [Chapter Ten §4.4](../core_10_standing_integration.md#44-remedy-parity-and-lock-preconditions) tripwire heard only inside the starved body;
