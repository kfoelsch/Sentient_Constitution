...
*In plain terms: this is the table of contents for the forum folder — sixteen stable families, each with a home file.*
...
| **CF-2** | Implementation integration map: forum topic router, overlap discipline, and read-with order | [cf_02_implementation_integration_map.md](cf_02_implementation_integration_map.md) |
