...
Where internal process remains available, the [forum case record](../core_05defs_accountability.md#forum-case-record) must state what issues are stayed, what issues proceed, what evidence must be preserved, and what deadline or trigger returns the matter to the forum if the internal process fails.
