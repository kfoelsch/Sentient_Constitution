...
- Topic routing (primary owner): **CJS-R03** (*Lawful panel formation, disclosure, recusal, substitution, inability-to…*) in **CJS-2.1** (*Topic router (stable IDs)*). Mandatory read-with: **CJS-4.5**, **CJS-5.13** (*procedural integrity and adjudication terms*), **CI-4**, **CI-5**, [Chapter Nine §4.3](../core_09-09_standing_integration.md#43-special-locks), [§5.2](../core_09-09_standing_integration.md#52-competency-gates), [§7](../core_09-09_standing_integration.md#7-restoration-and-reassessment), and **Chapter Eleven**.
