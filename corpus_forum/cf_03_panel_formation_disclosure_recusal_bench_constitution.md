...
- Read with: **CF-3**; **CF-3.1**; **CF-3.2**; **CF-3.3**; **CF-3.4**; **CF-3.5**; [CJS-1.1](../corpus_joint_structure/cjs_01_scope_purpose_boundary_interface.md#cjs-11-shared-implementation-corpus-preamble-contract) shared implementation-corpus contract.
