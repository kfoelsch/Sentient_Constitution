...
- Downstream: this section's local operational requirements for **CF-9: Technical specialist forums and specialist chambers**.
- Read with: **CF-9**.
...
**Departure and variance rule.** Shared standards published by technical specialist forums are presumptively applicable requirements within adopted scope, not silent maxima. A lead forum may adopt a stricter application where the constitution, adopting law, or materially distinct facts require it. A lead forum may depart from a published standard only through a reasoned and reviewable record that:
