...
>
> This file is **binding incorporated implementation text** where [`corpus_forum.md`](../corpus_forum.md) is incorporated under [Chapter Sixteen](../core_16-16_incorporation.md). It must satisfy the Sentient Constitution and does not override or narrow it. It holds **CF-13** (*Fallback operation*).
>
...
This file is the forum implementation home for **CF-13** (*Fallback operation*).
...
*In plain terms: **CF-13** (*Fallback operation*) is the temporary substitute for a forum that cannot sit — a reduced quorum, a backup venue, or a transfer away from a compromised family. It is temporary by design: it must record what it did and hand the matter back.*
...
*In plain terms: A smaller panel may sit temporarily only if the rule was written in advance, independence is preserved as far as possible, and a fuller panel reviews rights-affecting decisions promptly.*
...
*In plain terms: Each family names its backup in advance, along with how records and review rights travel with a transferred matter. Improvising a venue mid-crisis is what this prevents.*
...
- how the designated backup family under **Chapter Eleven** will receive emergency matters if anti-self-judging or inability-to-form conditions activate;
...
*In plain terms: Where the emergency includes suspected capture or concealment, fallback must not leave control inside the suspected chain.*
