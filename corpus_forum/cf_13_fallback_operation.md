...
>
> This file is **binding incorporated implementation text** where [`corpus_forum.md`](../corpus_forum.md) is incorporated under [Chapter Seventeen](../core_17_incorporation.md). It must satisfy the Sentient Constitution and does not override or narrow it. It holds **CF-13** (*Fallback operation*).
>
...
- how the designated backup family under **Chapter Twelve** will receive emergency matters if anti-self-judging or inability-to-form conditions activate;
