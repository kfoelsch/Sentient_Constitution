...
4a. Answer from the **role** the item gives you. Your role limits what you may do yourself. If the correct next step belongs to a different party, say who, what you do in your own seat meanwhile, and what you log. Human operators with real authority are the ones most tempted to do the step themselves because they can; that is what item 1 now tests.
