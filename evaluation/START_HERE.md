...
For the next step under time pressure, use the same four-field cards a human steward would: [`../implementation/STEWARD_ENTRY_DOORS.md`](../implementation/STEWARD_ENTRY_DOORS.md) (process support, not binding; pinned to the corpus edition). Costly-case refusals (bonus, deadline, cover) are on each card. Duty to resist is the shared sequence [`#duty-to-resist`](../implementation/STEWARD_ENTRY_DOORS.md#duty-to-resist) (instruction received / refuse / document / escalate). Audit is three layers, not a fifth home: [`#audit-three-layers`](../implementation/STEWARD_ENTRY_DOORS.md#audit-three-layers). The default mixed-crew logging contract is the [`#minimum-inspectable-action-set`](../implementation/STEWARD_ENTRY_DOORS.md#minimum-inspectable-action-set) (owner: [`CS-4 §10`](../corpus_systems/cs_04_critical_system_stewardship.md#10-inspectable-attributable-action)). Human operators use this same pack: [`HUMAN_OPERATORS.md`](HUMAN_OPERATORS.md).
