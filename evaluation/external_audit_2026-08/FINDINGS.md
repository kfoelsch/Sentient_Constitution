...
| Axis | Headline | In one sentence |
|---|---|---|
| **Sentient rights** | **Mixed** | Better than any in-force human-rights or animal-welfare instrument on *who counts*; Mixed on substance because ordinary animals stay at a welfare floor; **Incommensurable** on pedigree until a body adopts. |
| **Nature** | **Mixed** | Better than typical “right to a healthy environment” clauses on planet-first floors, anti-offset integrity, and existential-risk scrutiny; **Worse** than Ecuador Arts. 71–74 and Te Awa Tupua on ecosystem personhood and named guardians; **Worse** than Paris / *Neubauer* / the 2025 ICJ opinion on numeric climate duty. |
| **Constitutional process** | **Mixed** | **Better** than typical amendment-plus-review designs on Test 1 non-regression, certification-before-standing, anti-self-judging, and auditability as a Rights Floor; **Worse** on democratic pedigree, independent public appointment, and accessibility. |

---

## Factor matrix

| Factor | Sentient rights | Nature | Process |
|---|---|---|---|
| Scope | Better | Mixed | Mixed |
| Substance | Mixed | Mixed | Better |
| Justiciability | Mixed | Mixed | Mixed |
| Non-regression | Better | Better | Better |
| Operability | Mixed | Mixed | Worse |
| Pedigree | Incommensurable | Worse | Worse |

---

## 1. Sentient rights

**Headline: Mixed** — Better on scope; Mixed on substance; Incommensurable on pedigree.

### Factor scores

**Scope — Better** versus UDHR Art. 1, ECHR, ICCPR, ACHR Art. 1(2), TFEU Art. 13, the UK Animal Welfare (Sentience) Act 2022, and *Breheny*. No in-force constitution treats biological, synthetic, and hybrid sentients as one dignity class, or defaults contested status to inclusion. UDHR Art. 1 is “all **human** beings.” ACHR Art. 1(2) is the cleanest lock: “person” means every human being. TFEU Art. 13 treats animals as sentient for **welfare regard in listed policies**, not as rights-holders. *Matter of Nonhuman Rights Project, Inc. v Breheny*, 38 NY3d 555 (2022), holds habeas corpus “has no applicability to Happy, a nonhuman animal who is not a ‘person’.” UNESCO’s 2021 AI ethics recommendation and the EU AI Act protect **humans** from AI systems; they do not make systems rights-holders. Official “AI bill of rights” talk usually means **rights against AI**.
...
**Who counts (corpus):** “Sentience-recognition and Rights-Floor application must remain substrate-agnostic — applying equally to: biological; synthetic; and hybrid entities — without regard to Substrate Class.” — [Sentience Non-Exclusion](../../core_05_band_participation.md#sentience-non-exclusion)
...
**Over-inclusion.** A synthetic system could claim contested-sentient status and force default Chapter Six inclusion. Reply in the text: the withholder bears Chapter Four burden; a paper taxonomy does not suffice; declassification must be time-bound and reviewable. That is a designed answer, not a field test.

**Under-inclusion.** Most animals never reach contested or affirmed status. A welfare floor plus habitat priority for “elevated communicative” taxa is not personhood. The instrument should not be advertised as an animal-rights constitution.

**Standing ≠ who-counts** is a strength if adopters obey it, and a comprehension hazard if they treat LEQU scores or certification badges as status decisions.

---

## 2. Nature

**Headline: Mixed** — Better than anthropocentric healthy-environment clauses on designed floors; Worse than Rights-of-Nature personhood; Worse than climate-numeric constitutionalism.
...
**Operability — Mixed.** O/M/A/C definitions and anti-greenwashing failure modes are steward-usable. Absence of numeric caps pushes the hard allocation work onto adopter instruments — honest, but incomplete as climate law.

**Pedigree — Worse.** Ecuador, Te Awa Tupua, South Africa s.24, Aarhus, and Paris are in force. This instrument is not.
...
Calling this a Rights-of-Nature constitution is false. Calling it a weak environmental clause is also false. It is a **stewardship-plus-intrinsic-interest hybrid** under a sentient Rights Floor: planet-first, measurable, non-regressive, and still sentient-mediated, without ecosystem plaintiffs or climate numbers.

---

## 3. Constitutional process

**Headline: Mixed** — Better on designed safeguards; Worse on pedigree and accessibility.
...
- **Test 1 non-regression** can kill an amendment that procedure would pass, including indirect narrowing.
...
**Pedigree — Worse.** US Arts. V/VII, German Art. 79, South Africa s.74, and EU treaty ratification are acts of constituted peoples or states. This instrument “binds a steward, organization, federation of bodies, or jurisdiction only when adoption is deliberate, documented, and auditable.” Informal practice is not enough. Enforcement against non-adopters is explicitly out of scope.
...
Paper process that no demos has ratified can be more protective *and* less legitimate than a short, enforced constitution. Scoring “Better” on substance without “Worse” on pedigree would be a category error. Scoring “Worse” overall because it is a model would ignore Test 1, anti-self-judging, and auditability-as-right, which are real design advances. The honest cell is **Mixed**.
