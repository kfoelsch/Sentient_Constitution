# External comparative audit (desk review)
...
| File | Job |
|---|---|
| [FINDINGS.md](FINDINGS.md) | Axis verdicts (Better / Mixed / Worse / Incommensurable) with paired quotes |
| [BIBLIOGRAPHY.md](BIBLIOGRAPHY.md) | Locked primary-source comparators with URLs |
| [EXPERT_TOR.md](EXPERT_TOR.md) | Terms of reference so independent reviewers can reuse the same rubric |
| [IMPROVEMENTS.md](IMPROVEMENTS.md) | Viable potential corpus improvements derived from the findings |

Interactive scorecard (open beside chat): [external-audit-scorecard.canvas.tsx](/Users/kfoelsch/.cursor/projects/Users-kfoelsch-Documents-Sentient-Constitution/canvases/external-audit-scorecard.canvas.tsx)
