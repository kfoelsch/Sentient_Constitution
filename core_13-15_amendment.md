...
<details>
<summary><strong><span style="color: #2563eb;">Reader guidance (non-operative): where Chapter Thirteen lives and what stays here</span></strong></summary>
...
- Subsections: [§1](#1-non-regression-floor); [§3](#2-test-1-substantive-non-regression-validity); [§11](#3-anti-evasion-clause-and-constitutional-misconduct-referral); [§2](#4-layer-scope).
- Downstream: [Chapter Fourteen](core_13-15_amendment.md#chapter-fourteen-expansion-supremacy-and-external-legal-orders) expansion and supremacy; [Chapter Fifteen](core_13-15_amendment.md#chapter-fifteen-amendment-ratification-and-procedural-validity) procedural validity, ratification, and amendment requirements; [Chapter Eight](core_08-08_standing_assessment.md#chapter-eight-compliance-violation-and-standing-model) and [Chapter Ten](core_10_a_misconduct_designation.md#chapter-ten-anti-constitutional-misconduct) for canonical classification where referral triggers route.
...
- Downstream: [§11](#3-anti-evasion-clause-and-constitutional-misconduct-referral) evasion and misconduct referral; [Chapter Fifteen](core_13-15_amendment.md#chapter-fifteen-amendment-ratification-and-procedural-validity) Tests 2–4 and procedural requirements (invalid if Test 1 fails regardless of procedure).
...
- Downstream: Mandatory referral records route to [Chapter Eight](core_08-08_standing_assessment.md#chapter-eight-compliance-violation-and-standing-model) (separate Contribution Axis and Violation Axis records and numeric measurement on the §7 unified scale), [Chapter Nine §2](core_09-09_standing_integration.md#2-integration-record-and-decision-order) (integration routing of qualifying Violation Axis slot 7–9 findings), and [Chapter Ten](core_10_a_misconduct_designation.md#chapter-ten-anti-constitutional-misconduct) (the corresponding anti-constitutional-misconduct designation for a qualifying Chapter Eight Violation Axis slot 7, 8, or 9 record); this chapter does not classify.
...
- Upstream: [§11](#3-anti-evasion-clause-and-constitutional-misconduct-referral) referral-only discipline; [Chapter Eight](core_08-08_standing_assessment.md#chapter-eight-compliance-violation-and-standing-model) and [Chapter Ten](core_10_a_misconduct_designation.md#chapter-ten-anti-constitutional-misconduct) canonical owners.
...
- Read with: [Constitutional Owner Layers](core_05defs_integrative.md#constitutional-owner-layers); [archive/ARCHITECTURE_PRIMER_ARCHIVED_2026-05-08.md](archive/ARCHITECTURE_PRIMER_ARCHIVED_2026-05-08.md) on change-path and incorporation; [Chapter Fifteen](core_13-15_amendment.md#chapter-fifteen-amendment-ratification-and-procedural-validity) for validity tests that do not duplicate slot-classification taxonomy.
...
Future additions that touch offense-flavored, sanction-flavored, or classification-flavored language must include an explicit non-relocation pointer to the canonical owner home in [Constitutional Owner Layers](core_05defs_integrative.md#constitutional-owner-layers).
...
> The following content is **reader guidance only**. It does not add, remove, or narrow binding obligations elsewhere in this chapter or in other chapters.
>
> Canonical owner routing lives in [Constitutional Owner Layers](core_05defs_integrative.md#constitutional-owner-layers). For editorial orientation, obligations outside the substantive change-validity owner layer include:
> - **general contribution and violation measurement** (Contribution Axis / Violation Axis) — **Chapter Eight** in [core_08-08_standing_assessment.md](core_08-08_standing_assessment.md); **standing effects and integration** — **Chapter Nine** in [core_09-09_standing_integration.md](core_09-09_standing_integration.md#chapter-nine-standing-effects-and-integration);
...
> - **detailed institutional procedure, staffing mechanics, and cross-implementation joint structural integration** for review execution — designated implementation text and owner chapters named in [Constitutional Owner Layers](core_05defs_integrative.md#constitutional-owner-layers).
>
> Owner layers must not be read as relocating constitutional validity standards out of **Chapters Thirteen and Fifteen**, Contribution Axis / Violation Axis measurement authority out of the **Chapter Eight §7 unified scale**, or anti-constitutional-misconduct designation authority out of **Chapter Ten**. Chapter Ten does not assign the numeric slot. For a non-operative architecture walkthrough, see [archive/ARCHITECTURE_PRIMER_ARCHIVED_2026-05-08.md](archive/ARCHITECTURE_PRIMER_ARCHIVED_2026-05-08.md).
...
- Upstream: [Chapter Thirteen](core_13-15_amendment.md#chapter-thirteen-non-regression-and-substantive-amendment-validity) non-regression and Test 1; [Authority Stack and Internal Hierarchy](core_05defs_integrative.md#authority-stack), [Supremacy and Enforceability](core_05defs_integrative.md#supremacy-and-enforceability), and related [Corpus](core_05defs_integrative.md#corpus) boundary concepts.
...
- Upstream: [Chapter Fourteen](#chapter-fourteen-expansion-supremacy-and-external-legal-orders) chapter frame; [Chapter Thirteen](core_13-15_amendment.md#chapter-thirteen-non-regression-and-substantive-amendment-validity) non-regression (expansion must not violate Test 1).
- Downstream: [§3](#2-continuity-of-supremacy-and-challenge-rights-during-amendment) continuity during change; [Authority Stack and Internal Hierarchy](core_05defs_integrative.md#authority-stack) (*including Chapters One through Five consistency checks in operative text*).
- Read with: [Chapter Six](core_06-06_rights_part_a.md#chapter-six-foundational-rights) when additions implicate new rights or classes.

</details>

<br>

*In plain terms: forward is fine — new rights, stronger safeguards, and broader inclusion are welcome when they genuinely increase protection and stay consistent with the rest of this **Constitution**; the guardrail is Chapter Thirteen, not a ban on improvement.*

Constitutional change may add new rights, safeguards, accountability mechanisms, representational guarantees, or protected classes and protected characteristics. Additions are permitted where they increase substantive protection, inclusion, or binding effect consistent with **Chapters One through Five** and **Chapter Thirteen**.
...
- Downstream: [§11](#3-supremacy-relative-to-other-binding-norms) internal hierarchy and stricter-external rule; [Chapter Fifteen §9](core_13-15_amendment.md#8-provisional-effect-rule) provisional effect on rights-affecting amendments.
...
- Upstream: [§3](#2-continuity-of-supremacy-and-challenge-rights-during-amendment) continuity of supremacy during amendment; [Chapter Five *Authority Stack and Internal Hierarchy*](core_05defs_integrative.md#authority-stack).
- Subsections: [Chapter One §8.1](#31-internal-hierarchy-for-adopters)–[§11.3](#33-conflict-disclosure-and-mitigation).
- Downstream: [§2](#4-disputes-involving-external-legal-orders) external tribunals and preserved pathways; [Chapter Thirteen](core_13-15_amendment.md#chapter-thirteen-non-regression-and-substantive-amendment-validity) non-regression on internal-hierarchy maneuvers.
- Read with: [Chapter Five *Supremacy and Enforceability*](core_05defs_integrative.md#supremacy-and-enforceability) as cross-linked from Chapter One §8.1 operative text.
...
#### 3.16 Internal Hierarchy for Adopters
<details>
<summary><strong><span style="color: #2563eb;">Trace</span></strong></summary>

- Upstream: [§11](#3-supremacy-relative-to-other-binding-norms) supremacy framing.
- Downstream: [Chapter One §8.2](#32-stricter-external-protections) stricter-external overlay; [§11.3](#33-conflict-disclosure-and-mitigation) irreconcilable-conflict duties.
- Read with: [Authority Stack and Internal Hierarchy](core_05defs_integrative.md#authority-stack) for the boundary between source-layer authority and [Chapter One](core_01_c_stewardship_capacity_principles.md#chapter-01-principles-and-constraints) last-resort hierarchy.

</details>

<br>

*In plain terms: the binding corpus and its definitions control how compliance is read for adopters, alongside adopted implementation in its lane — but nothing in that stack can be used to walk back Chapter Thirteen floors or Chapter Five supremacy rules.*

For adopting entities, this Constitution and its integrated definitions govern interpretation and compliance. Adopted implementation text governs as well for systems, stewardship, designated institutional relationships, forum operations, and cross-implementation joint structure within the stated scope of adoption. That governance is subject to **Chapter Thirteen** non-regression requirements and to **Supremacy and Enforceability** in Chapter Five. The canonical statement integrating this adopter-facing precedence with source-layer authority and the **Chapter One** last-resort hierarchy across principles, articles, and definitions lives at [Authority Stack and Internal Hierarchy](core_05defs_integrative.md#authority-stack) in Chapter Five.

#### 3.16 Stricter External Protections
<details>
<summary><strong><span style="color: #2563eb;">Trace</span></strong></summary>

- Upstream: [Chapter One §8.1](#31-internal-hierarchy-for-adopters) internal hierarchy baseline.
- Downstream: [§11.3](#33-conflict-disclosure-and-mitigation) when stricter external and constitutional requirements appear to collide.
...
- Upstream: [§2](#4-disputes-involving-external-legal-orders) external-dispute frame.
- Downstream: [Chapter One §8.2](#42-preserved-internal-pathways) when external process is slow or inadequate.
- Read with: Truth and auditability obligations in [Chapters Two through Four](core_02-03_definition_mechanics.md), [Evidence Preservation](core_05defs_oversight.md#evidence-preservation), and [Chapter Six](core_06-06_rights_part_a.md#chapter-six-foundational-rights) as applicable to record preservation.

</details>

<br>

*In plain terms: show up in good faith to lawful external processes — and do not weaponize "cooperation" to stall remedies or destroy the evidence others need to check what happened.*
...
- Read with: [Article XXIII-A](core_06-06_rights_part_d.md) (*Justice Objective and Scope*) review and appeal safeguards referenced in operative text; [Chapter Ten, section 5.2 — *Rights-Floor waivers and unconstitutional contract terms*](core_10_b_misconduct_pattern_applications.md#52-rights-floor-waivers-and-unconstitutional-contract-terms).
...
- Upstream: [Chapter Thirteen](core_13-15_amendment.md#chapter-thirteen-non-regression-and-substantive-amendment-validity) substantive tests; procedural tests in [§2](#4-test-2-procedural-validity-and-publication-integrity)–[§5](#6-test-4-contestability-and-independent-review-validity).
- Downstream: Operative text: failure of any floor invalidates regardless of procedural completion.
- Read with: [§15](#9-invalid-change-handling-and-remediation-continuity) remediation when a change fails the floor.
...
- Read with: [Chapter Five *Corpus*](core_05defs_integrative.md#corpus) and [README.md](README.md) (edition identifiers); [Corpus, Authority Stack, Supremacy, and Enforceability](core_05defs_accountability.md#corpus-authority-stack-supremacy-and-enforceability-cluster) (*Chapter Five Chapter One §8.16 cluster*).

</details>

<br>

*In plain terms: Test 3 is the chain-of-custody test — if nobody can tell which text is authoritative, who approved it, or when it took effect, the amendment does not constitutionally exist as binding.*
...
*In plain terms: Test 4 blocks amendments that kill meaningful pushback — no fake consultation, no bullying **stakeholders** into waiving audit or standing, and no skipping independent review where the chapter demands it.*

A proposed amendment is invalid if it:
- forecloses meaningful contest
- suppresses independent review where heightened review is required
- conditions participation on coercive waivers of auditability, standing, or challenge rights protected by this Constitution
...
- Read with: [Chapter Nine §7 — *Final standing effect*](core_09-09_standing_integration.md#7-final-standing-effect); [Chapter Eight §7 unified scale](core_08-08_standing_assessment.md#7-unified-proportional-lequ-scale) (*shared five-times LEQU measurement foundation for separate Contribution and Violation records*).

</details>

<br>

*In plain terms: certain topics automatically deserve the harder review path — rights, foundational review safeguards, standing, emergencies, and cross-border enforcement hooks — because the downside of getting them wrong is structural.*
...
- standing effects ([Chapter Nine §7 — *Final standing effect*](core_09-09_standing_integration.md#7-final-standing-effect); read with the [Chapter Eight §7 unified scale](core_08-08_standing_assessment.md#7-unified-proportional-lequ-scale) — separate-axis measurement)
- emergency powers
...
- Upstream: [§14](#7-review-triggers) heightened review triggers.
- Downstream: [§15](#9-invalid-change-handling-and-remediation-continuity) invalidity handling; [Chapter Fourteen §2](core_13-15_amendment.md#2-continuity-of-supremacy-and-challenge-rights-during-amendment) continuity of challenge rights.
- Read with: [Chapter Six](core_06-06_rights_part_a.md#chapter-six-foundational-rights) rights materiality for what counts as "rights-affecting."
...
- Upstream: [§11](#3-validity-floor-rule)–[§13](#8-provisional-effect-rule) validity and timing rules.
...
*In plain terms: when a change is declared invalid, treat it as void for constitutional purposes from that determination forward, spell out what must be rolled back and how **affected** **parties** get a fair remedy — and publish a time-bounded plan that restores protections and preserves evidence.*

Where a change is found invalid, it is treated as non-operative for constitutional supremacy purposes from the point of determination. Decision records must identify scope, affected acts, remediation obligations, and required restoration steps for materially affected parties.
...
- preserves evidence under [Evidence Preservation](core_05defs_oversight.md#evidence-preservation) and audit trails
...
*In plain terms: claiming this constitution as a shield without a deliberate, documented adoption that matches impact and class — or letting new parties "join" in a way that strips **existing** **covered** **sentients** of floors — is exactly what these ratification rules forbid.*
...
- Downstream: [§4](#9-test-3-authority-chain-and-custody-validity) Test 3 chain checks against instrument contents.
- Read with: [README.md](README.md) and [Chapter Five *Corpus*](core_05defs_integrative.md#corpus) (authoritative corpus and edition identifier expectations).

</details>

<br>

*In plain terms: keep a clear paper trail — who adopted, what scope, when it starts, who holds the master copy of the corpus — so nobody can launder authority through ambiguous version drift.*
...
- Read with: [Article X-B: Collective Harm Boundary and Enforcement Interface](core_06-06_rights_part_b.md#article-x-b-collective-harm-boundary-and-enforcement-interface) where participation weight applies per operative cross-reference.
...
- Upstream: [§2](#4-test-2-procedural-validity-and-publication-integrity) Test 2; [§16](#10-ratification-and-adoption) adoption instruments.
...
*In plain terms: amending has to follow a visible process — real notice, real chance to object, independence where the chapter demands it — and effect dates have to be honest records, not retroactive surprises hidden from affected stakeholders.*
...
- Downstream: [§4](#9-test-3-authority-chain-and-custody-validity) alignment of effective date with adoption chain reliability.
- Read with: [§15](#9-invalid-change-handling-and-remediation-continuity) remediation when undisclosed scope undermines supremacy claims.

</details>

<br>

*In plain terms: effect follows what is honestly recorded on a stated date or event — secret patches or silent scope expansions do not count as valid constitutional amendments for supremacy purposes.*
...
- Upstream: [Chapter Thirteen §4](#4-layer-scope) substantive-chapter mirror; [§14](#7-review-triggers) and [§15](#9-invalid-change-handling-and-remediation-continuity) trigger language scoped here.
- Downstream: [Chapter Eight](core_08-08_standing_assessment.md#chapter-eight-compliance-violation-and-standing-model) and [Chapter Ten](core_10_a_misconduct_designation.md#chapter-ten-anti-constitutional-misconduct) remain sole canonical homes for listed taxonomies.
- Read with: [Chapter Six — Layer scope](core_06-06_rights_part_a.md#chapter-six--layer-scope) and [Constitutional Owner Layers](core_05defs_integrative.md#constitutional-owner-layers) for the converse Rights-Floor discipline pattern.
...
Future additions that touch offense-flavored or sanction-flavored language must include an explicit non-relocation pointer to the canonical owner home in [Constitutional Owner Layers](core_05defs_integrative.md#constitutional-owner-layers).
...
> The following content is **reader guidance only**. It does not add, remove, or narrow binding obligations elsewhere in this chapter or in other chapters.
>
> Canonical owner routing lives in [Constitutional Owner Layers](core_05defs_integrative.md#constitutional-owner-layers). For editorial orientation, obligations outside the procedural change-validity owner layer include:
> - **general contribution and violation measurement** (Contribution Axis / Violation Axis) — **Chapter Eight** in [core_08-08_standing_assessment.md](core_08-08_standing_assessment.md); **standing effects and integration** — **Chapter Nine** in [core_09-09_standing_integration.md](core_09-09_standing_integration.md#chapter-nine-standing-effects-and-integration);
...
> - **sanction taxonomy** and adjudicative workflow — owner layers identified in [Chapter Thirteen §4 Layer scope](#4-layer-scope) and [Constitutional Owner Layers](core_05defs_integrative.md#constitutional-owner-layers).

</details>

---

**Previous file:** [core_12-12_governance.md](core_12-12_governance.md)

**Next file:** [core_16-16_incorporation.md](core_16-16_incorporation.md)
