...
>
> This file is **part of the Sentient Constitution** and is **binding only together** with the other numbered `core_*` files read as one instrument. It contains **Chapter Ten**, the standing-pipeline top-slot finalization chapter for final Violation Axis `s = 7`, `s = 8`, and `s = 9` anti-constitutional misconduct assignment inside the pipeline begun in [Chapter Eight](core_08-08_standing_assessment.md#chapter-eight-compliance-violation-and-standing-model) and integrated in [Chapter Nine](core_09-09_standing_integration.md#chapter-nine-standing-effects-and-integration). It does **not** replace general violation classification outside those top slots. Anti-constitutional misconduct at **s = 7, 8, or 9** is **tetrad capture** at scale — read with the [Continuity aim](core_00_preamble.md#continuity) under [Two Constitutional Aims](core_00_preamble.md#two-constitutional-aims). Change-path validity interactions continue in [Chapters Thirteen through Fifteen](core_13-15_amendment.md#chapter-thirteen-non-regression-and-substantive-amendment-validity); justice constraints remain in [Chapter Six Part D](core_06-06_rights_part_d.md). Chapter numbering and cross-references match the integrated instrument. Reading order, the binding/support split, and corpus edition metadata are maintained in [README.md](README.md).
...
- **Chapter Eight:** supplies the standing record, verified-input gate, Contribution and Violation axes, standing-slot grammar, and ordinary violation severity.
- **Chapter Nine:** supplies process / response attachments, descriptors, standing integration, standing locks, final standing effect rules, and the pointer here; it does not itself assign final **s = 7**, **s = 8**, or **s = 9** anti-constitutional misconduct slots.
...
- **Chapter Twelve:** supplies governance legitimacy consequences tied to final Chapter Ten slot assignment.
...
Chapter Ten is the constitutional owner of **final Violation Axis s = 7, 8, and 9 anti-constitutional misconduct slot assignment, criteria, and cross-chapter discipline**.
...
Under the [Continuity aim](core_00_preamble.md#continuity) and [Two Constitutional Aims](core_00_preamble.md#two-constitutional-aims), top-slot assignment protects long-horizon constitutional operation when conduct threatens to hollow the [Constitutional Tetrad](core_00_preamble.md#constitutional-tetrad) — **participation**, **oversight**, **accountability**, and **timeliness** — below [material stake](core_00_preamble.md#material-stake) requirements. Read [Chapters Eight–Eleven constitutional compass](core_08-08_standing_assessment.md#chapters-eight-eleven-constitutional-compass) first.

By the time a matter reaches this chapter, the basic work should already be done. Chapter Eight should have opened a bounded **violation standing record**, applied the **verified input** gate, and placed the matter on the shared classification scale. Chapter Nine should have handled ordinary standing integration, including any standing locks and consequence rules.

Chapter Ten then asks the final top-slot question: what happened, how serious was it, which criteria apply, and have the required due-process safeguards been met? A Chapter Eight measurement or Chapter Nine standing lock may help explain the record, but neither can replace this chapter's criteria, gravity rules, or safeguards.
...
4. Apply **section 4** before any slot assignment is final.
5. Apply **section 4.1** for imprisonment requirements after final slot assignment.
...
*In plain terms: Under the [Continuity aim](core_00_preamble.md#continuity), this chapter **guards** the top of the standing pipeline — it decides only whether verified misconduct reaches the highest three violation slots after Chapters Six and Seven have done their work, when conduct amounts to **tetrad capture** at scale.*
...
- Upstream map: [Chapter Eight §4.7](core_08-08_standing_assessment.md#7-slot-grammar-and-display-labels) (*standing-slot grammar*).
...
- Downstream: [§3](#2-criteria-set-for-slot-assignment) (*Criteria set*); [§11](#3-violation-axis-s-7-9-slot-assignment-incident-gravity) (*Violation Axis s = 7–9 slot assignment*).
- Safeguards and discipline: [§2](#4-due-process-safeguards-for-slot-assignment) (*Due-process safeguards*); [§4.1](#4-1-imprisonment-for-anti-constitutional-misconduct) (*Imprisonment for anti-constitutional misconduct*); [§4.2](#4-2-restitution-remedy-priority-and-consequence-integration) (*Restitution, remedy priority, and consequence integration*); [§4.3](#4-3-voluntary-public-accountability-expression) (*Voluntary public accountability expression*); [§4](#5-cross-chapter-discipline) (*Cross-chapter discipline*).
- Pattern applications: [§5](#6-pattern-applications-and-criteria-routing) (*named patterns route into the same criteria and slot rules*).
...
Top-slot review is a specialized **Violation Axis Question 2** gravity step for **s = 7–9** only. Question 1 verified facts and ordinary Question 2 measurement remain in [Chapter Eight](core_08-08_standing_assessment.md#chapter-eight-compliance-violation-and-standing-model); Question 3 remedies, safeguards, and lock design remain in [Chapter Nine](core_09-09_standing_integration.md#chapter-nine-standing-effects-and-integration).

**Anti-constitutional misconduct** under the final three violation categories is assigned only under **this chapter**. The conduct may arise in **constitutional change** under **Chapters Thirteen through Fifteen**, including **regressive deception** reflected in criteria **1–4**. It may also arise through **criteria 5** or **6**, or through other conduct that materially affects constitutional **validity**, **operation**, or **Rights-Floor** governance. **No** adopting instrument, process note, or subsidiary body may issue final **anti-constitutional misconduct** classification in place of **this chapter**.

**Decision sequence.** Final slot assignment under this chapter proceeds in the following order:
...
5. apply **section 4** due-process safeguards before treating the slot assignment as final;
...
- Downstream slot assignment: [§11](#3-violation-axis-s-7-9-slot-assignment-incident-gravity).
- Downstream safeguards and discipline: [§2](#4-due-process-safeguards-for-slot-assignment); [§4](#5-cross-chapter-discipline).
- Downstream pattern applications and criteria routing: [§5](#6-pattern-applications-and-criteria-routing), including [§5](#61-concentration-based-subversion-criteria-interaction), [§12](#62-rights-floor-waivers-and-unconstitutional-contract-terms), [§11.3](#63-flooding-the-zone-and-contest-pathway-denial), [§11.4](#64-info-sphere-zone-flooding), [§6.5](#65-bribery-and-improper-benefit-exchange), [§6.6](#66-unlawful-or-unconstitutional-command-conduct), [§6.7](#67-reward-protection-or-normalization-of-anti-constitutional-conduct), [§6.8](#68-enforcement-refusal-suppression-or-non-prosecution-conduct), [§6.9](#69-infrastructure-denial-destruction-or-dependency-cutoff-conduct), and [§6.10](#610-forum-recusal-failure-and-biased-panel-participation).
- Read with: [Chapters Two through Four](core_02-03_definition_mechanics.md) for record, custody, and verification expectations tied to **criteria 1–4**.

</details>

<strong><span style="color: #2563eb;">Definition:</span></strong> [Necessity](core_05a_accountability_definitions.md#necessity) · [O](core_05a_accountability_definitions.md#necessity) · [A](core_05a_accountability_definitions.md#necessity-a) · [C](core_05a_accountability_definitions.md#necessity-c)
...
### 3. Violation Axis s = 7–9 slot assignment (incident gravity)
...
- Upstream: [§3](#2-criteria-set-for-slot-assignment) (*Criteria set*).
- Criteria interactions: [§5](#61-concentration-based-subversion-criteria-interaction); [§12](#62-rights-floor-waivers-and-unconstitutional-contract-terms); [§11.3](#63-flooding-the-zone-and-contest-pathway-denial); [§11.4](#64-info-sphere-zone-flooding); [§6.5](#65-bribery-and-improper-benefit-exchange); [§6.6](#66-unlawful-or-unconstitutional-command-conduct); [§6.7](#67-reward-protection-or-normalization-of-anti-constitutional-conduct); [§6.8](#68-enforcement-refusal-suppression-or-non-prosecution-conduct); [§6.9](#69-infrastructure-denial-destruction-or-dependency-cutoff-conduct); [§6.10](#610-forum-recusal-failure-and-biased-panel-participation).
- Downstream: [§2](#4-due-process-safeguards-for-slot-assignment) (*Due-process safeguards*), [§4.1](#4-1-imprisonment-for-anti-constitutional-misconduct) (*Imprisonment for anti-constitutional misconduct*), [§4.2](#4-2-restitution-remedy-priority-and-consequence-integration) (*Restitution, remedy priority, and consequence integration*), [§4.3](#4-3-voluntary-public-accountability-expression) (*Voluntary public accountability expression*), and [§4](#5-cross-chapter-discipline) (*Cross-chapter discipline*).
- Downstream forums: [Chapter Eleven](core_11-11_forum.md#chapter-eleven-forums-and-jurisdiction) [§3](core_11-11_forum.md#2-default-venue-and-primary-stakes) gives the Integrity default lead where final Chapter Ten slot assignment is the primary stake. [Chapter Eleven §8](core_11-11_forum.md#7-escalation-and-certification) covers forum certification and independent review for final **s = 7**, **s = 8**, and **s = 9** classification.
...
*In plain terms: the serious anti-constitutional slots depend on how bad the whole incident is. One blow can threaten the system; a long pattern can do the same damage over time. The question is not how many unrelated scraps of evidence can be tied to checklist boxes. Real forum process is still required before anyone treats the finding like constitutional crime-level conduct.*

**Chapters Thirteen through Fifteen** do not supply final anti-constitutional misconduct assignment for anti-constitutional misconduct within their scope. **No** other pathway may substitute final Chapter Ten slot assignment for **this chapter**.
...
**Top Violation Axis labels (Table 1, rows 7–9).** The top three **Violation Axis** rows for anti-constitutional misconduct use **Chapter Eight**'s standing-slot index. In Chapter Ten, those three slots read (in order) **Serious anti-constitutional misconduct**, **Grave anti-constitutional misconduct**, and **Pernicious anti-constitutional misconduct**. The full nine-row Table 1 is not repeated here; the short table below shows only the rows where Chapter Ten supplies final slot assignment.

| `s` | Violation Axis — Chapter Ten display |
| ---: | --- |
| 7 | **Serious** anti-constitutional misconduct |
| 8 | **Grave** anti-constitutional misconduct |
| 9 | **Pernicious** anti-constitutional misconduct |

Assignment proceeds by **unified incident** and final **Violation Axis** slot as stated in the row for that **s** in the table above and in the operative bullets below.

- **Serious anti-constitutional misconduct:** A **unified incident** **materially implicates** one or more **section 2** criteria **and** triggers mandatory **heightened** review, [Evidence Preservation](core_05o_oversight_definitions.md#evidence-preservation) obligations, and published remediation controls, **but** does **not** satisfy grave or pernicious under the bullets below. Where materially necessary, it also triggers provisional suspension of disputed constitutional effect (including under **Chapters Thirteen through Fifteen** where applicable).
...
### 4. Due-process safeguards for slot assignment — Oversight safeguards
<details>
<summary><strong><span style="color: #2563eb;">Trace</span></strong></summary>

- Upstream: [§11](#3-violation-axis-s-7-9-slot-assignment-incident-gravity) (*Violation Axis s = 7–9 slot assignment*); [§3](#2-criteria-set-for-slot-assignment) (*Criteria set*), especially **criteria 5** and **6** and the **good-faith** drafting carve-out.
...
- Forum discipline: [Chapter Eleven §2](core_11-11_forum.md#2-default-venue-and-primary-stakes) through [§14](core_11-11_forum.md#7-escalation-and-certification) cover default Integrity lead, forum-family application of due process, transfer, and certification. Read **section 4** with **Article XXIII** (*Conflict Resolution, Escalation, and Emergency Proportionality*) in **Chapter Six**.
- Read with: [Article XXIII-A: Justice Objective and Scope](core_06-06_rights_part_d.md#article-xxiii-a-justice-objective-and-scope) for review and publication safeguards; [Chapters Two through Four](core_02-03_definition_mechanics.md) tracing standards for publication.
...
No final **Violation Axis anti-constitutional misconduct** slot assignment under this chapter may be issued without independent review, contestable notice, and reasoned publication. Publication must satisfy **Chapters Two through Four** tracing standards and **Article XXIII-A** (*Justice Objective and Scope*) review safeguards. Good-faith drafting error that is promptly disclosed and cured before constitutional effect is not anti-constitutional misconduct **when** that error is material only to **criteria 1–4** in **change** or **record** contexts; it does **not** excuse **criteria 5** or **6** conduct.
...
- Upstream: [§11](#3-violation-axis-s-7-9-slot-assignment-incident-gravity) (*Violation Axis s = 7–9 slot assignment*); [§2](#4-due-process-safeguards-for-slot-assignment) (*Due-process safeguards*).
- Downstream: [§4.2](#4-2-restitution-remedy-priority-and-consequence-integration) (*Restitution, remedy priority, and consequence integration*); [§4.3](#4-3-voluntary-public-accountability-expression) (*Voluntary public accountability expression*); [§4](#5-cross-chapter-discipline) (*Cross-chapter discipline*).
...
- Upstream: [§11](#3-violation-axis-s-7-9-slot-assignment-incident-gravity) (*Violation Axis s = 7–9 slot assignment*); [§2](#4-due-process-safeguards-for-slot-assignment) (*Due-process safeguards*); [§4.1](#4-1-imprisonment-for-anti-constitutional-misconduct) (*Imprisonment for anti-constitutional misconduct*) where imprisonment is implicated.
- Downstream: [§4.3](#4-3-voluntary-public-accountability-expression) (*Voluntary public accountability expression*); [§4](#5-cross-chapter-discipline) (*Cross-chapter discipline*); [Chapter Nine](core_09-09_standing_integration.md#chapter-nine-standing-effects-and-integration) standing-effect and standing-lock integration; [Chapter Eleven](core_11-11_forum.md#chapter-eleven-forums-and-jurisdiction) forum routing and certification.
...
- Upstream: [§11](#3-violation-axis-s-7-9-slot-assignment-incident-gravity) (*Violation Axis s = 7–9 slot assignment*); [§2](#4-due-process-safeguards-for-slot-assignment) (*Due-process safeguards*); [§4.2](#4-2-restitution-remedy-priority-and-consequence-integration) (*Restitution, remedy priority, and consequence integration*).
- Downstream: [§4](#5-cross-chapter-discipline) (*Cross-chapter discipline*).
...
- **Voluntary public accountability expression:** After final slot assignment under **section 3** with **section 4** safeguards met, accountable parties in restorative pathways for verified anti-constitutional misconduct may voluntarily choose public acknowledgment or apology as a supplementary accountability act.
...
- Upstream: [§1](#1-decision-framework-scope-and-authority) (*Decision framework, scope, and authority*); [§3](#2-criteria-set-for-slot-assignment) (*Criteria set*).
- Pattern and slot sources: [§11.3](#63-flooding-the-zone-and-contest-pathway-denial); [§11.4](#64-info-sphere-zone-flooding); [§6.5](#65-bribery-and-improper-benefit-exchange); [§6.6](#66-unlawful-or-unconstitutional-command-conduct); [§6.7](#67-reward-protection-or-normalization-of-anti-constitutional-conduct); [§6.8](#68-enforcement-refusal-suppression-or-non-prosecution-conduct); [§6.9](#69-infrastructure-denial-destruction-or-dependency-cutoff-conduct); [§6.10](#610-forum-recusal-failure-and-biased-panel-participation); [§11](#3-violation-axis-s-7-9-slot-assignment-incident-gravity); [§2](#4-due-process-safeguards-for-slot-assignment); [§4.1](#4-1-imprisonment-for-anti-constitutional-misconduct); [§4.2](#4-2-restitution-remedy-priority-and-consequence-integration); [§4.3](#4-3-voluntary-public-accountability-expression).
...
*In plain terms: this section is about misconduct connected to constitutional change. Chapters Thirteen through Fifteen decide whether a proposed constitutional change is allowed, whether the process was fair, and whether the official record is trustworthy. This chapter answers a different question: did someone misuse the constitutional-change process badly enough to count as serious anti-constitutional misconduct?*

**Chapter Thirteen** decides whether a constitutional change would wrongly weaken protected constitutional rights or duties, including through evasion. **Chapter Fifteen** decides whether the change process was properly run, whether the records were properly kept, whether review was triggered when required, and whether any temporary effect is valid.

Those chapters decide whether the constitutional change itself can stand. They do **not** decide the final misconduct label for the sentients or institutions involved. If conduct within this chapter's scope may deserve a final anti-constitutional misconduct slot assignment, including a final **Violation Axis** slot, any connected sanctions, or escalation as anti-constitutional misconduct, that decision remains **in this chapter**.
...
- Upstream: [§3](#2-criteria-set-for-slot-assignment) (*Criteria set*); [§11](#3-violation-axis-s-7-9-slot-assignment-incident-gravity) (*Violation Axis s = 7–9 slot assignment*); [§2](#4-due-process-safeguards-for-slot-assignment) (*Due-process safeguards*); [§4](#5-cross-chapter-discipline) (*Cross-chapter discipline*).
- Subsections: [§5](#61-concentration-based-subversion-criteria-interaction); [§12](#62-rights-floor-waivers-and-unconstitutional-contract-terms); [§11.3](#63-flooding-the-zone-and-contest-pathway-denial); [§11.4](#64-info-sphere-zone-flooding); [§6.5](#65-bribery-and-improper-benefit-exchange); [§6.6](#66-unlawful-or-unconstitutional-command-conduct), including [§6.6.1](#661-follower-and-implementer-accountability); [§6.7](#67-reward-protection-or-normalization-of-anti-constitutional-conduct); [§6.8](#68-enforcement-refusal-suppression-or-non-prosecution-conduct); [§6.9](#69-infrastructure-denial-destruction-or-dependency-cutoff-conduct); [§6.10](#610-forum-recusal-failure-and-biased-panel-participation).
...
Prohibited **concentration of wealth, power, control, or opportunity**, including durable domination under **Chapter One §13.2** and unrebutted consolidation-ceiling breach under **§13.3**, is not a separate slot-assignment criterion. It is reached through the existing criteria where it produces the equivalent constitutional effect:
...
The absence of overt deception or forcible act does **not** defeat anti-constitutional misconduct assignment where prohibited concentration, durable domination, or unrebutted consolidation-ceiling breach produces the equivalent constitutional effect. Quantitative threshold-setting and ceiling-setting for concentration remain owned by **Chapter One §13**, **§13.1**, and **§13.3** and are not relitigated here; this chapter evaluates the **conduct** that creates, maintains, exploits, conceals, or restructures around concentration, consolidation, or domination that has crossed the **§13** floor.

### 6.2 Rights-Floor waivers and unconstitutional contract terms
<details>
<summary><strong><span style="color: #2563eb;">Trace</span></strong></summary>

- Upstream: [§3](#2-criteria-set-for-slot-assignment) (*Criteria set*); [Chapter Six](core_06-06_rights_part_a.md#chapter-six-foundational-rights) Rights Floor; [Chapter Nine §6.7](core_09-09_standing_integration.md#67-duty-to-resist-unlawful-or-unconstitutional-instructions) (*Duty to Resist Unlawful or Unconstitutional Instructions*) for unconstitutional-instruction routing named in the second bullet.
- Downstream: [§4](#5-cross-chapter-discipline) (*Cross-chapter discipline*); [Article XXIII-A: Justice Objective and Scope](core_06-06_rights_part_d.md#article-xxiii-a-justice-objective-and-scope) for review pathways that waiver devices must not defeat.
...
*In plain terms: “click here to give up your core rights” clauses — buried in employment, platform, or service terms — are not a lawful way to silence audits, challenges, or appeals, and convenience alone is never a good enough excuse.*
...
- **Rights-Floor waiver conduct:** conditioning cooperative participation, employment, platform access, services, or comparable ordinary association on giving up protected rights or review paths. This includes waiver, disclaimer, or relinquishment of **Chapter Six** Rights-Floor protections; interpretation, appeal, or review pathways under **Article XXIII-A** (*Justice Objective and Scope*); constitutionally required **auditability** or **contestability**; or **standing** needed to vindicate those protections. The condition is in scope where it functions to defeat, narrow, or chill those protections without **Necessity** and **Proportionality** under **Chapter One** and **Chapter Five**, and outside **Chapter Fifteen** procedural-validity rules for adoption instruments themselves. **Ordinary commercial convenience alone** is not a sufficient justification.

- **Unconstitutional contract-term conduct:** any agreement, adhesion term, policy, or comparable instrument that purports to waive, disclaim, override, or contract around binding **Sentient Constitution** obligations or **Chapter Six** Rights Floors, **including** **non-disclosure agreements** (**NDAs**) and **overbroad confidentiality** terms where they **function** as **waiver**, **gag**, or **override** devices. This also includes a **contractual directive** requiring unlawful conduct or material constitutional violation (read with **Chapter Nine** [§3.7](core_09-09_standing_integration.md#67-duty-to-resist-unlawful-or-unconstitutional-instructions) and [Chapter One §8.1](core_09-09_standing_integration.md#38-standing-integration-contribution-and-violation-nature)).

- **Post-employment mobility-restriction conduct:** **non-compete** or **no-poach** terms in employment, **operator**, **steward**, platform, or comparable arrangements — prohibited categorically in any form, scope, or duration, with **no operative effect** to restrict labor mobility. **Excessive** **non-solicitation** or **functionally equivalent** post-association terms that purport to **foreclose** **contestable** **labor** **mobility** or to **chill** **standing**, **audit**, **contestability**, or **Article XXIII-A** (*Justice Objective and Scope*) review in ways that **degrade** **Chapter Six** protections **without** **Necessity** and **Proportionality** under **Chapter One** and **Chapter Five**. **Retention** or **competitive** convenience **alone** is not a sufficient justification.

**Non-binding effect.** Provisions and conditions within the bullets above are **never binding** and have **no operative effect** to defeat, narrow, or foreclose Rights-Floor protections, challenge or **standing** rights, audit or verification rights, or **Article XXIII-A** (*Justice Objective and Scope*) pathways. **NDAs** and **confidentiality** terms are **void** and **without operative effect** to the extent they would **suppress** **disclosure** or **cooperation** necessary for **accountability** for **criminal** conduct (including **reporting** to **competent** **criminal** or **oversight** process) or for **anti-constitutional misconduct** within **this chapter’s** scope. Actors must not treat them as lawful authority for selective compliance, evidence destruction, forum shopping, or reincorporation arbitrage.
...
- Upstream: [§3](#2-criteria-set-for-slot-assignment) (*Criteria set*); [Chapter Eleven](core_11-11_forum.md#chapter-eleven-forums-and-jurisdiction) (*default venue, intake triage, transfer and consolidation, anti-gaming, and interim relief — operational response without relocating slot assignment*).
- Downstream: [§11](#3-violation-axis-s-7-9-slot-assignment-incident-gravity) (*Violation Axis s = 7–9 slot assignment*); [§4](#5-cross-chapter-discipline) (*Cross-chapter discipline*).
...
- Distinct pattern: [§11.4](#64-info-sphere-zone-flooding) covers info-sphere flooding.
...
- Coordinated or serial duplicative filings without a good-faith distinct predicate.
- Synthetic or inauthentic party or standing traffic.
...
- Good-faith parallel filings whose dominant purpose is substantive redress and that do not produce the defeat, denial, or degradation effects above.
- Lawful scope expansion, consolidation, or representative treatment under **Chapter Eleven**.
- Ordinary caseload pressure without the imputed purpose or material effect stated here.
- Volume alone, without culpable purpose or foreseeable indifference tied to those effects.

**Operational response** — including primary-stakes routing, per-family intake triage, consolidation, anti-gaming measures, forum performance and backlog requirements, continuity measures, and forensic support — remains governed by **Chapter Eleven** and adopted implementation. This subsection states when such conduct may implicate final anti-constitutional misconduct slot assignment under this chapter; it does not relocate operational rules to this chapter.
...
### 6.4 Info-sphere zone flooding
<details>
<summary><strong><span style="color: #2563eb;">Trace</span></strong></summary>

- Upstream: [§3](#2-criteria-set-for-slot-assignment) (*Criteria set*); [§11.3](#63-flooding-the-zone-and-contest-pathway-denial) (*Flooding the zone — contest-pathway distinction*); [Chapter One §3.2](core_01_a_values_principles.md#32-truth-epistemic-integrity-constraint) (*Truth / epistemic integrity*); [Chapter One §6.2.1](core_01_b_interaction_interpretation.md#621-preservation-of-epistemic-integrity) (*Preservation of epistemic integrity*).
- Downstream: [§11](#3-violation-axis-s-7-9-slot-assignment-incident-gravity) (*Violation Axis s = 7–9 slot assignment*); [§4](#5-cross-chapter-discipline) (*Cross-chapter discipline*).
...
**Info-sphere zone flooding** (including **epistemic flooding** and **attention-pathway denial**) is **anti-constitutional misconduct within this chapter’s scope** when substantiated under **Chapters Two through Four** and assessed through the **section 2** criteria for possible anti-constitutional misconduct assignment. It means deliberate, reckless, or foreseeably indifferent use of high volume, redundancy, distributed load, automation, coordination across channels, ranking or discovery manipulation, synthetic or inauthentic persona traffic, or comparable means.

Those means are in scope when they burden attention, indexing, search, verification, audit, correction, notice, or publication pathways in the **info-sphere**.
...
- Plural speech, dissent, organized advocacy, journalism, whistleblowing, satire, or good-faith scientific or political contestation that does not produce the defeat, degradation, or denial-of-verification effects above.
...
**Operational response** — including Rights-Floor implementation under **Chapter Six**, **Article XV** (*Audit, Transparency, and Independent Verification*) verification and auditability discipline, **[corpus_systems.md](corpus_systems.md)** handling where designated, and institutional governance under **Chapter Sixteen** — remains governed by those instruments and adopted owner layers. This subsection states when such conduct may implicate final anti-constitutional misconduct slot assignment under this chapter; it does not relocate operational rules to this chapter.
...
### 6.5 Bribery and improper benefit exchange
<details>
<summary><strong><span style="color: #2563eb;">Trace</span></strong></summary>

- Upstream: [§3](#2-criteria-set-for-slot-assignment) (*Criteria set*); [§11](#3-violation-axis-s-7-9-slot-assignment-incident-gravity) (*Violation Axis s = 7–9 slot assignment*); [§2](#4-due-process-safeguards-for-slot-assignment) (*Due-process safeguards*).
- Integrity and governance context: [Chapter Eleven](core_11-11_forum.md#chapter-eleven-forums-and-jurisdiction) for Integrity-family routing where final Chapter Ten classification is the primary stake; [Chapter Twelve](core_12-12_governance.md#chapter-twelve-constitutional-contract-legitimacy-authorization-and-stewardship) where governing authority, selection, or stewardship legitimacy is materially distorted.
...
*In plain terms: bribery can corrupt constitutional government from either side. Offering or giving the benefit, asking for or receiving it, routing it through an ally or shell entity, or disguising it as funding can all matter if the exchange distorts duties, records, review, votes, enforcement, or remedies.*

**Bribery and improper benefit exchange** is **anti-constitutional misconduct within this chapter's scope** when substantiated under **Chapters Two through Four** and assessed through the **section 2** criteria for possible anti-constitutional misconduct assignment. It means offering, promising, giving, soliciting, requesting, accepting, receiving, concealing, or routing a material benefit, advantage, threat-relief, appointment, opportunity, funding stream, favorable treatment, information advantage, or comparable thing of value in order to distort a constitutionally governed duty, decision, record, forum, review path, enforcement action, publication, vote, appointment, allocation, or remedy.

The conduct is in scope whether the actor is the **giver**, **offeror**, **promisor**, **solicitor**, **recipient**, **beneficiary**, **intermediary**, or **coordinating sponsor**, provided the record supports accountable attribution under **Chapters Two through Four** and **section 4** safeguards. Indirect routing through affiliates, contractors, shell entities, family or associational channels, contingent claims, donations, procurement terms, employment promises, deferred rewards, or post-decision benefits does not remove the conduct from scope where the exchange or expected exchange is materially linked to constitutional distortion.
...
### 6.6 Unlawful or unconstitutional command conduct
<details>
<summary><strong><span style="color: #2563eb;">Trace</span></strong></summary>

- Upstream: [§3](#2-criteria-set-for-slot-assignment) (*Criteria set*); [§11](#3-violation-axis-s-7-9-slot-assignment-incident-gravity) (*Violation Axis s = 7–9 slot assignment*); [§2](#4-due-process-safeguards-for-slot-assignment) (*Due-process safeguards*); [Chapter Nine Chapter One §8.10](core_09-09_standing_integration.md#410-collective-accountability-and-acquiescent-participation) (*Collective Accountability and Acquiescent Participation*); [Chapter Nine §6.7](core_09-09_standing_integration.md#67-duty-to-resist-unlawful-or-unconstitutional-instructions) (*Duty to Resist Unlawful or Unconstitutional Instructions*).
- Integrity and governance context: [Chapter Eleven](core_11-11_forum.md#chapter-eleven-forums-and-jurisdiction) for Integrity-family routing where final Chapter Ten classification is the primary stake; [Chapter Twelve](core_12-12_governance.md#chapter-twelve-constitutional-contract-legitimacy-authorization-and-stewardship) where governing authority, stewardship, or role legitimacy is materially distorted; [Chapter Six](core_06-06_rights_part_a.md#chapter-six-foundational-rights) Rights Floor where command conduct affects protected rights, challenge, review, or remedy.
...
*In plain terms: an unlawful or unconstitutional order is not just a bad downstream act. Giving, approving, passing along, or enforcing the order can itself be anti-constitutional conduct. Following it is also accountable when the actor had real capacity to refuse, document, or escalate, but dependency, threat, and practical capacity matter.*

**Unlawful or unconstitutional command conduct** is **anti-constitutional misconduct within this chapter's scope** when substantiated under **Chapters Two through Four** and assessed through the **section 2** criteria for possible anti-constitutional misconduct assignment. It means issuing, authorizing, directing, approving, transmitting, ratifying, enforcing, or materially maintaining an instruction, order, policy, workflow, command, contractual directive, technical control, or comparable authority signal that requires, induces, or foreseeably causes unlawful conduct or constitutional violation.

The command conduct is in scope whether the actor is the **issuer**, **authorizer**, **supervisor**, **commander**, **policy owner**, **workflow designer**, **transmitter**, **ratifier**, **enforcer**, **implementation lead**, **intermediary**, or **coordinating sponsor**, provided the record supports accountable attribution under **Chapters Two through Four** and **section 4** safeguards. Delegation, automation, chain-of-command layering, contractor use, role fragmentation, collective approval, or later institutional discipline does not remove the conduct from scope where the actor materially caused, enabled, concealed, maintained, or benefited from the unlawful or unconstitutional directive.
...
**Criteria routing.** Evaluators assess these patterns under **criteria 1 and 2** where deception, concealment, material omission, or record, custody, evidence, publication, provenance, or verification manipulation is implicated. **Criterion 3** applies where the directive produces material rollback or an equivalent structural workaround. **Criterion 4** applies where it materially contributes to unlawful constitutional effect, delayed correction, blocked challenge rights, Rights-Floor degradation, or selectively weakened enforcement or remedy. **Criterion 5** applies where the directive materially organizes or authorizes unlawful force, coercion, or usurpation to overthrow, suspend, or replace operative constitutional authority. **Criterion 6** applies only where **section 2** and **section 4** substantiation shows that constitutional process or remedies became unusable in practice. Command issuance, obedience, hierarchy, or role participation alone is not sufficient for final slot assignment without the required criteria and due-process showing.

This subsection does **not** add an additional slot-assignment criterion beyond the **section 2** set; it routes evaluation of the named pattern into that set.

### 6.7 Reward, protection, or normalization of anti-constitutional conduct
<details>
<summary><strong><span style="color: #2563eb;">Trace</span></strong></summary>

- Upstream: [§3](#2-criteria-set-for-slot-assignment) (*Criteria set*); [§11](#3-violation-axis-s-7-9-slot-assignment-incident-gravity) (*Violation Axis s = 7–9 slot assignment*); [§2](#4-due-process-safeguards-for-slot-assignment) (*Due-process safeguards*); [Chapter One §2.2](core_01_a_values_principles.md#22-recognition-reinforcement-and-aspiration) (*Recognition, Reinforcement, and Aspiration*); [Chapter One §11](core_01_c_stewardship_capacity_principles.md#11-incentive-alignment-and-system-capture) (*Incentive Alignment and System Capture*); [Chapter Eight §4.5.1 Misaligned Reward Forfeiture](core_08-08_standing_assessment.md#451-misaligned-reward-forfeiture); [Chapter Eight §4.5.2 Misaligned Reward Reporting](core_08-08_standing_assessment.md#452-misaligned-reward-reporting); [Chapter Eight §4.5.3](core_08-08_standing_assessment.md#453-misaligned-reward-benefit-retention-record-and-measurement-discipline) (*misaligned-reward record and measurement discipline*); [Chapter Nine Chapter One §8.1](core_09-09_standing_integration.md#38-standing-integration-contribution-and-violation-nature) (*Standing integration*).
...
**Reward, protection, or normalization of anti-constitutional conduct** is **anti-constitutional misconduct within this chapter's scope** when substantiated under **Chapters Two through Four** and assessed through the **section 2** criteria for possible anti-constitutional misconduct assignment. It means granting, promising, preserving, concealing, laundering, or structuring a material benefit, advantage, protection, or status because an actor committed, enabled, concealed, normalized, refused to correct, retaliated for reporting, or obstructed accountability for anti-constitutional conduct.
...
### 6.8 Enforcement refusal, suppression, or non-prosecution conduct
<details>
<summary><strong><span style="color: #2563eb;">Trace</span></strong></summary>

- Upstream: [§3](#2-criteria-set-for-slot-assignment) (*Criteria set*); [§11](#3-violation-axis-s-7-9-slot-assignment-incident-gravity) (*Violation Axis s = 7–9 slot assignment*); [§2](#4-due-process-safeguards-for-slot-assignment) (*Due-process safeguards*); [§6.7](#67-reward-protection-or-normalization-of-anti-constitutional-conduct) (*Reward, protection, or normalization of anti-constitutional conduct*).
...
This subsection does **not** create a mandatory-prosecution rule, add an independent slot-assignment criterion beyond the **section 2** set, or relocate prosecutorial, investigative, or forum-interface operations from Chapter Eleven, **CF-9** (*Independent investigative service and prosecution interface*), or adopted implementation. It routes evaluation of the named pattern into the existing criteria, slot-assignment, and due-process safeguards of this chapter.

### 6.9 Infrastructure denial, destruction, or dependency cutoff conduct
<details>
<summary><strong><span style="color: #2563eb;">Trace</span></strong></summary>

- Upstream: [§3](#2-criteria-set-for-slot-assignment) (*Criteria set*); [§11](#3-violation-axis-s-7-9-slot-assignment-incident-gravity) (*Violation Axis s = 7-9 slot assignment*); [§2](#4-due-process-safeguards-for-slot-assignment) (*Due-process safeguards*); [Chapter Eight §4.9.2](core_08-08_standing_assessment.md#92-violation-axis-severity-ladder) (*Violation Axis severity, including ecological or infrastructure damage*).
...
- dependency leverage, access discrimination, technical lockout, or resource-flow cutoff that produces Rights-Floor degradation, material rollback, system capture, or an equivalent structural workaround;
...
This subsection does **not** add an additional slot-assignment criterion beyond the **section 2** set, create a general public-utility ownership rule, prohibit all exclusion or security control, or relocate infrastructure operations from Chapter Six, Chapter Eleven, adopted systems protocols, or implementation law. It routes evaluation of the named pattern into the existing criteria, slot-assignment, and due-process safeguards of this chapter.

<a id="610-forum-recusal-failure-and-biased-panel-participation"></a>

### 6.10 Forum recusal failure and biased panel participation
<details>
<summary><strong><span style="color: #2563eb;">Trace</span></strong></summary>

- Upstream: [Chapter Eight §4.9.3](core_08-08_standing_assessment.md#93-forum-disclosure-and-recusal-process-impact) (*forum disclosure omission and recusal-process impact*); [Article XXII-B](core_06-06_rights_part_c.md#article-xxii-b-composition-rotation-and-conflict-controls) (*Constitutional forum recusal and enforcement routing*); [corpus_forum.md](corpus_forum.md) **CF-4** (*panel formation, disclosure, recusal, and lawful bench constitution*).
- Forum routing: [Chapter Eleven §2](core_11-11_forum.md#2-default-venue-and-primary-stakes) (*Integrity default lead*); [Chapter Eleven §6](core_11-11_forum.md#6-transfer-consolidation-and-coordination) (*cross-forum anti-self-judging rule*).
...
This subsection does **not** add an additional slot-assignment criterion beyond the **section 2** set, convert every recusal dispute into a top-slot matter, or relocate panel-formation mechanics from **CF-4**, **Chapter Eleven**, or **Article XXII-B** (*Composition, Rotation, and Conflict Controls*). It routes evaluation of the named pattern into the existing criteria, slot-assignment, due-process safeguards, and **Integrity**-first routing of this chapter and **Chapter Eleven**.

---

**Previous file:** [core_09-09_standing_integration.md](core_09-09_standing_integration.md)

**Next file:** [core_11-11_forum.md](core_11-11_forum.md)
