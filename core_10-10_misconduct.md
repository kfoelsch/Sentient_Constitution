...
- Safeguards and discipline: [§4](#4-due-process-safeguards-for-slot-assignment) (*Due-process safeguards for designation*); [§4.1](#4-1-imprisonment-for-anti-constitutional-misconduct) (*Imprisonment for anti-constitutional misconduct*); [§4.2](#4-2-restitution-remedy-priority-and-consequence-integration) (*Restitution, remedy priority, and consequence integration*); [§4.3](#4-3-voluntary-public-accountability-expression) (*Voluntary public accountability expression*); [§5](#5-cross-chapter-discipline) (*Cross-chapter discipline*).
...
- Upstream: [§3](#3-violation-axis-s-7-9-slot-assignment-incident-gravity) (*Violation Axis s = 7–9 designation*); [§2](#2-criteria-set-for-slot-assignment) (*Criteria set*), especially **criteria 5** and **6** and the **good-faith** drafting carve-out.
...
- Upstream: [§3](#3-violation-axis-s-7-9-slot-assignment-incident-gravity) (*Violation Axis s = 7–9 designation*); [§4](#4-due-process-safeguards-for-slot-assignment) (*Due-process safeguards for designation*).
...
- Upstream: [§3](#3-violation-axis-s-7-9-slot-assignment-incident-gravity) (*Violation Axis s = 7–9 designation*); [§4](#4-due-process-safeguards-for-slot-assignment) (*Due-process safeguards for designation*); [§4.1](#4-1-imprisonment-for-anti-constitutional-misconduct) (*Imprisonment for anti-constitutional misconduct*) where imprisonment is implicated.
...
- **Boundary:** This section does not re-measure LEQU impact, invent or move numeric slots, add new designation criteria, or relocate forum operations, institutional dissolution, remedy-organ design, or implementation templates into Chapter Ten. It states the consequence-integration requirement triggered by a final anti-constitutional-misconduct designation on an existing **s = 7, s = 8, or s = 9** finding. Chapter Nine applies standing locks and final standing effects — including the **Anti-Constitutional Trust Lock** only after final designation. Operational mechanics remain in Chapter Eleven and incorporated forum, systems, institutions, and joint-structure text, subject to the Chapter Six Rights Floor.
...
- Upstream: [§3](#3-violation-axis-s-7-9-slot-assignment-incident-gravity) (*Violation Axis s = 7–9 designation*); [§4](#4-due-process-safeguards-for-slot-assignment) (*Due-process safeguards for designation*); [§4.2](#4-2-restitution-remedy-priority-and-consequence-integration) (*Restitution, remedy priority, and consequence integration*).
...
- Read with: [Chapter Eight](core_08-08_standing_assessment.md#chapter-eight-compliance-violation-and-standing-model) for **the Contribution and Violation axes**, violation severity, process / response character, and the boundary that final Chapter Ten anti-constitutional-misconduct **designations** for qualifying **s = 7, 8, or 9** findings are supplied only here; Chapter Eight alone supplies the numeric impact slot.
...
- Upstream: [§2](#2-criteria-set-for-slot-assignment) (*Criteria set*); [§3](#3-violation-axis-s-7-9-slot-assignment-incident-gravity) (*Violation Axis s = 7–9 designation*); [§4](#4-due-process-safeguards-for-slot-assignment) (*Due-process safeguards for designation*); [§5](#5-cross-chapter-discipline) (*Cross-chapter discipline*).
...
- Downstream: [§3](#3-violation-axis-s-7-9-slot-assignment-incident-gravity) (*Violation Axis s = 7–9 designation*); [§5](#5-cross-chapter-discipline) (*Cross-chapter discipline*).
...
- Upstream: [§2](#2-criteria-set-for-slot-assignment) (*Criteria set*); [§3](#3-violation-axis-s-7-9-slot-assignment-incident-gravity) (*Violation Axis s = 7–9 designation*); [§4](#4-due-process-safeguards-for-slot-assignment) (*Due-process safeguards for designation*).
...
- Upstream: [§2](#2-criteria-set-for-slot-assignment) (*Criteria set*); [§3](#3-violation-axis-s-7-9-slot-assignment-incident-gravity) (*Violation Axis s = 7–9 designation*); [§4](#4-due-process-safeguards-for-slot-assignment) (*Due-process safeguards for designation*); [Chapter Nine §5.4](core_09-09_standing_integration.md#54-special-violation-rules) (*Collective Accountability and Acquiescent Participation*); [Chapter Nine §5.4](core_09-09_standing_integration.md#54-special-violation-rules) (*Duty to Resist Unlawful or Unconstitutional Instructions*).
...
- Upstream: [§2](#2-criteria-set-for-slot-assignment) (*Criteria set*); [§3](#3-violation-axis-s-7-9-slot-assignment-incident-gravity) (*Violation Axis s = 7–9 designation*); [§4](#4-due-process-safeguards-for-slot-assignment) (*Due-process safeguards for designation*); [Chapter One §2.2](core_01_a_values_principles.md#22-recognition-reinforcement-and-aspiration) (*Recognition, Reinforcement, and Aspiration*); [Chapter One §11](core_01_c_stewardship_capacity_principles.md#11-incentive-alignment-and-system-capture) (*Incentive Alignment and System Capture*); [Chapter Nine §5.4](core_09-09_standing_integration.md#54-special-violation-rules) (*misaligned-reward reporting, forfeiture, correction, and records*); [Chapter Nine §2](core_09-09_standing_integration.md#2-integration-record-and-decision-order) (*Standing integration*).
...
- Upstream: [§2](#2-criteria-set-for-slot-assignment) (*Criteria set*); [§3](#3-violation-axis-s-7-9-slot-assignment-incident-gravity) (*Violation Axis s = 7–9 designation*); [§4](#4-due-process-safeguards-for-slot-assignment) (*Due-process safeguards for designation*); [§6.7](#67-reward-protection-or-normalization-of-anti-constitutional-conduct) (*Reward, protection, or normalization of anti-constitutional conduct*).
...
- Upstream: [§2](#2-criteria-set-for-slot-assignment) (*Criteria set*); [§3](#3-violation-axis-s-7-9-slot-assignment-incident-gravity) (*Violation Axis s = 7–9 designation*); [§4](#4-due-process-safeguards-for-slot-assignment) (*Due-process safeguards for designation*); [Chapter Eight §7](core_08-08_standing_assessment.md#7-unified-proportional-lequ-scale) (*proportional Violation Axis impact, including ecological or infrastructure loss*).
