...
No final **Violation Axis anti-constitutional misconduct** classification under this chapter may be issued without independent review, contestable notice, and reasoned publication. Publication must satisfy **Chapters Two through Four** tracing standards and **Article XXIII-A** (*Justice Objective and Scope*) review safeguards. Good-faith drafting error that is promptly disclosed and cured before constitutional effect is not anti-constitutional misconduct **when** that error is material only to **criteria 1–4** in **change** or **record** contexts; it does **not** excuse **criteria 5** or **6** conduct.
...
- Upstream: [§3](#2-criteria-set-for-slot-assignment) (*Criteria set*); [§11](#3-violation-axis-s-7-9-slot-assignment-incident-gravity) (*Violation Axis s = 7-9 slot assignment*); [§2](#4-due-process-safeguards-for-slot-classification) (*Due-process safeguards*); [Chapter Eight §7.2](core_08-08_standing_assessment.md#72-violation-axis-severity-ladder) (*Violation Axis severity, including ecological or infrastructure damage*).
