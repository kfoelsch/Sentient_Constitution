...
- Upstream: [§3](#2-criteria-set-for-slot-assignment) (*Criteria set*); [§11](#3-violation-axis-s-7-9-slot-assignment-incident-gravity) (*Violation Axis s = 7-9 slot assignment*); [§2](#4-due-process-safeguards-for-slot-assignment) (*Due-process safeguards*); [Chapter Eight §7](core_08-08_standing_assessment.md#7-violation-axis-severity-ladder) (*Violation Axis severity, including ecological or infrastructure damage*).
...
- Upstream: [Chapter Eight §8](core_08-08_standing_assessment.md#8-forum-disclosure-and-recusal-process-impact) (*forum disclosure omission and recusal-process impact*); [Article XXII-B](core_06-06_rights_part_c.md#article-xxii-b-composition-rotation-and-conflict-controls) (*Constitutional forum recusal and enforcement routing*); [corpus_forum.md](corpus_forum.md) **CF-4** (*panel formation, disclosure, recusal, and lawful bench constitution*).
