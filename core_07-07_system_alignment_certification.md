...
- Upstream: [§3](#3-system-class-evaluation) (*misclassification and drift*); [§5](#5-ecological-footprint-evaluation) (*footprint misrepresentation and drift*); [§5A](#5a-proportionate-cross-system-support-evaluation) (*resource-flow misrepresentation, extraction drift, and support inadequacy*); [§5B](#5b-nondiscrimination-evaluation) (*discrimination-pattern drift and proxy evasion*); [§5C](#5c-accessibility-evaluation) (*accessibility drift and paper-only accommodation*); [§5D](#5d-educational-capability-and-learning-system-integrity-evaluation) (*assessment-opacity drift, credential gatekeeping, and imposed-obsolescence drift*); [§5E](#5e-trustworthiness-and-system-reliance-integrity-evaluation) (*false-trust drift, perverse-incentive drift, and recovery-integrity drift*); [§6](#6-transparency-auditability-and-contestability) (*contestability*); [§7](#7-supervisory-sequence-and-contestability-chain) (*credible challenge and reopening*); [Chapter Three §1](core_02-03_definition_mechanics.md#1-definition-integrity-and-anti-evasion-constraints) and [§2](core_02-03_definition_mechanics.md#2-non-compliance-from-observable-system-behavior) (*definition integrity and evasion*); [Chapter Three §2.1 Common Evasion Patterns](core_02-03_definition_mechanics.md#21-common-evasion-patterns) (*scope-and-boundary evasion*).
