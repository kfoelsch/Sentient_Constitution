...
- Upstream: [§2](#2-certification-record) (*record contents*); [§3](#3-system-class-evaluation), [§4](#4-data-types-and-handling-evaluation), [§5](#5-ecological-footprint-evaluation), [§5A](#5a-proportionate-cross-system-support-evaluation), [§5B](#5b-nondiscrimination-evaluation), [§5C](#5c-accessibility-evaluation), and [§5D](#5d-educational-capability-and-learning-system-integrity-evaluation) (*class, data, footprint, cross-system support, nondiscrimination, accessibility, and educational-capability evaluation inputs*); Chapters Two through Four (*burden, tracing, verification, and evidence preservation*); [Constitutional Tetrad](core_00_preamble.md#constitutional-tetrad) — **oversight**, **accountability**, **participation**, and **timeliness**; [Chapter Five §3.2 *Transparency, Auditability, and Verification*](core_05o_oversight_definitions.md#transparency-auditability-and-verification-cluster); [Contestability](core_05a_accountability_definitions.md#contestability).
...
**Sentient forums** retain component authority for rights, stakeholder impact, and sentience-status questions within system alignment certification — including whether certification would preserve or defeat **Article III-A** survival essentials, **Article III-B** educational access, **Article VI** sentient-centered education capability where materially implicated — including evaluation under [§5D](#5d-educational-capability-and-learning-system-integrity-evaluation) where the Article VI materiality trigger applies — **Article V-B** nondiscrimination floors where materially implicated — including evaluation under [§5B](#5b-nondiscrimination-evaluation) where the Article V-B materiality trigger applies — **Article V-G** accessibility floors where materially implicated — including evaluation under [§5C](#5c-accessibility-evaluation) where the Article V-G materiality trigger applies — **Article IV** resource-allocation and dependency floors — including [Proportionate Cross-System Support](core_05c_continuity_definitions.md#proportionate-cross-system-support-constitutional) under [§5A](#5a-proportionate-cross-system-support-evaluation) where materially implicated — and safety-related floors under **Article XII-A** and [**Safe Conditions**](core_05c_continuity_definitions.md#safe-conditions-constitutional) where materially implicated.
