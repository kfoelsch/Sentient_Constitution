...
- **Standard tests:** baseline suites appropriate to the assigned class and domain, including baseline security, abuse-resistance, and failure-mode coverage under CJS-5.21 and [Protocol A](corpus_systems/cs_protocol_a_system_design_testing_verification_deployment.md); and
- **Custom tests:** system-specific tests for the system's threat model, dependencies, data types in scope under [§4](#4-data-types-and-handling-evaluation), and known failure or abuse modes that standard suites alone would not cover.
...
- Upstream: [§2](#2-certification-record) (*record contents*); [§3](#3-system-class-evaluation) and [§4](#4-data-types-and-handling-evaluation) (*class and data evaluation inputs*); Chapters Two through Four (*burden, tracing, verification, and evidence preservation*); [Chapter Five §3.2 *Transparency, Auditability, and Verification*](core_05o_oversight_definitions.md#transparency-auditability-and-verification-cluster); [Contestability](core_05a_accountability_definitions.md#contestability).
...
- Upstream: [§2](#2-certification-record) (*record contents*); [§5](#5-transparency-auditability-and-contestability) (*record integrity requirements*); [§7](#7-forum-supervision-and-component-roles) (*component role assignments*); [Chapter Eleven §4](core_11-11_forum.md#4-forum-families) (*Integrity-led alignment recognition, component referral, and validation*); [Chapter Eleven §6](core_11-11_forum.md#6-transfer-consolidation-and-coordination) (*Integrity-led alignment coordination and anti-self-judging*).
...
The **supervisory sequence** is the ordered chain of supervisory authority for a certification record. Unless Chapter Eleven primary-stakes routing, anti-self-judging protection, or certification requires a different lawful order, the sequence is:
...
3. **Referral, certification, and stay.** The lead forum must refer, certify, or stay component questions that belong primarily in another forum family. It must not finalize recognition, validation, revalidation, or material release from conditions while a timely required component finding, objection, remediation condition, or certified question assigned to another family remains unresolved.
...
The supervisory sequence must be stated on the certification record under [§2](#2-certification-record). Technical expertise or Integrity coordination must not displace assigned merits authority for rights, stakeholder, institutional, sentience-status, constitutional-validity, structural-remedy, ecological, or other primary-stakes questions.
...
2. **Component challenge.** A challenge confined to a component finding routes to the forum family with merits authority over that component. The lead forum may stay reliance on the challenged component pending timely review.
3. **Lead-coordination challenge.** A challenge to capture, concealment, self-review, sequencing abuse, premature finalization, or lead-forum integrity routes under Chapter Eleven integrity and anti-self-judging rules. Lead coordination must not be the sole final merits forum for a claim whose primary issue is that same lead forum's bias, capture, conflict, or process abuse.
...
The contestability chain must be stated on the certification record. Internal operator review, vendor attestation, or technical sign-off alone does not exhaust contestability where forum-supervised challenge is required.
...
- Upstream: [§6](#6-supervisory-sequence-and-contestability-chain) (*supervisory sequence and contestability chain*); [Chapter Eleven §4](core_11-11_forum.md#4-forum-families) (*forum families and alignment recognition*).
- Downstream: [§8](#8-relationship-to-standing) (*standing-record bridge*).
- Read with: [corpus_forum.md](corpus_forum.md), **CF-10** (*Technical specialist forums and specialist chambers*).

</details>

<br>

**Technical forums** maintain and apply technical specifications, measurement methods, testing protocols, expert-evidence standards, uncertainty-reduction methods, and technical adequacy findings within their lawful scope. Those technical outputs are component findings for a certification record, including class-scaled assurance and data-handling infrastructure findings under [§3](#3-system-class-evaluation) and [§4](#4-data-types-and-handling-evaluation).

**Integrity forums** are the default lead for official constitutional alignment recognition and ongoing alignment validation unless Chapter Eleven assigns a different primary stake. Integrity forums must use technical-forum standards where materially applicable and must refer, certify, or stay component questions assigned to other forum families as [§6](#6-supervisory-sequence-and-contestability-chain) requires.

**Environment forums** hold the environmental-alignment component role where material ecological exposure, environmental-precondition dependency, lifecycle burden, restoration duty, or reasonably foreseeable ecological risk is present.

**Sentient, Institutional, Constitutional,** and other regular forum families retain their assigned component authority for rights, stakeholder, institutional, sentience-status, constitutional-validity, structural-remedy, or other primary-stakes questions. A certification process must not let technical expertise or Integrity coordination displace those assigned merits roles.
...
Certification records do not themselves apply standing effects. Chapter Eight controls standing records and axis-pure classification; Chapter Nine controls standing effects, competency gates, standing locks, restoration, and integration. No certification record may merge contribution and violation into a single score, convert technical adequacy into final constitutional alignment by itself, or treat recognition as permanent authorization.

<a id="9-reopening-drift-and-non-evasion"></a>

### 9. Reopening, Drift, and Non-Evasion

Recognition is scope-bound and time-bound. Material change, drift, concealed behavior, dependency growth, new risk, incident history, credible challenge under [§6](#6-supervisory-sequence-and-contestability-chain), ecological objection, stakeholder evidence, system-class drift, data-type or handling drift, or classification drift reopens review under Chapter Eleven and incorporated system implementation duties.

System owners, operators, stewards, institutions, and forums must not fragment a system, relabel its scope, suppress evidence, shift work across entities, mislabel data types, or claim experimental, personal, isolated, or technical-only status to evade certification, revalidation, transparency, auditability, contestability, or Chapter Eight standing consequences where material impact is present.
