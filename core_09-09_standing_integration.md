...
Evasion can aggravate violation nature when it conceals responsibility, frustrates audit, blocks remedy, or repeats harm after notice. Anti-evasion tools must remain evidence-based, contestable, proportionate, and reviewable; they authorize functional accountability, not guilt by association. Read with [Chapter One §11.4 Successor Responsibility and Formal-Structure Non-Escape](core_01_c_stewardship_capacity_principles.md#114-successor-responsibility-and-formal-structure-non-escape).
