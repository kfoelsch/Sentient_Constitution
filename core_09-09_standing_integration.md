...
The lock reaches indirect influence as well as formal office. A locked actor must not route control through shell entities, nominees, advisory capture, funding leverage, contractual vetoes, information chokepoints, data custody, reputation systems, technical standards, model weights, privileged access, procurement conditions, or comparable mechanisms that materially steer a covered system or forum pathway. Ordinary speech, petition, testimony, personal defense, whistleblowing, participation as an affected party, baseline rights, and survival-critical access remain protected unless an independent justice process imposes a separate lawful restriction under Article XXIII.
