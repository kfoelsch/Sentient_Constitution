...
| Findings this run | 1 |
| Ledger open findings | 1 |
| Ledger stale findings | 0 |
...
- **CJS-TRACE** `CJS-TRACE:f5168ce6f5ed` — CJS-5.0 @ `corpus_joint_structure/cjs_05_cross_implementation_operational_terms.md:27`: Principle basis is inferred from subject matter, not directly cited to Chapter 01.
