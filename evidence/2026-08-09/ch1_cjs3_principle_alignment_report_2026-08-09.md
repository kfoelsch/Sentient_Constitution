...
- **CJS-3.4** `corpus_joint_structure/cjs_03o_oversight_operations.md`:267: Audit process output disclosure preference missing OP-E, OP-C
- **CJS-3.4** `corpus_joint_structure/cjs_03o_oversight_operations.md`:271: 3. escalate to **forensic** or more-restricted tiers (**Type H**, **Type I**, **Type S**, **Type N**, or justified hold-backs) only when required by the applicable type, necessity, and constraint rules — and only while preserving maximum feasible visibility into the existence and character of the audit and its material results. missing OP-O

### Owner Drift

- **CJS-3.2** `corpus_joint_structure/cjs_03o_oversight_operations.md`:46: No owner-layer routing reference detected.
- **CJS-3.5** `corpus_joint_structure/cjs_03o_oversight_operations.md`:298: No owner-layer routing reference detected.
- **CJS-3.20** `corpus_joint_structure/cjs_03c_continuity_operations.md`:447: No owner-layer routing reference detected.
- **CJS-3.21** `corpus_joint_structure/cjs_03c_continuity_operations.md`:512: No owner-layer routing reference detected.
- **CJS-3.22** `corpus_joint_structure/cjs_03i_integrative_operations.md`:41: No owner-layer routing reference detected.
