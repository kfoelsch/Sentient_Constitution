...
- Candidates: 29
- Confidence: high 15, medium 11, low 3
...
### 1. CI-1: Scope, purpose, and legitimacy interface
...
### 5. CI-11: Resource stewardship and incentive integrity
...
### 7. CI-9.3: Delegated subunits, institutional design class, and attachment discipline
...
### 8. CI-14.1: Interface — Article XXV-D (non-compliant property, seizure, voluntary incentives)
...
### 10. CI-20: Care labor, dependent support, respite, and care-economy fairness
...
### 12. CI-10.2: Recurring charges, renewals, and commercial billing integrity
...
- Signals: routing-read-with(3), shared-procedure(3), dependency-failure(2), forum-system-touch(4)
- Router matches: CJS-R19 — Implementation and cross-implementation integrity assurance and resilience operations; CJS-R17 — Cross-implementation trust integrity (joint operation model); CJS-R15 — Contest-integrity monitoring (pathway integrity, not merits)
...
### 14. CI-18: Community life, voluntary association, and non-instrumental time
...
### 15. CI-9.2: Published industry and domain mapping
...
### 16. CI-9.4: Survival floors, voluntary exchange, and markets (Article III-A interface)
...
### 17. CI-9: Classification-linked institutional obligations
...
### 18. CI-1.1: Definition discipline and source hierarchy
...
### 19. CI-22: Commons, cooperatives, mutual aid, and non-market community governance
...
### 21. CI-9.3.2: Authority composition
...
### 23. CI-4: Appointment, competency, rotation, and removal
...
### 24. CI-14: Transitional governance and institutional evolution
...
### 26. CI-12.3: Digital self-service pathway integrity
...
### 27. CI-25: Collective public health, epidemic response, and addiction-informed care
...
### 28. CI-12: Transparency, participation, and accessible pathways
...
### 29. CI-8: Cross-institution coordination and escalation
