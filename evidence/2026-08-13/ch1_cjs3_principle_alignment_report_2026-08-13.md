...
| CJS-3.3 | Oversight: auditability and reconstructability terms (annex) | `corpus_joint_structure/cjs_03o_oversight_operations.md` | 3.2, 4, 7.1, 7.2 | 12.1, 12.2, 2.2, 3, linked | Article VII-B, Article XII-B, Article XV, Article XV-A, Article XV-B, Article XX (+6) | complete |
| CJS-3.4 | Oversight: tiered transparency and audit-access terms | `corpus_joint_structure/cjs_03o_oversight_operations.md` | 3.2, 6.2, 6.4, 7.1, 8 | 11.2, 11.4, 12.1, 13, 2.2, 6.3.1, linked | Article VII-B, Article XV, Article XV-A, CF, CS, corpus_forum.md (+1) | complete |
...
- **CJS-3.5** `corpus_joint_structure/cjs_03o_oversight_operations.md`:580: No owner-layer routing reference detected.
- **CJS-3.20** `corpus_joint_structure/cjs_03c_continuity_operations.md`:1029: No owner-layer routing reference detected.
- **CJS-3.21** `corpus_joint_structure/cjs_03c_continuity_operations.md`:1154: No owner-layer routing reference detected.
