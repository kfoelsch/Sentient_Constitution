...
**Topic group members.** This group comprises:
- [Shared-System Capacity](#shared-system-capacity-constitutional);
...
- C: Non-compliant: imposing or maintaining avoidable burden where a less-burdensome option satisfies the same constitutional outcomes under Chapter One §9.1.4; incentives that reward burden creation or maintenance contrary to [Incentive Alignment](core_05-05_definitions_a_independent.md#incentive-alignment) and Chapter One §7.4.
...
- O: Workable opportunities for materially affected sentients to learn how shared systems that affect them operate, with understanding scaled by [Materiality Determination](#materiality-determination) and [Dependency](core_05-05_definitions_a_independent.md#dependency), supporting informed participation, stewardship, and [Contestability](#contestability).
<a id="distributed-understanding-constitutional-e"></a>
- E: Distinguish from nominal disclosure, jargon barriers, or summaries that misstate operative effect. Read with [Educational Agency](core_05-05_definitions_c_dependent_clusters.md#educational-agency), [Transparency](core_05-05_definitions_c_dependent_clusters.md#transparency), and [Accessibility](core_05-05_definitions_a_independent.md#accessibility-constitutional). Scale depth, format, and timing to material impact, dependency, and adversarial conditions without defeating practical comprehension.
