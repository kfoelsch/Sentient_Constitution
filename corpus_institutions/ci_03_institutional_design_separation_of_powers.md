...
- Read with: **CI-3**; **CI-3.1**; **CI-3.2**; **CI-3.6**; [CJS-2.1](../corpus_joint_structure/cjs_02_implementation_integration_map.md#cjs-21-topic-router-stable-ids) topic router; **CJS-5.11** (*distributed and proportional authority terms*); **CJS-5.7** (*quorum and participatory legitimacy terms*).
...
- [Charter](../core_05c_continuity_definitions.md#charter) · [O](../core_05c_continuity_definitions.md#charter) · [A](../core_05c_continuity_definitions.md#charter-a) · [C](../core_05c_continuity_definitions.md#charter-c)
...
*In plain terms: some decisions are too important to hand to a subordinate — the governing body must keep them. At minimum that means staying aligned with the constitution, accepting serious risk, deciding to dissolve the institution, and adopting or amending its [Charter](../core_05c_continuity_definitions.md#charter). Any other non-delegable duties must be written down in a list.*

The following are non-delegable by the governing authority:
- constitutional alignment,
- material risk acceptance,
- dissolution decisions,
- [Charter](../core_05c_continuity_definitions.md#charter) adoption and material charter amendment.
...
Delegations must remain consistent with the institution's governing [Charter](../core_05c_continuity_definitions.md#charter). A delegation may not expand institutional scope beyond the Charter, silently amend the Charter, or defeat periodic charter-review duties.
...
- Upstream: [CJS-1.2](../corpus_joint_structure/cjs_01_scope_purpose_boundary_interface.md#cjs-12-shared-implementation-corpus-preamble-contract) shared implementation-corpus contract; [CJS-2.1](../corpus_joint_structure/cjs_02_implementation_integration_map.md#cjs-21-topic-router-stable-ids) topic router; [Chapter Sixteen](../core_16-16_incorporation.md#chapter-sixteen-incorporation-bridge) incorporation discipline; [Chapter Five](../core_05-05_definitions_a_independent.md#chapter-five-foundational-definitions) canonical definitions — especially [Charter](../core_05c_continuity_definitions.md#charter); [System Creation](../core_05p_participation_definitions.md#system-creation-constitutional); [Business Creation](../core_05p_participation_definitions.md#business-creation-constitutional); and [Chapter Six](../core_06-06_rights_part_a.md#chapter-six-foundational-rights) rights architecture where rights interfaces are invoked.
...
- Read with: **CI-3.6**; **CJS-5.11** (*Formation and authorization proportionality floor*); **CI-8** / **CI-26** where charter publication intersects governance disclosure; [Chapter Seven](../core_07_a_system_alignment_certification_evaluation.md#chapter-seven-system-alignment-certification) where the institution operates or stewards a materially impactful system.
- Topic routing (primary owner): **CJS-R14** (*Institutional functional lanes and non-delegable splits*) in **CJS-2.1** (*Topic router (stable IDs)*). Mandatory read-with: **CJS-5.11** (*distributed and proportional authority terms*).
...
- [Charter](../core_05c_continuity_definitions.md#charter) · [O](../core_05c_continuity_definitions.md#charter) · [A](../core_05c_continuity_definitions.md#charter-a) · [C](../core_05c_continuity_definitions.md#charter-c)
- [System Boundaries](../core_05c_continuity_definitions.md#system-boundaries) · [O](../core_05c_continuity_definitions.md#system-boundaries) · [A](../core_05c_continuity_definitions.md#system-boundaries-a) · [C](../core_05c_continuity_definitions.md#system-boundaries-c)
...
8. **Periodic-review cadence** — next review date or interval, scaled to [material stake](../core_00_preamble.md#material-stake), class, dependency, and risk under [Proportionality](../core_05a_accountability_definitions.md#proportionality) and [Classification-Scaled Governance](../core_05o_oversight_definitions.md#classification-scaled-governance).
...
- stated purpose and in-scope / out-of-scope limits still match observed operation and [System Boundaries](../core_05c_continuity_definitions.md#system-boundaries);
...
**Anti-evasion.** Charter text does not establish classification, defeat [System Boundary Integrity](../core_05c_continuity_definitions.md#system-boundary-integrity), or substitute for forum-supervised system alignment certification where Chapter Seven requires it. Paper-only Charters, overdue reviews treated as current authorization, and delegations that expand scope beyond the Charter are non-compliant under this subsection and [CI-3.3](#ci-33-authority-chain-and-delegation-controls).

**Systems and businesses.** Non-institutional systems and commercial forms that require a Charter under Chapter Five [Charter](../core_05c_continuity_definitions.md#charter) should use the same minimum field set. Certification-record duties remain with Chapter Seven; institutional adoption, custody, and non-delegable amendment for institutions remain with this subsection.
