...
- Downstream: this section's local operational requirements for **Institutions registry (stable section families)**.
- Read with: **CI-1**; **CI-2**; **CI-3**; **CI-4**; **CI-26**.
...
| **CI-2** | Implementation integration map: institutional topic router, overlap discipline, and read-with order | [ci_02_implementation_integration_map.md](ci_02_implementation_integration_map.md) |
