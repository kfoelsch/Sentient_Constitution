...
**2. Unpaid care recognition.** **Metrics** and **governance** **disclosures** under **CI-12.4** (*Governance disclosure schema*) should **surface** **unpaid** **care** **load** and **dependency** **concentration** as **first-class** **risk** **inputs**, not **private** **background**.
