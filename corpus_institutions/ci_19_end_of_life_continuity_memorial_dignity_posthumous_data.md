...
- Downstream: this section's local operational requirements for **CI-19: End-of-life continuity, memorial dignity, and posthumous-data stewardship**.
- Read with: **CI-19**; **CI-12**.
...
- [Irreversible Deprivation Measure](../core_05-05_definitions_c_dependent_clusters.md#irreversible-deprivation-measure-constitutional) · [O](../core_05-05_definitions_c_dependent_clusters.md#irreversible-deprivation-measure-constitutional) · [E](../core_05-05_definitions_c_dependent_clusters.md#irreversible-deprivation-measure-constitutional-e) · [C](../core_05-05_definitions_c_dependent_clusters.md#irreversible-deprivation-measure-constitutional-c)
...
- **Read with** — **CI-12** for participation and pathway accessibility.
...
- **Article VII-C** (*Mental-Health Crisis and Involuntary-Intervention Floor*) in **Chapter Ten** — crisis-intervention safeguards that **CI-19** does not narrow.
- **CI-19 scope** — does not repeat those floors; states local advance-planning, palliative-routing, memorial, disposition, grief-accommodation, and likeness-protection owner duties.

**Apply**

- Apply **CJS-5.18** **Data-retention and lifecycle-integrity terms** for the shared posthumous-data and continuity floor.
- **CI-19** states only local owner duties under **Article VII-E**, **Article VIII**, **Article III-C**, and **Article XXIII-B** — without narrowing **Article VII-C** crisis-intervention safeguards or authorizing deprivation of life as sanction.
...
- **advance-instruction custody** — who receives, stores, versions, and honors advance directives, living wills, and comparable end-of-life instructions while the person can still update them;
- **substitute decision-maker records** — who maintains the official file for designated agents, guardians, or comparable substitute decision-makers, including scope, activation triggers, and challenge routes;
...
Read **CI-12** for participation and accessibility interfaces.
