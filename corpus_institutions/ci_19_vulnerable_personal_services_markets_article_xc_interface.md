## CI-19: Vulnerable personal services markets — general regulation and Article X-C interface
<details>
...
- Downstream: this section's local operational requirements for **CI-19: Vulnerable personal services markets — general regulation and Article X-C interface**.
- Read with: **CI-19**; **CI-8.3**; **CI-6**; **CI-8**; **CI-9**; [CJS-2.1](../corpus_joint_structure/cjs_02_implementation_integration_map.md#cjs-21-topic-router-stable-ids) topic router.
...
- **Article X-C** (*Adult consensual commercial sexual services and sexual exploitation*) in **Chapter Six** — decriminalization floor, exploitation proscriptions, nondiscrimination, general-market integration, anti-circumvention, and transition relief. **Articles X-A**, **V-B**, **I-C**, **IV-A**, and **IV-C** and **Chapter Five** (*Protected Characteristics*, *Consent*, *Coercion and Manipulation*) remain the rights single home alongside **Article X-C**.
...
- **CI-19** states only local **Article X-C** application-file owner duties. Comparable lawful personal services should use comparable regulatory families unless documented **Necessity** and **Proportionality** justify differentiation.
...
- **remedy and escalation routes** — where affected sentients obtain non-criminal remedies and where stalled or conflicted review escalates;
