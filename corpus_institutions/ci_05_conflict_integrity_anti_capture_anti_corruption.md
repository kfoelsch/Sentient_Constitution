...
**Sortition integrity controls:** apply `corpus_joint_structure.md` **CJS-5B.1** (*Implementation and cross-implementation integrity assurance and resilience operations*) **Sortition and civic-lottery integrity controls** for the shared randomization, briefing, staff-separation, intimidation, post-service benefit, and contest-route floor. CI-5 states the institutional application: each institution using sortition or civic-lottery bodies must publish the local control-map owner, source-list custodian, conflict-screening route, access-support owner, briefing and facilitation independence checks, records required for audit reconstruction, and escalation path for credible manipulation, capture, intimidation, or laundering of a predetermined outcome.
