...
*In plain terms: each institution must write down who does what when honesty or independence is at stake — not leave it implied. That means a published map of anti-corruption safeguards, named roles for publishing disclosures and tracking fix deadlines, records when serious breaches trigger forfeiture, oversight of prediction-market-style systems, and a clear path to outside review when the institution cannot credibly investigate itself.*

Each institution must maintain and publish:
- an integrity control map naming who owns each safeguard;
