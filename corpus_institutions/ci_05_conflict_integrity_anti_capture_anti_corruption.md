...
- Downstream: [CI-5.1: Integrity trigger taxonomy and cross-layer routing (control package)](#ci-51-integrity-trigger-taxonomy-and-cross-layer-routing-control-package).
- Read with: **CI-5**; **CI-7.2**; **CI-8**; **CI-11**; **CI-13**; **CI-6**; **CI-5.1**.
...
This subsection names institutional trigger categories for **CI-5** (*Conflict integrity, anti-capture, and anti-corruption*) control maps and training. Shared cross-layer routing for integrity triggers is governed by `corpus_joint_structure.md` **CJS-5B.1** (*Implementation and cross-implementation integrity assurance and resilience operations*), especially the **Integrity-trigger routing chain** entry. This subsection does **not** add constitutional rights, offense labels, forum structure, or final classification rules.
...
**Routing (owner sections, not parallel doctrine):** Apply **CJS-5B.1** for the shared routing chain. Institutional intake and triage remain under **CI-5** detection requirements; institutional assurance and custody remain under **CI-7**; independence failure and transfer or co-assignment remain under **CI-8**; institutional separation, recusal, and secondary-review interfaces remain under **CI-2** and **CI-6**; forum, investigative, forensic, technical-specialist, or adjudicative support remains under the applicable **CF** sections; and institutional sanctions or role forfeiture remain under **CI-11** and **CI-13**.
