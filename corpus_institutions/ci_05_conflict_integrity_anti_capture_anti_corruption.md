...
**Routing.** Apply **CJS-5B.1** **Integrity-trigger routing chain** for the shared cross-layer traceability floor. Institutional trigger labels above map to **CI-5**, **CI-7**, **CI-8**, **CI-2**, **CI-6**, applicable **CF** sections, **CI-11**, and **CI-13** for local intake, assurance, escalation, procedure, forum support, and sanctions duties.
