...
- **unpaid-care metrics** — who maintains the **CI-8.4** governance-disclosure fields that make unpaid care, dependency concentration, and carer burden visible in periodic reports rather than treating them as private background; where demonstrable informal care is sought as a [Chapter Eight](../core_08_standing_assessment.md#chapter-eight-compliance-violation-and-standing-model) contribution record (*Caretaking and Dependency Support*), this or another disinterested office with authority to rely on the record is the **record-opening authority** under [Chapter Eight §3.7](../core_08_standing_assessment.md#37-informal-and-small-scope-records) (*Informal and small-scope records*) and [Chapter One §10.2 Segregation of Duties](../core_01_c_stewardship_capacity_principles.md#102-segregation-of-duties) — the carer is the claimant, the dependent or household members are beneficiaries whose attestations are inputs, and no formal-institution credential is required where this office can verify;
