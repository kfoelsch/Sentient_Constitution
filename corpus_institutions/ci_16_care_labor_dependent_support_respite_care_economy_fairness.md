...
- **unpaid-care metrics** — who maintains the **CI-8.4** governance-disclosure fields that make unpaid care, dependency concentration, and carer burden visible in periodic reports rather than treating them as private background; where demonstrable informal care is sought as a [Chapter Nine](../core_09_standing_assessment.md#chapter-nine-compliance-violation-and-standing-model) contribution record (*Caretaking and Dependency Support*), this or another disinterested office with authority to rely on the record is the **record-opening authority** under [Chapter Nine §3.7](../core_09_standing_assessment.md#37-informal-and-small-scope-records) (*Informal and small-scope records*) and [Chapter Seven §2 Four-Seat Constitutional Floor](../core_07_functional_independence_segregation_of_duties.md#2-four-seat-constitutional-floor) — the carer is the claimant, the dependent or household members are beneficiaries whose attestations are inputs, and no formal-institution credential is required where this office can verify;
