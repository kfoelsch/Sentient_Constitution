...
- **continuity and succession routing** — who preserves governance records, handoff authority, and service continuity when commons stewards rotate, cooperatives reorganize, or mutual-aid networks change form; where a standing record exists, this office is its **record custodian** under Chapter Nine §3.7 (*Record custody and opening authority*), and enters and holds what the separate records-recognition office verified; the two offices may be hosted by the same relying body under its published lane map and independence safeguards, but the custodian never verifies the same record or acts as a claimant; and
