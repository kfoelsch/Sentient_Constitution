...
**5. Domain carve-outs and presumptive public-access regimes.** Institutions must maintain published rules identifying domains where strong exclusion is presumptively unavailable or categorically unavailable under adopting law. Those rules must identify the local public-access mechanism and the showing required for any narrower temporary exclusion.

**6. Duration, review, and sunset.** Institutions must maintain the published expiry schedule, review calendar, and record-update process for exclusionary innovation rewards. Review findings must identify whether the local instrument leaves the claim unchanged, narrows it, converts it to a less restrictive mechanism, accelerates sunset, or refers the matter for specialist review.
