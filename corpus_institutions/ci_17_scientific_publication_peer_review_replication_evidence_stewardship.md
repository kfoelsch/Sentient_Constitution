...
**2. Evidence package minimums.** For material empirical, analytical, or methodological claims, apply `corpus_joint_structure.md` **CJS-5B.4** (*Implementation and cross-implementation independent verification and claim-integrity terms*) **Structured claim-testing, reliance, and correction integrity** and **Structured review and incentive-integrity floor**. CI-17 adds the science-publication application: publication packages should support the independent understanding and proportionate verification required by **Article XVII-E**, and claims lacking the minimum package must be visibly marked as preliminary, incomplete, or non-verifying.

**3. Review as structured claim testing.** Structured review dimensions and reliance consequences are governed by `corpus_joint_structure.md` **CJS-5B.4**. CI-17 adds the science-publication application: institutions must keep publication-review records in a form that can support Article XVII-E reliance, correction, appeal, and specialist-forum review.

**4. Review identity options and conflict controls.** Review identity modes, conflict controls, editorial override records, and reviewer-independence expectations follow `corpus_joint_structure.md` **CJS-5B.4**. CI-17 adds the institutional custody duty: the publication owner must preserve reviewer selection, recusal, funding-tie, editorial-intervention, and substantive-review records for qualified audit, retaliation review, and appeal.

**5. Reliance gate and challenge lane.** The shared reliance and challenge floor is governed by `corpus_joint_structure.md` **CJS-5B.4**. CI-17 adds the institutional publication duty: institutions must maintain a first-class publication lane for good-faith challenge work and must record reliance status before giving durable institutional reliance to high-impact claims.

**6. Correction, retraction, and supersession integrity.** Correction-history and supersession integrity follow `corpus_joint_structure.md` **CJS-5B.4**. CI-17 adds the science-publication rule: retraction or correction must preserve the publication audit trail unless a narrower privacy, security, or safety exception is justified.
...
**8. Incentives, standing, and anti-prestige capture.** Anti-prestige and incentive-integrity rules for claim reliance are governed by `corpus_joint_structure.md` **CJS-5B.4**. CI-17 adds the institutional record duty: institutions must publish or preserve the criteria used for publication-related hiring, promotion, grantmaking, ranking, and standing decisions.
