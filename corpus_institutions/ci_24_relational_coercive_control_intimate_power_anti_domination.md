## CI-24: Relational coercive control, intimate power, and anti-domination routing
...
**3. Platform and reputation systems.** **Reputation**, **scoring**, and **visibility** **tools** that **trap** **in-home** or **gig** **workers** route through **CI-15** (*Transparency, participation, and accessible pathways*), **CI-5** (*Conflict integrity, anti-capture, and anti-corruption*), and **`corpus_systems.md` Chapter S2** **section 9** as **applicable**.

---

---

**Previous file:** [ci_23_care_labor_dependent_support_respite_care_economy_fairness.md](ci_23_care_labor_dependent_support_respite_care_economy_fairness.md)
**Next file:** [ci_25_commons_cooperatives_mutual_aid_non_market_governance.md](ci_25_commons_cooperatives_mutual_aid_non_market_governance.md)
