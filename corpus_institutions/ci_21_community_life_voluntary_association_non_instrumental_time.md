...
- **Article V-H** (*Expression, Assembly, and Press*); **Article X-A** (*Non-Imposition and Consent in Association*).
...
*In plain terms: institutions that control parks, halls, transit-to-gathering routes, recreation programs, or scheduling rules must not treat cultural gathering, play, recreation, or quiet non-productive time as second-class uses that only survive if they pay their way.*
...
*In plain terms: joining a club, mutual-aid circle, faith community, or online group must rest on real consent — and leaving must not trigger retaliation, reputational lock-in, or hidden informal punishment. Community warmth is not a license for capture.*
