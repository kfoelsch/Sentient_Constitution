...
| Meta-integrity obligations — **constitutional incorporation hook** | **Core** — Sentient Constitution Ch 15 (`core_15-15_incorporation.md`) | Ch 1–14; **CP-PCH1 — Meta-integrity obligations** elaboration in [corpus_joint_structure.md](corpus_joint_structure.md) (*Cross-domain implementation layer*) |
| Meta-integrity elaboration; presentation / architecture / governance implementation labels | **Implementation file** — [corpus_joint_structure.md](corpus_joint_structure.md) **Cross-domain implementation layer** (**CP-PCH1** through **CP-PCH4**) | Ch 1–15, CS S1/S2/Protocol A as needed; avoid duplicating Protocol B *engineering* checklist unless harmonizing |
...
| Meta layer (elaborated) | CP-PCH1 — Meta-integrity obligations | Sentient Constitution Ch 14 (*incorporation bridge*); CP “Interpretation — Meta-integrity obligations” |
| Legitimacy / adoption / amendment machinery | Sentient Constitution Ch 10, Ch 11–13 | Implementation-file operational hooks |
| Stable implementation labels | Registry in corpus_joint_structure.md | Sentient Constitution Ch 10 (governance) and Ch 14 (incorporation hook); CP-PCH1 through CP-PCH4 |
...
**Legacy shorthand:** Older drafts sometimes wrote “CP Ch 6–9,” “Sentient Constitution Ch 6–9,” or “Implementation Group N” for the same four CP chapters; replace with **CP-PCH1** through **CP-PCH4** plus the applicable **PRIM** or **PROT** code where available.
...
- **To meta incorporation hook:** `Sentient Constitution Ch14` (*incorporation bridge*) plus **CP-PCH1** / “corpus_joint_structure.md, meta-integrity obligations.”
- **To CP implementation labels:** `CP-PCH1` through `CP-PCH4` ([corpus_joint_structure.md](corpus_joint_structure.md)) — **not** Sentient Constitution chapter numbers.
...
`corpus_joint_structure.md` now uses one active navigation grammar only: **CP-PCH1** through **CP-PCH4**, with **PRIM1-PRIM15** and **PROT1-PROT6** as the canonical internal structure.
