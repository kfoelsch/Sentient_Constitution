...
| System alignment certification | Ch 7 | `core_07_a_system_alignment_certification_evaluation.md` (Part A — evaluation); `core_07_b_system_alignment_certification_record_process.md` (Part B — record and process); reading index: `core_07-07_system_alignment_certification.md`. Under **oversight**, oversight requires auditing (**Article XV** / [Auditability](core_05defs_oversight.md#auditability) / **CJS-5.3**–**CJS-5.5**); Ch 7 is one especially large, high-stakes audit process among others — not the sole auditing home. |
