...
| Productive capacity, constitutional efficiency, and avoidable burden | Sentient Constitution Ch 5 **§2** semi-independent cluster (*Avoidable Burden*, *Constitutional Efficiency*, *Productive Capacity*, and *Burden-Reduction Duty*); Ch 5 **§3.27** broader limitations / burden-efficiency dependent cluster where its admission scope applies | Ch 1 **§5.1** (instrumental-good framing), **§6.1.4** (fourth Core Tradeoff Principle), **§7.2.2** (stewardship incentive alignment); Ch 9 **Article XX** avoidable-complexity clause; Ch 10 **§3** burden-reduction duty and **§3.2** Ecosystem Value Orientation |
