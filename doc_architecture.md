...
- **CJS-only** substance that other layers must cite — purpose of the joint layer / implementation-corpus gateway (**CJS-1.0**), identifier rules including **oDef** / **Def** and the constitutional-vs-joint-operational-definition distinction (**CJS-1.1**), shared contract (**CJS-1.3**), and parse mechanics for **oDef** (**CJS-1.13**–**CJS-1.14**) — lives in **CJS-1** (and its subsections). Parse mechanics live in [cjs_01_odef_parse.md](corpus_joint_structure/cjs_01_odef_parse.md); drafting contracts (**CJS-1.7**–**CJS-1.8.1**) live in [cjs_01_drafting_contracts.md](corpus_joint_structure/cjs_01_drafting_contracts.md). **CS** / **CI** / **CF** point to those homes; they do not restate them. Applicability, combined satisfaction, the default **CJS → CS → CI → CF** reading stack, and stricter-wins among jointly applicable incorporated obligations live in **Chapter One §8.4.4** and **§8.4.3**; CJS cites those homes and does not restate them. Non-operative how-to-read for average humans lives in [cjs_reader_guide.md](corpus_joint_structure/cjs_reader_guide.md) only.
...
| Parse mechanics (guidepost **What it is** / **How to measure and assess** / **What must hold**; **oDef** clusters) | **CJS-1.13**–**CJS-1.14** in [cjs_01_odef_parse.md](corpus_joint_structure/cjs_01_odef_parse.md) |
...
- **Cross-implementation routing:** **CJS-0.1** in [`cjs_00_topic_router.md`](corpus_joint_structure/cjs_00_topic_router.md#cjs-01-topic-router-stable-ids); `make router-bidirectional-audit`. Compatibility anchors remain in [`cjs_00_registry_and_reading_rules.md`](corpus_joint_structure/cjs_00_registry_and_reading_rules.md#cjs-01-cross-file-routing).
...
- **Topic router reader index (generated, human view):** [doc_architecture/generated/topic_router_reader_index.md](doc_architecture/generated/topic_router_reader_index.md) — plain-language grouped index derived from **CJS-0.1** in [`cjs_00_topic_router.md`](corpus_joint_structure/cjs_00_topic_router.md); reading guidance and two-tier plain view in **CJS-0.1** ([Cross-file routing](corpus_joint_structure/cjs_00_topic_router.md#cjs-01-cross-file-routing)). Authoritative mandatory read-with lists remain in the integrator table. Machine twin: [topic_router.json](doc_architecture/generated/topic_router.json). Compact locator including the same rows plus family IDs and definition terms: [`ai_corpus/indexes/id_resolver.json`](ai_corpus/indexes/id_resolver.json) (derived; cannot narrow core).
