...
2. **Aim and leg apex files** — dedicated files hold canonical O/M/A/C plus decomposition routing only: [Flourishing aim](core_05apex_flourishing_aim.md), [Continuity aim](core_05apex_continuity_aim.md), [Oversight leg](core_05apex_oversight_leg.md), [Participation leg](core_05apex_participation_leg.md), [Accountability leg](core_05apex_accountability_leg.md) (**Timeliness** co-leg). Filename prefix `core_05apex_` sorts before band files.
