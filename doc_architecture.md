...
- **Aim and band file rollups** (for example [Constitutional Aim decomposition](core_05f_flourishing_aim.md#flourishing-aim-decomposition)) route to definition homes; they do not restate per-term measurement tiers once those tiers live on the definition entry.
