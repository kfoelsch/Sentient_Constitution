...
**Purpose and owner boundary.** This section governs institutional handling of innovation-reward systems where constitutional adoption brings them within scope. Constitutional meaning remains in **Chapter Five** (*Innovation Reward and Anti-Enclosure*) and **Chapter Ten**, **Article XVII-D**. Cross-implementation and burden discipline remain in `corpus_joint_structure.md` **PRIM7 — Interoperability, Portability, and Exit Integrity**, **PROT4 — Burden of Justification and Constraint**, **CJS-5.8**, and **CJS-5.19**. This section supplies only the institutional registry, review, access-order, sunset, and appeal mechanics.
