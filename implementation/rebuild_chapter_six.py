...
def main():
    ...
    preamble = preamble.replace(
        "> - **Principle foundation (non-operative gloss):** [Chapter One §5.2 — Distributed Understanding and Stewardship](core_00-01_principles.md#52-distributed-understanding-and-stewardship) states the *why* for **standing** that ties trust-, role-, and recognition-eligibility to **distributed competence** and **consequential stewardship** under audit and contestability — not to opaque prestige or symbolic participation alone. Operative integration lives in **section 1** and **section 2** of this chapter.",
        "> - **Principle foundation (non-operative gloss):** [Chapter One §5.2 — Distributed Understanding and Stewardship](core_00-01_principles.md#52-distributed-understanding-and-stewardship) states the *why* for **standing** that ties trust-, role-, and recognition-eligibility to **distributed competence** and **consequential stewardship** under audit and contestability — not to opaque prestige or symbolic participation alone. Operative integration lives in **section 2** of this chapter (**standing effect** and **verified inputs for standing**).",
    )
    preamble = preamble.replace(
    ...
    **Section 5**’s **shared domain lens** table **pairs** [§3.7](#37-stackable-benefit-and-stewardship-descriptors-axis-i-supplement) prosocial supplements with [§4.13](#413-non-exclusive-harm-and-conduct-descriptors) harm-route descriptors **without** replacing primary **§3.1–3.3** bands or **§4.1–4.12** severity / legal typing; **§3.7**’s **remedial and restorative benefit** **stacks** across those lenses and **read with** **§4.5** when remedy dominates (**§5** table).
    ...
    - Upstream: [§1](#1-purpose-and-role) (*two-axis frame*); [Chapter One §5.2 — Distributed Understanding and Stewardship](core_00-01_principles.md#52-distributed-understanding-and-stewardship); [Chapters Two through Four](core_02-04_definition_mechanics.md); [Chapter Five](core_05-05_definitions_a_independent.md#chapter-five-foundational-definitions).
