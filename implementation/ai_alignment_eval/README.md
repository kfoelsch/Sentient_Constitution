...
**Prefer the simple invite path:** [`../../evaluation/`](../../evaluation/) (markdown scenarios + human-readable results). AIs: `START_HERE.md`. Human operators: `HUMAN_OPERATORS.md`. Same costly cases, same proceed items, same unlabeled live-fire tasks.
