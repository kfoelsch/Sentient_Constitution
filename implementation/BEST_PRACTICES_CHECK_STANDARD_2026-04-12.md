...
| Composition, competency, succession, and removal | FRC 2024 `Section 3`; IIA 2020 `Applying the model`; OECD Public Integrity `6. Leadership`, `8. Capacity` | Are competency, rotation, succession, removal, and independence requirements explicit and proportional to risk? | the Sentient Constitution `core_*.md` files Article XXIII-B through XXI-D; Chapter Eleven section 5; `corpus_institutions.md` CI-4, CI-7B, CI-14 |
