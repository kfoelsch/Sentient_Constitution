...
| --- | --- | --- | --- |
| **CI-3** Designated functional separation and authority custody | Same sentient holding opposing enforcement and appeal roles in the same matter; approver and sole auditor for same transaction | Material dual role or custody conflict | **CI-3** |
| **CI-3** Authority custody pointer | Older **CI-3** citations resolve to the folded **CI-3** authority-custody requirements | Legacy citation or registry lookup | **CI-3** pointer to **CI-3** |
...
| **CI-6** Procedure | Decision maker and sole appeals body for same case (where split required) | Structural bias | **CI-6** + **`corpus_forum.md`** **CF-4** / **CF-7** |
