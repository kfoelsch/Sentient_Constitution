...
- Adoption-scope note: what remains in force for non-adopters vs adopters (Chapter Sixteen framing).

## 3. Validity and non-regression checklist

- [ ] Chapters Twelve–Fourteen validity / non-regression checks satisfied for the change class
- [ ] No silent companion-file drift outside adoption chain
- [ ] Chapter Nine / Seven classification routing unchanged in meaning where not intentionally amended
