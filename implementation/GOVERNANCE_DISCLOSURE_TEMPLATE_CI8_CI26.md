...
**Maps to:** `corpus_institutions.md` **CI-8** (*Transparency, participation, accessible challenge and service pathways*), **CI-8.4** (*Governance disclosure schema*), **CI-26** (*Compliance mapping and stable registry*).  
**Non-authoritative** unless adopted.

## Publication cadence

- Annual / quarterly / event-triggered: (pick; justify by class/tier)
...
- Participation rate, contest outcomes, backlog against **CF-11** targets where forums are in scope.
- Integrity incidents and closure status (**CI-5** / **CI-13**).

## Model flexibility

Adopters may use different governance brands; this template requires **disclosure content**, not a specific organizational chart.
