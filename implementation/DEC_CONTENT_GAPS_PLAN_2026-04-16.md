...
2. **Chapter Five admission gate (`doc_architecture.md` §4).** Every new Ch 5 entry stays at concept + O / E / C only. No authority, procedure, or workflow language. Cite owner layers (Ch 6–14, CJS-META, CP-PCH2–PCH4, CS S1–S3 / protocols) for mechanics. Verified in blocking regression by `make ch5-definitions-gravity-audit`.
