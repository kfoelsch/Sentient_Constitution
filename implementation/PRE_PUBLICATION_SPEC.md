...
| **Audit stack picture** | **Shipped 2026-08-12; relocated to Article XV 2026-09-08.** Three layers (Article XV floor / Auditability property / CJS-3.3 how-when) in [Article XV](../core_06-06_rights_part_c.md#audit-three-layers). Chapter Seven is a user of the stack, not a fifth home. Steward pointer: [`STEWARD_ENTRY_DOORS.md`](STEWARD_ENTRY_DOORS.md#audit). |
...
| 4 | **Mature the Audit stack** — define home, reader door, and operator path; remove false “reader-facing integration” patterns | **Shipped 2026-08-12; picture relocated to Article XV 2026-09-08** — three-layer picture in [Article XV](../core_06-06_rights_part_c.md#audit-three-layers); operator path remains **CJS-3.3** |
...
| Candidate | Decision |
|---|---|
| **Audit / oversight** | **Named use stack.** Three-layer home pinned 2026-08-12: Article XV (floor), Auditability (property), CJS-3.3 (how/when). Reader picture in [Article XV](../core_06-06_rights_part_c.md#audit-three-layers) (relocated from the doors page 2026-09-08). Operator path is CJS-3.3; Chapter Seven uses the stack and is not a fourth layer. |
