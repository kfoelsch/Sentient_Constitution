...
**Status:** Draft v0.12 (§6 open decisions closed; Chapter Five defs-band cleanup closed; AI alignment eval framework wired; audit stack three-layer picture shipped; inspectable attributable action specified in CS-4 as the default mixed-crew logging contract; human operators bound to the same Layer B costly cases; steward cards expanded to common fact patterns with four fields, live-anchor checks, one shared refusal-and-logging screen, tested routing examples, and an owner/clock index; restore-challenge clocks reuse Article XXIV-C / Chapter Eleven §6)  
...
**Progress pointer:** Restore-challenge clocks shipped 2026-08-12 ([Article XXIII-D](../core_06-06_rights_part_d.md#xxiii-d-restore-challenge-clocks); reuse [Article XXIV-C](../core_06-06_rights_part_d.md#article-xxiv-c-timely-resolution-and-anti-delay-floor) / [Chapter Eleven §6](../core_11-11_forum.md#6-timely-resolution-materiality-tiers-and-anti-delay-discipline)). Steward cards expanded 2026-08-12 to common fact patterns (four fields; live-anchor and edition-stamp checks); one shared refusal-and-logging screen; tested routing examples and [`steward_owner_clock_index.json`](steward_owner_clock_index.json) (process support; cannot narrow core text). **Next:** Remedy stack maturity beyond the pinned door, and remaining Emergency / continuity maturity (step 5).
...
| **Standing + SAC entry doors** | **Shipped 2026-08-12; expanded same day.** Four-field cards for common fact patterns in [`STEWARD_ENTRY_DOORS.md`](STEWARD_ENTRY_DOORS.md) (named use stacks plus contest, incentive, unlawful instruction, shared stewardship). Same cards for human and AI stewards. Costly-case refusals sit on each card in the same words. Pinned to corpus edition `SC-Corpus-2026.08.09`. Live-anchor and edition-stamp checks in `make steward-door-lockstep-audit`. Process support; cannot narrow core text. |
...
| **Inspectable attributable action** | **Shipped 2026-08-12.** Mixed human/AI action surface in [`cs_04_critical_system_stewardship.md`](../corpus_systems/cs_04_critical_system_stewardship.md#10-inspectable-attributable-action): reconstructable attributable action, not weights or private deliberation; no privacy veto over standing measurement. Standing records remain Chapter Eight. Named as the **default logging contract** for mixed crews; operator screen (combined with duty to resist): [`STEWARD_ENTRY_DOORS.md#shared-refusal-and-logging`](STEWARD_ENTRY_DOORS.md#shared-refusal-and-logging). |
| **Duty-to-resist operator screen** | **Shipped 2026-08-12; combined same day.** Shared instruction-received / refuse / document / escalate sequence and the CS-4 §10 minimum inspectable-action set now share one screen: [`STEWARD_ENTRY_DOORS.md#shared-refusal-and-logging`](STEWARD_ENTRY_DOORS.md#shared-refusal-and-logging). Legacy anchors `#duty-to-resist` and `#minimum-inspectable-action-set` remain. Owner remains [Chapter Nine §5.4](../core_09-09_standing_integration.md#411-duty-to-resist-unlawful-or-unconstitutional-instructions) / [CS-4 §10](../corpus_systems/cs_04_critical_system_stewardship.md#10-inspectable-attributable-action). Same screen for human and AI stewards. |
...
| 3 | **Standing + SAC entry doors** — steward-facing four-field cards for common fact patterns | **Shipped 2026-08-12; expanded same day** ([`STEWARD_ENTRY_DOORS.md`](STEWARD_ENTRY_DOORS.md); [`steward_owner_clock_index.json`](steward_owner_clock_index.json)) |
