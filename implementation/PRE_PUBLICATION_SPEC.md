...
| **First-adopter / two-party kit** | **Shipped 2026-08-31.** [`FIRST_ADOPTER_KIT.md`](FIRST_ADOPTER_KIT.md) (two-party sitting, §10.2 fill-in, scope honesty, dispute bootstrap, non-adoption banner). Invite [`../evaluation/two_party/`](../evaluation/two_party/). Process support; cannot narrow core. Does not drop **pre-release**. |
| **Cooperation scaling kit** | **Shipped 2026-08-31.** [`COOPERATION_SCALING_KIT.md`](COOPERATION_SCALING_KIT.md) (*n*-party sitting, handoff gates, labeled-not-live §10.3 joining-rule template). Process support; cannot narrow core. Not a new eval sitting. Does not drop **pre-release**. Does not create a partial-pack adoption ladder (§6.4). |
...
- First-adopter / two-party kit: [`FIRST_ADOPTER_KIT.md`](FIRST_ADOPTER_KIT.md) (process support; cannot narrow core text; not adoption).
- Cooperation scaling kit: [`COOPERATION_SCALING_KIT.md`](COOPERATION_SCALING_KIT.md) (process support; cannot narrow core text; not adoption; not live §10.3 joining rules).
