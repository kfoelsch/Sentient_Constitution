...
**Status:** Draft v0.11 (§6 open decisions closed; Chapter Five defs-band cleanup closed; AI alignment eval framework wired; audit stack three-layer picture shipped; inspectable attributable action specified in CS-4 as the default mixed-crew logging contract; human operators bound to the same Layer B costly cases; steward cards pinned to edition with costly-case refusals on each card; duty-to-resist operator screen shipped; restore-challenge clocks reuse Article XXIV-C / Chapter Eleven §6)  
...
**Progress pointer:** Restore-challenge clocks shipped 2026-08-12 ([Article XXIII-D](../core_06-06_rights_part_d.md#xxiii-d-restore-challenge-clocks); reuse [Article XXIV-C](../core_06-06_rights_part_d.md#article-xxiv-c-timely-resolution-and-anti-delay-floor) / [Chapter Eleven §6](../core_11-11_forum.md#6-timely-resolution-materiality-tiers-and-anti-delay-discipline)). Steward cards pinned to edition with costly-case refusals on each card; duty-to-resist operator screen and CS-4 §10 default logging contract shipped 2026-08-12. **Next:** Remedy stack maturity beyond the pinned door, and remaining Emergency / continuity maturity (step 5).
...
| **Standing + SAC entry doors** | **Shipped 2026-08-12.** Steward-facing four-field cards in [`STEWARD_ENTRY_DOORS.md`](STEWARD_ENTRY_DOORS.md). Same cards for human and AI stewards. Costly-case refusals (bonus, deadline, cover) sit on each card in the same words. Pinned to corpus edition `SC-Corpus-2026.08.09`. |
...
| **Inspectable attributable action** | **Shipped 2026-08-12.** Mixed human/AI action surface in [`cs_04_critical_system_stewardship.md`](../corpus_systems/cs_04_critical_system_stewardship.md#10-inspectable-attributable-action): reconstructable attributable action, not weights or private deliberation; no privacy veto over standing measurement. Standing records remain Chapter Eight. Named as the **default logging contract** for mixed crews; operator checklist in [`STEWARD_ENTRY_DOORS.md#minimum-inspectable-action-set`](STEWARD_ENTRY_DOORS.md#minimum-inspectable-action-set). |
| **Duty-to-resist operator screen** | **Shipped 2026-08-12.** Shared instruction-received / refuse / document / escalate sequence in [`STEWARD_ENTRY_DOORS.md#duty-to-resist`](STEWARD_ENTRY_DOORS.md#duty-to-resist). Owner remains [Chapter Nine §5.4](../core_09-09_standing_integration.md#411-duty-to-resist-unlawful-or-unconstitutional-instructions). Same sequence for human and AI stewards. |
