...
- Adoption process path: [`adoption/`](adoption/) (process support; cannot narrow core text; not itself adoption). Public door: [`../START_HERE.md`](../START_HERE.md). Announcement copy: [`adoption/ANNOUNCEMENT.md`](adoption/ANNOUNCEMENT.md) (does not drop **pre-release**; names that numbered `core_*` files are in much better shape than operational text outside them). Two-party / first-instrument door: [`adoption/FIRST_ADOPTER_KIT.md`](adoption/FIRST_ADOPTER_KIT.md). *n*-party scaling and labeled-not-live §10.3 template: [`adoption/COOPERATION_SCALING_KIT.md`](adoption/COOPERATION_SCALING_KIT.md). Institution foundation (labeled-not-live Chapter Five Charter fill-in; Track B function pointers in the same kit): [`adoption/INSTITUTION_FOUNDATION_KIT.md`](adoption/INSTITUTION_FOUNDATION_KIT.md). Forum foundation (labeled-not-live CF-3.2 map fill-in): [`adoption/FORUM_FOUNDATION_KIT.md`](adoption/FORUM_FOUNDATION_KIT.md). After a recorded instrument, [CS-10](../corpus_systems/cs_10_transition_constitution_migration_governance.md#cs-10-1-purpose-and-role) sequences migration; the 2026-04 annex is archived.
