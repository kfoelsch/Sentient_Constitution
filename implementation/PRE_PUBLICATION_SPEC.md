...
| 10 | **Cut gate** — §2 criteria checklist + regression green | **Open.** First-adopter kit does not authorize dropping **pre-release** or bumping `SC-Corpus-2026.08.09`. |
