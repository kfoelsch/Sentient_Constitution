# Minimum-viable adopter profile (size, class, bodies, cost)
...
>
> Start here only to ask *which bodies, in what order, at what order-of-magnitude staff and funding, for an adopter of size N and impact Class X*. Where this would actually fit: [`FIT_SITUATIONS.md`](FIT_SITUATIONS.md). Two parties or a first qualifying body: [`FIRST_ADOPTER_KIT.md`](FIRST_ADOPTER_KIT.md). Founding an institution: [`INSTITUTION_FOUNDATION_KIT.md`](INSTITUTION_FOUNDATION_KIT.md). Naming independent review or founding a forum family: [`FORUM_FOUNDATION_KIT.md`](FORUM_FOUNDATION_KIT.md). Day-to-day next steps: [`STEWARD_ENTRY_DOORS.md`](../STEWARD_ENTRY_DOORS.md).
...
This page is the process-support home for sizing what an adopter of headcount *N* and impact Class *X* actually has to stand up.

*In plain terms: pick your size and class, then read which bodies are required, which are optional, in what order, and roughly how many sentients and how much money that takes. The full companion stack — six forum families, about twenty-five CI families, about fifteen CF modules, institution Track A and Track B — is not standable by a forty-person lab as written. That is a fact about cost, not a new duty and not a thinner constitution.*
...
<a id="1-how-to-read-n-and-class-x"></a>
## 1. How to read *N* and Class *X*

*In plain terms: N is how many sentients actually do the work. Class X is the highest impact class of the systems the body can bind. Guessing low on class to dodge burden is the failure this page is written against.*
...
|---|---|---|
| **P** | Personal, private-use, isolated, experimental | Effects stay inside a private unit with no meaningful outside reliance |
| **L** | Local, limited-impact, non-critical | Effects beyond a private unit but local, replaceable, and containable |
...
| **B** | Critical, high-dependency, systemically significant | Dependents cannot keep core function without it; survival not immediately lost |
| **A** | Survival-critical, foundational, irreplaceable | Failure within survival-relevant time with no viable substitute → loss of survival conditions |
...
<a id="2-binding-floors-that-drive-cost"></a>
## 2. Binding floors that drive cost

*In plain terms: four owner-file rules, not this page, are why the full stack is expensive. The FTE columns later are estimates sitting on top of these floors.*
...
<a id="4-order-of-work"></a>
## 4. Order of work

*In plain terms: fitness and own-conduct first. Charter before constitutional-function machinery. Named independent review before an instrument. Live forum families after the instrument. CS-10 last.*

Do not skip a row because it is expensive. Skipping a row and still claiming the later row is the failure this page exists to name.

```text
1. Pin the edition. Classify the systems you can actually bind (CS-3).
        ↓
2. Fitness screen + own-conduct declaration (still not adoption)
        ↓
3. Can a body bind those systems AND name independent review
   that is not the founding crew?
        ↓ no  → operations-guide + declarations (non-adoption banner)
                 optional: Institution Track A Charter for a cooperative /
                 research body / commons you do control
        ↓ yes
...
6. Institution Track B functions (oversight, standing-record admin,
   amendment admin, certification steward) — same institution kit
        ↓
7. Forum Track B: CF-3.2 map for all six families
...
|---|---|---|---|
| **Sentient** | Not founded. Name Forum Track A independent review if you will later record an instrument | Same: name, do not found | **Required** — distinct family |
| **Technical Forum Domains** | Not founded | Not founded | **Required** — distinct family |
| **Institutional** | Not founded | Not founded | **Required** — distinct family |
| **Environment** | Not founded | Not founded | **Required** — distinct family |
| **Integrity** | Not founded | Not founded | **Required** — distinct family |
| **Constitutional** | Not founded | Not founded | **Required** — distinct family |

**Hosted vs in-house.** Full adoption requires a published map for each family. It does **not** require six in-house benches if an existing independent adjudicative body can be named for that family’s work and the map identifies the concrete forums, benches, or officers ([CF-3.4](../../corpus_forum/cf_03_forum_formation_chamber_structure.md#cf-34-minimum-structural-availability-by-family)). The founding crew cannot be the only merits path for any family.

<a id="52-institution-families-ci"></a>
### 5.2 Institution families (CI)

Treat these as **duty homes**, not automatically as separate offices. One body may host more than one lane if independence safeguards are published ([CI-3.2](../../corpus_institutions/ci_03_institutional_design_separation_of_powers.md#ci-32-functional-separation-lanes)).

| Band | Families | When required | When optional / skip |
|---|---|---|---|
...
**CI-2** is a reserved family id, not a body.

<a id="53-forum-modules-cf"></a>
### 5.3 Forum modules (CF)

| Band | Modules | When required | When optional / skip |
|---|---|---|---|
...
<a id="54-systems-layer-cs--not-extra-bodies-still-cost"></a>
### 5.4 Systems layer (CS) — not extra bodies, still cost

| Piece | When it bites |
|---|---|
| **CS-3** classification | Always, if you claim a class. Honesty about Class *X* is a prerequisite for every profile below |
| **CS-4** critical-system stewardship | Class A/B (and Class C where gated) |
| **CS-10** migration | **After** a recorded instrument, not before |
...
*In plain terms: these are order-of-magnitude pictures, not budgets and not floors. Rescale the money to your cost environment. Do not rescale the binding floors in §2.*

**Estimate convention.** One **loaded FTE** here means one sentient-year of fully loaded compensation in a **2026 high-cost professional** setting (roughly 150–250 thousand currency-units). Figures are order-of-magnitude bands, not quotes. An adopter in a different cost environment should rescale the money and **not** the CJS-2.4 three-sentient rule, the six-family inventory, or the remedy-parity floor.

**Staff vs N.** *N* is the adopter’s total working headcount. **Staff** in these tables is the slice of *N* (plus contracted independent review) that the constitutional work consumes. If that slice does not fit inside *N* after ordinary product or research work, the profile does not fit.

### 6.1 Profile 1 — Operations-guide crew

| | |
|---|---|
| **Typical *N*** | 2–40 |
| **Typical class** | Whatever they actually run, honestly classified. Small *N* does not cap class |
| **Mode** | Operations-guide |
| **Required bodies** | None of the six forum families as live families. No Track B functions |
| **Optional** | Institution Track A Charter if they found a cooperative, research body, or commons they can bind. Forum Track A naming of an existing external reviewer |
| **Order** | Steps 1–3 of [§4](#4-order-of-work). Stop. Attach the [non-adoption banner](FIRST_ADOPTER_KIT.md#6-non-adoption-banner) |
| **Staff** | 0.2–1 FTE process (steward doors, reconstructable logs, own-conduct). Independent-review retainer if named |
| **Funding** | Existing payroll plus a modest legal/review retainer (order 10⁴–10⁵ currency-units / year) |
| **Honest claim** | “We use stacks as an operations guide.” Not “we adopted” |
| **Does not fit** | Standing up lock machinery, a merits bench, or CI-7 oversight from the same crew |

### 6.2 Profile 2 — Track A institution (Charter, no instrument)
...
| **Staff** | 2–8 FTE governance overlay (direction, execution, challenge, assurance, publication — merged hosting allowed with published safeguards). Plus paid independent review |
| **Funding** | Order 10⁵–10⁶ currency-units / year for the overlay and review, on top of ordinary operations |
| **Honest claim** | “We published a Chapter Five Charter for this body.” Not “we adopted the Constitution.” Not “we are the oversight body for others” |
| **Does not fit** | Certification-steward or CI-7 oversight of non-consenters. Six live forum families |

### 6.3 Profile 3 — Instrument plus hosted families

| | |
|---|---|
| **Typical *N*** | 40–200 (in-house) plus **named external** adjudicative capacity |
| **Typical class** | **L** or **C**. **B** only if the hosted bodies can actually hear Class B stakes |
| **Mode** | Full adoption |
| **Required bodies** | Recorded §10.1–§10.2 instrument. Forum Track A naming on that instrument. CF-3.2 map that gives operational effect to **all six** families, mapped onto existing independent bodies. Institution Track B functions at class-scaled depth. **CI-27** remedy capacity at §9.2 parity. CS-3 (and CS-4 if Class B) |
| **Optional** | In-house specialist CF-8/9/10 if caseload needs them; otherwise contracted through the hosted bodies. Domain CI-15–CI-25 |
| **Order** | Steps 1–9, with step 7 as **hosted/mapped**, not in-house benches |
| **Staff** | 8–25 FTE in-house (instrument custody, Track B functions, remedy file, classification, CS-10) **plus** contracted or statutory hosted-forum capacity that is not the founding crew |
| **Funding** | Order 10⁶–10⁷ currency-units / year in-house, plus whatever the hosted bodies cost, with remedy ≥ lock spend per class |
| **Honest claim** | “This body adopted, for these systems, and these named independent bodies do the family work.” The map must be usable by a filer |
| **Does not fit** | Mapping all six families onto the same founding crew. Class A survival-critical systems with only hosted, untested capacity. A forty-person lab that also tries to staff Track B and remedy from the same forty |

### 6.4 Profile 4 — Instrument plus in-house six families
...
| **Funding** | Order 10⁷–10⁸ currency-units / year in a high-cost setting, scaled to class, caseload, and remedy parity |
| **Honest claim** | “This adopting entity published and staffs the six families.” |
| **Does not fit** | A forty-person lab. A two-hundred-person company that still has to ship product with the same sentients. Any adopter that funds locks and starves remedy |

---

<a id="7-the-forty-person-lab"></a>
## 7. The forty-person lab

*In plain terms: a forty-person lab can use this Constitution as an operations guide, and can publish a Chapter Five Charter for work it actually binds. It cannot stand the full companion stack as written, and saying it can is the claim this page exists to refuse.*

Worked row, because this is the case the backlog named.
...
1. Classify honestly ([CS-3](../../corpus_systems/cs_03_a_system_classification_machinery.md)).
2. Sit fitness and own-conduct ([`SELF_APPLICATION_GATEWAY.md`](SELF_APPLICATION_GATEWAY.md)).
3. Use steward doors and CS-4 §10 logs as operations-guide ([`STEWARD_ENTRY_DOORS.md`](../STEWARD_ENTRY_DOORS.md)).
4. If they can bind a named research or commons scope, publish a Chapter Five Charter (Institution Track A).
5. Name independent review they do not staff (Forum Track A).
6. If a qualifying body later records an instrument, take Profile 3 (hosted families) only when those hosted bodies are real. Do not skip to Profile 4.

---

<a id="8-worked-lookups"></a>
## 8. Worked lookups

Use this as a lookup, not as a new mode.

| If you are… | Highest class you can bind | Open | Staff / funding band |
|---|---|---|---|
| Two sentients sharing a protocol | Any, if they cannot bind the host product | Profile 1. [`FIRST_ADOPTER_KIT.md`](FIRST_ADOPTER_KIT.md) | 0.2–1 FTE; 10⁴–10⁵ / year |
...
| [`FIT_SITUATIONS.md`](FIT_SITUATIONS.md) | Where the instrument is a practical fit. This page sizes what that fit costs |
| [`FIRST_ADOPTER_KIT.md`](FIRST_ADOPTER_KIT.md) | Two-party sitting, §10.2 fill-in, scope honesty, non-adoption banner |
