# For you — a mental-health diagnosis, or when care is used to take over your say
...
| | |
|---|---|
| **Alive in it now** | about **1 in 7** of everyone counted worldwide live with a mental disorder (~1.1 billion in 2021). WHO’s 2022 report used a 2019 baseline of about **1 in 8**. |
| **Counted in world output** | no clean share in the books. Mental disorders are the leading cause of years lived with disability — about **1 in 6** of those years worldwide. Job and access gaps shrink what gets counted. |
| **Meet it in a full life** | no single global share (surveys often fall roughly between 1 in 5 and 1 in 2). Nearly everyone will meet it, or help someone through it. Most who live with a mental disorder still cannot reach effective care. |

These figures are approximate — nearest 1-in-n or whole percent. Sources: [`SCALE_NOTES.md`](SCALE_NOTES.md).

## Your situation

You have a diagnosis. Or someone treats a missed refill or a rough week as proof you can no longer make your own choices — about money, housing, doctors, or who you live with — and they start deciding those things for you, without checking what you can still do. Family or a clinic still call it help — the spare room, the pills, the ride.

If a clinic, hospital, or other body that actually runs the systems in your life agreed to follow this Constitution:

**Care you can reach is not treatment they can force.**
...
- **“If I say no to help, they’ll say that proves I can’t choose for myself.”** Saying no to help that comes with extra conditions is not, by itself, proof you cannot make your own choices. That is the same pattern [E01](E01_pregnant_reproducing.md) names in a different scene.
...
- Treating family concern as automatically abusive, or treating what is easier for your family as, by itself, what is good for you.
- A guarantee of your preferred clinician or format in every setting.
