# For you — an investor or capital allocator
...
The interesting fact is the inversion: a thin slice of adults, nearly half of counted wealth. Sources: [`SCALE_NOTES.md`](SCALE_NOTES.md).

## Your situation

You allocate capital: a fund, an angel book, a family office, a cooperative treasury, or a public development book. A founder wants speed.
...
- **With this Constitution:** Who may govern is documented separately from voice inside an already-authorized system. That protects real capital from fake constitutional theater as much as it limits it.
