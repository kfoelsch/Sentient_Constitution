...
*In plain terms: the body that made the call about you is not supposed to be the only final home for a claim that it is biased or captured — and a report waiting to be looked at is not already a verdict.*

## What is happening

Someone with power over housing, care, pay, movement, or a system you depend on has decided. The same office that decided also hears the complaint. A relative’s letter, a flag, or a score is treated as if it already proved the case.

## If a body that actually runs the systems in your life agreed to follow this Constitution

**Independent review is not the founding crew judging itself.**
...
|---|---|
| You need challenge, review, or to be made whole | [G01 — Challenge, review, and being made whole](G01_challenge_review_redress.md) |
| Help or harm is being treated as already scored | [G04 — Help and harm that are supposed to be written down](G04_help_and_harm.md) |
| Day-to-day next step for those running the system | [Which role am I in](../../STEWARD_ENTRY_DOORS.md#which-seat-am-i-in) |
