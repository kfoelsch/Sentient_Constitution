...
This page is the process-support home for scaling low-count cooperation toward a Chapter Sixteen instrument.
...
This page scales low-count operations-guide cooperation toward a real Chapter Sixteen instrument without inventing a new adoption status. It names the three scaling axes, gives an *n*-party sitting protocol, states handoff gates (cliffs, not a ramp), and ships a **labeled-not-live** [§10.3](../../core_16_amendment_ratification.md#103-joining-by-additional-parties) joining-rule template.
...
own-conduct declarations if Yes or Mixed (still not adoption)
        ↓
         handoff gates (section 4) — fail any cliff → stay here
                    ↓ pass
     qualifying body records a Chapter Sixteen instrument
                    ↓
...
A **qualifying adopter** records deliberate, documented, auditable adoption under [§10.1–§10.2](../../core_16_amendment_ratification.md#101-deliberate-adoption), with Chapter Seventeen custody.
...
5. **Independent review is not “the other signatories.”** [Chapter Twelve §3](../../core_12_forum.md#3-transfer-consolidation-and-coordination--continuity-and-anti-capture) and [Chapter Sixteen Test 4](../../core_16_amendment_ratification.md#6-test-4--contestability-and-independent-review-validity) still apply. A crew that reviews only itself has not named independent review.
...
| **Remedy capacity** | Practical capacity to deliver challenge and redress, not paper routes ([Chapter Ten §9](../../core_10_standing_integration.md#9-enforcement-realism-and-remedy-systems)). | Named routes with no capacity. Do not treat that as substep 1.3. |
...
[ ] If affected sentients expanded past this crew, a Chapter Thirteen §1.1
...
It is not published joining rules under Chapter Sixteen §10.3.
...
Independent review path that is not solely the publishing adopter
    or the applicant (Chapter Twelve §3; Chapter Sixteen Test 4):

Non-regression (Chapter Fourteen): joining must not wipe the floor.
...
4. **Adoption.** Only a body that can bind the relevant systems records a Chapter Sixteen instrument. Joining later, if it happens, uses rules that adopter publishes — not this template, and not our declarations.
...
| Date | Version | Note |
|---|---|---|
| 2026-08-31 | v0.1 | Initial process-support kit: three scaling axes, *n*-party sitting, handoff gates, labeled-not-live §10.3 joining-rule template. Not Chapter Sixteen adoption. Not CS-10. Not live joining rules. |
