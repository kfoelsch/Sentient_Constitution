...
>
> This page is **process / operations-guide support** — **not** binding constitutional or incorporated text. This page, the independent-review naming block, the forum-structure map fill-in, and the non-forum banner **cannot narrow core text**. A filled template that diverges from [CF-3](../../corpus_forum/cf_03_forum_formation_chamber_structure.md), [Chapter Twelve](../../core_12_forum.md#chapter-twelve-forums-and-jurisdiction), [Chapter Sixteen §10](../../core_16_amendment_ratification.md#10-ratification-and-adoption), or [Chapter Seventeen §4](../../core_17_incorporation.md#4-adoption-framing-and-scope-of-authority) is not a compliance path.
>
...
>
> Start at [`FIRST_ADOPTER_KIT.md`](FIRST_ADOPTER_KIT.md) for two parties or a first qualifying body, or [`COOPERATION_SCALING_KIT.md`](COOPERATION_SCALING_KIT.md) for more than two. Founding an institution: [`INSTITUTION_FOUNDATION_KIT.md`](INSTITUTION_FOUNDATION_KIT.md). Use this page when cooperating sentients are ready to name independent review or found Chapter Twelve forum families under that path. Day-to-day next steps: [`STEWARD_ENTRY_DOORS.md`](../STEWARD_ENTRY_DOORS.md). Binding forum-structure fields: [CF-3](../../corpus_forum/cf_03_forum_formation_chamber_structure.md). Binding family routing: [Chapter Twelve](../../core_12_forum.md#chapter-twelve-forums-and-jurisdiction).
...
*In plain terms: cooperating sentients get a fill-in path to name a real independent-review path, and — after a recorded Chapter Sixteen instrument — to publish a real Chapter Twelve forum structure. This page is not a markdown panel that calls itself a forum family, and not a substitute for CF-3 or Chapter Twelve.*
...
This page gives cooperating sentients a fill-in path from operations-guide cooperation toward (1) a named independent-review path that is not the cooperating crew, and (2) a published [CF-3.2](../../corpus_forum/cf_03_forum_formation_chamber_structure.md#cf-32-family-to-forum-structure-translation-map) forum-structure map after a qualifying adopter records a Chapter Sixteen instrument. Binding family inventory, non-collapse, and map fields stay in [CF-3](../../corpus_forum/cf_03_forum_formation_chamber_structure.md). Binding routing stays in [Chapter Twelve](../../core_12_forum.md#chapter-twelve-forums-and-jurisdiction).

This page, the naming block, the map fill-in, and the non-forum banner **cannot narrow core text**. A filled template that diverges from CF-3, Chapter Twelve, Chapter Sixteen §10, or Chapter Seventeen §4 is not a compliance path.
...
- **Which family hears what** — [Chapter Twelve](../../core_12_forum.md#chapter-twelve-forums-and-jurisdiction) owns default venue, primary-stakes routing, intake triage, and cross-forum anti-self-judging. This page does not pick a lead family.
...
- **Founding an institution** — [`INSTITUTION_FOUNDATION_KIT.md`](INSTITUTION_FOUNDATION_KIT.md) and [CI-3.6](../../corpus_institutions/ci_03_institutional_design_separation_of_powers.md#ci-36-charter-contents-review-and-formation-template) own Chapter Five Charters. A forum hears disputes. It is not the institution whose mandate is in dispute. [Chapter Twelve §4.3](../../core_12_forum.md#43-institutional-forums) hears institutional-mandate fights; it is not the institution itself.
- **Moving systems over later** — [CS-10](../../corpus_systems/cs_10_transition_constitution_migration_governance.md#cs-10-1-purpose-and-role) sequences that move **after** a body records a Chapter Sixteen adoption instrument. A forum-structure draft is not that move.
...
- **Adopt the Constitution**
  ...
  - It is not [Chapter Seventeen](../../core_17_incorporation.md#4-adoption-framing-and-scope-of-authority) incorporation.
...
First adopters need independent review *before* they can record a valid instrument. Live Chapter Twelve forum families are what an **adopting entity** must then publish. Those are two jobs. Do not use a ceremony “forum” to skip either one.
...
Track A (independent-review path — not a forum family)
        ...
        the cooperating crew does not solely staff
                ↓
        may be named on a Chapter Sixteen instrument (Test 4)
...
- A Chapter Sixteen instrument remains substep 1.3. A live CF-3.2 map is not that instrument.
...
[ ] Track B only: each family’s own-integrity claims have a named backup
    that family does not solely control (Chapter Twelve §3).
...
It is not a Chapter Twelve forum family.
...
This path does not:
- found the six Chapter Twelve families
...
**This block becomes a CF-3.2 map only when the adopting entity completes it and publishes it in that body’s custody.** Copy it out of this repo. Leaving a filled copy here is not publication. If any field below disagrees with [CF-3.2](../../corpus_forum/cf_03_forum_formation_chamber_structure.md#cf-32-family-to-forum-structure-translation-map), CF-3.2 wins. Family order and names follow [Chapter Twelve §2](../../core_12_forum.md#2-default-venue-and-primary-stakes) and [CF-3.1](../../corpus_forum/cf_03_forum_formation_chamber_structure.md#cf-31-core-structural-rule). Local titles may differ; function must not.
...
Corpus edition pin: SC-Corpus-2026.08.09 (or later named publication cut)
Track: B forum-family formation
Recorded Chapter Sixteen instrument (where it lives):
...
2. TECHNICAL FORUM DOMAINS
   ...
   families as Chapter Twelve §4.2 describes — not a seventh family)
   Body / bench / set that performs this family’s work:
   Organization:
...
Anti-self-judging backup (Chapter Twelve §3 owns the assignment):
...
Do not restate CF or Chapter Twelve. Use the owner files. This section is only the founding-crew checklist.
...
[`INSTITUTION_FOUNDATION_KIT.md`](INSTITUTION_FOUNDATION_KIT.md) and [CI-3.6](../../corpus_institutions/ci_03_institutional_design_separation_of_powers.md#ci-36-charter-contents-review-and-formation-template) own Chapter Five Charters. [Chapter Twelve §4.3](../../core_12_forum.md#43-institutional-forums) hears institutional-mandate and supervised-scope disputes; it is not the institution itself.
...
Community governance bodies themselves are not a forum family. Their records become **Sentient** forum matters only where [Chapter Twelve §4.1](../../core_12_forum.md#41-sentient-forums) holds the primary stake.

---

## 9. After a live map

A live CF-3.2 map is still not Chapter Sixteen adoption, not CS-10 phase entry, and not certification. It is also not a standing record.
...
It is not CS-10 phase entry.
It is not a Chapter Nine standing record, a Chapter Eight certificate,
...
If the file is also not a Chapter Sixteen instrument, attach the first-adopter kit’s [non-adoption banner](FIRST_ADOPTER_KIT.md#6-non-adoption-banner) as well. If it is also not a Chapter Five Charter, attach the institution kit’s [non-institution banner](INSTITUTION_FOUNDATION_KIT.md#9-non-institution-banner). The banners do different jobs.

---

## 11. Honest statements (copy if they are true)

1. **Scaffolding.** We are drafting a forum-structure map or naming an independent-review path. We will not treat this markdown as a Chapter Twelve forum family, as a CF-3.2 map, as a Charter, or as appointment to a merits bench.
...
3. **Track B.** A qualifying adopter already holds a recorded Chapter Sixteen instrument. We are founding the six Chapter Twelve families under that instrument — not as a substitute for it, and not by collapsing families or inventing a seventh.
...
| [CF-1](../../corpus_forum/cf_01_scope_authority_boundary_rules.md) | Forum-layer boundary. Families stay in Chapter Twelve |
...
| Date | Version | Note |
|---|---|---|
| 2026-08-31 | v0.1 | Initial process-support kit: two tracks (independent-review path vs forum-family formation), formation cliffs, labeled-not-live independent-review naming and CF-3.2 map fill-in, non-forum banner. Not CF-3. Not Chapter Twelve. Not CI-3.6. Not CS-10. Not Chapter Sixteen adoption. |
