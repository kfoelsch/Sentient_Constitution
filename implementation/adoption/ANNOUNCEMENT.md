...
>
> This page is **process / operations-guide support** — **not** binding constitutional or incorporated text. It **cannot narrow core text**. Publishing a note from this page is not [Chapter Sixteen §10](../../core_16_amendment_ratification.md#10-ratification-and-adoption) adoption and not [Chapter Seventeen §4](../../core_17_incorporation.md#4-adoption-framing-and-scope-of-authority) incorporation.
>
...
- System alignment certification. Before people rely on a system at
  ...
  must be repeated on a schedule that matches the risk. (Chapter Eight)
- Standing records. What a person, organization, or system has done —
  ...
  record, not from reputation or a popularity score. (Chapters Nine
  and Nine)
- Contestability. Anyone affected by a system or a decision can
  ...
  get it corrected within set time limits. (Chapter Twelve)
...
- Reading it, forking it, or saying "we follow it" is not adoption.
  ...
  records a formal instrument under Chapter Sixteen.
...
| **Model constitution.** It may guide now. It binds a body only after that body records a Chapter Sixteen instrument ([Chapter Seventeen §4](../../core_17_incorporation.md#4-adoption-framing-and-scope-of-authority)). | “We launched it as law.” “Our org / city / protocol has adopted it” — unless that instrument exists. |
| **Does not supersede applicable law.** Publication is not a claim of supremacy over local, national, or international law. Adoption binds only the adopting body, within its lawful authority and recorded scope ([Chapter Fifteen §5](../../core_15_expansion_supremacy.md#5-relation-to-applicable-external-law)). Where used inside an external legal framework, processes and participation must stay consistent with that framework. | “This Constitution now overrides city / national / treaty law.” “Using it as an operations guide displaces our regulator.” |
...
| **Describe the working parts** — definitions with a way to check them ([Chapter Five](../../core_05__definitions_home.md)); certification ([Chapter Eight](../../core_08_a_system_alignment_certification_evaluation.md)); standing records ([Chapter Nine](../../core_09_standing_assessment.md)); contestability ([Chapter Twelve](../../core_12_forum.md)) — as verified, written down, time-limited, and challengeable. | “Simple, proven, and effective.” No adopter has run them yet. |
...
- Keep a dated outreach log **outside** this corpus. A contact list is not a Chapter Nine standing record.
...
| [Chapter Fifteen §5](../../core_15_expansion_supremacy.md#5-relation-to-applicable-external-law) | Non-displacement of applicable external law; alignment when used inside an external legal framework |
...
| 2026-09-09 | v0.5 | Announcement and say / do-not-say table state that this Constitution does not supersede local, national, or international law; adoption binds only the adopting body within its lawful authority; use inside an external legal framework must stay consistent with that framework. Canonical home: [Chapter Fifteen §5](../../core_15_expansion_supremacy.md#5-relation-to-applicable-external-law). Still not adoption; still does not drop **pre-release**. |
