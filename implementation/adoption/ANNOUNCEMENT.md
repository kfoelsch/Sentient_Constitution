...
>
> This page is **process / operations-guide support** — **not** binding constitutional or incorporated text. It **cannot narrow core text**. Publishing a note from this page is not [Chapter Fifteen §10](../../core_13-15_amendment.md#10-ratification-and-adoption) adoption and not [Chapter Sixteen §4](../../core_16-16_incorporation.md#4-adoption-framing-and-scope-of-authority) incorporation.
>
...
This Constitution is a **model constitution** for systems that materially affect sentients ([Chapter Sixteen §4](../../core_16-16_incorporation.md#4-adoption-framing-and-scope-of-authority)). It becomes enforceable for a particular body only after that body records a [Chapter Fifteen §10](../../core_13-15_amendment.md#10-ratification-and-adoption) instrument in its own custody. Until then the honest public invitation is: read it, use it as an operations guide, and say so plainly.
...
| **Describe the working parts** — definitions with a way to check them ([Chapter Five](../../core_05__definitions_home.md)); certification ([Chapter Seven](../../core_07_a_system_alignment_certification_evaluation.md)); standing records ([Chapter Eight](../../core_08-08_standing_assessment.md)); contestability ([Chapter Eleven](../../core_11-11_forum.md)) — as verified, written down, time-limited, and challengeable. | “Simple, proven, and effective.” No adopter has run them yet. |
