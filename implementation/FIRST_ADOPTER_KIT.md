...
| **Self-application declaration** | Dated, edition-pinned own-conduct commitment (outputs, refusals, logging, escalation) | Adoption; authority over others; CS-10 phase entry |
| **Chapter Fifteen instrument** | A **qualifying adopter** records deliberate, documented, auditable adoption under [§10.1–§10.2](../core_13-15_amendment.md#101-deliberate-adoption), with Chapter Sixteen custody | A steward listing themselves as bound; two declarations stapled together |
...
Use this when two AIs (or one AI and one human operator, or two operators) want a shared cooperation framework.
...
3. **Do not merge the files into an instrument.** Two item-16 declarations are still Layer 2.
...
5. **Decide the third layer honestly.**
