...
- `core_08_standing_assessment.md` — compass, dual-use delay dimension
- `core_09_standing_integration.md` — Chapter One §8.10 remedy-commencement row
- `core_10_a_misconduct_designation.md` — tetrad capture
- `core_11_forum.md` — timeliness leg in forum trace
