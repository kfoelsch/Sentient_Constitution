...
- **Article V-B (*Nondiscrimination*), *Language, Culture, and Heritage Protection* bullet (core_10-10_rights_part_b.md):** covers language, cultural affiliation, heritage, traditions, and comparable cultural-identity characteristics as protected-characteristic specializations. Explicitly notes: *"Indigenous continuity questions and territorial-continuity interactions remain a matter for review under Article I-A and Chapter Fifteen incorporation, and this bullet neither expands nor narrows them."*
...
- **Article I-A (*Environmental Preconditions and Ecological Integrity*), core_10-10_rights_part_a.md:** carries the territorial / ecosystem-integrity floor, separate Animal Life and Contested-Sentient Life interactions, and the biosphere-as-precondition policy.
...
- **Chapter Fourteen (*Incorporation*):** §3 strictest-applicable-level and Chapter Twelve non-regression floor; §4 adoption policy.
...
- **Non-regression policy** for adopter instruments that currently recognize indigenous or analogous community-continuity rights. Chapter Twelve non-regression applies to constitutional rights-floor content; it does not by itself fix a floor against which adopter regression in this domain can be measured.
...
- **No new Chapter Ten article.** The existing Article V-B hedge language is minimally updated from *"neither expands nor narrows"* to *"is read with Chapter Five Indigenous Continuity"* (pointer-only).

- **Pros.** Adds explicit Chapter Five surface with hooks for regression seeding and consumer-article reference; avoids category-contest by using capability-functional trigger conditions; avoids territorial-claim adjudication by explicit Chapter Fourteen routing; preserves substrate-agnostic discipline by reading to communities not sentients; anchors adopter non-regression discipline.
...
- **Assessment.** **Recommended.** Adds real surface with minimal adjudication risk; is consistent with the corpus's broader discipline (capability-functional triggers; owner-article routing; Chapter Fifteen adopter discipline); is the narrowest scope that materially improves on the status quo.

### 3.3 Scope (c) — Chapter Five entry AND new Chapter Ten article (e.g., Article V-I Indigenous Continuity)
...
### 3.4 Scope (d) — Indigenous-continuity policy addressed solely through Chapter Fifteen incorporation discipline

No Chapter Five entry; no Chapter Ten article. Chapter Fourteen §3 (strictest-applicable-level) and §4 (adoption policy) are relied on to pull adopter-instrument protections into the custody chain for adopting entities that already recognize indigenous-continuity rights.
...
*Memo authored 2026-04-17 under the open Q-10.2.B line in [TODO.md](../TODO.md). Authoritative state remains [core_00-01_principles.md](../core_00-01_principles.md) through [core_15-15_incorporation.md](../core_15-15_incorporation.md) and the four `corpus_*.md` files.*
