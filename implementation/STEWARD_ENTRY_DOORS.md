...
The four fields match the [handoff bar](PRE_PUBLICATION_SPEC.md#24-ai-handoff-readiness): owner, conflict rule, next-step class, forbidden move.
...
**When:** An operator claims a standing effect. The record is missing, stale, or disputed. No forum case has been filed yet.
