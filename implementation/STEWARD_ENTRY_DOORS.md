...
**Owner:** [CI-4.6](../corpus_institutions/ci_04_appointment_competency_rotation_removal.md#ci-46-seat-catalog) (*Seat catalog*) — nine seat types, each with what it may do, may not do, hands off to, and logs. Principle-layer floor: [Chapter One §10.1 *Segregation of duties*](../core_01_c_stewardship_capacity_principles.md#101-segregation-of-duties). Same seats for human and AI stewards. This pointer **cannot narrow** those homes and does not restate the rows.
