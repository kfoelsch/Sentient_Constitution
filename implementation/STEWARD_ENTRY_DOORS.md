...
| Founding an oversight body, cooperative, or “constitutional institution” from the cooperating crew | [`adoption/INSTITUTION_FOUNDATION_KIT.md`](adoption/INSTITUTION_FOUNDATION_KIT.md). A markdown working group is not a [Chapter Five Charter](../core_05_band_continuity.md#charter) and not a forum family. Binding formation fields: [CI-3.6](../corpus_institutions/ci_03_institutional_design_separation_of_powers.md#ci-36-charter-contents-review-and-formation-template). Forums: [CF-3](../corpus_forum/cf_03_forum_formation_chamber_structure.md). |
