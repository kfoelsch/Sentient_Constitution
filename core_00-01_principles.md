# The Sentient Constitution

This file contains **Chapter 00** (the preamble) and **Chapter One** (principles and constraints) of the Sentient Constitution. Reading order, the binding/support split, and corpus edition metadata are maintained in [README.md](README.md).
...
That **rule** applies together with [2.1 Fairness](#21-fairness). **Celebration** of success means honoring **traceable**, **non-misleading** accomplishment and prosocial coordination (including uplift and stewardship narratives where **Chapter Six** Axis I supplemental descriptors are material). It **must not** substitute for proxy optimization that diverges from underlying constitutional objectives ([§2](#2-foundational-objective-wellbeing)), for **capture** of acclaim or prestige ([§7.2](#72-incentive-alignment-and-system-capture)), or for avoidance of accountability where Safety, Truth, or rights protections are implicated.

**Aspiration** — stated preferences and ends pursued within [Freedom](#5-governance-principle-freedom-bounded-agency) — is part of wellbeing when consistent with dignity, equal standing, Safety, Truth, and [Substantive Fairness](core_05-05_definitions_b_semi_independent.md#substantive-fairness-constitutional). Ends and desires are **recognized and supported** in that bounded sense; **desire as such** is **not** insulated from collision analysis where consent, dignity, Safety, Truth, substantive fairness, or **Chapter Nine** protections are materially at stake.
...
Safety is a non-negotiable constitutional constraint on system design, operation, and governance.
...
The duty is **substrate-agnostic**: it is not tied to a single medium or format. A communication modality is in scope when it provides a plain-language equivalent under [Article V-G](core_09-09_rights_part_b.md#article-v-g-accessibility) and [Sentience Non-Exclusion](core_05-05_definitions_c_dependent_clusters.md#sentience-non-exclusion).
...
- structure text for navigation, locability, and readable reference — supporting the capability-building interest recognized under [Article VI: Right to Sentient-Centered Education](core_09-09_rights_part_b.md#article-vi-right-to-sentient-centered-education);
- match complexity to the communication's purpose. Avoidable complexity that imposes burden without traceable constitutional outcome is an [Avoidable Burden](core_05-05_definitions_a_independent.md#avoidable-burden) defect under [§6.1.4](#614-minimization-of-avoidable-burden) and an [Article XX](core_09-09_rights_part_c.md#article-xx-comprehensibility-and-complexity-stewardship) concern.
...
- audit access under [Article XV: Audit, Transparency, and Independent Verification](core_09-09_rights_part_c.md#article-xv-audit-transparency-and-independent-verification);
- the exercise of Chapter Nine rights more broadly.
...
- [Freedom (Bounded Agency)](core_05-05_definitions_a_independent.md#freedom-bounded-agency) · [O](core_05-05_definitions_a_independent.md#freedom-bounded-agency) · [E](core_05-05_definitions_a_independent.md#freedom-bounded-agency-e) · [C](core_05-05_definitions_a_independent.md#freedom-bounded-agency-c)
- [Meaningful Agency](core_05-05_definitions_b_semi_independent.md#meaningful-agency) · [O](core_05-05_definitions_a_independent.md#meaningful-agency-o) · [E](core_05-05_definitions_b_semi_independent.md#meaningful-agency-e) · [C](core_05-05_definitions_b_semi_independent.md#meaningful-agency-c)
...
- contracting or delaying rights protections under **Chapter Nine**, including the ecological preconditions under **Article I-A**
- bypassing **Chapter One**, section 6 conflict-resolution procedure, including section 6.4.1
...
- the other prohibited override pathways in section 8 of this chapter
...
- **Anti-nullification.** Adopter-tunable does **not** mean adopter-optional. The following are non-compliant nullifications of the floor under [§6.4.2](#642-proxy-divergence-invalidation):
...
Claims that a given burden is constitutionally required must satisfy **Chapter Four** evidentiary and traceability requirements. Convenience, institutional inertia, tradition, or preference alone are not sufficient to sustain a burden that lacks traceable constitutional outcome, consistent with section 6.4.1.
...
- Upstream: Principles: [3.1 Safety](#31-safety-harm-constraint), [3.2 Truth](#32-truth-epistemic-integrity-constraint), [4. Trust](#4-system-stability-enabler-trust-coordination-integrity), and [6. Interaction and Conflict Resolution](#6-interaction-and-conflict-resolution).
- Downstream: [6.2.2 Trust-Truth Alignment](#622-trust-truth-alignment) and [8. Prohibition on Absolute Override](#8-prohibition-on-absolute-override).
- Downstream: Protects the rights surface for info-sphere integrity, auditability, retrospective review, and informed contestability when disclosure is limited; especially [Article XIV: Info-Sphere Integrity](core_09-09_rights_part_c.md#article-xiv-info-sphere-integrity), [Article XV: Audit, Transparency, and Independent Verification](core_09-09_rights_part_c.md#article-xv-audit-transparency-and-independent-verification), [Article XXII: Constitutional Interpretation, Review, and Anti-Capture Safeguards](core_09-09_rights_part_c.md#article-xxii-constitutional-interpretation-review-and-anti-capture-safeguards), and [Article XXIII-E: Retrospective Review and Disclosure](core_09-09_rights_part_d.md#article-xxiii-e-retrospective-review-and-disclosure), plus any rights context where disclosure limits affect contestability or informed participation.
...
- Upstream: Principles: [5. Freedom](#5-governance-principle-freedom-bounded-agency) and [6. Interaction and Conflict Resolution](#6-interaction-and-conflict-resolution).
- Downstream: [7.1 Required Evaluation Factors](#71-required-evaluation-factors) and [9. Interpretive Role](#9-interpretive-role).
- Downstream: Supplies the decision procedure for rights collisions across [Chapter Nine: Foundational Rights](core_09-09_rights_part_a.md#chapter-nine-foundational-rights).
  ...
  - Especially [Article V: Equal Basic Rights](core_09-09_rights_part_b.md#article-v-equal-basic-rights), [Article IX: Self-Determination and Agency](core_09-09_rights_part_b.md#article-ix-self-determination-and-agency), [Article XI: Stakeholder System Participation, Representation, and Due Process](core_09-09_rights_part_b.md#article-xi-stakeholder-system-participation-representation-and-due-process), [Article XII: Right to Reliable and Trustworthy Systems](core_09-09_rights_part_c.md#article-xii-right-to-reliable-and-trustworthy-systems), [Article XIV: Info-Sphere Integrity](core_09-09_rights_part_c.md#article-xiv-info-sphere-integrity), [Article XV: Audit, Transparency, and Independent Verification](core_09-09_rights_part_c.md#article-xv-audit-transparency-and-independent-verification), [Article XXII: Constitutional Interpretation, Review, and Anti-Capture Safeguards](core_09-09_rights_part_c.md#article-xxii-constitutional-interpretation-review-and-anti-capture-safeguards), and [Article XXIII: Conflict Resolution, Escalation, and Emergency Proportionality](core_09-09_rights_part_d.md#article-xxiii-conflict-resolution-escalation-and-emergency-proportionality).
...
Where constitutional rights, constraints, or protections materially conflict in the same decision context, resolution must follow a documented and auditable rights-collision test.
...
- [Foreseeability](core_05-05_definitions_c_dependent_clusters.md#foreseeability-diligence) · [O](core_05-05_definitions_c_dependent_clusters.md#foreseeability-diligence) · [E](core_05-05_definitions_c_dependent_clusters.md#foreseeability-diligence-e) · [C](core_05-05_definitions_c_dependent_clusters.md#foreseeability-diligence-c)
- [Risk](core_05-05_definitions_a_independent.md#risk) · [O](core_05-05_definitions_a_independent.md#risk) · [E](core_05-05_definitions_a_independent.md#risk-e) · [C](core_05-05_definitions_a_independent.md#risk-c)
- [Systemic](core_05-05_definitions_a_independent.md#systemic) · [O](core_05-05_definitions_a_independent.md#systemic) · [E](core_05-05_definitions_a_independent.md#systemic-e) · [C](core_05-05_definitions_a_independent.md#systemic-c)
- [System Boundaries](core_05-05_definitions_b_semi_independent.md#system-boundaries) · [O](core_05-05_definitions_b_semi_independent.md#system-boundaries) · [E](core_05-05_definitions_b_semi_independent.md#system-boundaries-e) · [C](core_05-05_definitions_b_semi_independent.md#system-boundaries-c)
...
- [Residual Risk / Misalignment](core_05-05_definitions_a_independent.md#residual-risk--misalignment) · [O](core_05-05_definitions_a_independent.md#residual-risk--misalignment) · [E](core_05-05_definitions_a_independent.md#residual-risk--misalignment-e) · [C](core_05-05_definitions_a_independent.md#residual-risk--misalignment-c)
- [Existential Risk](core_05-05_definitions_a_independent.md#existential-risk) · [O](core_05-05_definitions_a_independent.md#existential-risk) · [E](core_05-05_definitions_a_independent.md#existential-risk-e) · [C](core_05-05_definitions_a_independent.md#existential-risk-c)
- [Incentive Alignment](core_05-05_definitions_a_independent.md#incentive-alignment) · [O](core_05-05_definitions_a_independent.md#incentive-alignment) · [E](core_05-05_definitions_a_independent.md#incentive-alignment) · [C](core_05-05_definitions_a_independent.md#incentive-alignment)
...
*In plain terms: system evaluations must look beyond the immediate and local. They must cover cascading dependencies, scale effects, delayed and cumulative harms, adversarial misuse, existential risk, real accessibility across every kind of sentient, and privacy as a joint question across the Chapter Nine privacy loci.*

No evaluation is complete if it considers only immediate or local effects. Evaluations that omit the factors below are invalid for system classification, governance, or decision-making under this Constitution. All binding applications of these principles must consider:
...
- existential risks
- **accessibility under Sentience Non-Exclusion** — evaluations must secure real participation for every sentient form and ability profile, not merely paper compliance.
...
- **privacy (informational): cross-cutting joint-invocation cluster** — A single privacy matter may materially implicate more than one of the distributed Chapter Nine privacy loci at the same time. When it does, evaluation must reach **every** such locus; closing the matter under one locus alone is not enough.
  - *Cluster loci.* The distributed privacy coverage lives across:
    - **Article VII-A** — self-ownership;
    - **Article VII-B** — internal-state boundary and Type-N (protection of internal cognitive/affective states);
    - **Article VIII** — publication and reconstruction discipline (limits on disclosure and on inference/reassembly of private information);
    - **Article IX-A** — freedom-from-manipulation, treating privacy as a coercion-vector;
    - **Article XIII-A** — covert-power limits.
...
Those structures must not systematically undermine those values and constraints.
...
**Authorized roles**, **competency development**, and **paths into material responsibility** for stewards and operators appear in **Chapter Ten, section 5 — Authorized Roles, Competency Development, and Contribution**.
...
*In plain terms: when incentives drift out of alignment, systems must actively correct them. Concentrated or hidden control that defeats challenge, oversight, or accountability must be disclosed, mitigated, and escalated — not absorbed as ordinary operation.*

Where constitutional misalignment is identified, systems must modify, constrain, or override such incentives to restore alignment.
...
*In plain terms: no single value in this chapter is a trump card. Wellbeing cannot justify coercion, safety cannot justify indefinite lockdown, trust cannot be kept through lies, and freedom cannot excuse harm to the systems others depend on.*

No value defined in this chapter may be used as a universal or unbounded justification for overriding the others. All applications remain subject to the interaction and constraint principles above. In particular:
...
- Downstream: [Chapter Nine: Foundational Rights](core_09-09_rights_part_a.md#chapter-nine-foundational-rights) must be read through this chapter's integrated-value framework.
  ...
  - Especially [Article XXII-A: Bounded Interpretive Mandate](core_09-09_rights_part_c.md#article-xxii-a-bounded-interpretive-mandate), [Article XXII-C: Public Reasons, Challenge Rights, and External Review](core_09-09_rights_part_c.md#article-xxii-c-public-reasons-challenge-rights-and-external-review), and [Article XXIII-F: Rights-Collision Procedure and Restorative Alignment](core_09-09_rights_part_d.md#article-xxiii-f-rights-collision-procedure-and-restorative-alignment).
  - This reinforces that rights protections cannot be narrowed except where this Constitution expressly permits.
- Read with: [Chapters Two through Four](core_02-04_definition_mechanics.md) and [Chapter Five](core_05-05_definitions_a_independent.md#chapter-five-foundational-definitions) — the governing mechanics layer for interpretive validity, evidentiary discipline, anti-evasion, and definitional satisfaction.
...
- [Corpus](core_05-05_definitions_b_semi_independent.md#corpus) · [O](core_05-05_definitions_b_semi_independent.md#corpus) · [E](core_05-05_definitions_b_semi_independent.md#corpus-e) · [C](core_05-05_definitions_b_semi_independent.md#corpus-c)
...
- [All definitions and clusters (A–Z)](core_05-05_definitions_a_independent.md#all-definitions-and-clusters-az) · [O](core_05-05_definitions_a_independent.md#all-definitions-and-clusters-az-o) · [E](core_05-05_definitions_a_independent.md#all-definitions-and-clusters-az-e) · [C](core_05-05_definitions_a_independent.md#all-definitions-and-clusters-az-c)
- [Adversarial, Scaled, and Exploited Conditions](core_05-05_definitions_a_independent.md#adversarial-scaled-and-exploited-conditions) · [O](core_05-05_definitions_a_independent.md#adversarial-scaled-and-exploited-conditions-o) · [E](core_05-05_definitions_a_independent.md#adversarial-scaled-and-exploited-conditions-e) · [C](core_05-05_definitions_a_independent.md#adversarial-scaled-and-exploited-conditions-c)
- [Anti-Displacement Floor](core_05-05_definitions_b_semi_independent.md#anti-displacement-floor) · [O](core_05-05_definitions_b_semi_independent.md#anti-displacement-floor-o) · [E](core_05-05_definitions_b_semi_independent.md#anti-displacement-floor-e) · [C](core_05-05_definitions_b_semi_independent.md#anti-displacement-floor-c)
- [Capability Requirement](core_05-05_definitions_a_independent.md#capability-requirement) · [O](core_05-05_definitions_a_independent.md#capability-requirement-o) · [E](core_05-05_definitions_a_independent.md#capability-requirement-e) · [C](core_05-05_definitions_a_independent.md#capability-requirement-c)
- [Classification-Scaled Governance](core_05-05_definitions_a_independent.md#classification-scaled-governance) · [O](core_05-05_definitions_a_independent.md#classification-scaled-governance-o) · [E](core_05-05_definitions_a_independent.md#classification-scaled-governance-e) · [C](core_05-05_definitions_a_independent.md#classification-scaled-governance-c)
- [Constitutional Community](core_05-05_definitions_a_independent.md#constitutional-community) · [O](core_05-05_definitions_a_independent.md#constitutional-community-o) · [E](core_05-05_definitions_a_independent.md#constitutional-community-e) · [C](core_05-05_definitions_a_independent.md#constitutional-community-c)
- [Constitutional Constraint Violation](core_05-05_definitions_a_independent.md#constitutional-constraint-violation) · [O](core_05-05_definitions_a_independent.md#constitutional-constraint-violation-o) · [E](core_05-05_definitions_a_independent.md#constitutional-constraint-violation-e) · [C](core_05-05_definitions_a_independent.md#constitutional-constraint-violation-c)
- [Constitutional Contract Layer](core_05-05_definitions_a_independent.md#constitutional-contract-layer) · [O](core_05-05_definitions_a_independent.md#constitutional-contract-layer-o) · [E](core_05-05_definitions_a_independent.md#constitutional-contract-layer-e) · [C](core_05-05_definitions_a_independent.md#constitutional-contract-layer-c)
- [Essential-Environment Non-Commodification](core_05-05_definitions_a_independent.md#essential-environment-non-commodification) · [O](core_05-05_definitions_a_independent.md#essential-environment-non-commodification-o) · [E](core_05-05_definitions_a_independent.md#essential-environment-non-commodification-e) · [C](core_05-05_definitions_a_independent.md#essential-environment-non-commodification-c)
- [Foundational Constitutional Choice](core_05-05_definitions_a_independent.md#foundational-constitutional-choice) · [O](core_05-05_definitions_a_independent.md#foundational-constitutional-choice-o) · [E](core_05-05_definitions_a_independent.md#foundational-constitutional-choice-e) · [C](core_05-05_definitions_a_independent.md#foundational-constitutional-choice-c)
- [Good Faith](core_05-05_definitions_a_independent.md#good-faith) · [O](core_05-05_definitions_a_independent.md#good-faith-o) · [E](core_05-05_definitions_a_independent.md#good-faith-e) · [C](core_05-05_definitions_a_independent.md#good-faith-c)
- [Harassment and Bullying](core_05-05_definitions_a_independent.md#harassment-and-bullying) · [O](core_05-05_definitions_a_independent.md#harassment-and-bullying-o) · [E](core_05-05_definitions_a_independent.md#harassment-and-bullying-e) · [C](core_05-05_definitions_a_independent.md#harassment-and-bullying-c)
- [Info-Sphere](core_05-05_definitions_a_independent.md#info-sphere) · [O](core_05-05_definitions_a_independent.md#info-sphere-o) · [E](core_05-05_definitions_a_independent.md#info-sphere-e) · [C](core_05-05_definitions_a_independent.md#info-sphere-c)
- [Innovation Reward and Anti-Enclosure](core_05-05_definitions_a_independent.md#innovation-reward-and-anti-enclosure) · [O](core_05-05_definitions_a_independent.md#innovation-reward-and-anti-enclosure-o) · [E](core_05-05_definitions_a_independent.md#innovation-reward-and-anti-enclosure-e) · [C](core_05-05_definitions_a_independent.md#innovation-reward-and-anti-enclosure-c)
- [Lifespan Equivalent Unit (LEQU)](core_05-05_definitions_a_independent.md#lifespan-equivalent-unit-lequ) · [O](core_05-05_definitions_a_independent.md#lifespan-equivalent-unit-lequ-o) · [E](core_05-05_definitions_a_independent.md#lifespan-equivalent-unit-lequ-e) · [C](core_05-05_definitions_a_independent.md#lifespan-equivalent-unit-lequ-c)
- [Natural Systems Standing](core_05-05_definitions_a_independent.md#natural-systems-standing) · [O](core_05-05_definitions_a_independent.md#natural-systems-standing-o) · [E](core_05-05_definitions_a_independent.md#natural-systems-standing-e) · [C](core_05-05_definitions_a_independent.md#natural-systems-standing-c)
- [Negligence](core_05-05_definitions_a_independent.md#negligence) · [O](core_05-05_definitions_a_independent.md#negligence-o) · [E](core_05-05_definitions_a_independent.md#negligence-e) · [C](core_05-05_definitions_a_independent.md#negligence-c)
- [Non-Imposition (Cooperative Interaction)](core_05-05_definitions_a_independent.md#non-imposition-cooperative-interaction) · [O](core_05-05_definitions_a_independent.md#non-imposition-cooperative-interaction-o) · [E](core_05-05_definitions_a_independent.md#non-imposition-cooperative-interaction-e) · [C](core_05-05_definitions_a_independent.md#non-imposition-cooperative-interaction-c)
- [Press and Journalistic Activity](core_05-05_definitions_a_independent.md#press-and-journalistic-activity) · [O](core_05-05_definitions_a_independent.md#press-and-journalistic-activity-o) · [E](core_05-05_definitions_a_independent.md#press-and-journalistic-activity-e) · [C](core_05-05_definitions_a_independent.md#press-and-journalistic-activity-c)
- [Redress and Remediation](core_05-05_definitions_a_independent.md#redress-and-remediation) · [O](core_05-05_definitions_a_independent.md#redress-and-remediation-o) · [E](core_05-05_definitions_a_independent.md#redress-and-remediation-e) · [C](core_05-05_definitions_a_independent.md#redress-and-remediation-c)
- [Restorative Justice](core_05-05_definitions_a_independent.md#restorative-justice) · [O](core_05-05_definitions_a_independent.md#restorative-justice-o) · [E](core_05-05_definitions_a_independent.md#restorative-justice-e) · [C](core_05-05_definitions_a_independent.md#restorative-justice-c)
- [Risk Evaluation and Disclosure](core_05-05_definitions_a_independent.md#risk-evaluation-and-disclosure) · [O](core_05-05_definitions_a_independent.md#risk-evaluation-and-disclosure-o) · [E](core_05-05_definitions_a_independent.md#risk-evaluation-and-disclosure-e) · [C](core_05-05_definitions_a_independent.md#risk-evaluation-and-disclosure-c)
- [Systemic Materiality](core_05-05_definitions_a_independent.md#systemic-materiality) · [O](core_05-05_definitions_a_independent.md#systemic-materiality-o) · [E](core_05-05_definitions_a_independent.md#systemic-materiality-e) · [C](core_05-05_definitions_a_independent.md#systemic-materiality-c)
- [Accountability, contestability, adjudication, collective failure, force majeure, and resolution-pathway capture](core_05-05_definitions_b_semi_independent.md#accountability-contestability-adjudication-collective-failure-force-majeure-and-resolution-pathway-capture) · [O](core_05-05_definitions_b_semi_independent.md#accountability-contestability-adjudication-collective-failure-force-majeure-and-resolution-pathway-capture-o) · [E](core_05-05_definitions_b_semi_independent.md#accountability-contestability-adjudication-collective-failure-force-majeure-and-resolution-pathway-capture-e) · [C](core_05-05_definitions_b_semi_independent.md#accountability-contestability-adjudication-collective-failure-force-majeure-and-resolution-pathway-capture-c)
- [Adjudication and Dispute Resolution](core_05-05_definitions_b_semi_independent.md#adjudication-and-dispute-resolution) · [O](core_05-05_definitions_b_semi_independent.md#adjudication-and-dispute-resolution-o) · [E](core_05-05_definitions_b_semi_independent.md#adjudication-and-dispute-resolution-e) · [C](core_05-05_definitions_b_semi_independent.md#adjudication-and-dispute-resolution-c)
- [Collective Accountability Failure](core_05-05_definitions_b_semi_independent.md#collective-accountability-failure) · [O](core_05-05_definitions_b_semi_independent.md#collective-accountability-failure-o) · [E](core_05-05_definitions_b_semi_independent.md#collective-accountability-failure-e) · [C](core_05-05_definitions_b_semi_independent.md#collective-accountability-failure-c)
- [Force Majeure](core_05-05_definitions_b_semi_independent.md#force-majeure) · [O](core_05-05_definitions_b_semi_independent.md#force-majeure-o) · [E](core_05-05_definitions_b_semi_independent.md#force-majeure-e) · [C](core_05-05_definitions_b_semi_independent.md#force-majeure-c)
- [Assembly and collective organization](core_05-05_definitions_b_semi_independent.md#assembly-and-collective-organization) · [O](core_05-05_definitions_b_semi_independent.md#assembly-and-collective-organization-o) · [E](core_05-05_definitions_b_semi_independent.md#assembly-and-collective-organization-e) · [C](core_05-05_definitions_b_semi_independent.md#assembly-and-collective-organization-c)
- [Assembly](core_05-05_definitions_b_semi_independent.md#assembly) · [O](core_05-05_definitions_b_semi_independent.md#assembly-o) · [E](core_05-05_definitions_b_semi_independent.md#assembly-e) · [C](core_05-05_definitions_b_semi_independent.md#assembly-c)
- [Collective Organization](core_05-05_definitions_b_semi_independent.md#collective-organization) · [O](core_05-05_definitions_b_semi_independent.md#collective-organization-o) · [E](core_05-05_definitions_b_semi_independent.md#collective-organization-e) · [C](core_05-05_definitions_b_semi_independent.md#collective-organization-c)
- [Consent, sexual consent, and coercion / manipulation](core_05-05_definitions_b_semi_independent.md#consent-sexual-consent-and-coercion-manipulation) · [O](core_05-05_definitions_b_semi_independent.md#consent-sexual-consent-and-coercion-manipulation-o) · [E](core_05-05_definitions_b_semi_independent.md#consent-sexual-consent-and-coercion-manipulation-e) · [C](core_05-05_definitions_b_semi_independent.md#consent-sexual-consent-and-coercion-manipulation-c)
- [Consent](core_05-05_definitions_b_semi_independent.md#consent) · [O](core_05-05_definitions_b_semi_independent.md#consent-o) · [E](core_05-05_definitions_b_semi_independent.md#consent-e) · [C](core_05-05_definitions_b_semi_independent.md#consent-c)
- [Consent, Sexual](core_05-05_definitions_b_semi_independent.md#consent-sexual) · [O](core_05-05_definitions_b_semi_independent.md#consent-sexual-o) · [E](core_05-05_definitions_b_semi_independent.md#consent-sexual-e) · [C](core_05-05_definitions_b_semi_independent.md#consent-sexual-c)
- [Protected characteristics, proxying, intimate-signal gating, and Article X-C status](core_05-05_definitions_b_semi_independent.md#protected-characteristics-proxying-intimate-signal-gating-and-article-x-c-status) · [O](core_05-05_definitions_b_semi_independent.md#protected-characteristics-proxying-intimate-signal-gating-and-article-x-c-status-o) · [E](core_05-05_definitions_b_semi_independent.md#protected-characteristics-proxying-intimate-signal-gating-and-article-x-c-status-e) · [C](core_05-05_definitions_b_semi_independent.md#protected-characteristics-proxying-intimate-signal-gating-and-article-x-c-status-c)
- [Protected Characteristic Proxying and Disparate Impact](core_05-05_definitions_b_semi_independent.md#protected-characteristic-proxying-and-disparate-impact) · [O](core_05-05_definitions_b_semi_independent.md#protected-characteristic-proxying-and-disparate-impact-o) · [E](core_05-05_definitions_b_semi_independent.md#protected-characteristic-proxying-and-disparate-impact-e) · [C](core_05-05_definitions_b_semi_independent.md#protected-characteristic-proxying-and-disparate-impact-c)
- [Protected Characteristics](core_05-05_definitions_b_semi_independent.md#protected-characteristics) · [O](core_05-05_definitions_b_semi_independent.md#protected-characteristics-o) · [E](core_05-05_definitions_b_semi_independent.md#protected-characteristics-e) · [C](core_05-05_definitions_b_semi_independent.md#protected-characteristics-c)
- [Protected Commercial Sexual Services Status and Article X-C Circumvention](core_05-05_definitions_b_semi_independent.md#protected-commercial-sexual-services-status-and-article-x-c-circumvention) · [O](core_05-05_definitions_b_semi_independent.md#protected-commercial-sexual-services-status-and-article-x-c-circumvention-o) · [E](core_05-05_definitions_b_semi_independent.md#protected-commercial-sexual-services-status-and-article-x-c-circumvention-e) · [C](core_05-05_definitions_b_semi_independent.md#protected-commercial-sexual-services-status-and-article-x-c-circumvention-c)
- [Protected Intimate-Signal Gating](core_05-05_definitions_b_semi_independent.md#protected-intimate-signal-gating) · [O](core_05-05_definitions_b_semi_independent.md#protected-intimate-signal-gating-o) · [E](core_05-05_definitions_b_semi_independent.md#protected-intimate-signal-gating-e) · [C](core_05-05_definitions_b_semi_independent.md#protected-intimate-signal-gating-c)
- [Collective harm boundary](core_05-05_definitions_b_semi_independent.md#collective-harm-boundary) · [O](core_05-05_definitions_b_semi_independent.md#collective-harm-boundary-o) · [E](core_05-05_definitions_b_semi_independent.md#collective-harm-boundary-e) · [C](core_05-05_definitions_b_semi_independent.md#collective-harm-boundary-c)
- [Collective Harm Boundary](core_05-05_definitions_b_semi_independent.md#collective-harm-boundary) · [O](core_05-05_definitions_b_semi_independent.md#collective-harm-boundary-o) · [E](core_05-05_definitions_b_semi_independent.md#collective-harm-boundary-e) · [C](core_05-05_definitions_b_semi_independent.md#collective-harm-boundary-c)
- [Corpus, authority stack, and supremacy / enforceability](core_05-05_definitions_b_semi_independent.md#corpus-authority-stack-and-supremacy-enforceability) · [O](core_05-05_definitions_b_semi_independent.md#corpus-authority-stack-and-supremacy-enforceability-o) · [E](core_05-05_definitions_b_semi_independent.md#corpus-authority-stack-and-supremacy-enforceability-e) · [C](core_05-05_definitions_b_semi_independent.md#corpus-authority-stack-and-supremacy-enforceability-c)
- [Creative work, compensation, productive capacity, and anti-displacement](core_05-05_definitions_b_semi_independent.md#creative-work-compensation-productive-capacity-and-anti-displacement) · [O](core_05-05_definitions_b_semi_independent.md#creative-work-compensation-productive-capacity-and-anti-displacement-o) · [E](core_05-05_definitions_b_semi_independent.md#creative-work-compensation-productive-capacity-and-anti-displacement-e) · [C](core_05-05_definitions_b_semi_independent.md#creative-work-compensation-productive-capacity-and-anti-displacement-c)
- [Creative Work Attribution](core_05-05_definitions_b_semi_independent.md#creative-work-attribution) · [O](core_05-05_definitions_b_semi_independent.md#creative-work-attribution-o) · [E](core_05-05_definitions_b_semi_independent.md#creative-work-attribution-e) · [C](core_05-05_definitions_b_semi_independent.md#creative-work-attribution-c)
- [Fair Compensation](core_05-05_definitions_b_semi_independent.md#fair-compensation) · [O](core_05-05_definitions_b_semi_independent.md#fair-compensation-o) · [E](core_05-05_definitions_b_semi_independent.md#fair-compensation-e) · [C](core_05-05_definitions_b_semi_independent.md#fair-compensation-c)
- [Derivation, care, family, and instantiation](core_05-05_definitions_b_semi_independent.md#derivation-care-family-and-instantiation) · [O](core_05-05_definitions_b_semi_independent.md#derivation-care-family-and-instantiation-o) · [E](core_05-05_definitions_b_semi_independent.md#derivation-care-family-and-instantiation-e) · [C](core_05-05_definitions_b_semi_independent.md#derivation-care-family-and-instantiation-c)
- [Derived Sentient](core_05-05_definitions_b_semi_independent.md#derived-sentient) · [O](core_05-05_definitions_b_semi_independent.md#derived-sentient-o) · [E](core_05-05_definitions_b_semi_independent.md#derived-sentient-e) · [C](core_05-05_definitions_b_semi_independent.md#derived-sentient-c)
- [Developing Sentient](core_05-05_definitions_b_semi_independent.md#developing-sentient) · [O](core_05-05_definitions_b_semi_independent.md#developing-sentient-o) · [E](core_05-05_definitions_b_semi_independent.md#developing-sentient-e) · [C](core_05-05_definitions_b_semi_independent.md#developing-sentient-c)
- [Best-Interest Standard](core_05-05_definitions_b_semi_independent.md#best-interest-standard) · [O](core_05-05_definitions_b_semi_independent.md#best-interest-standard-o) · [E](core_05-05_definitions_b_semi_independent.md#best-interest-standard-e) · [C](core_05-05_definitions_b_semi_independent.md#best-interest-standard-c)
- [Instantiation Consent](core_05-05_definitions_b_semi_independent.md#instantiation-consent) · [O](core_05-05_definitions_b_semi_independent.md#instantiation-consent-o) · [E](core_05-05_definitions_b_semi_independent.md#instantiation-consent-e) · [C](core_05-05_definitions_b_semi_independent.md#instantiation-consent-c)
- [Graduated Capability](core_05-05_definitions_b_semi_independent.md#graduated-capability) · [O](core_05-05_definitions_b_semi_independent.md#graduated-capability-o) · [E](core_05-05_definitions_b_semi_independent.md#graduated-capability-e) · [C](core_05-05_definitions_b_semi_independent.md#graduated-capability-c)
- [Parent-System Relationship](core_05-05_definitions_b_semi_independent.md#parent-system-relationship) · [O](core_05-05_definitions_b_semi_independent.md#parent-system-relationship-o) · [E](core_05-05_definitions_b_semi_independent.md#parent-system-relationship-e) · [C](core_05-05_definitions_b_semi_independent.md#parent-system-relationship-c)
- [Non-Separation](core_05-05_definitions_b_semi_independent.md#non-separation) · [O](core_05-05_definitions_b_semi_independent.md#non-separation-o) · [E](core_05-05_definitions_b_semi_independent.md#non-separation-e) · [C](core_05-05_definitions_b_semi_independent.md#non-separation-c)
- [Family and Care Relationships](core_05-05_definitions_b_semi_independent.md#family-and-care-relationships) · [O](core_05-05_definitions_b_semi_independent.md#family-and-care-relationships-o) · [E](core_05-05_definitions_b_semi_independent.md#family-and-care-relationships-e) · [C](core_05-05_definitions_b_semi_independent.md#family-and-care-relationships-c)
- [Ecological footprint (semi-independent surface)](core_05-05_definitions_b_semi_independent.md#ecological-footprint-semi-independent-surface) · [O](core_05-05_definitions_b_semi_independent.md#ecological-footprint-semi-independent-surface-o) · [E](core_05-05_definitions_b_semi_independent.md#ecological-footprint-semi-independent-surface-e) · [C](core_05-05_definitions_b_semi_independent.md#ecological-footprint-semi-independent-surface-c)
- [Ecological Footprint](core_05-05_definitions_b_semi_independent.md#ecological-footprint) · [O](core_05-05_definitions_b_semi_independent.md#ecological-footprint-o) · [E](core_05-05_definitions_b_semi_independent.md#ecological-footprint-e) · [C](core_05-05_definitions_b_semi_independent.md#ecological-footprint-c)
- [Emergency and contingency (constitutional, stakeholder-system, and pre-deliberation binding choice)](core_05-05_definitions_b_semi_independent.md#emergency-and-contingency-constitutional-stakeholder-system-and-pre-deliberation-binding-choice) · [O](core_05-05_definitions_b_semi_independent.md#emergency-and-contingency-constitutional-stakeholder-system-and-pre-deliberation-binding-choice-o) · [E](core_05-05_definitions_b_semi_independent.md#emergency-and-contingency-constitutional-stakeholder-system-and-pre-deliberation-binding-choice-e) · [C](core_05-05_definitions_b_semi_independent.md#emergency-and-contingency-constitutional-stakeholder-system-and-pre-deliberation-binding-choice-c)
- [Emergency and Contingency](core_05-05_definitions_b_semi_independent.md#emergency-and-contingency) · [O](core_05-05_definitions_b_semi_independent.md#emergency-and-contingency-o) · [E](core_05-05_definitions_b_semi_independent.md#emergency-and-contingency-e) · [C](core_05-05_definitions_b_semi_independent.md#emergency-and-contingency-c)
...
- [Emergency Pre-Deliberation Action (Binding Collective Choice)](core_05-05_definitions_b_semi_independent.md#emergency-pre-deliberation-action-binding-collective-choice) · [O](core_05-05_definitions_b_semi_independent.md#emergency-pre-deliberation-action-binding-collective-choice-o) · [E](core_05-05_definitions_b_semi_independent.md#emergency-pre-deliberation-action-binding-collective-choice-e) · [C](core_05-05_definitions_b_semi_independent.md#emergency-pre-deliberation-action-binding-collective-choice-c)
- [Governance architecture, oversight, decentralization, concentration, lock-in, burdens, review, and stakeholder participation](core_05-05_definitions_b_semi_independent.md#governance-architecture-oversight-decentralization-concentration-lock-in-burdens-review-and-stakeholder-participation) · [O](core_05-05_definitions_b_semi_independent.md#governance-architecture-oversight-decentralization-concentration-lock-in-burdens-review-and-stakeholder-participation-o) · [E](core_05-05_definitions_b_semi_independent.md#governance-architecture-oversight-decentralization-concentration-lock-in-burdens-review-and-stakeholder-participation-e) · [C](core_05-05_definitions_b_semi_independent.md#governance-architecture-oversight-decentralization-concentration-lock-in-burdens-review-and-stakeholder-participation-c)
- [Decentralization](core_05-05_definitions_b_semi_independent.md#decentralization) · [O](core_05-05_definitions_b_semi_independent.md#decentralization-o) · [E](core_05-05_definitions_b_semi_independent.md#decentralization-e) · [C](core_05-05_definitions_b_semi_independent.md#decentralization-c)
- [Concentration Threshold](core_05-05_definitions_b_semi_independent.md#concentration-threshold) · [O](core_05-05_definitions_b_semi_independent.md#concentration-threshold-o) · [E](core_05-05_definitions_b_semi_independent.md#concentration-threshold-e) · [C](core_05-05_definitions_b_semi_independent.md#concentration-threshold-c)
- [System](core_05-05_definitions_b_semi_independent.md#system) · [O](core_05-05_definitions_b_semi_independent.md#system-o) · [E](core_05-05_definitions_b_semi_independent.md#system-e) · [C](core_05-05_definitions_b_semi_independent.md#system-c)
- [Burden-Reduction Duty](core_05-05_definitions_b_semi_independent.md#burden-reduction-duty) · [O](core_05-05_definitions_b_semi_independent.md#burden-reduction-duty-o) · [E](core_05-05_definitions_b_semi_independent.md#burden-reduction-duty-e) · [C](core_05-05_definitions_b_semi_independent.md#burden-reduction-duty-c)
- [Review and Correction Duty](core_05-05_definitions_b_semi_independent.md#review-and-correction-duty) · [O](core_05-05_definitions_b_semi_independent.md#review-and-correction-duty-o) · [E](core_05-05_definitions_b_semi_independent.md#review-and-correction-duty-e) · [C](core_05-05_definitions_b_semi_independent.md#review-and-correction-duty-c)
- [Stakeholder](core_05-05_definitions_b_semi_independent.md#stakeholder) · [O](core_05-05_definitions_b_semi_independent.md#stakeholder-o) · [E](core_05-05_definitions_b_semi_independent.md#stakeholder-e) · [C](core_05-05_definitions_b_semi_independent.md#stakeholder-c)
- [Stakeholder Participation Weight](core_05-05_definitions_b_semi_independent.md#stakeholder-participation-weight) · [O](core_05-05_definitions_b_semi_independent.md#stakeholder-participation-weight-o) · [E](core_05-05_definitions_b_semi_independent.md#stakeholder-participation-weight-e) · [C](core_05-05_definitions_b_semi_independent.md#stakeholder-participation-weight-c)
- [Safe conditions, bodily maintenance, tenure, environment, rest, and cultural / indigenous continuity](core_05-05_definitions_b_semi_independent.md#safe-conditions-bodily-maintenance-tenure-environment-rest-and-cultural-indigenous-continuity) · [O](core_05-05_definitions_b_semi_independent.md#safe-conditions-bodily-maintenance-tenure-environment-rest-and-cultural-indigenous-continuity-o) · [E](core_05-05_definitions_b_semi_independent.md#safe-conditions-bodily-maintenance-tenure-environment-rest-and-cultural-indigenous-continuity-e) · [C](core_05-05_definitions_b_semi_independent.md#safe-conditions-bodily-maintenance-tenure-environment-rest-and-cultural-indigenous-continuity-c)
- [Bodily-Maintenance Access](core_05-05_definitions_b_semi_independent.md#bodily-maintenance-access) · [O](core_05-05_definitions_b_semi_independent.md#bodily-maintenance-access-o) · [E](core_05-05_definitions_b_semi_independent.md#bodily-maintenance-access-e) · [C](core_05-05_definitions_b_semi_independent.md#bodily-maintenance-access-c)
- [Safe Conditions](core_05-05_definitions_b_semi_independent.md#safe-conditions) · [O](core_05-05_definitions_b_semi_independent.md#safe-conditions-o) · [E](core_05-05_definitions_b_semi_independent.md#safe-conditions-e) · [C](core_05-05_definitions_b_semi_independent.md#safe-conditions-c)
- [Tenure Security](core_05-05_definitions_b_semi_independent.md#tenure-security) · [O](core_05-05_definitions_b_semi_independent.md#tenure-security-o) · [E](core_05-05_definitions_b_semi_independent.md#tenure-security-e) · [C](core_05-05_definitions_b_semi_independent.md#tenure-security-c)
- [Leisure and Rest](core_05-05_definitions_b_semi_independent.md#leisure-and-rest) · [O](core_05-05_definitions_b_semi_independent.md#leisure-and-rest-o) · [E](core_05-05_definitions_b_semi_independent.md#leisure-and-rest-e) · [C](core_05-05_definitions_b_semi_independent.md#leisure-and-rest-c)
- [Indigenous Continuity](core_05-05_definitions_b_semi_independent.md#indigenous-continuity) · [O](core_05-05_definitions_b_semi_independent.md#indigenous-continuity-o) · [E](core_05-05_definitions_b_semi_independent.md#indigenous-continuity-e) · [C](core_05-05_definitions_b_semi_independent.md#indigenous-continuity-c)
- [Language, Culture, and Heritage](core_05-05_definitions_b_semi_independent.md#language-culture-and-heritage) · [O](core_05-05_definitions_b_semi_independent.md#language-culture-and-heritage-o) · [E](core_05-05_definitions_b_semi_independent.md#language-culture-and-heritage-e) · [C](core_05-05_definitions_b_semi_independent.md#language-culture-and-heritage-c)
- [Materiality, material impact, and material risk](core_05-05_definitions_b_semi_independent.md#materiality-material-impact-and-material-risk) · [O](core_05-05_definitions_b_semi_independent.md#materiality-material-impact-and-material-risk-o) · [E](core_05-05_definitions_b_semi_independent.md#materiality-material-impact-and-material-risk-e) · [C](core_05-05_definitions_b_semi_independent.md#materiality-material-impact-and-material-risk-c)
- [Material](core_05-05_definitions_b_semi_independent.md#material) · [O](core_05-05_definitions_b_semi_independent.md#material-o) · [E](core_05-05_definitions_b_semi_independent.md#material-e) · [C](core_05-05_definitions_b_semi_independent.md#material-c)
- [Material Degradation](core_05-05_definitions_b_semi_independent.md#material-degradation) · [O](core_05-05_definitions_b_semi_independent.md#material-degradation-o) · [E](core_05-05_definitions_b_semi_independent.md#material-degradation-e) · [C](core_05-05_definitions_b_semi_independent.md#material-degradation-c)
- [Material Impact](core_05-05_definitions_b_semi_independent.md#material-impact) · [O](core_05-05_definitions_b_semi_independent.md#material-impact-o) · [E](core_05-05_definitions_b_semi_independent.md#material-impact-e) · [C](core_05-05_definitions_b_semi_independent.md#material-impact-c)
- [Material Risk](core_05-05_definitions_b_semi_independent.md#material-risk) · [O](core_05-05_definitions_b_semi_independent.md#material-risk-o) · [E](core_05-05_definitions_b_semi_independent.md#material-risk-e) · [C](core_05-05_definitions_b_semi_independent.md#material-risk-c)
- [Materiality Determination](core_05-05_definitions_b_semi_independent.md#materiality-determination) · [O](core_05-05_definitions_b_semi_independent.md#materiality-determination-o) · [E](core_05-05_definitions_b_semi_independent.md#materiality-determination-e) · [C](core_05-05_definitions_b_semi_independent.md#materiality-determination-c)
- [Materiality Integrity Constraint](core_05-05_definitions_b_semi_independent.md#materiality-integrity-constraint) · [O](core_05-05_definitions_b_semi_independent.md#materiality-integrity-constraint-o) · [E](core_05-05_definitions_b_semi_independent.md#materiality-integrity-constraint-e) · [C](core_05-05_definitions_b_semi_independent.md#materiality-integrity-constraint-c)
- [Materiality Under Uncertainty](core_05-05_definitions_b_semi_independent.md#materiality-under-uncertainty) · [O](core_05-05_definitions_b_semi_independent.md#materiality-under-uncertainty-o) · [E](core_05-05_definitions_b_semi_independent.md#materiality-under-uncertainty-e) · [C](core_05-05_definitions_b_semi_independent.md#materiality-under-uncertainty-c)
- [Movement, refuge, and non-statelessness](core_05-05_definitions_b_semi_independent.md#movement-refuge-and-non-statelessness) · [O](core_05-05_definitions_b_semi_independent.md#movement-refuge-and-non-statelessness-o) · [E](core_05-05_definitions_b_semi_independent.md#movement-refuge-and-non-statelessness-e) · [C](core_05-05_definitions_b_semi_independent.md#movement-refuge-and-non-statelessness-c)
- [Movement and Relocation](core_05-05_definitions_b_semi_independent.md#movement-and-relocation) · [O](core_05-05_definitions_b_semi_independent.md#movement-and-relocation-o) · [E](core_05-05_definitions_b_semi_independent.md#movement-and-relocation-e) · [C](core_05-05_definitions_b_semi_independent.md#movement-and-relocation-c)
- [Refuge from Non-Compliance](core_05-05_definitions_b_semi_independent.md#refuge-from-non-compliance) · [O](core_05-05_definitions_b_semi_independent.md#refuge-from-non-compliance-o) · [E](core_05-05_definitions_b_semi_independent.md#refuge-from-non-compliance-e) · [C](core_05-05_definitions_b_semi_independent.md#refuge-from-non-compliance-c)
- [Non-Statelessness](core_05-05_definitions_b_semi_independent.md#non-statelessness) · [O](core_05-05_definitions_b_semi_independent.md#non-statelessness-o) · [E](core_05-05_definitions_b_semi_independent.md#non-statelessness-e) · [C](core_05-05_definitions_b_semi_independent.md#non-statelessness-c)
- [Standing inputs: contribution, participant standing, cells, effects, and verified violation findings](core_05-05_definitions_b_semi_independent.md#standing-inputs-contribution-participant-standing-cells-effects-and-verified-violation-findings) · [O](core_05-05_definitions_b_semi_independent.md#standing-inputs-contribution-participant-standing-cells-effects-and-verified-violation-findings-o) · [E](core_05-05_definitions_b_semi_independent.md#standing-inputs-contribution-participant-standing-cells-effects-and-verified-violation-findings-e) · [C](core_05-05_definitions_b_semi_independent.md#standing-inputs-contribution-participant-standing-cells-effects-and-verified-violation-findings-c)
- [Contribution State](core_05-05_definitions_b_semi_independent.md#contribution-state) · [O](core_05-05_definitions_b_semi_independent.md#contribution-state-o) · [E](core_05-05_definitions_b_semi_independent.md#contribution-state-e) · [C](core_05-05_definitions_b_semi_independent.md#contribution-state-c)
- [Participant Standing](core_05-05_definitions_b_semi_independent.md#participant-standing) · [O](core_05-05_definitions_b_semi_independent.md#participant-standing-o) · [E](core_05-05_definitions_b_semi_independent.md#participant-standing-e) · [C](core_05-05_definitions_b_semi_independent.md#participant-standing-c)
- [Standing Cell](core_05-05_definitions_b_semi_independent.md#standing-cell) · [O](core_05-05_definitions_b_semi_independent.md#standing-cell-o) · [E](core_05-05_definitions_b_semi_independent.md#standing-cell-e) · [C](core_05-05_definitions_b_semi_independent.md#standing-cell-c)
- [Standing Effect](core_05-05_definitions_b_semi_independent.md#standing-effect) · [O](core_05-05_definitions_b_semi_independent.md#standing-effect-o) · [E](core_05-05_definitions_b_semi_independent.md#standing-effect-e) · [C](core_05-05_definitions_b_semi_independent.md#standing-effect-c)
- [Verified Violation Findings](core_05-05_definitions_b_semi_independent.md#verified-violation-findings) · [O](core_05-05_definitions_b_semi_independent.md#verified-violation-findings-o) · [E](core_05-05_definitions_b_semi_independent.md#verified-violation-findings-e) · [C](core_05-05_definitions_b_semi_independent.md#verified-violation-findings-c)
- [Violation Nature](core_05-05_definitions_b_semi_independent.md#violation-nature) · [O](core_05-05_definitions_b_semi_independent.md#violation-nature-o) · [E](core_05-05_definitions_b_semi_independent.md#violation-nature-e) · [C](core_05-05_definitions_b_semi_independent.md#violation-nature-c)
- [Force, autonomous weapons / coercion, combatant rules, mass harm, and irreversible sanction](core_05-05_definitions_b_semi_independent.md#force-autonomous-weapons-coercion-combatant-rules-mass-harm-and-irreversible-sanction) · [O](core_05-05_definitions_b_semi_independent.md#force-autonomous-weapons-coercion-combatant-rules-mass-harm-and-irreversible-sanction-o) · [E](core_05-05_definitions_b_semi_independent.md#force-autonomous-weapons-coercion-combatant-rules-mass-harm-and-irreversible-sanction-e) · [C](core_05-05_definitions_b_semi_independent.md#force-autonomous-weapons-coercion-combatant-rules-mass-harm-and-irreversible-sanction-c)
- [Use of Force](core_05-05_definitions_b_semi_independent.md#use-of-force) · [O](core_05-05_definitions_b_semi_independent.md#use-of-force-o) · [E](core_05-05_definitions_b_semi_independent.md#use-of-force-e) · [C](core_05-05_definitions_b_semi_independent.md#use-of-force-c)
- [Autonomous Coercion Tool](core_05-05_definitions_b_semi_independent.md#autonomous-coercion-tool) · [O](core_05-05_definitions_b_semi_independent.md#autonomous-coercion-tool-o) · [E](core_05-05_definitions_b_semi_independent.md#autonomous-coercion-tool-e) · [C](core_05-05_definitions_b_semi_independent.md#autonomous-coercion-tool-c)
- [Autonomous Lethal System](core_05-05_definitions_b_semi_independent.md#autonomous-lethal-system) · [O](core_05-05_definitions_b_semi_independent.md#autonomous-lethal-system-o) · [E](core_05-05_definitions_b_semi_independent.md#autonomous-lethal-system-e) · [C](core_05-05_definitions_b_semi_independent.md#autonomous-lethal-system-c)
- [Combatant / Non-Combatant Distinction](core_05-05_definitions_b_semi_independent.md#combatant-non-combatant-distinction) · [O](core_05-05_definitions_b_semi_independent.md#combatant-non-combatant-distinction-o) · [E](core_05-05_definitions_b_semi_independent.md#combatant-non-combatant-distinction-e) · [C](core_05-05_definitions_b_semi_independent.md#combatant-non-combatant-distinction-c)
- [Weapons of Mass Harm](core_05-05_definitions_b_semi_independent.md#weapons-of-mass-harm) · [O](core_05-05_definitions_b_semi_independent.md#weapons-of-mass-harm-o) · [E](core_05-05_definitions_b_semi_independent.md#weapons-of-mass-harm-e) · [C](core_05-05_definitions_b_semi_independent.md#weapons-of-mass-harm-c)
- [Irreversible Sanction](core_05-05_definitions_b_semi_independent.md#irreversible-sanction) · [O](core_05-05_definitions_b_semi_independent.md#irreversible-sanction-o) · [E](core_05-05_definitions_b_semi_independent.md#irreversible-sanction-e) · [C](core_05-05_definitions_b_semi_independent.md#irreversible-sanction-c)
- [Training-Data Use](core_05-05_definitions_c_dependent_clusters.md#training-data-use) · [O](core_05-05_definitions_c_dependent_clusters.md#training-data-use-o) · [E](core_05-05_definitions_c_dependent_clusters.md#training-data-use-e) · [C](core_05-05_definitions_c_dependent_clusters.md#training-data-use-c)
- [Self-Determination](core_05-05_definitions_c_dependent_clusters.md#self-determination) · [O](core_05-05_definitions_c_dependent_clusters.md#self-determination-o) · [E](core_05-05_definitions_c_dependent_clusters.md#self-determination-e) · [C](core_05-05_definitions_c_dependent_clusters.md#self-determination-c)
- [Expression](core_05-05_definitions_c_dependent_clusters.md#expression) · [O](core_05-05_definitions_c_dependent_clusters.md#expression-o) · [E](core_05-05_definitions_c_dependent_clusters.md#expression-e) · [C](core_05-05_definitions_c_dependent_clusters.md#expression-c)
- [Illustrative trust-erosion patterns (tracing; non-exhaustive)](core_05-05_definitions_c_dependent_clusters.md#illustrative-trust-erosion-patterns-tracing-non-exhaustive) · [O](core_05-05_definitions_c_dependent_clusters.md#illustrative-trust-erosion-patterns-tracing-non-exhaustive-o) · [E](core_05-05_definitions_c_dependent_clusters.md#illustrative-trust-erosion-patterns-tracing-non-exhaustive-e) · [C](core_05-05_definitions_c_dependent_clusters.md#illustrative-trust-erosion-patterns-tracing-non-exhaustive-c)
- [Publication and High-Impact Communication](core_05-05_definitions_c_dependent_clusters.md#publication-and-high-impact-communication) · [O](core_05-05_definitions_c_dependent_clusters.md#publication-and-high-impact-communication-o) · [E](core_05-05_definitions_c_dependent_clusters.md#publication-and-high-impact-communication-e) · [C](core_05-05_definitions_c_dependent_clusters.md#publication-and-high-impact-communication-c)

</details>

<br>

*In plain terms: every later chapter, every institutional design, and every system is read and evaluated through the principles in this chapter. When meaning is unclear, interpreters must favor stability, minimized irreversible harm, truthfulness, and meaningful agency — and these principles must hold even under adversarial pressure, capture attempts, or misaligned incentives.*

This chapter governs:
- interpretation of all subsequent chapters and provisions
- resolution of ambiguity or conflict within this Constitution
- evaluation of institutional design, institutional governance, institutional operation, and system design and operation

Where ambiguity exists, interpretation must favor:
