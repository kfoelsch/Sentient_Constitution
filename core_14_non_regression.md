<a id="chapter-fourteen-non-regression-and-substantive-amendment-validity"></a>
...
> - **Anti-relocation rule:** this chapter does not assign final offense labels, numeric slots, or sanction taxonomy. Numeric Contribution and Violation slots remain measured on the [Chapter Nine §7 unified proportional LEQU scale](core_09_standing_assessment.md#7-unified-proportional-lequ-scale--contribution-and-violation-axes), with separate axis records and Violation slots controlled only by verified impact. **Chapter Eleven** of [core_11_a_misconduct_designation.md](core_11_a_misconduct_designation.md#chapter-eleven-anti-constitutional-misconduct) may add the corresponding anti-constitutional-misconduct designation to a Chapter Nine Violation Axis slot 7, 8, or 9 record but does not assign the numeric slot.
>
...
- Upstream: [Chapter One](core_01_c_stewardship_capacity_principles.md#chapter-01-principles-and-constraints); [Chapters Two through Four](core_02_definition_structure.md) integrity and verification; [Chapter Six](core_06_rights_part_a.md#chapter-six-foundational-rights) Rights Floor; [Chapter Thirteen](core_13_governance.md#chapter-thirteen-constitutional-contract-legitimacy-authorization-and-stewardship) legitimacy and stewardship requirements.
...
- Downstream: [Chapter Fifteen](core_15_expansion_supremacy.md#chapter-fifteen-expansion-supremacy-and-external-legal-orders) expansion and supremacy; [Chapter Sixteen](core_16_amendment_ratification.md#chapter-sixteen-amendment-ratification-and-procedural-validity) procedural validity, ratification, and amendment requirements; [Chapter Nine](core_09_standing_assessment.md#chapter-nine-compliance-violation-and-standing-model) and [Chapter Eleven](core_11_a_misconduct_designation.md#chapter-eleven-anti-constitutional-misconduct) for canonical classification where referral triggers route.
- Read with: [archive/ARCHITECTURE_PRIMER_ARCHIVED_2026-05-08.md](archive/ARCHITECTURE_PRIMER_ARCHIVED_2026-05-08.md) non-operative walkthrough for **Chapters Twelve through Fourteen** on constitutional change and incorporation.

</details>

<br>

Chapter Fourteen is the constitutional owner of **substantive non-regression and substantive amendment validity** (Test 1), anti-evasion controls, and validity-protection measures.
...
- legitimacy and stewardship obligations in Chapter Thirteen

Permitted expansion of protection and supremacy sequencing are governed by **Chapter Fifteen**; ratification and procedural validity are governed by **Chapter Sixteen**.
...
- Downstream: [§3](#3-anti-evasion-clause-and-constitutional-misconduct-referral) evasion and misconduct referral; [Chapter Sixteen](core_16_amendment_ratification.md#chapter-sixteen-amendment-ratification-and-procedural-validity) Tests 2–4 and procedural requirements (invalid if Test 1 fails regardless of procedure).
- Read with: [Chapter One](core_01_c_stewardship_capacity_principles.md#chapter-01-principles-and-constraints) non-negotiable principle constraints; [Chapter Thirteen](core_13_governance.md#chapter-thirteen-constitutional-contract-legitimacy-authorization-and-stewardship) legitimacy obligations.

</details>

<br>

*In plain terms: Test 1 is the checklist — if a proposal would gut Chapter One constraints, Chapters Two through Four integrity, Chapter Six Rights Floors, or Chapter Thirteen legitimacy, it fails, including when the damage is done through procedure, evidence rules, or re-tagging rather than a single blunt deletion.*
...
- Chapter Thirteen legitimacy obligations
...
- Downstream: Mandatory referral records route to [Chapter Nine](core_09_standing_assessment.md#chapter-nine-compliance-violation-and-standing-model) (separate Contribution Axis and Violation Axis records and numeric measurement on the §7 unified scale), [Chapter Ten §2](core_10_standing_integration.md#2-automatic-integration-review-and-continuity) (integration routing of qualifying Violation Axis slot 7–9 findings), and [Chapter Eleven](core_11_a_misconduct_designation.md#chapter-eleven-anti-constitutional-misconduct) (the corresponding anti-constitutional-misconduct designation for a qualifying Chapter Nine Violation Axis slot 7, 8, or 9 record); this chapter does not classify.
- Read with: [Chapter Fourteen §4](#4-layer-scope) layer scope (triggers are not canonical slot-classification or sanction law).
...
**Forcible** or **nullification** misconduct routes through **criteria 5** and **6** of the same section where material. Those traits remain character descriptors and designation predicates; they do not move the numeric Violation Axis slot. The record must be transmitted to the canonical classification authorities; **this chapter does not itself classify**. **General contribution and violation measurement** (Contribution Axis and Violation Axis), including numeric slot assignment on the shared five-times LEQU bands from verified impact and separate axis records, is owned by the [**Chapter Nine §7 unified scale**](core_09_standing_assessment.md#7-unified-proportional-lequ-scale--contribution-and-violation-axes) in [core_09_standing_assessment.md](core_09_standing_assessment.md). [**Chapter Ten**](core_10_standing_integration.md#chapter-ten-standing-effects-and-integration) owns standing effects and integration without moving either slot. For a final Chapter Nine **Violation Axis s = 7, s = 8, or s = 9** impact slot, **Chapter Eleven** (*Anti-Constitutional Misconduct*) in [core_11_a_misconduct_designation.md](core_11_a_misconduct_designation.md#chapter-eleven-anti-constitutional-misconduct) may add the corresponding **anti-constitutional-misconduct designation**, subject to its criteria, due-process safeguards, and cross-chapter discipline, as referenced under **Chapter Nine** [section 5.1](core_09_standing_assessment.md#5-slot-grammar-and-display-labels) and the [Chapter Ten §2 gateway](core_10_standing_integration.md#2-automatic-integration-review-and-continuity). This chapter issues **referral and review triggers only**; it does not assign or move a numeric slot or attach, narrow, or expand canonical designations.
...
- Upstream: [§3](#3-anti-evasion-clause-and-constitutional-misconduct-referral) referral-only discipline; [Chapter Nine](core_09_standing_assessment.md#chapter-nine-compliance-violation-and-standing-model) and [Chapter Eleven](core_11_a_misconduct_designation.md#chapter-eleven-anti-constitutional-misconduct) canonical owners.
- Downstream: [Chapter Sixteen §12](core_16_amendment_ratification.md#12-layer-scope) mirrored procedural-layer discipline; implementation text for review execution mechanics.
- Read with: [Authority Stack and Internal Hierarchy](core_05_band_integrative.md#owner-non-relocation) and the [Preamble — constitutional owner register](core_00_preamble.md#4-principles-definitions-and-rights); [archive/ARCHITECTURE_PRIMER_ARCHIVED_2026-05-08.md](archive/ARCHITECTURE_PRIMER_ARCHIVED_2026-05-08.md) on change-path and incorporation; [Chapter Sixteen](core_16_amendment_ratification.md#chapter-sixteen-amendment-ratification-and-procedural-validity) for validity tests that do not duplicate slot-classification taxonomy.
...
<details>
<summary><strong><span style="color: #2563eb;">Reader guidance (non-operative): Chapter Fourteen layer routing index</span></strong></summary>
...
> - **numeric Contribution and Violation Axis slots** — the **Chapter Nine §7 unified scale**, with separate records and Violation slots controlled only by verified impact; and the corresponding **anti-constitutional-misconduct designation** for a qualifying Violation Axis slot 7, 8, or 9 — **Chapter Eleven** in [core_11_a_misconduct_designation.md](core_11_a_misconduct_designation.md#chapter-eleven-anti-constitutional-misconduct);
> - **forum-operational workflow and adjudicative procedure** — **Chapter Twelve** and [corpus_forum.md](corpus_forum.md);
> - **procedural and custody validity** for amendment, ratification, and adoption — **Chapter Sixteen** in [`core_16_amendment_ratification.md`](core_16_amendment_ratification.md#chapter-sixteen-amendment-ratification-and-procedural-validity); and
...
>
> Owner layers must not be read as relocating constitutional validity standards out of **Chapters Fourteen and Fifteen**, Contribution Axis / Violation Axis measurement authority out of the **Chapter Nine §7 unified scale**, or anti-constitutional-misconduct designation authority out of **Chapter Eleven**. Chapter Eleven does not assign the numeric slot. For a non-operative architecture walkthrough, see [archive/ARCHITECTURE_PRIMER_ARCHIVED_2026-05-08.md](archive/ARCHITECTURE_PRIMER_ARCHIVED_2026-05-08.md).

</details>

---

**Previous file:** [core_13_governance.md](core_13_governance.md)

**Next file:** [core_15_expansion_supremacy.md](core_15_expansion_supremacy.md)
