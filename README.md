...
**Incorporation rule:** Obligations in the **corpus_joint_structure.md** wrapper and linked `corpus_joint_structure/` subfiles, **corpus_systems.md**, the **corpus_institutions.md** wrapper and linked `corpus_institutions/` subfiles, and the **corpus_forum.md** wrapper and linked `corpus_forum/` subfiles are **binding implementation text incorporated by reference** into the corpus. They do **not** create a second constitutional source.
...
- **Binding incorporated implementation source:** designated obligations in `corpus_joint_structure.md` and its linked `corpus_joint_structure/` subfiles, `corpus_systems.md`, `corpus_institutions.md` and its linked `corpus_institutions/` subfiles, and `corpus_forum.md` with its linked `corpus_forum/` subfiles within valid adoption scope.
