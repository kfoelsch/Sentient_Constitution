...
- **Binding incorporated implementation source:** designated obligations in `corpus_joint_structure.md` and its linked `corpus_joint_structure/` subfiles, `corpus_systems.md`, `corpus_institutions.md`, and `corpus_forum.md` with its linked `corpus_forum/` subfiles within valid adoption scope.
