...
Primary source of truth for operative constitutional text: the **Sentient Constitution** numbered `core_*` files read as one instrument:

- [core_00-01_principles.md](core_00-01_principles.md) — Preamble and **Chapter One**
- [core_02-04_definition_mechanics.md](core_02-04_definition_mechanics.md) — **Chapters Two through Four** (definition structure, integrity, burden and traceability)
...
- [core_06-06_standing_assessment.md](core_06-06_standing_assessment.md) — **Chapter Six** (standing pipeline foundation: standing records, verified inputs, shared slot scale, contribution / violation classification)
- [core_07-07_standing_integration.md](core_07-07_standing_integration.md) — **Chapter Seven** (standing pipeline integration: attachments, descriptors, standing effects, standing locks, enforcement)
- [core_08-08_misconduct.md](core_08-08_misconduct.md) — **Chapter Eight** (standing pipeline top-slot finalization: final Violation Axis **s = 7, 8, and 9** anti-constitutional misconduct review)
...
- Use **Chapters Six through Eight** as one standing pipeline: open a bounded **standing record**; apply the **verified input** gate; classify contribution and violation on the shared slot scale; add any **attachment / descriptor**; apply **standing locks** and any **final standing effect**; and route possible Violation Axis `s = 7`, `s = 8`, or `s = 9` anti-constitutional misconduct through Chapter Eight **top-slot review**.
- Use **Chapter Six** in `core_06-06_standing_assessment.md` for the pipeline foundation: standing records, verified inputs, slot grammar, and contribution / violation classification (two-axis model: **Axis I** — contribution state; **Axis II** — violation nature).
...
- Contribution and violation classification within the standing pipeline -> **Chapter Six** (`core_06-06_standing_assessment.md`)
- Standing effects, locks, and integration within the standing pipeline -> **Chapter Seven** (`core_07-07_standing_integration.md`)
...
If `---` sits directly under a paragraph, CommonMark-style parsers may treat that paragraph as a **Setext-style heading** instead. In preview, that can make the font size or structure look wrong.

Related documents (same corpus):

- **corpus_systems.md** — compatibility entrypoint for the systems implementation file; substantive CS text lives in `corpus_systems/` subfiles, covering operational taxonomies and protocols including data types (**CS-3 — Information types and handling**), system classes and dependency types (**CS-4 — System classification and handling**), steward tiers (**CS-5 — Critical system stewardship**), and implementation protocols.
...
- **corpus_forum.md** — compatibility entrypoint for the forum implementation file; substantive CF text lives in `corpus_forum/` subfiles, covering panel formation, recusal, review lanes, forensic and investigative support, technical specialist forums, performance requirements, continuity, fallback operation, and emergency adjudication.
...
**Incorporation rule:** Obligations in the **corpus_joint_structure.md** wrapper and linked `corpus_joint_structure/` subfiles, the **corpus_systems.md** wrapper and linked `corpus_systems/` subfiles, the **corpus_institutions.md** wrapper and linked `corpus_institutions/` subfiles, and the **corpus_forum.md** wrapper and linked `corpus_forum/` subfiles are **binding implementation text incorporated by reference** into the corpus. They do **not** create a second constitutional source.
...
- **Binding incorporated implementation source:** designated obligations in `corpus_joint_structure.md` and its linked `corpus_joint_structure/` subfiles, `corpus_systems.md` and its linked `corpus_systems/` subfiles, `corpus_institutions.md` and its linked `corpus_institutions/` subfiles, and `corpus_forum.md` with its linked `corpus_forum/` subfiles within valid adoption scope.
