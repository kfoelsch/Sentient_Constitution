...
- **corpus_systems.md** — compatibility entrypoint for the systems implementation file; substantive CS text lives in `corpus_systems/` subfiles, covering operational taxonomies and protocols including data types (**Chapter S1**), system classes and dependency types (**Chapter S2**), steward tiers (**Chapter S3**), and implementation protocols.
