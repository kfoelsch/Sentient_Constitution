...
**Segregation of duties.** This applies [Chapter One §10.1 *Segregation of duties*](core_01_c_stewardship_capacity_principles.md#101-segregation-of-duties) to standing records. Four duties touch every standing record, and each is a separate seat on the same record:
...
- the relying body's records office holds custody; for small scope, verify and enter-and-hold may sit in that one office under a disclosed safeguard, and it never sits with a claimant;
