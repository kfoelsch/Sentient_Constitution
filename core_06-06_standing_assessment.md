...
- where the violation finding involves a forum disclosure omission or intentional recusal-process failure, the verified basis for the omission or failure, the disclosure or recusal duty breached, the actor's knowledge, recklessness, or intent where found, and whether the conduct materially affected panel lawfulness, independence, recusal challenge, evidence integrity, remedy timing, backup routing, or practical contestability;
