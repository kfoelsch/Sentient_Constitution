...
- Chapter Six files: [Classification](core_06-06_standing_assessment.md#chapter-six-compliance-violation-and-standing-model) (*sections **1–3***); [Integration](core_06-06_standing_integration.md#chapter-six-standing-effects-and-integration) (*sections **4–10***).
...
- Downstream: [§3.0](#30-slot-grammar-and-display-labels) (*slot grammar and display labels*); [§3.1](#3-primary-category-defaults-and-lequ-slot-baseline) (*primary category defaults, LEQU baseline, and Contribution Axis primary bands*); [§3.3](#4-axis-ii-violation-nature-legal-constitutional-type) (*Violation Axis non-compliance ladder*); [§4](core_06-06_standing_integration.md#5-standing-effects) (*standing effects*); [§7](core_06-06_standing_integration.md#8-cross-axis-coupling-and-escalation-constraints) (*joint assessment*).
...
2. place any positive constitutional benefit on the **Contribution Axis** under **section 3.1**, including the applicable band and slot `s` where assigned;
...
For record separation and the rule that shared slot numbers do not create a net score, blended score, or tradeoff between axes, see **section 2.4** and the Standing Record requirements in **section 2.5**.

<a id="214-table-2-primary-category-defaults"></a>
<a id="3-primary-category-defaults-and-lequ-slot-baseline"></a>

#### 3.1 How the Nine Slots Map to Real-World Contributions and Violations
...
Column 1 uses the same `s` as **Table 1**. Read each row with **section 3.0** and **Table 1**, with **sections 2.1** and **2.5** for Standing Record requirements, and with this section and **section 3.3** in full for the authoritative category rules.
...
- Upstream: [§2](#2-standing-records-and-verified-inputs) (*standing records and verified-input rule*); [§3.0](#30-slot-grammar-and-display-labels) (*slot grammar and display labels*); [§3.1](#3-axis-i-contribution-state-and-standing-effect) (*primary category defaults, LEQU slot baseline, and contribution state on the **Contribution Axis***); [§6.3](core_06-06_standing_integration.md#73-stackable-harm-and-conduct-descriptors-violation-nature-supplement) (*Violation Axis supplements*).
- Downstream: [§5](core_06-06_standing_integration.md#6-extended-axis-ii-legal-hybrid-duty-and-harm-descriptors) (*process / response character, hybrid, and duty material*); [§7](core_06-06_standing_integration.md#8-cross-axis-coupling-and-escalation-constraints) (*standing integration and no-netting mechanics*); [Chapter Seven](core_07-07_misconduct.md#chapter-seven-anti-constitutional-misconduct) (*final Violation Axis **s = 7, 8, or 9** anti-constitutional misconduct assignment*).
...
| 7 | <a id="47-critical-non-compliance"></a><a id="44-critical-non-compliance"></a>**Serious anti-constitutional misconduct** where Chapter Seven so assigns / **Critical Non-Compliance** | **At least one LEQU destroyed** or comparable critical harm: catastrophic, existential, irreversible, Rights-Floor-defeating, constitution-undermining, large-scale systemic, severe persistent trauma with durable agency impairment, or material violation of non-negotiable floors including Safety, Truth, and dignity-equality protections. Immediate containment and heightened oversight apply. |
| 8 | **Grave anti-constitutional misconduct** | **Multiple LEQUs lost**, structural or cross-institutional constitutional damage, or a final Chapter Seven finding establishing **s = 8** grave anti-constitutional misconduct. |
| 9 | **Pernicious anti-constitutional misconduct** | **Worst-case systemic harm**: rare, intentional, systemic, intergenerational, civilizational, constitution-subverting harm at the widest material scope, or a final Chapter Seven finding establishing **s = 9** pernicious anti-constitutional misconduct. |
