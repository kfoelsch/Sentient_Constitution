...
| 6 | **Remedy**: contract reform, exit without penalty, driver stabilization fund, safety patch deployment, ecological remediation plan — look-through accountability on functional control ([Chapter Nine §8.4](core_09-09_standing_integration.md#84-anti-evasion-and-look-through-authority)). |
...
| Q3 integration | [Chapter Nine §8.5](core_09-09_standing_integration.md#85-timely-implementation-and-reassessment) — **Remedy commencement / pipeline delay** |
