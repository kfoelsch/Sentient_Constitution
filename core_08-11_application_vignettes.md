...
| 5 | **Question 2 — how bad was it?** ([Chapter Eight §7 unified scale](core_08_standing_assessment.md#7-unified-proportional-lequ-scale)): verified impact on the children controls the Violation Axis slot; likely `s` = 4–5 pending LEQU calibration. **Interpersonal / Care Duty Misconduct** and **Negligent Misconduct** remain character descriptors and do not move the slot. |
