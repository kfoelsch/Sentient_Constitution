...
- **Delegated binding bodies and hybrid composition (non-forum institutions)** — Start: [CI-9.3 — Delegated subunits, institutional design class, and attachment discipline](../../corpus_institutions/ci_09_classification_linked_institutional_obligations.md). Also read: **CJS-4.1**, **CJS-4.5**, **CJS-5.13**, **CI-3**, ….
- **Institutional functional lanes and non-delegable splits** — Start: [CI-3 — Institutional design, separation of powers, and authority custody](../../corpus_institutions/ci_03_institutional_design_separation_of_powers.md). Also read: **CJS-5.11**.
- **Contest-integrity monitoring (pathway integrity, not merits)** — Start: [CI-7.3 — Contest-integrity monitoring (Class A and Class B)](../../corpus_institutions/ci_07_oversight_assurance_controls_evidence.md). Also read: **CF-4**, **CF-11**, **CJS-5.13**.
