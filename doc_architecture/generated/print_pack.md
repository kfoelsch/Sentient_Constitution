...
Coverage: **127** of **127** Article headings carry a gloss.
...
| Article II-C: Designed Obsolescence and Incentive Discipline | products must not be built or updated to wear out early, or to push you into buying a replacement you don't need. | [Source](../../core_06_rights_part_a.md#article-ii-c-designed-obsolescence-and-incentive-discipline) |
...
| Article II-E: Data Handling and Network Dependency | any product that collects data about you must tell you what it collects, why, and how to delete it — and must delete it when you ask, except where records must be kept to protect others or hold someone accountable. When a product needs the operator's servers to work, the operator must say so up front and must not trap your data. | [Source](../../core_06_rights_part_a.md#article-ii-e-info-sphere-dependency-continuity-and-operator-non-viability) |
| Article II-F: Continuity and Operator Shutdown | the operator must plan for service shutdown, give fair notice and time to move when it happens, and cannot let bankruptcy or a sale erase those duties. | [Source](../../core_06_rights_part_a.md#article-ii-f-continuity-and-operator-shutdown) |
