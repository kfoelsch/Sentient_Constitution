...
Generated: 2026-08-15T06:42:38+00:00
...
| Bodily-Maintenance Access | approved | primary_secondary | cluster_member | `core_05_band_continuity.md` | yes | pass |
...
| Harm | approved | primary_secondary | measurement_family_member | `core_05_band_accountability.md` | yes | pass |
| Irreversible Deprivation Measure | approved | primary_only | cluster_member | `core_05_band_accountability.md` | yes | pass |
| Irreversible Harm | approved | primary_secondary | cluster_member | `core_05_band_accountability.md` | yes | pass |
| Leisure and Rest | approved | primary_only | cluster_member | `core_05_band_continuity.md` | yes | pass |
| Likeness and Documentary Depiction Interface | approved | primary_only | cluster_member | `core_05_band_continuity.md` | yes | pass |
| Meaningful Agency | approved | full | constituent | `core_05_band_participation.md` | yes | pass |
| Occupancy Continuity | approved | primary_secondary | cluster_member | `core_05_band_continuity.md` | yes | pass |
| Psychological Harm | approved | primary_only | cluster_member | `core_05_band_accountability.md` | yes | pass |
...
| Wellbeing | approved | full | outcome_measure | `core_05_band_continuity.md` | yes | pass |
...
| Ecological Integrity | approved | primary_only | cluster_member | `core_05_band_continuity.md` | yes | pass |
| Ecological Recovery Capacity | approved | primary_only | cluster_member | `core_05_band_continuity.md` | yes | pass |
| Emergency and Contingency | approved | primary_only | cluster_member | `core_05_band_continuity.md` | yes | pass |
...
| Self-Healing | approved | primary_only | cluster_member | `core_05_band_continuity.md` | yes | pass |
| Shared-System Capacity | approved | primary_only | cluster_member | `core_05_band_continuity.md` | yes | pass |
| Short-Horizon Governance Defect | approved | primary_only | cluster_member | `core_05_band_continuity.md` | yes | pass |
| Stakeholder Emergency and Contingency | approved | primary_only | cluster_member | `core_05_band_continuity.md` | yes | pass |
| Stewardship | approved | primary_only | cluster_member | `core_05_band_continuity.md` | yes | pass |
| Stewardship Defect | approved | primary_only | cluster_member | `core_05_band_continuity.md` | yes | pass |
| Strategic Stewardship Obligation | approved | primary_only | cluster_member | `core_05_band_continuity.md` | yes | pass |
| Sustainability | approved | primary_secondary | cluster_member | `core_05_band_continuity.md` | yes | pass |
| System | approved | primary_only | cluster_member | `core_05_band_continuity.md` | yes | pass |
| System Alignment Certification | approved | primary_only | cluster_member | `core_05_band_continuity.md` | yes | pass |
| System Boundaries | approved | primary_only | cluster_member | `core_05_band_continuity.md` | yes | pass |
...
| Voluntary Discontinuation | approved | primary_only | cluster_member | `core_05_band_continuity.md` | yes | pass |

## 3.4 Participation

| Term | Status | Tier depth | Aim role | File | Has measurements | Audit |
| --- | --- | --- | --- | --- | --- | --- |
| Accessibility | approved | primary_secondary | independent | `core_05_band_participation.md` | yes | pass |
| Animal Life | approved | primary_only | cluster_member | `core_05_band_participation.md` | yes | pass |
| Assembly | approved | primary_only | cluster_member | `core_05_band_participation.md` | yes | pass |
| Best-Interest Standard | approved | primary_only | cluster_member | `core_05_band_participation.md` | yes | pass |
| Binding Stakeholder Choice — Decision-Resolution Requirements | approved | primary_only | cluster_member | `core_05_band_participation.md` | yes | pass |
| Business Creation | approved | primary_only | cluster_member | `core_05_band_participation.md` | yes | pass |
| Coercion and Manipulation | approved | primary_only | cluster_member | `core_05_band_participation.md` | yes | pass |
| Collective Organization | approved | primary_only | cluster_member | `core_05_band_participation.md` | yes | pass |
| Consent | approved | primary_only | cluster_member | `core_05_band_participation.md` | yes | pass |
...
| Movement and Relocation | approved | primary_only | cluster_member | `core_05_band_participation.md` | yes | pass |
| Natural Systems Standing | approved | primary_only | cluster_member | `core_05_band_participation.md` | yes | pass |
| Non-Imposition (Cooperative Interaction) | approved | primary_only | cluster_member | `core_05_band_participation.md` | yes | pass |
...
| Classification-Scaled Governance | approved | primary_only | cluster_member | `core_05_band_oversight.md` | yes | pass |
| Corpus | approved | primary_only | cluster_member | `core_05_band_integrative.md` | yes | pass |
...
| Material Impact | approved | primary_secondary | cluster_member | `core_05_band_oversight.md` | yes | pass |
...
| Security-Sensitive Disclosure Balance | approved | primary_only | cluster_member | `core_05_band_oversight.md` | yes | pass |
| Transparency | approved | full | cluster_member | `core_05_band_oversight.md` | yes | pass |
| Trust | approved | primary_only | cluster_member | `core_05_band_continuity.md` | yes | pass |
...
| Forum Case Record | approved | primary_only | cluster_member | `core_05_band_accountability.md` | yes | pass |
| Forum Family, Constitutional | approved | primary_only | cluster_member | `core_05_band_accountability.md` | yes | pass |
| Forum Family, Environment | approved | primary_only | cluster_member | `core_05_band_accountability.md` | yes | pass |
| Forum Family, Institutional | approved | primary_only | cluster_member | `core_05_band_accountability.md` | yes | pass |
| Forum Family, Integrity | approved | primary_only | cluster_member | `core_05_band_accountability.md` | yes | pass |
...
| Term | Status | Tier depth | Aim role | File | Has measurements | Audit |
| --- | --- | --- | --- | --- | --- | --- |
| Avoidable Burden | approved | full | cluster_member | `core_05_band_continuity.md` | yes | pass |
| Burden-Reduction Duty | approved | primary_secondary | cluster_member | `core_05_band_continuity.md` | yes | pass |
| Constitutional Efficiency | approved | full | measurement_family_member | `core_05_band_continuity.md` | yes | pass |
| Productive Capacity | approved | full | cluster_member | `core_05_band_continuity.md` | yes | pass |
