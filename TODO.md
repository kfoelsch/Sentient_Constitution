...
- **Follow-through still open:** CS-4 §10 and CI-27 / CF-11 companion text should be checked against the new core rules (companions satisfy, do not narrow); CJS-0.1 topic-router rows for remedy parity and capacity failure; CF-4 panel-formation text for the independent-representative appointment path; apply-test vignette 6 with a human and an AI steward.
...
- [ ] **I4 — Sentience adjudication operational pieces.** (a) ~~Representation/guardian rule; parent-system sole-filer/sole-witness bar~~ — landed in core 2026-09-09 (Article V-E; Chapter Eleven §5). (b) Sentience-Status Adjudication Record schema — a record format already exists ([corpus_forum/cf_sentience_status_record.md](corpus_forum/cf_sentience_status_record.md), `implementation/schemas/sentience_status_adjudication_record.schema.json`); **remaining:** add representative-appointment and intake-decline fields to match the two new Chapter Eleven §5 minimum implementation fields. (c) ~~Collision vignette~~ — landed as vignette 6.
