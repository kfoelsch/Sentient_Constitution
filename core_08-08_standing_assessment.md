...
When [material stake](core_00_preamble.md#material-stake) requires auditable standing, Chapters Eight through Ten form one continuous **standing pipeline** under the [Constitutional Tetrad](core_00_preamble.md#constitutional-tetrad) and [Two Constitutional Aims](core_00_preamble.md#two-constitutional-aims) — not reputation, allegations, or informal scoring. **Standing measurement** here classifies verified contribution and violation records on separate axes. **Constitutional measurement** ([Chapter Zero §2–§3](core_00_preamble.md#measurements-overview)) names the categories and families that evidence must address before records enter the standing pipeline ([Chapter Zero §4.1 Using Measurements in Governance](core_00_preamble.md#from-measurement-to-evidence-and-remedy)). [Chapter Eleven](core_11-11_forum.md#chapter-eleven-forums-and-jurisdiction) **supervises** how disputes move through that pipeline; it does **not** classify standing records under Chapter Eight or form a parallel adjudication track.
