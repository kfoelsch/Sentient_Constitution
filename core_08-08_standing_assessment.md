...
> | **Sections** | [§1](#2-purpose-and-role) purpose and two-question frame · [§3](#2-standing-records) records and gate · [§11](#6-classification-evaluation-dimensions) Question 1 evaluation dimensions · [§§4–6](#3-slot-grammar-and-display-labels) slot grammar, LEQU baseline, and primary axis defaults |
...
> | --- | --- | --- | --- |
> | [§3](#2-standing-records) | **Record layer** — axis-pure standing records, verified-input gate, no-offset bridge, forum boundary | **Participation**; **Oversight** (contestability and forum boundary) | **Flourishing** + **Continuity** (traceable, durable records) |
> | [§11](#6-classification-evaluation-dimensions) | **Classification layer** — evaluation dimensions (Question 1 on both axes) | **Oversight** | **Flourishing** + **Accountability** |
> | [§2](#3-slot-grammar-and-display-labels) | **Classification layer** — slot grammar (**Table 1**) | **Oversight** (display discipline) | **Flourishing** |
> | [§4](#32-constitutional-outcome-baseline-for-slots) | **Calibration layer** — LEQU baseline ([Chapter One §8.1](#41-lequ-contribution-calibration) contribution · [Chapter One §6.2](#42-lequ-violation-calibration) violation) | **Oversight** (verified calibration discipline) | **Flourishing** + **Accountability** |
> | [§5](#33-primary-category-defaults-and-lequ-slot-baseline) | **Classification layer** — primary defaults ([§11.1](#51-contribution-axis-bands-and-table-2) Contribution Axis · [§11.2](#52-violation-axis-severity-ladder) Violation Axis · [§11.3](#53-forum-disclosure-and-recusal-process-impact) forum disclosure and recusal) | **Oversight** + **Accountability** | **Flourishing** + **Accountability** |
>
> **How §2 and §§3–6 relate:** [§3](#2-standing-records) states *what may be recorded* and *how linked contribution and violation records stay separate* under the [Constitutional Tetrad](core_00_preamble.md#constitutional-tetrad) and [Two Constitutional Aims](core_00_preamble.md#two-constitutional-aims). [§11](#6-classification-evaluation-dimensions) states *what inputs to evaluate* for Question 1 inside each axis-pure record. [§§4–6](#3-slot-grammar-and-display-labels) state *how verified standing records map to axis categories* — Flourishing-side contribution under **[Chapter One §8.1](#41-lequ-contribution-calibration)** and **[§11.1](#51-contribution-axis-bands-and-table-2)**, Accountability-side violation under **[Chapter One §6.2](#42-lequ-violation-calibration)** and **[§11.2](#52-violation-axis-severity-ladder)**, with forum-integrity modifiers under **[§11.3](#53-forum-disclosure-and-recusal-process-impact)** where disclosure or recusal conduct is verified. Section 2 must be satisfied before sections 3–6 categories bind; sections 3–6 do not merge axes, substitute for section 2 record discipline, or apply standing effects. Integration begins in [Chapter Nine](core_09-09_standing_integration.md#chapter-nine-standing-effects-and-integration).
...
- Standing pipeline: [Chapters Eight–Eleven constitutional compass](#chapters-eight-eleven-constitutional-compass); [Chapter Eight — Classification](core_08-08_standing_assessment.md#chapter-eight-compliance-violation-and-standing-model) (*record, verification, and classification — sections **1–6***); [Chapter Nine — Standing Effects and Integration](core_09-09_standing_integration.md#chapter-nine-standing-effects-and-integration) (*attachments, descriptors, standing locks, standing effects, and enforcement — sections **1–6***); [Chapter Ten](core_10-10_misconduct.md#chapter-ten-anti-constitutional-misconduct) (*top-slot review and final Violation Axis `s = 7`, `s = 8`, and `s = 9` anti-constitutional misconduct assignment*).
- Subsections in this file: [§1](#2-purpose-and-role) (*purpose and two-question frame*); [§3](#2-standing-records) (*§Chapter One §8.1–2.3 — standing records, no-offset bridge, and operational requirements*); [§11](#6-classification-evaluation-dimensions) (*Question 1 evaluation dimensions*); [§§4–6](#3-slot-grammar-and-display-labels) (*slot grammar, LEQU baseline, and primary axis defaults*). **Tetrad / Aims map for §2 and §§3–6:** reader guidance under [Chapter Eight classification](#chapter-eight-compliance-violation-and-standing-model). Continued in [Chapter Nine — Standing Effects and Integration](core_09-09_standing_integration.md#chapter-nine-standing-effects-and-integration): [§1](core_09-09_standing_integration.md#5-standing-effects) through [§5](core_09-09_standing_integration.md#9-violation-axis-s-7-9-anti-constitutional-misconduct-authoritative-location).
...
| **[Ch 11 — Supervise](core_11-11_forum.md#chapter-eleven-forums-and-jurisdiction)** | Supervise dispute handling — routing, merits review, remediation sequencing, interim relief — so the pipeline moves lawfully **without substituting forum process for Chapter Eight standing-record classification** | **Participation** + **Oversight** + **Timeliness** ([Article XXIV-C](core_06-06_rights_part_d.md#article-xxiv-c-timely-resolution-and-anti-delay-floor) (*Timely Resolution and Anti-Delay Floor*); [§15](core_11-11_forum.md#10-timely-resolution-materiality-tiers-and-anti-delay-discipline)) | **Accountability** (verified findings feed the pipeline) |
...
**Forum supervision (Chapter Eleven).** Forum families **supervise** how concrete disputes traverse the standing pipeline above. They supply accessible challenge, independent review, forensic support, coordinated sequencing, and tier-default clocks — and they produce **verified findings** that may open or update standing records under [Chapter Eight §2](core_08-08_standing_assessment.md#2-standing-records). They do **not** hear disputes as a separate adjudication layer, merge axes, or substitute dispute narratives for standing classification ([Chapter Eight §2.3.7](core_08-08_standing_assessment.md#237-forum-boundary)). Illustrative domain walkthroughs: [Chapters Eight–Eleven application vignettes](core_08-11_application_vignettes.md#chapters-eight-eleven-application-vignettes).
...
>
> 1. **[§3](#2-standing-records)** — open axis-pure standing records and satisfy the verified-input gate.
> 2. **[§11](#6-classification-evaluation-dimensions)** — apply Question 1 evaluation dimensions inside each record.
> 3. **[§2](#3-slot-grammar-and-display-labels)** — name slots with **Table 1** display labels.
> 4. **[§4](#32-constitutional-outcome-baseline-for-slots)** — calibrate magnitude in LEQU.
> 5. **[§5](#33-primary-category-defaults-and-lequ-slot-baseline)** — assign operative Contribution Axis and Violation Axis categories.
>
...
- Tetrad leg(s): **participation**; **oversight** (contestability, challenge paths, forum boundary at **Chapter One §8.3.7**). Primary aim(s): **Flourishing** and **Continuity** (traceable records that preserve axis separation for later measurement). [material stake](core_00_preamble.md#material-stake) scaling applies where record scope is material.
- Downstream: [Chapter One §8.2](#22-linked-records-and-no-offset-bridge) (*linked-record no-offset bridge*); [§14.3.2](#232-minimum-record-contents) (*verified-input gate*); [Chapter One §8.3.7](#237-forum-boundary) (*forum boundary*); [§11](#6-classification-evaluation-dimensions) (*Question 1 evaluation dimensions*); [§§4–6](#3-slot-grammar-and-display-labels) (*slot grammar, LEQU baseline, and axis classification — contribution at **§Chapter One §8.1 and 6.1**, violation at **§Chapter One §6.2 and 6.2***); [Chapter Nine §1](core_09-09_standing_integration.md#5-standing-effects) (*standing effects*); [Chapter Nine §4](core_09-09_standing_integration.md#8-cross-axis-coupling-and-escalation-constraints) (*joint assessment*).
...
- A **contribution standing record** classifies verified **contribution state** under **section 6.1**.
- A **violation standing record** classifies verified **violation nature** under **section 6.2** and applicable attachments.
...
The same subject may hold multiple standing records over time, including linked contribution and violation standing records. Related records must **cross-reference** one another under **section 2.3.1** where they share subject, overlapping time window, bounded event, pattern, or decision context.

A standing record is not a freestanding reputation score, dignity rank, permanent status, general worth label, or merged scorecard. Operational requirements appear in **sections 2.3.1** through **2.3.7**.
...
- Downstream: [§14.3.1](#231-related-record-cross-references) (*related-record cross-references*); [§14.3.2](#232-minimum-record-contents) (*verified-input gate*); [Chapter One §8.3.7](#237-forum-boundary) (*forum boundary*); [§11](#6-classification-evaluation-dimensions) (*Question 1 evaluation dimensions*); [§2](#31-slot-grammar-and-display-labels) (*slot grammar and display labels*); [§4](#32-constitutional-outcome-baseline-for-slots) (*LEQU baseline*); [§11.1](#51-contribution-axis-bands-and-table-2) (*Contribution Axis primary category defaults*); [§11.2](#52-violation-axis-severity-ladder) (*Violation Axis severity ladder*).
...
**The only exception:** If a violation finding itself disproves a claimed contribution — for example, if evidence shows you didn't actually do what your contribution record claims — then the linked contribution standing record can be corrected or removed through the proper evidence and review process, with the required cross-reference under **section 2.3.1**. But the violation does not automatically erase unrelated good work recorded in separate contribution standing records.
...
<a id="231-related-record-cross-references"></a>

##### 2.3.1 Related record cross-references
...
<a id="232-minimum-record-contents"></a>

##### 2.3.2 Minimum record contents
...
- any related standing records cross-referenced as required under **section 2.3.1**;
...
<a id="235-implementation-visibility"></a>

##### 2.3.5 Implementation visibility

None of the following may be buried in a single opaque score or hidden label. Each must stay clear enough that someone can later check what changed and why:

- plain-language category names;
- which slot (`s`) applies;
- keeping contribution and violations on separate tracks;
- the reasoning that connects the facts to the chosen slot;
- where the evidence came from;
- how to challenge the record;
- whether the information is still current; and
- the assumptions used to calibrate impact.

<a id="236-implementation-tools"></a>

##### 2.3.6 Implementation tools

Teams may build practical tools for standing records — data fields, tags, thresholds, forms, dashboards, and review steps. Those tools must follow **section 2.3.5**, not water it down.

<a id="237-forum-boundary"></a>

##### 2.3.7 Forum boundary
...
Forum families under [Chapter Eleven](core_11-11_forum.md#chapter-eleven-forums-and-jurisdiction) **supervise** how concrete disputes traverse the standing pipeline. They supply accessible challenge, independent review, forensic support, remediation sequencing, and tier-default clocks under [Chapter Eleven §10](core_11-11_forum.md#10-timely-resolution-materiality-tiers-and-anti-delay-discipline) and [Article XXIV-C](core_06-06_rights_part_d.md#article-xxiv-c-timely-resolution-and-anti-delay-floor) (*Timely Resolution and Anti-Delay Floor*), and they may produce **verified findings** that open or update standing records under **section 2.3.2** when those findings satisfy the verified-input gate under Chapters Two through Four.
...
### 3. Classification evaluation dimensions — Question 1 (how good / how bad?)
<details>
<summary><strong><span style="color: #2563eb;">Trace</span></strong></summary>
...
- Downstream: [§§4–6](#3-slot-grammar-and-display-labels) (*slot grammar, LEQU calibration, and primary axis defaults — **[Chapter One §8.1](#41-lequ-contribution-calibration)** / **[§11.1](#51-contribution-axis-bands-and-table-2)** contribution · **[Chapter One §6.2](#42-lequ-violation-calibration)** / **[§11.2](#52-violation-axis-severity-ladder)** violation · **[§11.3](#53-forum-disclosure-and-recusal-process-impact)** forum integrity*); [Chapter Nine Chapter One §8.10](core_09-09_standing_integration.md#210-safe-delegation-competency-gate-dimensions) (*contribution Question 2 — safe delegation*); [Chapter Nine Chapter One §8.10](core_09-09_standing_integration.md#310-non-recurrence-lock-dimensions) (*violation Question 2 — non-recurrence*); [Chapter Nine Chapter One §8.1](core_09-09_standing_integration.md#71-shared-domain-lenses-cross-axis-vocabulary) (*benefit- and harm-route descriptor catalog*).
- Read with: [§14.3.2](#232-minimum-record-contents) (*standing records classify only — no standing effects in Chapter Eight*).
...
| **Forum-integrity injury** | — | [§11.3](#53-forum-disclosure-and-recusal-process-impact) classification modifier |
...
**Q1 outputs recorded:** stacked **Ecological Stewardship** and **Diligence** benefit-route descriptors; LEQU and scope inputs ready for **[section 5.1](#41-lequ-contribution-calibration)** calibration and **[section 6.1](#51-contribution-axis-bands-and-table-2)** band assignment. No standing effects apply in Chapter Eight.
...
### 4. Slot grammar and display labels

<a id="31-slot-grammar-and-display-labels"></a>

<a id="311-what-the-slot-grammar-does"></a>

#### 4.1 What the slot grammar does
...
- **Not an accusation metric.** Allegations, intake tags, routing decisions, reputation, disfavored status, or moral dislike do not supply Contribution Axis benefit or Violation Axis severity without verified inputs under **sections 2.3.2**, **6.1**, and **6.2**.
...
*In plain terms: This section translates the abstract nine-slot scale into operative categories on each axis — contribution under **§11.1**, violation under **§11.2**, and forum-integrity modifiers under **§11.3** — using the LEQU calibration in **section 5**. Read **§11.1** and **§11.2** side by side for the parallel axes, not as a merged score; read **§11.3** when verified disclosure or recusal conduct is in play.*
...
Column 1 uses the same `s` as **Table 1**. Read each row with **section 4**, **Table 1**, **section 5.1**, and **sections 2.1** and **2.2** for Standing Record requirements. For the Violation Axis display label paired with each `s`, see **Table 1** column 3 and **section 6.2**.
...
*In plain terms: **Violation nature** is the adverse side of the model. To decide which slot a verified violation belongs in, apply **section 5.2** LEQU calibration on the loss side — roughly, whether conduct impaired, destroyed, wrongfully consumed, or foreclosed constitutional wellbeing. Accusations and routing labels do not count; only verified findings do.*

The slot scale measures verified constitutional loss, harm, waste, foreclosure, or danger, not disfavored status, allegation, retaliation preference, or moral dislike alone. **Violation nature** includes Violation Axis severity under this subsection, process / response character under **Chapter Nine section 3**, and hybrid, duty, diffusion, negligence, and descriptor material where facts warrant. Apply the **full-life-equivalent constitutional loss** definition and **Important limits on using LEQU** in **section 5** to all violation-side calibration.
...
|    5 | <a id="45-aggravated-violation"></a>**Aggravated Violation** | Formal, remedial substantive, significant substantive, or duty-based violation with worsening features such as evasion, concealment, strategic obstruction of audit, dishonest forum disclosure omission, intentional recusal-process failure, repetition after notice, reckless disregard, exploitative incentive design, structural enablement, or material dependency-asymmetry abuse. For forum disclosure omission and recusal-process impact, read **§11.3**. |
...
<a id="53-forum-disclosure-and-recusal-process-impact"></a>
