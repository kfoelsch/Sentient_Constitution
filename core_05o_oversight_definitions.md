...
- E:
  - **Primary assessment.** Include all effect types, including [Systemic Materiality](core_05a_accountability_definitions.md#systemic-materiality), and justify conclusions under full functional system scope.
  ...
  - **Tertiary integrity check.** Where operators rely on boundaries, proxies, or informal low classification, apply [Materiality Integrity Constraint](core_05o_oversight_definitions.md#materiality-integrity-constraint) and [Proxy Divergence](core_05o_oversight_definitions.md#proxy-divergence) — distinguish durable materiality analysis from structural manipulation or indicator gaming.
<a id="materiality-determination-c"></a>
- C:
  - A determination satisfies **Materiality Determination** only if classification is documented, [Auditable](core_05o_oversight_definitions.md#auditability), and traceable to constitutionally material effects.
  ...
  - **Tertiary failure.** Non-compliant: determinations resting on manipulated boundaries or proxy satisfaction where [Materiality Integrity Constraint](core_05o_oversight_definitions.md#materiality-integrity-constraint) or [Proxy Divergence](core_05o_oversight_definitions.md#proxy-divergence) is reasonably observable.
...
*Measurements (family routing):* [Chapter Zero §3.5 *Measuring Oversight* / Truth and epistemic integrity](../core_00_preamble.md#measuring-oversight) — operative tiers on [Transparency](core_05o_oversight_definitions.md#transparency), [Auditability](core_05o_oversight_definitions.md#auditability), and [Verifiability](core_05o_oversight_definitions.md#verifiability) below; progress: [measurement rollout status](doc_architecture/generated/measurement_rollout_status.md).
...
**Previous file:** [core_05g_continuity_aim.md](core_05g_continuity_aim.md)
