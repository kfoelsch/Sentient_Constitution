...
LABEL_HINTS = {
    ...
    "CF-2": ["Forum Family, Constitutional", "Forum Family, Institutional", "Forum Family, Technical"],
    "CF-3": ["Procedural Fairness", "System Capture", "Accountability"],
    "CF-4": ["Adjudication and Dispute Resolution", "Accessibility", "Contestability"],
    "CF-5": ["Contestability", "Procedural Fairness", "Redress and Remediation"],
    "CF-6": ["System Capture", "Incentive Alignment", "Oversight"],
    "CF-7": ["Evidence Preservation", "Verifiability", "Auditability"],
    "CF-8": ["Oversight", "Evidence Preservation", "Accountability"],
