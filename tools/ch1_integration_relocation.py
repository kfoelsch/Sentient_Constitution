...
ANCHOR_MIGRATIONS: list[tuple[str, str]] = [
    ...
    ("#123-incentive-alignment-and-system-capture", "#123-incentive-alignment-and-system-capture"),
    ("#1233-contingent-claims-games-of-chance-and-event-contract-markets", "#1233-contingent-claims-games-of-chance-and-event-contract-markets"),
    ("#1232-misalignment-correction-and-capture-response", "#1232-misalignment-correction-and-capture-response"),
    ("#1231-alignment-requirement", "#1231-alignment-requirement"),
    ...
    ("#73-incentive-alignment-and-system-capture", "#123-incentive-alignment-and-system-capture"),
    ("#731-alignment-requirement", "#1231-alignment-requirement"),
    ("#732-misalignment-correction-and-capture-response", "#1232-misalignment-correction-and-capture-response"),
    ("#733-contingent-claims-games-of-chance-and-event-contract-markets", "#1233-contingent-claims-games-of-chance-and-event-contract-markets"),
    ("#74-stewardship-and-operator-incentive-alignment", "#124-stewardship-and-operator-incentive-alignment"),
...
def migrate_section_refs(content: str) -> str:
    pairs = [
        ...
        ("Chapter One §12.4", "Chapter One §12.4"),
        ("Chapter One §12.3.3", "Chapter One §12.3.3"),
        ("Chapter One §12.3.2", "Chapter One §12.3.2"),
        ("Chapter One §12.3.1", "Chapter One §12.3.1"),
        ("Chapter One §12.3", "Chapter One §12.3"),
        ...
        ("Chapter One §7.4", "Chapter One §12.4"),
        ("Chapter One §7.3.3", "Chapter One §12.3.3"),
        ("Chapter One §7.3.2", "Chapter One §12.3.2"),
        ("Chapter One §7.3.1", "Chapter One §12.3.1"),
        ("Chapter One §7.3", "Chapter One §12.3"),
        ...
        ("§7.4 Stewardship", "§12.4 Stewardship"),
    ]
    cleaned = []
    seen: set[str] = set()
...
def apply_trace_repairs_part_a(text: str) -> str:
    repl = [
        ...
        (
            "[§7.4 Stewardship and Operator Incentive Alignment](core_01_b_stewardship_capacity_principles.md#124-stewardship-and-operator-incentive-alignment)",
            "[§12.4 Stewardship and Operator Incentive Alignment](core_01_b_stewardship_capacity_principles.md#124-stewardship-and-operator-incentive-alignment)",
        ),
        (
