...
def render_ci_primary_markdown(root: Path) -> str:
    ...
    lines = [
        ...
        "Auto-generated by `make architecture-index`. Do not edit by hand.",
        "",
        "Filter of [corpus_joint_structure/cjs_00_registry_and_reading_rules.md](../../corpus_joint_structure/cjs_00_registry_and_reading_rules.md) **CJS-2.1** rows whose **primary owner** is one or more **CI** sections. Authoritative router and mandatory read-with lists remain in **CJS-2.1**; audit: `make router-bidirectional-audit`.",
        "",
