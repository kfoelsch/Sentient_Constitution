...
def full_topic_router_payload(root: Path) -> dict:
    ...
    return {
        ...
        "source": "corpus_joint_structure/cjs_00_topic_router.md",
...
def render_ci_primary_markdown(root: Path) -> str:
    ...
    lines = [
        ...
        "Auto-generated by `make architecture-index`. Do not edit by hand.",
        "",
        "Filter of [corpus_joint_structure/cjs_00_topic_router.md](../../corpus_joint_structure/cjs_00_topic_router.md) **CJS-0.1** rows whose **primary owner** is one or more **CI** sections. Authoritative router and mandatory read-with lists remain in **CJS-0.1**; audit: `make router-bidirectional-audit`.",
        "",
