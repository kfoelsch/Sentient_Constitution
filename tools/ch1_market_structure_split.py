...
def split_part_b(text: str) -> str:
    ...
    market_block = market_block.replace("does not narrow Article III-D, Article IV, Article XIX, **§8.5**, or Chapter Eleven", "does not narrow Article III-D, Article IV, Article XIX, **§14.3**, or Chapter Eleven")
