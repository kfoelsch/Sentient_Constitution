#!/usr/bin/env python3
"""Restructure Chapter Nine: §4 LEQU both axes (4.1/4.2); §5 classification both axes (5.1/5.2); drop §6.
...
Adopted implementation may publish calibrated units, evidentiary methods, and examples for full-life-equivalent benefit or loss. Those materials must remain subordinate to this section, **sections 5.1 and 5.2**, **Table 2**, **Chapter One**, and the **Chapter Six** Rights Floor.
...
*In plain terms: This section translates the abstract nine-slot scale into operative categories on each axis — contribution under **Chapter One §8.1**, violation under **Chapter One §6.2** — using the LEQU calibration in **section 4**. The two subsections are parallel; read them side by side, not as a merged score.*
...
- Upstream: [§3](#2-standing-records) (*standing records, verified-input gate, and no-offset bridge*); [§11](#31-slot-grammar-and-display-labels) (*slot grammar and display labels*); [Chapter One §8.2](#42-lequ-violation-calibration) (*violation LEQU calibration*); [Chapter One §8.1](#51-contribution-axis-bands-and-table-2) (*Contribution Axis rules and **Table 2***); [Chapter Ten §3.9](core_10_standing_integration.md#73-stackable-harm-and-conduct-descriptors-violation-nature-supplement) (*Violation Axis supplements*).
- Downstream: [Chapter Ten §3](core_10_standing_integration.md#6-extended-axis-ii-legal-hybrid-duty-and-harm-descriptors) (*process / response character, hybrid, and duty material*); [Chapter Ten §4](core_10_standing_integration.md#8-cross-axis-coupling-and-escalation-constraints) (*standing integration and no-netting mechanics*); [Chapter Eleven](core_10-10_misconduct.md#chapter-eleven-anti-constitutional-misconduct) (*final Violation Axis **s = 7, 8, or 9** anti-constitutional misconduct assignment*).
...
- [Harm](core_05_band_accountability.md#harm) · [O](core_05_band_accountability.md#harm) · [E](core_05_band_accountability.md#harm-e) · [C](core_05_band_accountability.md#harm-c)
- [Materiality Determination](core_05_band_oversight.md#materiality-determination) · [O](core_05_band_oversight.md#materiality-determination) · [E](core_05_band_oversight.md#materiality-determination-e) · [C](core_05_band_oversight.md#materiality-determination-c)
- [Constitutional Constraint Violation](core_05_band_integrative.md#constitutional-constraint-violation) · [O](core_05_band_integrative.md#constitutional-constraint-violation) · [E](core_05_band_integrative.md#constitutional-constraint-violation-e) · [C](core_05_band_integrative.md#constitutional-constraint-violation-c)
- [Coercion and Manipulation](core_05_band_participation.md#coercion-and-manipulation-constitutional) · [O](core_05_band_participation.md#coercion-and-manipulation-constitutional) · [E](core_05_band_participation.md#coercion-and-manipulation-constitutional-e) · [C](core_05_band_participation.md#coercion-and-manipulation-constitutional-c)
- [Foreseeability Diligence](core_05_band_oversight.md#foreseeability-diligence) · [O](core_05_band_oversight.md#foreseeability-diligence) · [E](core_05_band_oversight.md#foreseeability-diligence-e) · [C](core_05_band_oversight.md#foreseeability-diligence-c)
...
The slot scale measures verified constitutional loss, harm, waste, foreclosure, or danger, not disfavored status, allegation, retaliation preference, or moral dislike alone. **Violation nature** includes Violation Axis severity under this subsection, process / response character under **Chapter Ten section 3**, and hybrid, duty, diffusion, negligence, and descriptor material where facts warrant. Apply the **full-life-equivalent constitutional loss** definition and **Important limits on using LEQU** in **section 4** to all violation-side calibration.
...
|    6 | <a id="46-coercive-or-safeguard-process-violation"></a>**Coercive or Safeguard-Process Violation** | Culpability, coercion, manipulation, violence, credible threat, liberty-threatening response, or comparable social danger serious enough to require criminal-process or equivalent constitutional protections where coercive or liberty-restricting response is in play. This severity may carry **Chapter Ten section 3.2** coercive or liberty-restricting safeguard character, but severity and process / response character remain separately traceable. |
| 7 | <a id="47-critical-non-compliance"></a>**Serious anti-constitutional misconduct** where Chapter Eleven so assigns / **Critical Non-Compliance** | **At least one LEQU destroyed** or comparable critical harm: catastrophic, existential, irreversible, Rights-Floor-defeating, constitution-undermining, large-scale systemic, severe persistent trauma with durable agency impairment, or material violation of non-negotiable floors including Safety, Truth, and dignity-equality protections. Immediate containment and heightened oversight apply. |
| 8 | **Grave anti-constitutional misconduct** | **Multiple LEQUs lost**, structural or cross-institutional constitutional damage, or a final Chapter Eleven finding establishing **s = 8** grave anti-constitutional misconduct. |
| 9 | **Pernicious anti-constitutional misconduct** | **Worst-case systemic harm**: rare, intentional, systemic, intergenerational, civilizational, constitution-subverting harm at the widest material scope, or a final Chapter Eleven finding establishing **s = 9** pernicious anti-constitutional misconduct. |

This table is the operative Violation Axis severity ladder for Chapter Nine. Display labels for each `s` appear in **Table 1** column 3. LEQU calibration for each level appears in **section 4.2**. Final anti-constitutional misconduct assignment for **s = 7**, **s = 8**, and **s = 9** remains in **Chapter Eleven**. Process / response character attaches under **Chapter Ten section 3** and does not create a second severity ladder. **Violation standing records** under **§Chapter One §8.1 and 2.3.2** must identify the finding authority or record basis and review status for the Violation Axis classification.
...
**Supplements.** Read **Chapter Ten section 2.1** (domain cross-walk), **Chapter Ten section 2.2** (Contribution Axis supplements), **Chapter Ten section 3.9** (Violation Axis supplements), and **Chapter Ten §Chapter One §8.1–3.8** (process / response character and duty material) with this severity ladder.

**What happens next.** Standing effects are in **Chapter Ten section 1**. Standing integration and no-netting mechanics are in **Chapter Ten section 4** (including standing-orientation by Violation Axis slot at section 4.3). Final anti-constitutional-misconduct designation is in **Chapter Eleven**. Adopted implementation may publish LEQU-equivalent loss calibration only as subordinate support under **section 4.2** and this subsection.
'''
...
def guard_other_chapters(text: str) -> str:
    """Temporarily mask Chapter Nine §6 refs that collide with other chapters' §6."""
    text = re.sub(
        r"(\[Chapter Ten §6\]\(core_10_standing_integration\.md#[^)]+\))",
...
CORPUS_REPLACEMENTS = [
    ...
    ("Operative criteria for Violation Axis `s` = 7, 8, and 9 remain in **section 6** and **Chapter Eleven**.", "Operative criteria for Violation Axis `s` = 7, 8, and 9 remain in **section 5.2** and **Chapter Eleven**."),
    ...
    ("Chapter Nine section 6 severity", "Chapter Nine section 5.2 severity"),
    ("Chapter Nine section 6** severity", "Chapter Nine section 5.2** severity"),
    ("Chapter Nine section 6.", "Chapter Nine section 5.2."),
    ("Chapter Nine section 6,", "Chapter Nine section 5.2,"),
    ("Chapter Nine section 6 ", "Chapter Nine section 5.2 "),
    ("Chapter Nine **§§5–6**", "Chapter Nine **§Chapter One §8.1–5.2**"),
    ("Chapter Nine **section 5**", "Chapter Nine **section 5.1**"),
    ("Chapter Nine **section 6**", "Chapter Nine **section 5.2**"),
    ("Chapter Nine section 5**", "Chapter Nine section 5.1**"),
    ("Chapter Nine section 5,", "Chapter Nine section 5.1,"),
    ("Chapter Nine section 5.", "Chapter Nine section 5.1."),
    ("Chapter Nine section 5 ", "Chapter Nine section 5.1 "),
    ("Chapter Nine §6", "Chapter Nine Chapter One §6.2"),
    ("Chapter Nine — section 5", "Chapter Nine — section 5.1"),
    ("Chapter Nine — section 6", "Chapter Nine — section 5.2"),
    ("Chapter Nine §5", "Chapter Nine Chapter One §8.1"),
    ("[§5](core_09_standing_assessment.md#34-violation-axis-rules-violation-nature-adverse-findings-and-severity)", "[Chapter One §6.2](core_09_standing_assessment.md#34-violation-axis-rules-violation-nature-adverse-findings-and-severity)"),
    ...
    ("in **section 5**", "in **section 5.1**"),
    ("**section 5**", "**section 5.1**"),
    ("§5](core_09_standing_assessment.md#33-primary-category-defaults-and-lequ-slot-baseline)", "Chapter One §8.1](core_09_standing_assessment.md#51-contribution-axis-bands-and-table-2)"),
    ("primary slot defaults", "primary category defaults"),
    ("the Chapter Nine **section 6** severity ladder", "the Chapter Nine **section 5.2** severity ladder"),
    ("Chapter Nine **section 6** severity ladder", "Chapter Nine **section 5.2** severity ladder"),
]
