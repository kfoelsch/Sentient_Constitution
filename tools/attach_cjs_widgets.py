...
LABEL_HINTS = {
    "CJS-5.14 and CJS-5.15": ["Risk", "Truth (Constitutional Constraint)", "Transparency"],
    "CJS-5.13": ["Accessibility", "Meaningful Agency", "Transparency"],
    "CJS-5.15": ["Transparency", "Disclosure Sufficiency"],
    "CJS-5.16": ["Dependency", "Risk"],
    "CJS-5.19": ["Cascading Failure", "Safety (Constraint)"],
    "CJS-5.17": ["Interoperability", "Dependency"],
    "CJS-5.20": ["Oversight", "Proportionality", "Redress and Remediation"],
    "CJS-5.9": ["Auditability", "Verifiability"],
    "CJS-5.10": ["Transparency", "Auditability"],
    "CJS-5.11": ["Verifiability", "Truth (Constitutional Constraint)"],
    "CJS-5.21 and CJS-5.18": ["Reversibility", "Risk"],
    "CJS-5.22": ["Adversarial, Scaled, and Exploited Conditions", "Safety (Constraint)"],
    "CJS-5.23 and CJS-5.8": ["Reversibility", "Trustworthiness"],
    "CJS-5.2 and CJS-5.12": ["Governance", "Proportionality"],
    "CJS-5.3 and CJS-5.20": ["Oversight", "Redress and Remediation", "Proportionality"],
    "CJS-5.4 and CJS-5.8": ["Transparency", "Accountability"],
    "CJS-5.5": ["Accountability", "Proportionality", "Necessity"],
    "CJS-5.6": ["Transparency", "Procedural Fairness"],
    "CJS-5.7": ["Procedural Fairness", "Adjudication and Dispute Resolution"],
}
