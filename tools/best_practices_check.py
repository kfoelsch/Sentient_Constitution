...
REVIEWS = [
    ...
    DomainReview(
        ...
        internal_anchor="Art XXI-B to XXI-D; Ch 10 sec. 5; CI-4, CI-7B, CI-14",
        design=2,
        operationalization=2,
        evidence=2,
        performance=2,
    ...
    DomainReview(
        ...
        internal_anchor="SC Ch 1 sec. 7; Arts XII-XV, XIX-XX; CI-3, CI-7; CS Protocol A; CS Ch S2-S3",
        design=3,
        operationalization=3,
        evidence=2,
        performance=2,
    ...
    DomainReview(
        ...
        performance=2,
        current_state=(
            "The corpus strongly protects disclosure, traceability, auditability, and accessible pathway concepts, with a dedicated governance disclosure schema hook in CI-12.2."
        ),
        ...
        proposed_close="Finish the CI-12/CI-16 reporting schema as a reusable disclosure template with cadence and comparison fields.",
        priority="P1",
    ),
    DomainReview(
        domain="Independent assurance and verification",
        external_sections="IIA Principles 4-5; OECD Integrity 12; FRC 2024 Section 4",
        internal_anchor="Arts XIV and XXI; Ch 8; Defs Ch 4; CI-7, CI-7A, CI-7B; doc_architecture sec. 15-17",
        design=3,
        operationalization=3,
        evidence=3,
        performance=2,
    ...
    DomainReview(
        ...
        internal_anchor="Arts XII-XVI, XIX-XX; CS Protocol A/B/R/D; CS Ch S1-S3",
        design=3,
        operationalization=3,
        evidence=2,
        performance=2,
