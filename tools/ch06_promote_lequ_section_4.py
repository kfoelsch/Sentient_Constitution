#!/usr/bin/env python3
"""Promote Chapter Six LEQU from §3.2 to top-level §4; renumber §3.3→§5, §3.4→§6."""
...
CH06_PROSE = [
    ...
    ("sections **1–3***", "sections **1–6***"),
    ("(*§§3.1–3.4 — slot grammar, LEQU constitutional-outcome baseline, primary category defaults, Contribution Axis rules, and Violation Axis rules*)",
    ...
    ("[§3](#3-primary-axis-categories-slot-grammar-and-defaults) slot grammar and axis rules",
     "[§§3–6](#3-slot-grammar-and-display-labels) slot grammar, LEQU baseline, and axis categories"),
    ("[§§3.1–3.3](#3-primary-axis-categories-slot-grammar-and-defaults) | **Classification layer** — slot grammar, LEQU baseline, Contribution Axis bands",
    ...
    ("[§3.4](#34-violation-axis-rules-violation-nature-adverse-findings-and-severity) | **Classification layer** — Violation Axis severity ladder",
     "[§6](#34-violation-axis-rules-violation-nature-adverse-findings-and-severity) | **Classification layer** — Violation Axis severity ladder"),
    ("**How §2 and §3 relate:**", "**How §2 and §§3–6 relate:**"),
    ("[§3](#3-primary-axis-categories-slot-grammar-and-defaults) states *how verified standing records map to axis categories* — Flourishing-side contribution under **§§3.1–3.3**, Accountability-side violation under **§3.4**. Section 2 must be satisfied before section 3 categories bind; section 3 does not merge",
     "[§§3–6](#3-slot-grammar-and-display-labels) state *how verified standing records map to axis categories* — Flourishing-side contribution under **§§3–5**, Accountability-side violation under **§6**. Section 2 must be satisfied before section 3 categories bind; sections 3–6 do not merge"),
    ("[§3](#3-primary-axis-categories-slot-grammar-and-defaults) (*slot grammar, primary axis categories, and LEQU slot baseline*);",
     "[§§3–6](#3-slot-grammar-and-display-labels) (*slot grammar, LEQU baseline, primary axis categories*);"),
    ("[§3](#3-primary-axis-categories-slot-grammar-and-defaults) (*slot grammar and axis classification — Flourishing measure at **§§3.1–3.3**, Accountability measure at **§3.4***);",
     "[§§3–6](#3-slot-grammar-and-display-labels) (*slot grammar, LEQU baseline, and axis classification — Flourishing measure at **§§3–5**, Accountability measure at **§6***);"),
    ...
    ("**§§3.1–3.3** — **oversight**", "**§§3–5** — **oversight**"),
    ("**§3.4** — **accountability**", "**§6** — **accountability**"),
    ("Primary aim(s): **§§3.1–3.3**", "Primary aim(s): **§§3–5**"),
    ("**§3.4** — **Accountability**", "**§6** — **Accountability**"),
    ...
    ("[§§3.1–3.3](#31-slot-grammar-and-display-labels)", "[§§3–5](#3-slot-grammar-and-display-labels)"),
    ("[§3.4](#34-violation-axis-rules-violation-nature-adverse-findings-and-severity)", "[§6](#34-violation-axis-rules-violation-nature-adverse-findings-and-severity)"),
    ("[§3.1](#31-slot-grammar-and-display-labels)", "[§3.1](#31-slot-grammar-and-display-labels)"),
    ("[§3.2](#32-constitutional-outcome-baseline-for-slots)", "[§4](#32-constitutional-outcome-baseline-for-slots)"),
...
CROSS_FILE = [
    ...
    ("Chapter Six **§2.3.2** and **§3.4**", "Chapter Six **§2.3.2** and **§6**"),
    ...
    ("[§3.2](core_06-06_standing_assessment.md#32-constitutional-outcome-baseline-for-slots)", "[§4](core_06-06_standing_assessment.md#32-constitutional-outcome-baseline-for-slots)"),
    ...
    ("Chapter Six §§3.1–3.3 read with Chapter Seven", "Chapter Six §§3–5 read with Chapter Seven"),
