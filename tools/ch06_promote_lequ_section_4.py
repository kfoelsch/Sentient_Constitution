...
CH06_PROSE = [
    ...
    ("[§3](#3-primary-axis-categories-slot-grammar-and-defaults) states *how verified standing records map to axis categories* — Flourishing-side contribution under **§Chapter One §8.1–3.3**, Accountability-side violation under **§3.4**. Section 2 must be satisfied before section 3 categories bind; section 3 does not merge",
    ...
    ("[§3](#3-primary-axis-categories-slot-grammar-and-defaults) (*slot grammar and axis classification — Flourishing measure at **§Chapter One §8.1–3.3**, Accountability measure at **§3.4***);",
