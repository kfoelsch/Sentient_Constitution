...
CI_CHAIN = tuple(
    ...
    for name in (
        ...
        "ci_08_transparency_participation_accessible_pathways.md",
        ...
        "ci_12_cross_institution_coordination_escalation.md",
        ...
        "ci_15_neurodiversity_disability_justice_trauma_informed_participation.md",
    ...
    if with_alignment:
        lines.extend(
            [
                ...
                "[Chapter Five *Corpus*](../core_05_band_integrative.md#corpus).",
                "",
                "---",
                "",
            ]
