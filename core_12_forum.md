...
> - **Pipeline navigation:** [README — Standing pipeline and forums](README.md#standing-pipeline-and-forums) — [§§1–7](#1-purpose-and-role--participation-architecture) in this file.
...
- Downstream: [§7](#7-forum-support-before-during-and-after-review--oversight-architecture) (*inspection, forensic, and follow-through support*); [§5](#interim-protection) (*Interim protection*); [corpus_forum.md](corpus_forum.md) (**CF-11.3.1** (*target windows and timing floors*)); [corpus_institutions.md](corpus_institutions.md) (**CI-8** (*accessible pathways*)); [Chapters Nine–Twelve application vignettes](core_09-12_application_vignettes.md#chapters-nine-twelve-application-vignettes); [Article XXIII-D](core_06_rights_part_d.md#xxiii-d-restore-challenge-clocks) (*same outer bounds as default restore-challenge windows*).
