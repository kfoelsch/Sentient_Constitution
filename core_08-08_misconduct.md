...
- **Serious anti-constitutional misconduct:** A **unified incident** **materially implicates** one or more **section 2** criteria **and** triggers mandatory **heightened** review, evidence-preservation obligations, and published remediation controls, **but** does **not** satisfy grave or pernicious under the bullets below. Where materially necessary, it also triggers provisional suspension of disputed constitutional effect (including under **Chapters Twelve through Fourteen** where applicable). 
...
- concealment, evidence suppression, record manipulation, or destruction or non-preservation of material evidence;
...
The conduct is in scope whether the actor is the **operator**, **owner**, **steward**, **administrator**, **maintainer**, **infrastructure provider**, **access gatekeeper**, **credentialing authority**, **security authority**, **funding authority**, **contracting party**, **platform**, **intermediary**, **technical-control holder**, **command issuer**, **coordinating sponsor**, or **beneficiary**, provided the record supports accountable attribution under **Chapters Two through Four** and **section 4** safeguards. Ownership, contract terms, licensing status, security labels, maintenance labels, insolvency, technical architecture, or delegation to automated systems does not remove the conduct from scope where the actor materially causes, maintains, exploits, conceals, or benefits from anti-constitutional results.
