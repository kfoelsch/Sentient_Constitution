...
- Forum and investigation interface: [Chapter Nine](core_09-09_forum.md#chapter-nine-forums-and-jurisdiction) for Integrity-family routing, anti-self-judging backup, transfer, and certification; [corpus_forum.md](corpus_forum.md) **CF-8** for independent investigative service and prosecution-interface requirements.
...
- refusal to activate independent investigation, transfer, co-assignment, external participation, or anti-self-judging backup where Chapter Nine, **CF-8**, or adopted implementation requires it.
...
This subsection does **not** create a mandatory-prosecution rule, add an independent slot-assignment criterion beyond the **section 2** set, or relocate prosecutorial, investigative, or forum-interface operations from Chapter Nine, **CF-8**, or adopted implementation. It routes evaluation of the named pattern into the existing criteria, slot-assignment, and due-process safeguards of this chapter.
