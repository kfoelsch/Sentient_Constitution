...
| 4 | **Question 1 — what happened?** Forum produces a **verified violation finding** → open a separate **violation standing record** on the guardian and, if verified, an **institutional vehicle** record on the platform scheduling policy ([Chapter Nine §2](core_09_standing_assessment.md#2-question-1--what-happened)). |
| 5 | **Question 2 — how bad was it?** ([Chapter Nine §7 unified scale](core_09_standing_assessment.md#7-unified-proportional-lequ-scale--contribution-and-violation-axes)): verified impact on the children controls the Violation Axis slot; likely `s` = 4–5. Reference working (not a live slot): [LEQU calibration W2](implementation/LEQU_CALIBRATION_REFERENCE.md#w2-two-children-survival-floor-deprivation). **Interpersonal / Care Duty Misconduct** and **Negligent Misconduct** remain character descriptors and do not move the slot. |
| 6 | **Question 3 — what happens because of it?** ([Chapter Ten §4.2](core_10_standing_integration.md#42-prevention--general-standing-locks)): **Safeguard Lock** + **protective participation lock** on unsupervised custody routes; **named-pathway-scoped** blocks on sole-custody authority until verified monitoring and respite plan. |
...
| Stage | Application |
| --- | --- |
| Stewardship | [Chapter One §10](core_01_c_stewardship_capacity_principles.md#10-consequential-stewardship-the-steward-role) — tetrad **timeliness** leg; [Stewardship Defect](core_05_band_continuity.md#stewardship-defect-constitutional) when chronic delay after notice |
| Q2 measurement | [Chapter Nine §7 unified scale](core_09_standing_assessment.md#7-unified-proportional-lequ-scale--contribution-and-violation-axes) — verified harm from the deferred repair determines any `s` = 4–5 impact slot; **Response timeliness / avoidable delay** is a character descriptor and does not move the slot |
| Q3 integration | [Chapter Ten §9.5](core_10_standing_integration.md#95-timely-implementation) — **Remedy commencement / pipeline delay** |
...
| One scale, separate records | [Chapter Nine §7 unified scale](core_09_standing_assessment.md#7-unified-proportional-lequ-scale--contribution-and-violation-axes) — shared five-times LEQU bands; Violation slots controlled only by verified impact |
