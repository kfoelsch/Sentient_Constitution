...
Each illustrative item uses **Chapter Six section 6.1** and **Table 2** as the authoritative band source and applies **§Chapter One §8.1–4.3** when **violation** findings co-exist. Apply [Ch6 §3, Contribution table](core_06-06_standing_assessment.md#contribution-table-q1-magnitude-input-dimensions) before competency-gate assignment; apply [**Table B (Contribution)**](#contribution-table-q2-safe-delegation-dimensions) for safe-delegation design.
