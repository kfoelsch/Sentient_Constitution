...
- Downstream: Principles: [4.1 Safety](core_01_a_values_principles.md#41-safety-harm-constraint).
...
- Downstream: Principles: [3. Foundational Objective: Wellbeing](core_01_a_values_principles.md#3-foundational-objective-wellbeing); [8.1.1 Proportionality](core_01_b_stewardship_capacity_principles.md#911-proportionality) (harm boundary in the tradeoff stack).
...
- Downstream: Principles: [4.1 Safety](core_01_a_values_principles.md#41-safety-harm-constraint), [8.1.1 Proportionality](core_01_b_stewardship_capacity_principles.md#911-proportionality), and [13. Integrated Application](core_01_b_stewardship_capacity_principles.md#13-integrated-application).
...
- Downstream: Principles: [1. Constitutional Interpretation](core_01_a_values_principles.md#1-constitutional-interpretation); [13. Integrated Application](core_01_b_stewardship_capacity_principles.md#13-integrated-application) (Authority Stack vs Internal Hierarchy read-with Chapter One).
- Downstream: [Chapter One — §1 Constitutional Interpretation](core_01_a_values_principles.md#1-constitutional-interpretation) (integrated reading and last-resort hierarchy); [Chapter Twelve §3.1](core_12-14_amendment.md#31-internal-hierarchy-for-adopters) (*Internal Hierarchy for Adopters*); [Chapter Fifteen §2](core_15-15_incorporation.md#2-authority-stack-and-invocation) (*Authority stack and invocation*).
...
- O: The paired rule for source status and residual conflict resolution across the operative [Corpus](#corpus).
  - **Authority Stack:** the ordered source-of-authority framework governing constitutional interpretation, adoption effect, and layer status across constitutional, incorporated, and support layers. Order:
    - binding constitutional sources — Sentient Constitution core files read together, starting with `core_00_preamble.md`, `core_01_a_values_principles.md`, and `core_01_b_stewardship_capacity_principles.md` and the remaining numbered core files;
...
- E: First identify the operative edition/custody chain and source layer under the Authority Stack. Then apply integrated reading under [Chapter One — §1 Constitutional Interpretation](core_01_a_values_principles.md#1-constitutional-interpretation). Preserve the Constitution's fullest protective effect as an integrated whole and the [Chapter Ten](core_10-10_rights_part_a.md#chapter-ten-foundational-rights) non-contraction default. Use Internal Hierarchy only as a last-resort residual rule; do not use it to replace ordinary integrated reading or to resolve mere disagreement over canonical term meaning. Where the dispute is term meaning, the Chapter Five canonical definition governs at every layer. Reject interpretations that invert source precedence, obscure source status, treat non-incorporated process text as binding constitutional law, or let incorporated/support layers narrow Sentient Constitution meaning. Apply Chapter Four burden, tracing, and verification requirements to any claim that a layer collision exists.
...
- C: Non-compliant:
  ...
  - treating canonical Chapter Five definitions as a competing substantive layer that displaces principles or articles ([Chapter One — §1 Constitutional Interpretation](core_01_a_values_principles.md#1-constitutional-interpretation));
...
- Downstream: Principles: [3. Foundational Objective: Wellbeing](core_01_a_values_principles.md#3-foundational-objective-wellbeing); [9.1.4 Minimization of Avoidable Burden](core_01_b_stewardship_capacity_principles.md#914-minimization-of-avoidable-burden) (labor-floor burden vs false efficiency).
...
- Downstream: Principles: [9.1.4 Minimization of Avoidable Burden](core_01_b_stewardship_capacity_principles.md#914-minimization-of-avoidable-burden) (participation-capacity preservation vs false efficiency); [§10 Freedom (Bounded Agency)](core_01_b_stewardship_capacity_principles.md#11-freedom-bounded-agency) (**Meaningful Agency** in tradeoff stack); [10.1 Required Evaluation Factors](core_01_b_stewardship_capacity_principles.md#101-required-evaluation-factors) (**Materiality** / **Dependency** scaling).
...
- Downstream: Principles: [§8.1 Productive Capacity (Instrumental Good)](core_01_b_stewardship_capacity_principles.md#81-productive-capacity-instrumental-good); [§6.2 Distributed Understanding](core_01_b_stewardship_capacity_principles.md#62-distributed-understanding) (attribution / traceability read-with).
- Cluster component: [Chapter Five §3.5 *Labor and Economic Floor*](#labor-and-economic-floor-cluster).
...
- E: Test substantive effect at population scale, not single-employer or single-platform framing:
  ...
  - where deployment shows concentration characteristics, interact explicitly with the [Chapter One §8](core_01_b_stewardship_capacity_principles.md#81-productive-capacity-instrumental-good) non-concentration principle and the [§6.3](core_01_b_stewardship_capacity_principles.md#83-concentration-threshold-mechanism-adopter-tunable) threshold mechanism.
...
- Downstream: Principles: [10.1 Required Evaluation Factors](core_01_b_stewardship_capacity_principles.md#101-required-evaluation-factors); [§7 Governance Under Stewardship Discipline](core_01_b_stewardship_capacity_principles.md#7-governance-under-stewardship-discipline) (standing signals and capture).
...
- Downstream: Principles: [10.1 Required Evaluation Factors](core_01_b_stewardship_capacity_principles.md#101-required-evaluation-factors) (materiality / verification in standing inputs); [9.4.2 Proxy-Divergence Invalidation](core_01_b_stewardship_capacity_principles.md#942-proxy-divergence-invalidation) (standing metrics vs demonstrable facts).
...
- Downstream: Principles: [4. Non-Negotiable Constraints: Safety and Truth](core_01_a_values_principles.md#4-non-negotiable-constraints-safety-and-truth); [9. Interaction and Conflict Resolution](core_01_b_stewardship_capacity_principles.md#9-interaction-and-conflict-resolution) (verified facts for adverse standing).
...
- Downstream: Principles: [9.4.1 Rights-Collision Decision Test](core_01_b_stewardship_capacity_principles.md#941-rights-collision-decision-test); [13. Integrated Application](core_01_b_stewardship_capacity_principles.md#13-integrated-application) (standing effects read through integrated interpretive framework).
...
- Downstream: Principles: [10.1 Required Evaluation Factors](core_01_b_stewardship_capacity_principles.md#101-required-evaluation-factors); [9.4.2 Proxy-Divergence Invalidation](core_01_b_stewardship_capacity_principles.md#942-proxy-divergence-invalidation) (bounded standing records vs merged labels).
...
- Downstream: Principles: [10.1 Required Evaluation Factors](core_01_b_stewardship_capacity_principles.md#101-required-evaluation-factors); [9.4.2 Proxy-Divergence Invalidation](core_01_b_stewardship_capacity_principles.md#942-proxy-divergence-invalidation) (Axis II classification integrity).
...
*Merged into [3.10 Stewardship, Governance Discipline, and Shared-System Capacity](#stewardship-governance-discipline-and-shared-system-capacity-cluster). This heading retains the legacy anchor only.*
...
- Downstream: Principles: [4. Non-Negotiable Constraints: Safety and Truth](core_01_a_values_principles.md#4-non-negotiable-constraints-safety-and-truth), [9. Interaction and Conflict Resolution](core_01_b_stewardship_capacity_principles.md#9-interaction-and-conflict-resolution), and [6.2.1 Preservation of Epistemic Integrity](core_01_b_stewardship_capacity_principles.md#921-preservation-of-epistemic-integrity), where materially relevant evidence must remain available for truth, safety, review, and correction.
...
- Downstream: Principles: [5. System Stability Enabler: Trust](core_01_a_values_principles.md#5-system-stability-enabler-trust-coordination-integrity).
...
- Downstream: Principles: [§7 Governance Under Stewardship Discipline](core_01_b_stewardship_capacity_principles.md#7-governance-under-stewardship-discipline).
