...
- Read with: [Chapter Eight §§4.3–4.4 — Normalized descriptor catalog](core_08-08_standing_assessment.md#43-route-descriptor-measurement-roles) where **domain-aligned** recognition or comparative **Contribution Axis / Violation Axis** descriptor narratives are material.
- Read with: [Chapter Eight §4.3 — Contribution-side descriptors](core_08-08_standing_assessment.md#43-route-descriptor-measurement-roles) where contribution nature and recognition narratives are material; [Chapter Nine §3](core_09-09_standing_integration.md#3-descriptor-integration-and-attachment-normalization) for their integration into Question 3.
