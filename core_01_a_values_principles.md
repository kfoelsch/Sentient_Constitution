...
- Read with: [Chapter Nine §3 — Shared descriptor and attachment normalization](core_09-09_standing_integration.md#3-shared-descriptor-and-attachment-normalization) where **domain-aligned** recognition or comparative **Contribution Axis / Violation Axis** descriptor narratives are material.
- Read with: [Chapter Nine §3 — Contribution-side descriptors](core_09-09_standing_integration.md#3-shared-descriptor-and-attachment-normalization) where contribution state and recognition narratives are material.
