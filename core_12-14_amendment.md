...
- Upstream: [Chapter One](core_01_b_stewardship_capacity_principles.md#chapter-01-principles-and-constraints); [Chapters Two through Four](core_02-04_definition_mechanics.md) integrity and verification; [Chapter Eleven](core_10-10_rights_part_a.md#chapter-ten-foundational-rights) Rights Floor; [Chapter Eleven](core_11-11_governance.md#chapter-eleven-constitutional-contract-legitimacy-authorization-and-stewardship) legitimacy and stewardship requirements.
...
- rights in Chapter Ten
- legitimacy and stewardship obligations in Chapter Eleven
...
- Read with: [Chapter Ten](core_10-10_rights_part_a.md#chapter-ten-foundational-rights) for Rights-Floor specifics; [Chapters Two through Four](core_02-04_definition_mechanics.md) for verification, standing gates, and observability as potential indirect narrowing vectors.

</details>

<br>

*In plain terms: weakening **Safety (Constraint)**, **Truth (Constitutional Constraint)**, **Epistemic Integrity**, **Dignity and Equal Moral Standing**, **Meaningful Agency**, or other Chapter Ten protections — including by tightening definitions, raising impossible proof bars, or carving emergencies so they eat the rule — counts as invalid even if the words "amendment" or "interpretation" are on the label.*

No constitutional change is valid if it materially weakens core protections for any covered sentient class. Core protections include Safety (Constraint), Truth (Constitutional Constraint), Epistemic Integrity, and Dignity and Equal Moral Standing. They include Meaningful Agency and other rights protections stated in Chapter Ten. Material weakening includes indirect narrowing through definitions, procedures, standing gates, verification barriers, or emergency carve-outs.
...
- Downstream: [§3](#3-anti-evasion-clause-and-constitutional-misconduct-referral) evasion and misconduct referral; [Chapter Fourteen](core_12-14_amendment.md#chapter-fourteen-amendment-ratification-and-procedural-validity) Tests 2–4 and procedural requirements (invalid if Test 1 fails regardless of procedure).
- Read with: [Chapter One](core_01_b_stewardship_capacity_principles.md#chapter-01-principles-and-constraints) non-negotiable constraints; [Chapter Eleven](core_11-11_governance.md#chapter-eleven-constitutional-contract-legitimacy-authorization-and-stewardship) legitimacy obligations.

</details>

<br>

*In plain terms: Test 1 is the checklist — if a proposal would gut Chapter One constraints, Chapters Two through Four integrity, Chapter Ten rights, or Chapter Eleven legitimacy, it fails, including when the damage is done through procedure, evidence rules, or re-tagging rather than a single blunt deletion.*
...
- Chapter Ten Rights Floors
- Chapter Eleven legitimacy obligations
...
- Downstream: Mandatory referral records route to [Chapter Six](core_06-06_standing_assessment.md#chapter-six-compliance-violation-and-standing-model) (Axes I and II) and [Chapter Eight](core_08-08_misconduct.md#chapter-eight-anti-constitutional-misconduct) (final Violation Axis s = 7, 8, or 9 classification); this chapter does not classify.
- Read with: [Chapter Twelve §4](#4-scope-limit-and-layer-discipline) scope limit (triggers are not canonical slot-classification or sanction law).
...
## CHAPTER THIRTEEN: EXPANSION, SUPREMACY, AND EXTERNAL LEGAL ORDERS
...
> - **Non-regression:** substantive floors remain in **Chapter Twelve**. Ratification, custody instruments, and procedural amendment validity remain in **Chapter Fourteen**.
>
> **Architecture — *In plain terms* placement:** Each *In plain terms* line appears immediately after the Trace navigational block (and the line break that follows it), and **before** the operative paragraphs and bullet lists for that section or subsection. Reader-facing gloss only; it does not add, remove, or narrow binding text.
...
- Upstream: [Chapter Thirteen](#chapter-thirteen-expansion-supremacy-and-external-legal-orders) chapter frame; [Chapter Twelve](core_12-14_amendment.md#chapter-twelve-non-regression-and-substantive-amendment-validity) non-regression (expansion must not violate Test 1).
- Downstream: [§2](#2-continuity-of-supremacy-and-challenge-rights-during-amendment) continuity during change; [Authority Stack and Internal Hierarchy](core_05i_integrative_definitions.md#authority-stack) (*including Chapters One through Five consistency checks in operative text*).
- Read with: [Chapter Ten](core_10-10_rights_part_a.md#chapter-ten-foundational-rights) when additions implicate new rights or classes.

</details>

<br>

*In plain terms: forward is fine — new rights, stronger safeguards, and broader inclusion are welcome when they genuinely increase protection and stay consistent with the rest of this **Constitution**; the guardrail is Chapter Twelve, not a ban on improvement.*

Constitutional change may add new rights, safeguards, accountability mechanisms, representational guarantees, or protected classes and protected characteristics. Additions are permitted where they increase substantive protection, inclusion, or binding effect consistent with **Chapters One through Five** and **Chapter Twelve**.
...
- Downstream: [§3](#3-supremacy-relative-to-other-binding-norms) internal hierarchy and stricter-external rule; [Chapter Fourteen §9](core_12-14_amendment.md#8-provisional-effect-rule) provisional effect on rights-affecting amendments.
...
## CHAPTER FOURTEEN: AMENDMENT, RATIFICATION, AND PROCEDURAL VALIDITY
...
> - **Substantive non-regression:** **Chapter Twelve**. **Supremacy** and **external legal orders:** **Chapter Thirteen**.
>
> **Architecture — *In plain terms* placement:** Each *In plain terms* line appears immediately after the Trace navigational block (and the line break that follows it), and **before** the operative paragraphs and bullet lists for that section or subsection. Reader-facing gloss only; it does not add, remove, or narrow binding text.
...
This Constitution may be amended to improve protection, clarity, binding effect, or institutional fitness under changing conditions, subject to **Chapter Twelve** (non-regression), **Chapter Thirteen** (supremacy and external-order interface), and the validity conditions in this chapter.

### 1. Heightened Review for Rights-Affecting Changes
<details>
<summary><strong><span style="color: #2563eb;">Trace</span></strong></summary>

- Upstream: [Chapter Fourteen](#chapter-fourteen-amendment-ratification-and-procedural-validity) validity stack; [Chapter Ten](core_10-10_rights_part_a.md#chapter-ten-foundational-rights) Rights Floor.
- Downstream: [§2](#2-burden-of-justification-and-public-traceability) public justification; [§8](#7-review-triggers) automatic triggers list.
- Read with: [Article XI](core_10-10_rights_part_b.md#article-xi-stakeholder-system-participation-representation-and-due-process) family for materially rights-affecting process design.
...
- Read with: [Chapter Twelve](core_12-14_amendment.md#chapter-twelve-non-regression-and-substantive-amendment-validity) non-regression compatibility as required justification content.
...
Proposed amendments must provide publicly auditable justification, including expected effects, affected populations, foreseeable risks, and compatibility with **Chapter Twelve** non-regression constraints. Unsupported claims of necessity or feasibility are insufficient.

### 3. Validity-Floor Rule
<details>
<summary><strong><span style="color: #2563eb;">Trace</span></strong></summary>

- Upstream: [Chapter Twelve](core_12-14_amendment.md#chapter-twelve-non-regression-and-substantive-amendment-validity) substantive tests; procedural tests in [§4](#4-test-2-procedural-validity-and-publication-integrity)–[§6](#6-test-4-contestability-and-independent-review-validity).
- Downstream: Operative text: failure of any floor invalidates regardless of procedural completion.
- Read with: [§10](#9-invalid-change-handling-and-remediation-continuity) remediation when a change fails the floor.
...
This chapter states minimum constitutional **procedural and custody** validity conditions for amendment and adoption actions, together with **Chapter Twelve** substantive conditions. Any amendment that fails **Chapter Twelve** or any test in **sections 4 through 6** of this chapter is invalid regardless of procedural completion.
...
- Read with: [Chapter Six, section 4 — *Standing Effects*](core_07-07_standing_integration.md#5-standing-effects); [section 4.1 — Axis I (Contribution Axis) and standing effect](core_06-06_standing_assessment.md#33-primary-category-defaults-and-lequ-slot-baseline) (*classification foundations*).
...
- standing effects ([Chapter Six, section 4 — *Standing Effects*](core_07-07_standing_integration.md#5-standing-effects); read with [section 4.1](core_06-06_standing_assessment.md#33-primary-category-defaults-and-lequ-slot-baseline) — Contribution Axis and standing-effect rules)
- emergency powers
...
- Upstream: [§8](#7-review-triggers) heightened review triggers.
- Downstream: [§10](#9-invalid-change-handling-and-remediation-continuity) invalidity handling; [Chapter Thirteen §2](core_12-14_amendment.md#2-continuity-of-supremacy-and-challenge-rights-during-amendment) continuity of challenge rights.
- Read with: [Chapter Ten](core_10-10_rights_part_a.md#chapter-ten-foundational-rights) rights materiality for what counts as "rights-affecting."
...
- preserves evidence under [Evidence Preservation](core_05o_oversight_definitions.md#evidence-preservation) and audit trails
...
- be consistent with document-control expectations in [README.md](README.md) and [Chapter Five *Corpus*](core_05i_integrative_definitions.md#corpus) (authoritative corpus, edition identifier, custody chain).
- be consistent with **Corpus** in Chapter Five ([core_05-05_definitions_a_independent.md](core_05i_integrative_definitions.md#corpus)).
...
- Read with: [Chapter Four](core_02-04_definition_mechanics.md) burden and tracing; [Article X-C](core_10-10_rights_part_b.md) for materially high-impact changes.
...
- Upstream: [Chapter Twelve §4](core_12-14_amendment.md#4-scope-limit-and-layer-discipline) substantive-chapter mirror; [§8](#7-review-triggers) and [§10](#9-invalid-change-handling-and-remediation-continuity) trigger language scoped here.
- Downstream: [Chapter Six](core_06-06_standing_assessment.md#chapter-six-compliance-violation-and-standing-model) and [Chapter Eight](core_08-08_misconduct.md#chapter-eight-anti-constitutional-misconduct) remain sole canonical homes for listed taxonomies.
- Read with: [core_10-10_rights_part_d.md](core_10-10_rights_part_d.md) Chapter Ten boundary-watch zone for the converse Rights-Floor discipline pattern.
