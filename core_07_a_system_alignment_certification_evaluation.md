...
- **Record requirement:**
  - a [System Classification Record](core_05_band_continuity.md#system-classification-record-constitutional) stating the assigned class, classification rationale, key assumptions, dependency types present, operational-criticality assessment where material, uncertainty, and the revalidation cadence scaled to class, as required by [Part B §11.1](core_07_b_system_alignment_certification_record_process.md#111-minimum-record-contents); and
...
- **Misclassification and defects:**
  ...
  - where the facts support it, the same classification problems may also count toward adverse standing findings in [Chapter Eight](core_08_standing_assessment.md#chapter-eight-compliance-violation-and-standing-model).
...
- **[Chapter Twelve §5 Authorized Roles, Competency Development, and Contribution](core_12_governance.md#5-authorized-roles-competency-development-and-contribution)** and **[corpus_systems.md](corpus_systems.md), CS-4 — Critical system stewardship** — operative role-definition, competency, and traceability floors where material;
