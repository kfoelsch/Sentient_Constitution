...
- **What it is**
  - **In scope:** The Rights-Floor concept limiting market-structured commodification of essential shelter and operating environments where commodification pressure at scale materially implicates the [Article III-A](core_06-06_rights_part_a.md#article-iii-a-survival) (*Survival*) survival-floor. It applies under [Sentience Non-Exclusion](core_05_band_participation.md#sentience-non-exclusion). Covered environments include:
    - physical dwellings;
    - healthy food;
    - clean water and air;
    - substrate hosting;
...
- Read with: [Consent](core_05_band_participation.md#consent-constitutional), [Coercion and Manipulation](core_05_band_participation.md#coercion-and-manipulation-constitutional), [Procedural Fairness](core_05_band_participation.md#procedural-fairness-constitutional), [Meaningful Agency](core_05_band_participation.md#meaningful-agency), [Freedom (Bounded Agency)](core_05_band_participation.md#freedom-bounded-agency), [Dependency](core_05_band_continuity.md#dependency), [Feasibility](core_05_band_accountability.md#feasibility), [Truth (Constitutional Constraint)](core_05_band_oversight.md#truth-constitutional-constraint), [Privacy (Informational)](core_05_band_continuity.md#privacy-informational), [Surveillance Boundary](core_05_band_continuity.md#surveillance-boundary), and [Bodily-Maintenance Access](core_05_band_continuity.md#bodily-maintenance-access-constitutional) where materially implicated; [Article III-A](core_06-06_rights_part_a.md#article-iii-a-survival) (*Survival*), [Article III-C](core_06-06_rights_part_a.md#article-iii-c-bodily-maintenance-and-healthcare-access) (*Bodily-Maintenance and Healthcare Access*), and [Article VII-C](core_06-06_rights_part_b.md#article-vii-c-mental-health-crisis-and-involuntary-intervention-floor) (*Mental-Health Crisis and Involuntary-Intervention Floor*).
...
- Cluster component: [System Alignment Certification, System Certification Record, System Classification Record, and System Data Types Record](core_05_band_continuity.md#system-alignment-certification-semi-independent).
- Downstream: [System Certification Record](core_05_band_continuity.md#system-certification-record-constitutional); [Chapter Eleven](core_11-11_forum.md#chapter-eleven-forums-and-jurisdiction) and [corpus_forum.md](corpus_forum.md) **CF-7.2** (*Constitutional alignment recognition and review*).
...
- **How to measure and assess**
  - **Primary measure:** [Continuity measurement family](core_05_apex_continuity_aim.md#continuity-measurement-family) — *Can sentients and systems endure — ecologically, dependably, and across failure?*
    ...
    **Primary assessment:** Evaluate whether:
    ...
    2. typing follows functional effect under CS-2 and [Chapter Seven §4](core_07_a_system_alignment_certification_evaluation.md#4-data-types-and-handling-evaluation), not declared intent, [Charter](core_05_band_continuity.md#charter) text alone, or self-description alone;
...
- **What it is**
  ...
  - **Depends on:** [Truth (Constitutional Constraint)](core_05_band_oversight.md#truth-constitutional-constraint) — paired non-negotiable constraint under [Chapter One §4](core_01_a_values_principles.md#3-non-negotiable-constraints-safety-and-truth). The following must remain honest and auditable:
    - safety claims;
...
- **What it is**
  - **In scope:** Likelihood, speed, and severity of [Harm](core_05_band_accountability.md#harm), including:
    - likelihood of harm;
  ...
  - **Primary measure:** [Flourishing measurement family](core_05_apex_flourishing_aim.md#flourishing-measurement-family) — *Are sentients sustained in life, safety, and access to essentials?*
    ...
    **Primary assessment:** Trace claimed wellbeing effects to the Ontological conditions under full functional system scope. Include:
    - direct, indirect, delayed, cumulative, and cross-system effects on:
      ...
      - [Meaningful Agency](core_05_band_participation.md#meaningful-agency) and participation; and
      - supporting [Dependency](core_05_band_continuity.md#dependency) relationships.
...
- **What must hold**
  ...
  - **Tertiary failure:**
    - treating proxy satisfaction as dispositive where [Proxy Divergence](core_05_band_oversight.md#proxy-divergence) is reasonably observable; or
...
- **What it is**
  - **In scope:** The biophysical and living-system conditions on which sentient survival and [Wellbeing](core_05_band_continuity.md#wellbeing) depend, including:
    - stable climate;
...
- **How to measure and assess**
  - **Primary measure:** [Continuity measurement family](core_05_apex_continuity_aim.md#continuity-measurement-family) — *Can sentients and systems endure — ecologically, dependably, and across failure?*
    ...
    **Primary assessment:** Assess recovery and containment under:
    ...
    - [Risk](core_05_band_continuity.md#risk);
    - [Irreversible Harm](core_05_band_accountability.md#irreversible-harm); and
...
- **How to measure and assess**
  - **Primary measure:** [Continuity measurement family](core_05_apex_continuity_aim.md#continuity-measurement-family) — *Can sentients and systems endure — ecologically, dependably, and across failure?*
    ...
    **Primary assessment:** Distinguish genuine recovery from masking. Recovery is not Self-Healing within the meaning of this Constitution when it:
    ...
    - an incentive-alignment defect under [Incentive Alignment](core_05_band_integrative.md#incentive-alignment).
  - **Evaluation covers:**
    - detection latency;
    - containment scope;
...
- **What it is**
  - **In scope:** A failure that amplifies impact beyond the originating system by propagating across [Dependency](core_05_band_continuity.md#dependency)-linked:
    - systems;
    - components; or
    - institutions.
...
- **How to measure and assess**
  - **Primary measure:** [Continuity measurement family](core_05_apex_continuity_aim.md#continuity-measurement-family) — *Can sentients and systems endure — ecologically, dependably, and across failure?*
    ...
    **Primary assessment:** Evaluate propagation pathways across [Dependency](core_05_band_continuity.md#dependency) relationships where:
    ...
    - resulting [Risk](core_05_band_continuity.md#risk) may spread across connected systems or institutions.
...
- **What must hold**
  - **Primary failure:** systems fail to identify, prevent, or mitigate cascading pathways that should have been revealed by:
    - [System Boundary Integrity](core_05_band_continuity.md#system-boundary-integrity); or
    - dependency mapping.
...
- **How to measure and assess**
  ...
  - **Secondary measure:** other measures that can show capacity is failing even when output numbers look steady:
    ...
    **Secondary assessment:** When evaluating the primary trace, align with each secondary co-measure. Detect schemes that degrade actual capacity, including:
    ...
    - coercive incentives.
  - **Tertiary measure:** [Proxy Divergence](core_05_band_oversight.md#proxy-divergence) — where the following substitute for substantive participation:
    - proxy-driven schemes;
    - conditional access; or
    - coercive incentives.

    **Tertiary assessment:** Where operators rely on output metrics or conditional-access schemes, apply [Proxy Divergence](core_05_band_oversight.md#proxy-divergence). Distinguish durable productive capacity from:
    - proxy throughput; or
    - coercive dependency.
...
- **How to measure and assess**
  ...
  - **Tertiary measure:** [Proxy Divergence](core_05_band_oversight.md#proxy-divergence) — where claimed necessity rests on proxies that diverge from underlying constitutional outcomes.
...
- **How to measure and assess**
  ...
  - **Secondary measure:** other measures that bound how burden reduction may be pursued:
    ...
    **Secondary assessment:** When evaluating the primary trace, distinguish burden reduction from:
    ...
    - reductions in proportionate audit or [Contestability](core_05_band_accountability.md#contestability); and
    - [Proxy Divergence](core_05_band_oversight.md#proxy-divergence) framed as efficiency.
...
- Downstream: Principles: [4.1 Safety](core_01_a_values_principles.md#31-safety-harm-constraint), [8.1.1 Proportionality](core_01_b_interaction_interpretation.md#613-proportionality), and [Chapter Seven §3 Whole-System Certification Evaluation](core_07_a_system_alignment_certification_evaluation.md#3-whole-system-certification-evaluation).
...
- **How to measure and assess**
  - **Primary measure:** [Continuity measurement family](core_05_apex_continuity_aim.md#continuity-measurement-family) — *Can sentients and systems endure — ecologically, dependably, and across failure?*
    ...
    **Level of assessment:** Assess at the level of affected ecosystems and life-supporting systems — whether they can sustain and regenerate themselves under prevailing habitat conditions through:
    ...
    - read with [Existential Risk](core_05_band_continuity.md#existential-risk) where civilization-scale pathways are credible; and
  ...
  - **Secondary measure:** co-measures that can defeat recovery-capacity claims even when local restoration or systems-layer recovery appears satisfied:
    ...
    **Secondary assessment:** When evaluating the primary trace:
    - do not treat systems-layer [Self-Healing](core_05_band_continuity.md#self-healing-constitutional) or [Reversibility](core_05_band_continuity.md#reversibility-constitutional) as substitutes for ecological recovery capacity where [Article I-D](core_06-06_rights_part_a.md#article-i-d-existential-risk-and-recovery-capacity) (*Existential Risk and Ecological Recovery Capacity*) applies;
...
- **What must hold**
  - **Primary failure:** irreversible ecological recovery-capacity loss offered as ordinary localized impact, including:
    ...
    - cumulative effects that foreclose restoration within intergenerationally relevant horizons.
  - **Secondary failure:**
    - routing ecological recovery-capacity analysis only through systems-layer [Self-Healing](core_05_band_continuity.md#self-healing-constitutional) or [Reversibility](core_05_band_continuity.md#reversibility-constitutional) where [Article I-D](core_06-06_rights_part_a.md#article-i-d-existential-risk-and-recovery-capacity) (*Existential Risk and Ecological Recovery Capacity*) applies;
...
- **What it is**
  - **In scope:** Attributable environmental burdens arising from a sentient, [System](#system), product, or service across its lifecycle and [Dependency](core_05_band_continuity.md#dependency) relationships, including flows of:
    - energy;
    - materials;
    - emissions;
    - land use; and
...
- **Floor protection:** does not authorize pretextual, sustained, or indefinite invocation that bypasses:
  ...
  - the [Constitutional Contract Layer](core_05_band_integrative.md#constitutional-contract-layer).

**Topic group members.** This group comprises:
- [Emergency and Contingency](core_05_band_continuity.md#emergency-and-contingency-constitutional) — the cluster head governing all emergency frameworks;
- [Constitutional Emergency and Contingency](core_05_band_continuity.md#constitutional-emergency-and-contingency) — emergencies affecting the authorization of governing authority itself under the [Constitutional Contract Layer](core_05_band_integrative.md#constitutional-contract-layer);
...
- **What it is**
  - **In scope:** Emergency or contingency affecting the [Constitutional Contract Layer](core_05_band_integrative.md#constitutional-contract-layer), including:
...
- **What it is**
  - **In scope:** Specialized [Stakeholder Emergency and Contingency](core_05_band_continuity.md#stakeholder-emergency-and-contingency) pathway for **temporary** action that may precede full deliberation in a binding stakeholder-choice pathway, limited to:
...
- Downstream: Continuity measurement family (*Dependency and resource flows as constitutional measurement*); Principles: [3. Foundational Objective: Wellbeing](core_01_a_values_principles.md#2-foundational-objective-wellbeing), [5. System Stability Enabler: Trust](core_01_a_values_principles.md#4-system-stability-enabler-trust-coordination-integrity), [Chapter One §5 Freedom](core_01_a_values_principles.md#5-freedom-bounded-agency), [6. Process Conflict Resolution](#6-process-conflict-resolution), [§6.1 decision-record discipline](core_01_b_interaction_interpretation.md#615-rights-collision-decision-test), and [Chapter Seven §3 Whole-System Certification Evaluation](core_07_a_system_alignment_certification_evaluation.md#3-whole-system-certification-evaluation).
...
- **What it is**
  - **In scope:** The extent to which a sentient or system relies on another system for:
    ...
    A core input to [Wellbeing](core_05_band_continuity.md#wellbeing), [Meaningful Agency](core_05_band_participation.md#meaningful-agency), and [Classification-Scaled Governance](core_05_band_oversight.md#classification-scaled-governance). Includes relationships that are:
    - direct or indirect;
...
<a id="dependency-c"></a>
- **What must hold**
  - **Primary failure:** dependencies omitted from system evaluation where [materially implicated](core_05_band_oversight.md#materially-implicated) (where the dependency duty is materially in play), including:
...
- Steward door (non-operative): Binding next-step statement: [Operative steward statement (Article IV-B)](core_06-06_rights_part_a.md#operative-steward-statement-cross-system-contribution). Support pointers cannot narrow it.
...
- **What it is**
  - **In scope:** Effects arising from system interactions and [Dependency](core_05_band_continuity.md#dependency) relationships, including effects that arise from:
...
- **What it is**
  - **In scope:** [Material Impact](core_05_band_oversight.md#material-impact) exceeding the sum of individual effects due to interaction, including amplification arising from:
    - propagation across [Dependency](core_05_band_continuity.md#dependency) relationships;
...
- **How to measure and assess**
  - **Primary measure:** [Continuity measurement family](core_05_apex_continuity_aim.md#continuity-measurement-family) — *Can sentients and systems endure — ecologically, dependably, and across failure?*
    ...
    **Primary assessment:** Include propagation and feedback loops across:
    ...
    - [Risk](core_05_band_continuity.md#risk) pathways; and
    - [Cascading Failure](core_05_band_continuity.md#cascading-failure) pathways.
...
- **What it is**
  - **In scope:** A structured set of components producing effects on sentients, environment(s), or other systems, including:
    ...
    - [Governance](core_05_band_accountability.md#governance) components.
  - **Out of scope:**
...
- **How to measure and assess**
  - **Primary measure:** [Continuity measurement family](core_05_apex_continuity_aim.md#continuity-measurement-family) — *Can sentients and systems endure — ecologically, dependably, and across failure?*
    ...
    **Primary assessment:** Identify the system by what it actually does, including:
    ...
    - [Dependency](core_05_band_continuity.md#dependency) relationships;
    - temporal effects; and
    - system interactions within [System Boundaries](core_05_band_continuity.md#system-boundaries).
  - **Secondary measure:** [System Boundaries](core_05_band_continuity.md#system-boundaries) and [System Boundary Integrity](core_05_band_continuity.md#system-boundary-integrity) — co-measures that fix the scope in which the system must be evaluated.
...
- **What must hold**
  - Systems must be evaluated in full functional scope under [System Boundaries](core_05_band_continuity.md#system-boundaries) and [System Boundary Integrity](core_05_band_continuity.md#system-boundary-integrity).
...
- **What it is**
  - **In scope:** Functional scope defined by [Material Impact](core_05_band_oversight.md#material-impact) and [Dependency](core_05_band_continuity.md#dependency), covering:
...
- **What it is**
  - **In scope:** Accuracy and stability of [System Boundaries](core_05_band_continuity.md#system-boundaries) definition, requiring that the drawn boundary is:
    - auditable;
...
- **What it is**
  - **In scope:** The affirmative access floor for bodily-maintenance and healthcare services necessary to preserve life, function, and dignity, applied under [Sentience Non-Exclusion](core_05_band_participation.md#sentience-non-exclusion) across materially relevant bodies and substrates. The floor covers:
    - preventive care;
    - acute care;
    - chronic care;
    - maintenance care;
...
- Downstream: Principles: [3. Foundational Objective: Wellbeing](core_01_a_values_principles.md#2-foundational-objective-wellbeing) (survival / shelter continuity); [§6.3.1 Rights-Collision Decision Test](core_01_b_interaction_interpretation.md#615-rights-collision-decision-test) (**Article XIX** (*Interoperability, Portability, Movement, Refuge, and Exit Integrity*) read-together noted in **O** line); [Chapter Seven §3 Whole-System Certification Evaluation](core_07_a_system_alignment_certification_evaluation.md#3-whole-system-certification-evaluation) (**Dependency** scaling).
...
- **What must hold**
  ...
  - **Secondary failure:**
    ...
    - treating this entry as overridden by [Article XIX](core_06-06_rights_part_c.md#article-xix-interoperability-portability-and-exit-integrity) (*Interoperability, Portability, Movement, Refuge, and Exit Integrity*) mechanics without resolving the collision under [Chapter One §6.3.1](core_01_b_interaction_interpretation.md#615-rights-collision-decision-test).
...
- **What it is**
  - **In scope:** The Rights-Floor concept covering community-level continuity for communities with durable historical connection to particular territory, ecosystem, or comparable substrate-context, where that connection is materially implicated in community continuity. Covered continuity domains are:
    ...
    The floor is:
    - community-anchored — distinct from but complementary to the individual-level protections of [Article V-B](core_06-06_rights_part_b.md#article-v-b-nondiscrimination) (*Nondiscrimination*) and [Language, Culture, and Heritage](core_05_band_continuity.md#language-culture-and-heritage-constitutional);
...
- **What it is**
  - **In scope:** The Rights-Floor concept covering substantive adequacy of compensation for productive, contributed, or comparable activity under [Sentience Non-Exclusion](core_05_band_participation.md#sentience-non-exclusion), whether that activity is:
    - waged;
    - contracted;
    - platformed;
    - cooperative; or
...
- **How to measure and assess**
  ...
  - **Secondary measure:** co-measures that can defeat compensation adequacy even where contractual terms are met:
    ...
    **Secondary assessment:** When evaluating the primary trace, read the labor-floor components jointly. Compensation that is nominally adequate does not satisfy this entry if it is sustained by:
    ...
    Also apply:
    - [Dependency](core_05_band_continuity.md#dependency) where any of the following hold compensation below substantive adequacy:
      - reliance asymmetry;
      - lock-in; or
...
- **How to measure and assess**
  ...
  - **Secondary measure:** when any of the following is compromised in a way that interferes with real attribution — even if a credit line exists on paper:
    ...
    **Secondary assessment:** When evaluating the primary trace:
    ...
    - read jointly with [Fair Compensation](core_05_band_continuity.md#fair-compensation-constitutional) under [Article III-D](core_06-06_rights_part_a.md#article-iii-d-labor-and-economic-floor) (*Labor and Economic Floor*) — attribution without compensation, or compensation without attribution, does not satisfy the floor where both are owed; and
...
- **How to measure and assess**
  ...
  - **Tertiary measure:** [Proxy Divergence](core_05_band_oversight.md#proxy-divergence) — where availability, possession, or prior disclosure metrics substitute for lifecycle privacy discipline.

    **Tertiary assessment:** Where operators rely on availability, possession, or prior-disclosure claims, apply [Proxy Divergence](core_05_band_oversight.md#proxy-divergence) — distinguish durable privacy from segmentation or read-across evasion.
...
<a id="trust-c"></a>
- **What must hold**
  - **Primary failure:** isolating **trust** or **reliance** rationales from [Trustworthiness](core_05_band_continuity.md#trustworthiness) requirements, where materially relevant.
  - **Secondary failure:** treating reputation-, history-, scale-, or endorsement-based indicia as sufficient without satisfying [Trustworthiness](core_05_band_continuity.md#trustworthiness), where materially relevant.
...
- **How to measure and assess**
  - **Primary measure:** [Oversight measurement family](core_05_apex_oversight_leg.md#oversight-measurement-family) — *Can sentients see, verify, and rely on what systems represent?*
    ...
    **Primary assessment:** Ask whether the system is trustworthy under the joint evidence requirements below where they matter. Judge by current behavior that can be observed and verified — not by claims, reputation, or past performance alone:
    ...
    - [Auditability](core_05_band_oversight.md#auditability) with independent verification.
  - **Secondary measure:** [Trust](core_05_band_continuity.md#trust), [Auditability](core_05_band_oversight.md#auditability), [Transparency](core_05_band_oversight.md#transparency), [Epistemic Integrity](core_05_band_oversight.md#epistemic-integrity), and [Meaningful Agency](core_05_band_participation.md#meaningful-agency) — co-measures that can defeat trustworthiness even when reputation or history appear favorable.
  ...
  - **Tertiary measure:** [Proxy Divergence](core_05_band_oversight.md#proxy-divergence) — where endorsement, scale, or engagement metrics substitute for observable reliable behavior.
    ...
    **Tertiary assessment:** Where operators rely on reputation, scale, adoption, or proxy satisfaction, apply [Proxy Divergence](core_05_band_oversight.md#proxy-divergence) — distinguish durable trustworthiness from indicator gaming.
...
- **What it is**
  - **In scope:** Evaluation conditions in which material reliance is at stake for decisions, continued participation, or [Oversight](core_05_apex_oversight_leg.md#oversight-constitutional), where that reliance rests on represented:
    - capability;
    - risk;
    - intent;
    - limits;
...
- **How to measure and assess**
  - **Primary measure:** [Oversight measurement family](core_05_apex_oversight_leg.md#oversight-measurement-family) — *Can sentients see, verify, and rely on what systems represent?*
    ...
    **Primary assessment:** First confirm this entry actually applies — material reliance is at stake under the scope above. Then evaluate under these requirements together:
    ...
    - **Verification, challenge, dependency, and exit:** integrate:
      - practical [Verifiability](core_05_band_oversight.md#verifiability);
      - practical [Contestability](core_05_band_accountability.md#contestability);
      - [Dependency](core_05_band_continuity.md#dependency) conditions; and
      - exit conditions under [Systemic Lock-In](core_05_band_continuity.md#systemic-lock-in).
    ...
    - **Proportional intensity scaling:** [Proportional](core_05_band_accountability.md#proportionality) intensity must scale with:
      - [Material Impact](core_05_band_oversight.md#material-impact);
      - stakeholder [Dependency](core_05_band_continuity.md#dependency);
      - [Irreversible Harm](core_05_band_accountability.md#irreversible-harm) risk from failure; and
      - reliance on system outputs for decision-making.
    - **Trust-erosion pattern mapping:** map each materially present pattern through:
      - [Epistemic Integrity](core_05_band_oversight.md#epistemic-integrity);
      - [Truth (Constitutional Constraint)](core_05_band_oversight.md#truth-constitutional-constraint);
      - [Transparency](core_05_band_oversight.md#transparency);
      - [Trustworthiness](core_05_band_continuity.md#trustworthiness);
      - [Contestability](core_05_band_accountability.md#contestability);
  ...
  - **Secondary measure:** [Auditability](core_05_band_oversight.md#auditability) and [Accountability](core_05_apex_accountability_leg.md#accountability) — co-measures for reconstructable records and an attributable answerability chain when trust degrades.
    ...
    **Secondary assessment:** When evaluating the primary trace, ask whether degradation can be:
    - reconstructed under [Auditability](core_05_band_oversight.md#auditability); and
    - attributed to identifiable actors, roles, or system components under [Accountability](core_05_apex_accountability_leg.md#accountability) —
...
**Previous file:** [core_05_band_accountability.md](core_05_band_accountability.md)

**Next file:** [core_05_band_integrative.md](core_05_band_integrative.md)
