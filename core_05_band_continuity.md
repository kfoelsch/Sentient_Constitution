...
- **What it is**
  ...
  - **Out of scope:**
    ...
    ordinary operator artifacts, not the forum-supervised Chapter Eight process.
  ...
  - **Primary measure:** [Continuity measurement family](core_05_apex_continuity_aim.md#continuity-measurement-family) — *Can sentients and systems endure — ecologically, dependably, and across failure?*
    ...
    **Primary assessment:** Evaluate whether:
    ...
    2. the record states, as Chapter Eight requires:
       ...
       - contestability chain and named contestability paths under [Chapter Eight Part B §14.2](core_08_b_system_alignment_certification_record_process.md#142-contestability-paths);
    3. where a Chapter Eight evaluation was required by an applicable materiality trigger, the record states the actual findings from that evaluation — not section titles or checkmarks alone — under [Chapter Eight Part B §11.2](core_08_b_system_alignment_certification_record_process.md#112-cross-section-record-requirements); and
...
- **What must hold**
  - **Primary failure:** The following are non-compliant:
    ...
    - evading Chapter Fifteen validity procedures; or
...
- **What it is**
  - **In scope:** The Rights-Floor concept covering community-level continuity for communities with durable historical connection to particular territory, ecosystem, or comparable substrate-context, where that connection is materially implicated in community continuity. Covered continuity domains are:
    ...
    Route territorial-continuity interactions to **Article I-A** (*Environmental Preconditions and Ecological Integrity*) (ecosystem / precondition integrity) and to [Chapter Seventeen](core_17_incorporation.md) (adopter-jurisdiction discipline). This entry does not adjudicate historical territorial claims or create a restitution mandate.
  - **Out of scope:**
